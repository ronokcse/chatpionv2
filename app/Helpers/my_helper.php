...
if ( ! function_exists('date_time_calculator'))
{
  function date_time_calculator($input_datetime, $format=false,$current_datetime=null,$return_ago_text=true)
  {
    ...
    $ago_text = $return_ago_text ? ' '.lang('ago') : '';
    ...
    if ($format == true) {
      ...
      if ($result['years'] > 0)
          return $result['years']." ".lang("year").$years_plular.$ago_text;
      else if ($result['months'] > 0)
          return $result['months']." ".lang("month").$months_plular.$ago_text;
      else if ($result['days'] > 0)
          return $result['days']." ".lang("day").$days_plular.$ago_text;
      else if ($result['hours'] > 0)
          return $result['hours']." ".lang("hour").$hours_plular.$ago_text;
      else if ($result['minutes'] > 0)
          return $result['minutes']." ".lang("minute").$minutes_plular.$ago_text;
      else if ($result['seconds'] > 0)
          return $result['seconds']." ".lang("second").$seconds_plular.$ago_text;
    }
    else return $result;

                ...
                <div class="card card-success no_radius mb-1 border-0">
                  ...
                  <div class="card-header p-0 bg-whatsapp d-flex flex-column no_radius" id="livechat_menu" style="<?php echo $backgroundStyle; ?>">
                    <h6 class="w-100 clearfix d-flex flex-row p-2 pt-3 pb-0 mb-0">
                        <input type="text" class="border-0 form-control float-start search_list mr-auto" autofocus onkeyup="search_in_subscriber_ul(this,'put_content')" placeholder="<?php echo lang('Search...') ?>">
                        <form class="form-inline mr-auto">   
                          <?php 
                              $current_account = isset($fb_rx_account_switching_info[session()->get('facebook_rx_fb_user_info')]['name']) ? $fb_rx_account_switching_info[session()->get('facebook_rx_fb_user_info')]['name'] : lang('No Account');
                              $fb_img = base_url('assets/img/avatar/avatar-1.png');
                              if(isset($fb_rx_account_switching_info[session()->get('facebook_rx_fb_user_info')]['access_token']))
                              $fb_img = 'https://graph.facebook.com/me/picture?access_token='.$fb_rx_account_switching_info[session()->get('facebook_rx_fb_user_info')]['access_token'].'&width=18&height=18';
                          ?>
                          <ul class="navbar-nav navbar-right d-block ml-2 mr-1 facebook">
                              ...
                              <div class="dropdown-menu dropdown-menu-right acount-switch-lists">
                                  <div class="dropdown-title"><?php echo lang('Interact as'); ?></div>               
                                  <?php 
                    ...
                    <ul class="nav nav-pills d-flex justify-content-between">
                      <li class="nav-item"><a class="text-white nav-link <?php if($message_type == 'all') echo 'active';?>" href="?message=all&media_type=<?php echo $media_type;?>" value="all"><?php echo lang('All')?></a></li>
                      <li class="nav-item"><a class="text-white nav-link <?php if($message_type=='mine') echo 'active';?>" href="?message=mine&media_type=<?php echo $media_type;?>" value="mine"><?php echo lang('Mine')?></a></li>
                      <li class="nav-item"><a class="text-white nav-link <?php if($message_type=='unread') echo 'active';?>" href="?message=unread&media_type=<?php echo $media_type;?>" value="unread"><?php echo lang('Unread')?></a></li>
                      <li class="nav-item"><a class="text-white nav-link <?php if($message_type=='archived') echo 'active';?>" href="?message=archived&media_type=<?php echo $media_type;?>" value="archived"><?php echo lang('Archived')?></a></li>
                    </ul>  
                  </div>
                  ...
                  <div class="bg-light">
                      <select name="whatsapp_bot_id" id="whatsapp_bot_id" class="form-control select2 w-100" autocomplete="off">
                        ...
                        <!-- <option data-wa-business-id="<?php echo $bot->id ;?>" value="<?php echo $bot->id?>" <?php if($bot->id == $first_bot_id) echo 'selected'; ?>><?php echo lang('Using').' : '.$bot->page_name.' ('.str_replace(['-',' '],'',$bot->username).')'; ?></option> -->
                        <option 
                            ...
                            <?php
                            if ($media_type === 'fb') {
                                echo lang('Using') . ' : ' . $bot->page_name . ' (' . str_replace(['-', ' '], '', $bot->username) . ')';
                            } elseif ($media_type === 'ig') {
                                echo lang('Using') . ' : ' . $bot->insta_username;
                            }
                            ?>
                        </option>
                ...
                <div class="card chat-box card-success no-radius mb-1 border-0" style="" id="mychatbox2">
                   ...
                   <div class="card-header pt-0 pb-2 bg-whatsapp no-radius d-flex flex-column" style="height: 106px; <?php echo $backgroundStyle; ?>">  
                        <div class="w-100 d-flex flex-row pt-3">
                            <input type="text" class="border-0 form-control search_list search_list2" onkeyup="search_in_div(this,'conversation_modal_body')" placeholder="<?php echo lang('Search...') ?>">
                            <a class="btn btn-outline-light btn-sm text-muted float-start mt-0 mx-1 action-item ml-2"     title="<?php echo lang('Reload') ?>" name="refresh_data" id="refresh_data"   whatsapp_bot_id="<?php echo $first_bot_id ?>"> <i class="fas fa-sync"></i>
                            </a>
                            <?php $notification_action = $browser_notification_enabled=='0' ? lang('Enable Notification') : lang('Disable Notification');?>
                            ...
                            <a class="btn btn-outline-light btn-sm text-muted float-start mt-0 me-2 mx-1 action-item" href="<?php echo base_url('dashboard');?>" title="<?php echo lang('Back to Dashbaord'); ?>" id=""> <i class="fas fa-less-than"></i></a>
                        </div>
                        <div class="w-100 d-flex flex-row mt-1">
                            <h6 class="w-100 pe-0 mt-2 mt-lg-2-5 mb-2">
                            <!-- <div class=""> -->
                                <a class="btn btn-outline-light btn-sm text-muted me-1 action-item" id="back-to-list" href="" data-toggle="tooltip" title="<?php echo lang('Back to List') ?>"> <i class="fas fa-less-than"></i></a>
                            ...
                            <select name="mark_as_action" id="mark_as_action" class="form-control pb-2 border-white text-white ml-auto mt-2">
                              <option class="text-dark" value=""> <?php echo lang('Mark as');?></option>
                              <option class="text-dark" value="read"> <?php echo lang('Read');?></option>
                              <option class="text-dark" value="unread"> <?php echo lang('Unread');?></option>
                              <option class="text-dark" value="archived"> <?php echo lang('Archived');?></option>
                              <option class="text-dark" value="unarchived"> <?php echo lang('Unarchived');?></option>
                            </select> 
                        </div>
                            ...
                            <div class="col-12 ps-0 pe-0">
                                <div class="input-group">
                                    <div class="d-flex" id="chat_options_left">
                                        ...
                                        <button type="button" title="<?php echo lang('Send Flow or Message Template');?>" class="btn btn-outline-primary" id="postback_reply_button" data-toggle="modal" data-target="#postbackModal" data-wa-business-id="{{$whatsapp_business_id}}">
                                            <i class="fas fa-robot"></i>
                                        </button>
                                        </div>
                                        <?php if($has_livechat_advanced_access) : ?>
                                            <div class="input-group-append">
                                                <button type="button" title="<?php echo lang('Canned Response');?>"class="btn btn-outline-dark" id="canned_response" data-toggle="modal" data-target="#canned_responseModal" data-wa-business-id="<?php echo$whatsapp_business_id;?>">
                                                    <i class="fab fa-autoprefixer"></i>
                                                </button>
                                            </div>                                                                       
                                            <div class="input-group-append">
                                                <button type="button" title="<?php echo lang('Attachment');?>"class="btn btn-outline-warning" id="send_file">
                                                    <i class="fas fa-paperclip"></i>
                                                </button>
                                            </div>
                                            <div class="input-group-append">
                                                <button type="button" title="<?php echo lang('Audio Record');?>"class="btn btn-outline-success" id="record_audio_message">
                                   ...
                                   <textarea type="text" id="reply_message" class="form-control border ms-1" placeholder="<?php echo lang('Type a message..');?>"></textarea>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title full_width" id="postbackModalLabel">
                        <i class="fas fa-paper-plane"></i> <?php echo lang('Send Flow or Message Template')?>
                        <input type="text" class="form-control d-inline float-end me-2" autofocus style="width: 130px;" autofocus="" onkeyup="search_in_class(this,'item-searchable')" placeholder="<?php echo lang('Search');?>">
                    </h5>
                ...
                <div class="modal-body" style="height:550px;overflow:auto">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link border-0 text-dark" id="pills-bot-flow-tab" data-toggle="pill" data-target="#pills-bot-flow" type="button" role="tab" aria-controls="pills-bot-flow" aria-selected="true"><?php echo lang('Bot Flow');?></button>
                        </li>
                        <!-- <li class="nav-item" role="presentation">
                            <button class="nav-link border-0 text-dark" id="pills-message-template-tab" data-toggle="pill" data-target="#pills-message-template" type="button" role="tab" aria-controls="pills-message-template" aria-selected="false"><?php echo lang('Message Template');?></button>
                        </li> -->
                    </ul>
                ...
                <form class="template-modal-form" action="#" method="post">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title full_width" id="template-modal-label">
                            <i class="fas fa-th-large"></i> <?php echo lang('Template'); ?> : <span></span>
                        </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;</button>
                    </div>
                        ...
                        <div id="bot-template-header-media-wrapper" class="form-group text-left mt-2 d-none">
                            <div class="header-media">
                                <div class="header-media-url pb-2">
                                    <label for="bot-template-header-media-url-input" class="pb-1"><?php echo lang('Media URL'); ?></label>
                                    <input type="text" class="form-control" id="bot-template-header-media-url-input" placeholder="<?php echo lang('Put media url here or click the upload box'); ?>">
                                ...
                                <div class="header-media-dropzone">
                                    <label for="" class="pb-1"><?php echo lang('Upload media'); ?></label>
                    ...
                    <div class="modal-footer d-flex align-items-center justify-content-between">
                        ...
                        <button type="submit" id="send-message-template-action" class="btn btn-primary"><?php echo lang('Submit'); ?></button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title full_width" id="canned_responseModalLabel">
                        <i class="fas fa-paper-plane"></i> <?php echo lang('Canned Response');?>&nbsp;&nbsp;
                        <button id="btnAddNew" type="button" class="btn btn-outline-primary " aria-expanded="false">
                        <i class="fas fa-plus-circle"></i> <?php echo lang('Add New');?></button>
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;</button>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title full_width" id="send_fileModalLabel">
                        <i class="fas fa-paperclip"></i> <?php echo lang('Send Attachment')?>
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;</button>
                </div>
                <div class="modal-body" style="height:550px;overflow:auto">
                    <div id="livechat-dropzone" class="dropzone mb-1">
                        <div class="dz-default dz-message">
                            ...
                            <span style="font-size: 20px;"><i class="fas fa-cloud-upload-alt" style="font-size: 35px;color: #6777ef;"></i> <?php echo lang('Upload') ;?></span>
                        </div>
                    </div>
                    <input type="text" class="form-control" placeholder="<?php echo lang('Instead of uploading, you can paste the attachment URL')?>" id="livechat-current-item-url">

<script>
    ...
    var global_lang_loading = '<?php echo lang('Loading') ?>';

    var whatsapp_bot_manager_lang_webhook_data_view_no_data = '<?php echo lang('No data available to show') ?>';
    ...
    if(filter.length>=3 && count_li==0){
        ...
        $.ajax({
            ...
            url:"<?php echo site_url();?>livechat/search_subscriber",
            type:'POST',

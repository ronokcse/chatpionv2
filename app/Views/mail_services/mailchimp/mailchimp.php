<section class="section section_custom">
	<div class="section-header">
		<h1><i class="fab fa-mailchimp"></i> <?php echo lang('Mailchimp Integration'); ?></h1>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-plus-circle"></i> Mailchimp - <?= lang('Add Account') ?></h5>
            ...
            <div class="modal-body">
                <form class="" id="mailchimp-integration-form">
		            ...
		            <div class="mt-5">           
		            	<button type="submit" class="btn btn-primary btn-shadow float-left" id="mailchimp-submit-button"><i class="fas fa-save"></i> <?= lang('Save') ?></button>
...
<div class="modal fade" tabindex="-1" role="dialog" id="mailchimp-details-modal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-list"></i> Mailchimp - <?= lang('Account Details') ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">               
                	<span aria-hidden="true">×</span>          
                </button>           
            </div>

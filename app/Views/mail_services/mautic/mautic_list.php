...
<section class="section section_custom">
	<div class="section-header">
		<h1><i class="fas fa-mail-bulk"></i> <?php echo lang('Mautic Integration'); ?></h1>
							...
							<table id="mautic-datatable" class="table table-bordered" style="width:100%">
						        <thead>
						            <tr>
						                ...
						                <th><?php echo lang('Mautic Base URL'); ?></th>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-plus-circle"></i> Mautic - <?= lang('Add Account') ?></h5>
            ...
            <div class="modal-body">
                <form class="" id="mautic-integration-form">
                    ...
                    <div class="form-group">
                        <label><?= lang('Mautic Base URL') ?></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                    ...
                    <div class="form-group">
                        <label><?= lang('Mautic account username') ?></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                    ...
                    <div class="form-group">
                        <label><?= lang('Mautic account password') ?></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
		            ...
		            <div class="mt-5">           
		            	<button type="submit" class="btn btn-primary btn-shadow btn-lg float-left" id="mautic-submit-button"><i class="fas fa-save"></i> <?= lang('Save') ?></button>
		            	<button type="button" class="btn btn-secondary btn-lg btn-shadow float-right" data-dismiss="modal"><i class="fas fa-times"></i> <?= lang('Cancel') ?></button>
		            </div>
	            </form>
            </div>
        </div>
...
<div class="modal fade" role="dialog" id="mautic-details-modal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-list"></i> Mautic - <?= lang('Account Details') ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">               
                	<span aria-hidden="true">×</span>          
                </button>           
            </div>

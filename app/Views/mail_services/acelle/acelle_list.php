...
<section class="section section_custom">
	<div class="section-header">
		<h1><i class="fas fa-box-open"></i> <?php echo lang('Acelle Integration'); ?></h1>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-plus-circle"></i> Acelle - <?= lang('Add Account') ?></h5>
            ...
            <div class="modal-body">
                <form class="" id="acelle-integration-form">
		            ...
		            <div class="mt-5">           
		            	<button type="submit" class="btn btn-primary btn-shadow btn-lg float-left" id="acelle-submit-button"><i class="fas fa-save"></i> <?= lang('Save') ?></button>
		            	<button type="button" class="btn btn-lg btn-secondary btn-shadow float-right" data-dismiss="modal"><i class="fas fa-times"></i> <?= lang('Cancel') ?></button>
		            </div>
	            </form>
            </div>
        </div>
...
<div class="modal fade" role="dialog" id="acelle-details-modal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document" style="min-width:40%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-list"></i> Acelle - <?= lang('Account Details') ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">               
                	<span aria-hidden="true">×</span>          
                </button>           
            </div>

...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
      <a class="btn btn-primary" id="add_feed" data-toggle="modal" href='#add_feed_modal'><i class="fas fa-plus-circle"></i> <?php echo lang('New Auto Posting Feed');?></a>
   </div>
  ...
  <div class="section-body">
    <div class='text-center text-primary' style='padding:12px;border:.5px solid #dee2e6;background: #fff;'><?php echo lang('RSS auto posting will be publised as Link post.It will post once any new feed comes to RSS feed after setting it in the system. It will not post any existing feeds during setup the campaign.') ?></div>
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
...
<script type="text/javascript">
  $("document").ready(function(){
    ...
    $(document).on('click','.force_process',function(e){ 
      ...
      swal({
        title: '<?php echo lang('Delete Campaign'); ?>',
        text: '<?php echo lang('Do you really want to force process this campaign? This can be helpful if your RSS posting tools have stopped for some unknown reasons and not responding.'); ?>',
        icon: 'warning',
        buttons: true,
        dangerMode: true,
      })
    ...
    $(document).on('click','#add_feed_submit',function(){ 
      ...
      if(feed_url=='')
      {
        swal('<?php echo lang('Error'); ?>', "<?php echo lang('Feed URL can not be empty');?>" , 'error');
        return;
      }
...
<div class="modal fade" id="add_feed_modal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title"><i class="fas fa-rss"></i> <?php echo lang('Auto-Posting Feed') ?></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>

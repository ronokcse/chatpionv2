  ...
  <div class="section-header">
    ...
    <div class="section-header-button">
     <a class="btn btn-primary enable_page_response" href="#">
        <i class="fas fa-plus-circle"></i> <?php echo lang('Create new template'); ?>
     </a> 
    </div>
              ...
              <table class="table table-bordered" id="mytable">
                <thead>
                  <tr>
                    ...
                    <th><?php echo lang('Template Name'); ?></th>
...
<script>
  ...
  $(document).ready(function(){
    ...
    $(document).on('click','.delete_reply_info',function(e){
        e.preventDefault();
        var doDelete = "<?php echo lang('are you sure that you want to delete this record?'); ?>";
        swal({
    ...
    <div class="modal-dialog modal-lg"  style="min-width: 70%;">
          ...
          <div id="new_template_section">
            ...
            <div class="row" style="padding: 10px 20px 10px 20px;">                
              <div class="col-12 col-md-4">
                <label><i class="fas fa-file-alt"></i> <?php echo lang('Please select a page for auto-reply') ?></label>
              </div>
              <div class="col-12 col-md-8">
                <select class="form-control select2" id="page_ids" name="page_ids[]">
                  <option><?php echo lang('Select a page'); ?></option>
                <?php
              ...
              <div class="col-12" style="margin-top: 15px;">
                <div class="form-group">
                  <label>
                    ...
                    <a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('message') ?>" data-content="<?php echo lang('write your auto reply campaign name here') ?>"><i class='fa fa-info-circle'></i> </a>
                  </label>
        ...
        <input type="hidden" name="btn_type" value="" id="submit_btn_values">
            ...
            <div class="modal-footer" style="padding-left: 45px; padding-right: 45px; ">
              <div class="row">
                <div class="col-6">
                  <button class="btn btn-lg btn-primary float-left" id="save_button"><i class='fa fa-save'></i> <?php echo lang('save') ?></button>
                </div>  
                <div class="col-6">

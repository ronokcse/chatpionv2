<script>
  ...
  $(document).on('click','.fullpage_pause_play',function(e){
    ...
    var warning_content = '';
    if(to_do == 'play')
      warning_content = "<?php echo lang('Do you really want to start full page campaign?'); ?>";
    else
      warning_content = "<?php echo lang('Do you really want to stop full page campaign?'); ?>";

...
$(document).ready(function(){
	...
	$(document).on('click','#save_button_template',function(){
		...
		{
			swal('<?php echo lang('Warning'); ?>', Youdidntselectanyoptionyet, 'warning');
			return false;
		}	

		if(auto_campaign_name_template == ''){
			swal('<?php echo lang('Warning'); ?>', TypeAutoCampaignname, 'warning');
			return false;
		}	
		...
		if(schedule_type == ''){
			swal('<?php echo lang('Warning'); ?>', YouDidnotchosescheduleType, 'warning');
			return false;
		}
		...
		{
			if(schedule_time == ''){
				swal('<?php echo lang('Warning'); ?>', YouDidnotchosescheduletime, 'warning');
				return false;
			}				
			if(time_zone == ''){
				swal('<?php echo lang('Warning'); ?>', YouDidnotchosescheduletimezone, 'warning');
				return false;
			}
		}
		...
		{
			if(periodic_time == ''){
				swal('<?php echo lang('Warning'); ?>', YoudidnotSelectPerodicTime, 'warning');
				return false;
			}
			...
			if(campaign_start_time == ''){
				swal('<?php echo lang('Warning'); ?>', YoudidnotSelectCampaignStartTime, 'warning');
				return false;
			}			
			if(campaign_end_time == ''){
				swal('<?php echo lang('Warning'); ?>', YoudidnotSelectCampaignEndTime, 'warning');
				return false;
			}
			...
			if( comment_start_time== '' ||  comment_end_time== ''){
				swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please select comment between times.');?>", 'warning');
				return false;
			}

			if(rep1 >= rep2)
			{
				swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Comment between start time must be less than end time.');?>", 'warning');
				return false;
			}
		}        
	...
	$(document).on('click','#edit_save_button_template',function(){
		...
		if($("#edit_auto_comment_template_id").val()== 0){
			swal('<?php echo lang('Warning'); ?>', '<?php echo lang('you have not select any template.');?>', 'warning');
			return false;
		}	

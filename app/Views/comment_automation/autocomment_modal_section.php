	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-header">
			  <h5 class="modal-title padding_10_20_10_20px" ><?php echo lang('Please give the following information for post auto comment') ?></h5>
				...
				<div class="row padding_20px">
					...
					<div class="col-12 margin_top_15">
						<div class="form-group">
							...
							<br>
							<input class="form-control" type="text" name="auto_campaign_name_template" id="auto_campaign_name_template" placeholder="<?php echo lang('Write your campaign name here'); ?>">
						</div>
					</div>
					<div class="col-12">
						...
						<div class='schedule_block_item_new instagram_padded_bordered_background_schedule_block'>
							...
							<div class="row">								
								<div class="form-group schedule_block_item_new col-12 col-md-6">
									...
									<input placeholder="<?php echo lang('Time'); ?>"  name="campaign_start_time" id="campaign_start_time" class="form-control datepicker_x" type="text"/>
								</div>						
								<div class="form-group schedule_block_item_new col-12 col-md-6">
									<label><?php echo lang('Campaign End time'); ?></label>
									<input placeholder="<?php echo lang('Time'); ?>"  name="campaign_end_time" id="campaign_end_time" class="form-control datepicker_x" type="text"/>
								</div>
							</div>
							...
							<div class="row">								
								<div class="form-group schedule_block_item_new col-12 col-md-6">
									...
									<input placeholder="<?php echo lang('Time'); ?>" value="00:00"  name="comment_start_time" id="comment_start_time" class="form-control datetimepicker2" type="text"/>
								</div>
						

								<div class="form-group schedule_block_item_new col-12 col-md-6">								
									<label class="instagram_relative_top_right_22px"><?php echo lang('to'); ?></label> 
									<input placeholder="<?php echo lang('Time'); ?>" value="23:59"  name="comment_end_time" id="comment_end_time" class="form-control datetimepicker2" type="text"/>
								</div>
							</div>
			...
			<div class="modal-footer padding_0_45px">
			  <div class="row">
			    <div class="col-6">
			      <button class="btn btn-lg btn-primary float-left" id="save_button_template"><i class='fa fa-save'></i> <?php echo lang('save') ?></button>
			    </div>  
			    <div class="col-6">
	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
				...
				<div class="row padding_20px">
					...
					<div class="col-12 margin_top_15">
						<div class="form-group">
							...
							<br>
							<input class="form-control"type="text" name="edit_campaign_name_template" id="edit_campaign_name_template" placeholder="<?php echo lang('Write your campaign name here'); ?>">
						</div>
					</div>
			...
			<div class="modal-footer padding_0_45px">
			  <div class="row">
			    <div class="col-6">
			      <button class="btn btn-lg btn-primary float-left" id="edit_save_button_template"><i class='fa fa-save'></i> <?php echo lang('save') ?></button>
			    </div>  
			    <div class="col-6">
			      <button class="btn btn-lg btn-secondary float-right cancel_button"><i class='fas fa-times'></i> <?php echo lang('cancel') ?></button>
			    </div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h5 class="modal-title"><?php echo lang('please provide a post id of page') ?> (<span id="manual_page_name"></span>)</h5>
			</div>
			<div class="modal-body ">
				<div class="row">
					...
					<div class="col-12 col-md-8 col-md-offset-2">
						<form>
							<div class="form-group">
							  <label for="manual_post_id_template"><?php echo lang('post id') ?> :</label>
							  <input type="text" class="form-control" id="manual_post_id_template" placeholder="<?php echo lang('please give a post id') ?>" value="">
							  <input type="hidden" id="manual_table_id_template">
							</div>
							<div class="text-center" id="manual_reply_error_template"></div>
						 
							<div class="form-group text-center">
							  <button type="button" class="btn btn-primary enable_auto_commnet_template" id="manual_auto_reply_template"><i class="fa fa-check-circle"></i> <?php echo lang('Enable Auto Comment') ?></button>
							</div>
						 </form>
						 <div class="form-group text-center">
							<button type="button" class="btn btn-outline-warning" id="check_post_id_template"><i class="fa fa-check"></i> <?php echo lang('check existance') ?></button>
						 </div>
...
<div class="modal fade" id="manual_edit_reply_by_post_template" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h5 class="modal-title"><?php echo lang('please provide a post id of page') ?> (<span id="manual_edit_page_name_template"></span>)</h5>
			</div>
			<div class="modal-body ">
				<div class="row">
					<div class="col-12" id="waiting_div"></div>
					<div class="col-12 col-md-8 col-md-offset-2">
						<form>
							<div class="form-group">
							  <label for="manual_post_id_template"><?php echo lang('post id') ?> :</label>
							  <input type="text" class="form-control" id="manual_edit_post_id_template" placeholder="<?php echo lang('please give a post id') ?>" value="">
						...
						<div class="form-group text-center margin_top_15">
						   <button type="button" class="btn btn-outline-warning edit_reply_info_template" id="manual_edit_auto_reply_template"><i class="fa fa-edit"></i> <?php echo lang('Edit Auto Comment') ?></button>
						</div>

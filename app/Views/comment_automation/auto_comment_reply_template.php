        ...
        <div class="modal-content">
            <form method="post" id="add_name">
                <div class="modal-header">
                    <h5 class="modal-title text-center"><i class="fa fa-th-large"></i> <?php echo lang('Please Give The Following Information For Post Auto Comment'); ?></h5>
                ...
                <div class="modal-body pb-0">
                    ...
                    <div class="form-group">
                        <input type="text" name="template_name" id="name" class="form-control" placeholder="<?php echo lang('Your Template Name'); ?>" />
                    </div>
                    <div id="dynamic_field">

                    </div>

                    <button type="button" name="add_more" id="add_more" class="font_size_10px text-center btn btn-sm btn-outline-primary add_more_edit float-right"><i class="fa fa-plus-circle"></i> <?php echo lang('add more'); ?></button>
                    <button type="button" id="add_more_new" class="font_size_10px text-center btn btn-sm btn-outline-primary add_more_new float-right">
                        <i class="fa fa-plus-circle"></i> <?php echo lang('add more'); ?>
                    </button>
                ...
                <div class="modal-footer mt-2">
                    ...
                    <button type="submit" name="submit" id="submit" class="btn btn-primary btn-lg"><i class='fa fa-save'></i> <?php echo lang('Save'); ?></button>
                    <button class="btn btn-lg btn-secondary float-right" data-dismiss="modal"><i class="fas fa-times"></i> <?php echo lang('Cancel'); ?></button>
...
<div class="modal fade" id="delete_template_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-center"><?php  echo lang('Template Delete Confirmation') ?></h4>

	        ...
	        <div class="card">
	          <div class="card-body data-card">
	          	<div class="input-group mb-3" id="searchbox">
	          	    ...
	          	    <input type="text" class="form-control" id="campaign_name" autofocus placeholder="<?php echo lang('Search...'); ?>" aria-label="" aria-describedby="basic-addon2" value="<?php if($post_id != 0) echo $post_id; ?>">
	...
	$(document).on('click','.renew_campaign',function(){		
		...
		$.ajax({
			...
			success:function(response){
				if(response == 'success')
				{
					iziToast.success({title: '',message: '<?php echo lang('Campaign has been renewed successfully.'); ?>',position: 'bottomRight'});
					table.draw();
				}
				if(response == 'error')
				{
			...
			if (willDelete) 
			{
				...
				$.ajax({
					...
					success:function(response){ 
						if(response=='1')
						{
							iziToast.success({title: '',message: "<?php echo lang('Force processing has been enabled successfully.'); ?>",position: 'bottomRight'});
							table.draw();
						}
						else 
    ...
    <div class="modal-dialog modal-mega">
        <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><i class="fas fa-reply-all"></i> <?php echo lang('Report of Auto Reply');?>
              	<small>
              	(
              	<?php 

      ...
      <div class="card main_card">
        <div class="card-header">
          <div class="col-6 padding-0">
            <h4><?php if($media_type =='ig') echo lang('Accounts'); else echo lang('Pages'); ?></h4>
          </div>
          <div class="col-6 padding-0">            
          ...
          <div class="makeScroll">
            <ul class="list-group" id="page_list_ul">
              <?php $i=0; foreach($page_info as $value) { ?> 
                <li class="list-group-item <?php if($i==0 || $value['id']==session()->get('selected_global_page_table_id')) echo 'active'; ?> page_list_item" page_table_id="<?php echo $value['id']; ?>">
                  <div class="row">
      ...
      <div class="card main_card">
        <div class="card-header padding-left-10 padding-right-10">
          ...
          <div class="col-4 padding-0 text-center">
            <a class="btn btn-outline-primary variables" href="#"><i class="fas fa-plus-circle"></i> <?php echo lang('Variables'); ?></a>
          </div>
          <?php else : ?>
          <div class="col-4 padding-0 text-center">
          </div>
          ...
          <div class="col-4 padding-0">
            <a href="#" data-toggle="dropdown" class="btn btn-outline-primary dropdown-toggle float-right"><?php echo lang('Options');?></a> 
            <ul class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="width: 250px;">
              <div class="dropdown-title"><?php echo lang('Actions');?></div>
              <?php if($media_type != 'ig') : ?>
              <li><a class="dropdown-item has-icon analytics_page" href="#"> <i class="far fa-chart-bar"></i> <?php echo lang('Page Analytics');?></a></li>
                      ...
                      <div class="col-12 col-md-6">
                          <a href="#" class="pointer">
                            <div class="card card-large-icons card-condensed">
                              ...
                              <div class="card-body">
                                <h4><?php echo lang('Checkbox Plugin'); ?></h4>
                              </div>
                            </div>
                          </a>
                      ...
                      <div class="col-12 col-md-6">
                        <a href="#" class="pointer">
                          <div class="card card-large-icons card-condensed">
                            ...
                            <div class="card-body">
                              <h4><?php echo lang('Send to Messenger'); ?></h4>
                            </div>
                          </div>
                        </a>
                      </div>
                      ...
                      <div class="col-12 col-md-6">
                        <a href="#" class="pointer">
                          <div class="card card-large-icons card-condensed">
                            ...
                            <div class="card-body">
                              <h4><?php echo lang('Customer Chat Plugin'); ?></h4>
                            </div>
                          </div>
                        </a>
                      </div>
                            ...
                            <div class="modal-content no_shadow">
                                <div class="modal-body padding-0" id="enable_start_button_modal_body">
                                  ...
                                  <div class="<?php if($media_type == "ig") echo "hidden"; ?>">
                                    <div class="section">                
                                       <h2 class="section-title"  style="margin-top:0"><?php echo lang('Get started & welcome message'); ?></h2>
                                       <!-- <p>&nbsp;</p>                                    -->
                                     </div>
                                     <br>
                                     <div class="form-group">
                                       <label><?php echo lang('Get started button status');?></label>
                                     ...
                                     <div class=""  id="delay_con2">
                                       <div class="form-group">
                                         <label>
                                           <?php echo lang('Welcome Message');?>
                                           <a href="#" data-placement="bottom" data-html="true"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Welcome Message') ?>" data-content="<?php echo lang('The greeting text on the welcome screen is your first opportunity to tell a person why they should start a conversation with your Messenger bot. Some things you might include in your greeting text might include a brief description of what your bot does, such as key features, or a tagline. This is also a great place to start establishing the style and tone of your bot.Greetings have a 160 character maximum, so keep it concise.')."<br><br>".lang('Variables')." : <br>{{user_first_name}}<br>{{user_last_name}}<br>{{user_full_name}}"; ?>">&nbsp;&nbsp;<i class='fa fa-info-circle'></i> </a>
                                         </label>
                                    
                                    
                                           <span class='float-right'> 
                                             <a title="<?php echo lang('You can include {{user_last_name}} variable inside your message. The variable will be replaced by real names when we will send it.') ?>" data-toggle="tooltip" data-placement="top" class='btn-sm getstarted_lead_last_name button-outline'><i class='fa fa-user'></i> <?php echo lang('last name') ?></a>
                                           </span>
                                           <span class='float-right'> 
                                             <a title="<?php echo lang('You can include {{user_first_name}} variable inside your message. The variable will be replaced by real names when we will send it.') ?>" data-toggle="tooltip" data-placement="top" class='btn-sm getstarted_lead_first_name button-outline'><i class='fa fa-user'></i> <?php echo lang('first name') ?></a>
                                           </span> 
                                    
                                           <div class="clearfix"></div>      
                                    
                                         <textarea name="welcome_message" id="welcome_message" class="form-control" style="height:100px;"></textarea>
                                         <a href="#" target="_BLANK" class="btn btn-outline-warning float-right btn-sm" id="getstarted_button_edit_url"><i class="far fa-edit"></i> <?php echo lang('edit get started reply');?></a>   
                                       </div>
                                     </div>
                                    <br><br>
                                  </div>
                                    ...
                                    <!-- ice breaker section -->
                                    <div class="section">                
                                      <h2 class="section-title"><?php echo lang('Ice breakers'); ?> <i class="fas fa-info-circle text-primary" id="ice_breaker_info"></i></h2>
                                      <p><?php echo lang('FAQ : Frequently Asked Questions'); ?>   </p>                                   
                                    </div>
                                    <br>
                                    ...
                                    <div class="input-group" style="margin-bottom: 15px;">                            
                                      <div class="input-group-prepend">
                                        <div class="input-group-text" style="font-weight: bold;">
                                          <?php echo lang('Ice Breakers Status'); ?>
                                        </div>
                                      </div>
                                    ...
                                    <div class="clearfix"> 
                                        <a href="#" target="_BLANK" id="enable_start_button_submit" class="btn-lg btn btn-primary float-left"><i class="fa fa-check-circle"></i> <?php echo lang('save');?></a>            
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                          ...
                          <div class="modal-content no_shadow">
                              <div class="modal-body padding-0 ">
                                    ...
                                    <div class="form-group <?php if($media_type == "ig") echo "hidden"; ?>">
                                      <label><?php echo lang('Mark as seen status');?></label>
                                    ...
                                    <div class="form-group">
                                      <label>
                                        <?php echo lang('Chat with human Email');?>
                                      </label>
                                    ...
                                    <div class="form-group">
                                      <label class="custom-switch">
                                        ...
                                        <span class="custom-switch-description"><?php echo lang('Reply if no match found');?></span>
                                      </label>
                                    </div>
                                    ...
                                    <?php if(session()->get('user_type') == 'Admin' || in_array(265,$module_access)) : ?>
                                      <div class="<?php if($media_type == "ig") echo "hidden"; ?>">
                                        <div class="section">                
                                          ...
                                          <p><?php echo lang('Send collected email from Quick Reply to your MailChimp account list. Page Name will be added as Tag Name in your MailChimp list.'); ?></p>
                                        </div>
                                        <div class="form-group">
                                          <label style="width: 100%;">
                                            <?php echo lang('Select MailChimp List'); ?>
                                            <a href="" class="text-danger float-right error_log_report2" data-type="Email Autoresponder" data-service="Mailchimp"><i class="fas fa-history"></i> <?php echo lang('API Log'); ?></a>                                        
                                          </label>
                                        ...
                                        <div class="section">                
                                          <h2 class="section-title"><?php echo lang('Sendinblue Integration'); ?> <span style="font-size: 12px !important;"><a href="<?php echo base_url('email_auto_responder_integration/sendinblue_list'); ?>" target="_BLANK"><?php echo lang('Add Sendinblue API'); ?></a></span></h2>
                                          <p><?php echo lang('Select Sendinblue list where email will be sent when user signup.'); ?></p>
                                        </div>
                                        <div class="form-group">
                                          <label style="width: 100%;">
                                            <?php echo lang('Select Sendinblue List'); ?>
                                            <a href="" class="text-danger float-right error_log_report2" data-type="Email Autoresponder" data-service="Sendinblue"><i class="fas fa-history"></i> <?php echo lang('API Log'); ?></a>                                        
                                          </label>
                                        ...
                                        <div class="section">                
                                          <h2 class="section-title"><?php echo lang('Activecampaign Integration'); ?> <span style="font-size: 12px !important;"><a href="<?php echo base_url('email_auto_responder_integration/activecampaign_list'); ?>" target="_BLANK"><?php echo lang('Add Activecampaign API'); ?></a></span></h2>
                                          <p><?php echo lang('Select Activecampaign list where email will be sent when user signup.'); ?></p>
                                        </div>
      
                                        <div class="form-group">
                                          <label style="width: 100%;">
                                            <?php echo lang('Select Activecampaign List'); ?>
                                            <a href="" class="text-danger float-right error_log_report2" data-type="Email Autoresponder" data-service="Activecampaign"><i class="fas fa-history"></i> <?php echo lang('API Log'); ?></a>                                        
                                          </label>
                                        ...
                                        <div class="section">                
                                          <h2 class="section-title"><?php echo lang('Mautic Integration'); ?> <span style="font-size: 12px !important;"><a href="<?php echo base_url('email_auto_responder_integration/mautic_list'); ?>" target="_BLANK"><?php echo lang('Add Mautic API'); ?></a></span></h2>
                                          <p><?php echo lang('Select Mautic list where email will be sent when user signup. Page name will be added as tag name in your Mautic list.'); ?></p>
                                        </div>
                                        <div class="form-group">
                                          <label style="width: 100%;">
                                            <?php echo lang('Select Mautic List'); ?>
                                            <a href="" class="text-danger float-right error_log_report2" data-type="Email Autoresponder" data-service="Mautic"><i class="fas fa-history"></i> <?php echo lang('API Log'); ?></a>                                        
                                          </label>
                                        ...
                                        <div class="section">                
                                          <h2 class="section-title"><?php echo lang('Acelle Integration'); ?> <span style="font-size: 12px !important;"><a href="<?php echo base_url('email_auto_responder_integration/acelle_list'); ?>" target="_BLANK"><?php echo lang('Add Acelle API'); ?></a></span></h2>
                                          <p><?php echo lang('Select Acelle list where email will be sent when user signup.'); ?></p>
                                        </div>
                                        <div class="form-group">
                                          <label style="width: 100%;">
                                            <?php echo lang('Select Acelle List'); ?>
                                            <a href="" class="text-danger float-right error_log_report2" data-type="Email Autoresponder" data-service="Acelle"><i class="fas fa-history"></i> <?php echo lang('API Log'); ?></a>                                        
                                          </label>
                                    ...
                                    <?php if(session()->get('user_type') == 'Admin' || in_array(264,$module_access)) : ?>
                                      <div class="<?php if($media_type == "ig") echo "hidden"; ?>">
                                        <div class="section">                
                                          ...
                                          <p><?php echo lang('Send automated SMS to users who provide phone number through Quick Reply.'); ?></p>
                                        </div>
                                        <div class="form-group">
                                          <label style="width: 100%;">
                                            <?php echo lang('Select SMS API'); ?>
                                            <a href="" class="text-danger float-right error_log_report2" data-type="SMS Sender"><i class="fas fa-history"></i> <?php echo lang('API Log'); ?></a>                                        
                                          </label>

                                          <select class="form-control select2" id="sms_api_id" name="sms_api_id">
                                            <option value=''><?php echo lang('Select API');?></option>
                                            <?php 
                                        ...
                                        <div class="form-group">
                                          <label> <?php echo lang('SMS Reply Message');?> </label>

                                            <span class='float-right'> 
                                              <a title="<?php echo lang('You can include {{user_last_name}} variable inside your message. The variable will be replaced by real names when we will send it.') ?>" data-toggle="tooltip" data-placement="top" class='btn-sm sms_api_last_name button-outline'><i class='fa fa-user'></i> <?php echo lang('last name') ?></a>
                                            </span>
                                            <span class='float-right'> 
                                              <a title="<?php echo lang('You can include {{user_first_name}} variable inside your message. The variable will be replaced by real names when we will send it.') ?>" data-toggle="tooltip" data-placement="top" class='btn-sm sms_api_first_name button-outline'><i class='fa fa-user'></i> <?php echo lang('first name') ?></a>
                                            </span> 
                                    ...
                                    <div class="<?php if($media_type == "ig") echo "hidden"; ?>">
                                        <div class="section">                
                                          <h2 class="section-title"><?php echo lang('Email Integration'); ?> <span style="font-size: 12px !important;"><a href="<?php echo base_url('messenger_bot_broadcast/index'); ?>" target="_BLANK"><?php echo lang('Add Email API'); ?></a></span></h2>
                                          <p><?php echo lang('Send automated Email to users who provide email address through Quick Reply.'); ?></p>
                                        </div>
                                      <div class="form-group">
                                        <label style="width: 100%;">
                                          <?php echo lang('Select Email API'); ?>
                                          <a href="" class="text-danger float-right error_log_report2" data-type="Email Sender"><i class="fas fa-history"></i> <?php echo lang('API Log'); ?></a>                                        
                                        </label>
                                      ...
                                      <div class="form-group">
                                        <label> <?php echo lang('Email Reply Message');?> </label>

                                          <span class='float-right'> 
                                            <a title="<?php echo lang('You can include {{user_last_name}} variable inside your message. The variable will be replaced by real names when we will send it.') ?>" data-toggle="tooltip" data-placement="top" class='btn-sm email_api_last_name button-outline'><i class='fa fa-user'></i> <?php echo lang('last name') ?></a>
                                          </span>
                                          <span class='float-right'> 
                                            <a title="<?php echo lang('You can include {{user_first_name}} variable inside your message. The variable will be replaced by real names when we will send it.') ?>" data-toggle="tooltip" data-placement="top" class='btn-sm email_api_first_name button-outline'><i class='fa fa-user'></i> <?php echo lang('first name') ?></a>
                                          </span> 
                                    ...
                                    <?php if ($basic->is_exist("add_ons",array("project_id"=>70)) && (session()->get('user_type') == 'Admin' || in_array(351, $module_access))){ ?>
                                      <div class="section">                
                                          ...
                                          <div class="form-group">
                                            <label style="width: 100%;">
                                              <?php echo lang('Select Google Sheet List'); ?>
                                              <a href="" class="text-danger float-right error_log_report2" data-type="Email Autoresponder" data-service="GoogleSheet"><i class="fas fa-history"></i> <?php echo lang('API Log'); ?></a>                                        
                                            </label>
                                    ...
                                    <a href="#" id="mark_seen_save_button" class="btn-lg btn btn-primary"><i class="fa fa-check-circle"></i> <?php echo lang('Save');?></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title"><?php echo lang('Upload Text File'); ?></h3>
      ...
      <div class="modal-body">
          <div class="form-group">
              <label for=""><?php echo lang('Select a text file'); ?></label>
              <div>
                  <input type="file" name="file" id="file" class="form-control" accept=".txt">
                  <span class="small text-muted"> <?php echo lang('File type support : only .txt'); ?> </span>
              </div>
          </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="saveImport"  class="btn btn-primary"><?php echo lang('Save changes'); ?></button>
      </div>
      </form>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
        ...
        if (file) {
            ...
            $.ajax({
                ...
                success: function(response) {
                  ...
                  {
                    swal('<?php echo lang('Error'); ?>', response.message, 'error').then((value) => {
                          $(".page_list_item.active").click();
                      });
                  }
                }
          ...
          swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Please attatch a file'); ?>', 'error').then((value) => {
            $(".page_list_item.active").click();
          });
        }
    });
    ...
    $(document).on('click', '#add_more_question_button', function(event) {
      ...
      $.ajax({
        ...
        success:function(response){
          ...
          {
            $('.add_more_question_block').before('<div class="single_question_block"><p class="clearfix"><b><?php echo lang('Question Block'); ?></b> <button class="btn btn-sm btn-outline-secondary float-right remove_question_div"><i class="fas fa-times"></i> <?php echo lang('Remove'); ?></button></p><div class="input-group" style="margin-bottom: 5px;"><div class="input-group-prepend"><div class="input-group-text" style="font-weight: bold;"><?php echo lang('Type your question'); ?></div></div><input class="form-control" type="text" name="questions[]"></div><div class="input-group"><div class="input-group-prepend"><div class="input-group-text" style="font-weight: bold;"><?php echo lang('Reply Message Template'); ?></div></div><select class="form-control" id="select_tag_id_'+question_block_counter+'" name="question_replies[]">'+response+'</select></div><a href="" class="add_template float-left"><i class="fa fa-plus-circle"></i>     <?php echo lang('Add Message Template'); ?></a><a href="" class="ref_template float-right"><i class="fa fa-refresh"></i> <?php echo lang('Refresh List'); ?></a><br/></div>');
    ...
    $(document).on('click','.check_review_status_class',function(e){
      ...
      $.ajax({
        ...
        {  
          ...
          {
            swal('<?php echo lang('Status'); ?>', response.message, 'success').then((value) => {
                $(".page_list_item.active").click();
              });            
          }
    ...
    $(document.body).on('click','.estimate_now_class',function(e){
      e.preventDefault();
      var auto_id = $(this).attr('data-id');
      var successfully="<?php echo lang('Estimation was run successfully'); ?>";
      var waiting="<?php echo lang('Please wait 20 seconds'); ?>";
      var estimate_now="<?php echo lang('Estimate Quick Send Reach'); ?>";
      ...
      $.ajax({
        ...
        {  
          ...
          if(response.status=="0")
            ...
            swal('<?php echo lang('Estimated reach'); ?>', response.message, 'success').then((value) => {
                $(".page_list_item.active").click();
              });       
        }
      });
    ...
    $(document).on('click', '.reset_action_settings', function(event) {
        ...
        swal({
            ...
            text: '<?php echo lang('Are you sure to reset action button settings?'); ?>',
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        })
  ...
  $("document").ready(function(){
    var session_value = "<?php echo session()->get('bot_list_get_page_details_page_table_id'); ?>";
    ...
    $(document).on('click','#import_bot_submit',function(e){
      ...
      {
        swal('<?php echo lang('Warning'); ?>', "<?php echo lang('You must select a template or upload one.');?>", 'warning');
        return;
      }
                  ...
                  if (willDelete) 
                  {
                    ...
                    $.ajax({
                      ...
                      success:function(response2){ 
                        ...
                        swal({ title:'<?php echo lang('Import Status'); ?>', content:span,icon:'success'});
                      }
                    });
                  } 
                });
    ...
    $(document).on('click','#export_bot_submit',function(e){
      ...
      if(template_name=="")
      {
        swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please provide template name.');?>", 'warning');
        return;
      }

      if(template_access=="public" && allowed_package_ids==null)
      {
        swal('<?php echo lang('Warning'); ?>', "<?php echo lang('You must choose user packages to give them template access.');?>", 'warning');
        return;
      }
      ...
      $.ajax({
            ...
            { 
              ...
              var span = document.createElement("span");
              span.innerHTML = success_message;
              if(response.status=='1') swal({ title:'<?php echo lang('Export Status'); ?>', content:span,icon:'success'});
              else swal({ title:'<?php echo lang('Export Status'); ?>', content:span,icon:'error'});
            }
      });
           ...
           success:function(response)
            {
              ...
              var span = document.createElement("span");
              span.innerHTML = success_message;
              swal({ title:'<?php echo lang('API Response'); ?>', content:span,icon:'info'});
            } 
        }); 
    });
...
<div class="modal fade" id="ice_breaker_info_modal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fas fa-info-circle"></i> <?php echo lang('Ice Breakers Reference'); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      </div>
      <div class="modal-body">
        <div class="section">                
          <h2 class="section-title"><?php echo lang('Client Requirements'); ?></h2>
          <ul>
            <li><?php echo lang('Messenger for Android +v240'); ?></li>
            <li><?php echo lang('Messenger for iOS +v240'); ?></li>
          </ul>
        </div>
        <div class="section">                
          <h2 class="section-title"><?php echo lang('Page Profile Priority'); ?></h2>
          <p><?php echo lang('Some of the profile elements like Ice Breakers and Get Started button are incompatible with each other. So when both are set one will take precedence over the other. Here is the priority from highest to lowest:'); ?></p>
          <ol>
            <li><?php echo lang('API Ice Breakers'); ?></li>
            <li><?php echo lang('Get Started button'); ?></li>
            <li><?php echo lang('Custom Questions set via the Page Inbox UI'); ?></li>
          </ol>
        </div>
        <div>
          <p><b>NB: </b><?php echo lang('Editing Custom Questions from the Page Inbox UI is disabled when Ice Breakers are set via API. This is to prevent breaking the experience set by the installed app.'); ?></p>
        </div>
      </div>
      <div class="modal-footer">
        <!-- <button data-dismiss="modal" type="button" class="btn-lg btn btn-dark"><i class="fa fa-times"></i> <?php echo lang('Close');?></button> -->
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="padding-left: 30px;">
                <h5 class="modal-title"><i class="fas fa-history"></i> <?php echo lang('Last 7 Days API Log');?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row">
                  <div class="col-12 margin-top">
                    <input type="text" id="error_searching2" name="error_searching2" class="form-control" placeholder="<?php echo lang('Search...'); ?>" style='width:200px;'>                                          
                      ...
                      <div class="table-responsive2">
                        <table class="table table-bordered" id="mytable2">
                          <thead>
                            <tr>
                              <th>#</th>
                              <th><?php echo lang('Settings Type'); ?></th>  
                              <th><?php echo lang('Status'); ?></th>  
                              <th><?php echo lang('Email/Phone'); ?></th>  
                              <th><?php echo lang('Auto Responde Type'); ?></th>  
                              <th><?php echo lang('API Name'); ?></th>  
                              <th><?php echo lang('Inserted at'); ?></th>  
...
<div class="modal fade" id="err-log" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="padding-left: 30px;">
                <h5 class="modal-title"><i class="fa fa-bug"></i> <?php echo lang('Last 7 Days Error Report');?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row">
                  ...
                  <div class="col-12 margin-top">
                    <input type="text" id="error_searching" name="error_searching" class="form-control" placeholder="<?php echo lang('Search...'); ?>" style='width:200px;'>                                          
                  </div>
                  <div class="col-12">
                    <div class="data-card">   
                      ...
                      <div class="table-responsive2">
                        <table class="table table-bordered" id="mytable1">
                          <thead>
                            <tr>
                              <th>#</th>
                              <th><?php echo lang('Bot Name'); ?></th> 
                              <th><?php echo lang('Error Message'); ?></th> 
                              <th><?php echo lang('Error Time'); ?></th> 
                              <th><?php echo lang('Actions'); ?></th>  
                            </tr>
                          </thead>
                        </table>
...
<div class="modal fade" id="export_bot_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="padding-left: 30px;">
                <h5 class="modal-title"><i class="fa fa-file-export"></i> <?php echo lang('Export Bot Settings');?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
                ...
                <form id="export_bot_form" method="POST">
                  <div class="col-12">
                    <div class="well text-justify" style="border:1px solid var(--blue);padding:15px;color:var(--blue);">
                      <?php echo lang('Webview form will not be exported/imported. If bot settings have webview form created, then after importing that bot settings for a page, you will need to create new form & change the form URL by the new URL for that page.'); ?>
                    </div>
                  </div><br>
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      <label><?php echo lang('Template Name');?> *</label>
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      <label><?php echo lang('Template Description');?> </label>
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      <label><?php echo lang('Template Preview Image');?> [Square image like (400x400) is recommended]</label>
                      <span style="cursor:pointer;" class="badge badge-status blue load_preview_modal float-right" item_type="image" file_path=""><i class="fa fa-eye"></i> <?php echo lang('preview'); ?></span>

                      <input type="hidden" name="template_preview_image" class="form-control" id="template_preview_image">                   
                      <div id="template_preview_image_div"><?php echo lang('upload') ?></div>
                    </div>
                  </div>
                  ...
                  <?php if(session()->get('user_type')=='Admin'){ ?>
                    ...
                    <div class="col-12 hidden" id="allowed_package_ids_con">
                      <div class="form-group">
                        <label><?php echo lang('Choose User Packages');?> *</label><br/>
                  ...
                  <div class="row">
                    <div class="col-6"><a href="#" id="export_bot_submit" class="btn btn-primary btn-lg"><i class="fa fa-file-export"></i> <?php echo lang('Export');?></a></div>                
                    <div class="col-6"><a href="#" id="cancel_bot_submit" class="btn btn-secondary btn-lg float-right"><i class="fa fa-close"></i> <?php echo lang('Cancel');?></a></div>
                  </div>
                  <div class="clearfix"></div>
                </form>
            </div>
...
<div class="modal fade" id="import_bot_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-mega">
        <div class="modal-content">
            <div class="modal-header" style="padding-left: 30px;">
                <h5 class="modal-title"><i class="fa fa-file-import"></i> <?php echo lang('Import Bot Settings');?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div class="modal-body" id="import_bot_modal_body">
                ...
                <form id="import_bot_form" method="POST">
                  ...
                  <!-- zilani -->
                  <p class="text-center" style="font-weight: bold;"><?php echo lang('Choose from previous template'); ?></p><br>
                              ...
                              <div class="col-4">
                                  <div class="avatar-item">
                                    <?php if($preview_image != '' && file_exists('upload/image/'.$val['user_id'].'/'.$preview_image)) : ?>
                                      <a target="_BLANK" href="<?php echo base_url('messenger_bot/saved_template_view/'.$id);?>" data-toggle='tooltip' title="<?php echo lang('Click here to see template details'); ?>">
                                ...
                                <div class="author-box-details" style="margin-left: 0;">
                                  <div class="author-box-name">
                                    <div class="row">
                                      ...
                                      <div class="col-2">
                                        <div class="custom-control custom-radio" data-toggle='tooltip' title="<?php echo lang('Click here to select this template'); ?>">
                  ...
                  <!-- <div class="container-fluid">
                    <div class="row">
                      <p class="text-center" style="font-weight: bold;"><?php echo lang('Choose from previous template'); ?></p>
                                        ...
                                        <div class="form-check float-right">
                                            <div class="clearfix"></div>
                                             <label class="radio_check">
                                               ...
                                               <span class="checkmark" data-toggle='tooltip' title="<?php echo lang('Click here to select this template'); ?>" ></span>
                                             </label>
                                           </div> 
                                           <div class="clearfix"></div>
                                </h4>
                                <div class="media">
                                  <div class="media-left">
                                          ...
                                          <?php if($preview_image != '') : ?>
                                                <a data-toggle='tooltip' title="<?php echo lang('Click here to see template details'); ?>" target="_BLANK" href="<?php echo base_url('messenger_bot_export_import/view/'.$id);?>">
              ...
              <?php endif; ?>
                  <!-- end new section -->
              <br><div class="col-12 text-center type2" style="font-weight: bold;"><?php echo lang('OR'); ?></div><br>
              <div class="col-12 type3">
                <div class="text-center">
                  <label><?php echo lang('Upload Template JSON');?></label>
                  <div class="form-group">    
                    <div id="json_upload"><?php echo lang('Upload');?></div>
                  ...
                  <div class="row">
                    <div class="col-6"><a href="#" id="import_bot_submit" class="btn btn-primary btn-lg"><i class="fa fa-file-import"></i> <?php echo lang('Import');?></a></div>                
                    <div class="col-6"><a href="#" id="cancel_import_bot" class="btn btn-secondary btn-lg float-right"><i class="fa fa-close"></i> <?php echo lang('Cancel');?></a></div>
                  </div>

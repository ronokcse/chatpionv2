<div class="well well_border_left">
	<h4 class="text-center"> <i class="fa fa-clock-o"></i> <?php echo lang('cron job'); ?></h4>
</div>
...
<section class="content-header">
   <section class="content">
			...
			<div id=''>
				<h4 style="margin:0">
					<div class="alert alert-info" style="margin-bottom:0;background:#fff !important; color:<?php echo $THEMECOLORCODE;?> !important;border-color:#fff;">
						<i class="fa fa-clock-o"></i> <?php echo lang('Download Profile Pic');?> [<?php echo lang('every 2 hours'); ?>]
						<br><i><small><?php echo lang('If you do not want to download subscriber profile pictures then you do not need this cron job.');?></small></i>
					</div>
				</h4>
		...
		<?php } else echo "<p class='text-center'><a class='btn btn-lg btn-primary' href='".base_url('native_api/index')."'><i class='fa fa-key'></i> ".lang('generate API key')."</a></";?>

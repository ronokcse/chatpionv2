    ...
    <table class="table table-bordered table-sm table-striped" id="mytable">
      <thead>
        <tr>
          ...
          <th><?php echo lang('RCN postback ID')?></th>
          <th><?php echo lang('Total OPTin subscribers')?></th>
          <th><?php echo lang('Last send time')?></th>
    ...
    <div class="modal-dialog" style="min-width: 95%;">
      <div class="modal-content">
        <div class="modal-header bbw">
          <h5 class="modal-title blue"><i class="fas fa-users"></i> <?php echo lang('RCN Subscribers');?></h5>
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        </div>

          <div id="modalBody" class="modal-body">
            <input type="text" class="form-control" id="postback_id" autofocus placeholder="<?php echo lang('RCN PostBack ID'); ?>" aria-label="" aria-describedby="basic-addon2" style="max-width: 40%">
              ...
              <table class="table table-bordered table-sm table-striped" id="mytable2">
                <thead>
                  <tr>
                    ...
                    <th><?php echo lang('RCN PostBack'); ?></th> 
...
<?php 
  ...
  $drop_menu = '<a href="'.$new_otn_url_builder.'" target="_BLANK" class="float-right btn btn-primary" title="'.lang('Use Flow Builder').'"><i class="fab fa-stack-overflow"></i> '.lang('New Template').'</a>&nbsp;';

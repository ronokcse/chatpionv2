...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active"><a href="<?php echo base_url('messenger_bot_broadcast/rcn_subscriber_broadcast_campaign'); ?>"><?php echo lang('RCN Subscriber Broadcast');?></a></div>
            ...
            <div class="col-12 col-md-6" >
              <div class="form-group">
                <label style="width:100%">
                  <?php echo lang('RCN postback template') ?>
                </label>
                <span id="otn_postback_section"><?php echo lang('Loading RCN templates...'); ?></span>                                
              </div>
            </div>
          </div>

...
<section class="section section_custom">
  <div class="section-header">
    <h1><i class="fa fa-users"></i> <?php echo lang('RCN Subscribers'); ?> </h1>
    <div class="section-header-breadcrumb">
      <div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot'); ?>"><?php echo lang('Messenger Bot'); ?></a></div>
      <div class="breadcrumb-item"><?php echo lang('RCN Subscriber Report'); ?></div>
    </div>
  </div>
        ...
        <div class="card">
          <div class="card-body data-card">
            ...
            <div class="input-group mb-3" id="searchbox">
                ...
                <input type="text" class="form-control" id="postback_id" autofocus placeholder="<?php echo lang('RCN PostBack ID'); ?>" aria-label="" aria-describedby="basic-addon2" style="max-width: 30%">

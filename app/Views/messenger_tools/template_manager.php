  ...
  <table class="table table-bordered table-sm table-striped" id="mytable">
    <thead>
      <tr>
        ...
        <th><?php echo lang('Postback ID')?></th>
...
$drop_menu = '<a href="'.$builder_load_url.'" class="float-right btn btn-primary" type="button" target="_BLANK"><i class="fas fa-plus-circle"></i> '.lang('New Postback').'</a> <a data-toggle="tooltip" title="'.lang('Use Classic Builder').'" href="'.$classic_url.'" id="add_bot_settings" class="float-right btn btn-info mx-1" type="button"><i class="fas fa-plus-circle"></i></a>';
?> 
    ...
    $(document).ready(function() {
      ...
      $(document).on('click','.delete_template',function(e){
        ...
        swal({
          ...
          text: '<?php echo lang('Do you want to detete this template?'); ?>',
          icon: 'warning',
          buttons: true,
          dangerMode: true,
        })
    ...
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center"><i class="fas fa-code"></i> <?php echo lang('JSON Code'); ?></h5>

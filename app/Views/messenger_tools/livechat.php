        ...
        <div class="modal-content">
            <form method="post" id="page_name">
                    ...
                    <div class="row">
                          <div class="col-12"> 
                            <div class="form-group">
                              <label><?php echo lang('Select Facebook page / Instagram account'); ?></label>
                ...
                <div class="modal-footer" style="margin-top: 10px;">
                    <button id="submit" class="btn btn-primary btn-lg"><i class="fas fa-comment-alt"></i> <?php echo lang('Live Chat'); ?></button>
                    <button type="button" class="btn btn-secondary btn-lg" data-dismiss="modal"><?php echo lang('Back'); ?></button>
                </div>
            </form>
        </div>
    </div>
...
$(document).ready(function(){
    ...
    $('#submit').click(function(e) {
       ...
       if(page_id == '')
       {
          swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Please select a Facebook page / Instagram account'); ?>', 'warning');
          return false;
       }
       else
       {

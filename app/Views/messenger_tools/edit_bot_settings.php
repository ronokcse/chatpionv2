...
<section class="section section_custom">
  <div class="section-header">
    <h1><i class='fa fa-edit'></i> <?php echo lang('Edit Bot Settings');?> : <a target='_BLANK' href='https://facebook.com/<?php echo $page_info['page_id'];?>'><?php echo $page_info['page_name'];?></a></h1>
    <div class="section-header-breadcrumb">
      <div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot/bot_menu_section'); ?>"><?php echo lang('Messenger Tools'); ?></a></div>
          ...
          <div class="row">
            <div class="col-12 col-md-9">
              ...
              <input type="hidden" name="main_reply_sort_order" id="main_reply_sort_order">
                ...
                <div class="row">
                  <div class="col-6">
                     <button id="submit" class="btn btn-lg btn-primary"><i class="fa fa-send"></i> <?php echo lang('Update'); ?></button>
                  </div>
                  <?php if($default_template == '0') : ?>
                  <div class="col-6">
                     <a class="btn btn-lg btn-secondary float-right" href="<?php echo $redirect_url; ?>"><i class="fas fa-times"></i> <?php echo lang('Back'); ?></a>
                  </div>  
                  <?php elseif($default_template == 'postback') : ?>
                  <div class="col-6">
                     <a class="btn btn-lg btn-secondary float-right" href="<?php echo base_url("messenger_bot/template_manager")."?media_type=".$media_type; ?>"><i class="fas fa-step-backward"></i> <?php echo lang('Back'); ?></a>
                  </div>
                  <?php elseif($default_template == 'errlog') : ?>
                  <div class="col-6">
                     <a class="btn btn-lg btn-secondary float-right" href="<?php echo base_url("messenger_bot/bot_list"); ?>"><i class="fas fa-step-backward"></i> <?php echo lang('Back'); ?></a>
                  </div>
                  <?php endif; ?>                
                </div>
              </form>
...
<?php endif; ?>
  ...
  <div class="alert alert-success text-center" id="bot_success"><i class="fa fa-check"></i> <?php echo lang('Bot settings has been updated successfully.');?></div>
  <?php } ?>
      ...
      if(ans)
      {
        $.ajax({
           ...
           success:function(response)
           {
            ...
            alertify.alert('<?php echo lang('Alert'); ?>',somethingwentwrong,function(){});
           }
        });
      }
    });

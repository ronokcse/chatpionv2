  ...
  <div class="modal-dialog" style="max-width:100%;margin:0px;">
    <div class="modal-content no_shadow">
      ...
      <div class="modal-header">
        <h5 class="modal-title"><i class='fa fa-plus-circle'></i> <?php echo lang('Add Bot Reply Setting');?> : <a target='_BLANK' href='https://facebook.com/<?php echo $page_info['page_id'];?>'><?php echo $page_info['page_name'];?></a></h5>
      </div>
      <?php endif; ?>
      <div class="modal-body <?php if($iframe=='1') echo 'padding-0 no_shadow';?>"> 
              ...
              <div class="row"> 
                <div class="col-12 col-sm-6"> 
                  <div class="form-group">
                    <label><?php echo lang('Bot Name'); ?></label>
              ...
              <?php for($k=1;$k<=6;$k++){ ?>
                  ...
                  <div class="card card-primary" id="multiple_template_div_<?php echo $k; ?>" <?php if($k != 1) echo "style='display : none;'"; ?> >
                    <div class="card-header">
                      <h4 class="full_width"><?php echo lang('Reply')." ".$k; ?> 
                    ...
                    <div class="card-body">
                      ...
                      <div style="">
                        ...
                        <div class="row hidden" id="delay_and_typing_on_<?php echo $k; ?>">
                          <div class="col-12 col-sm-6">
                            <div class="row">
                              <div class="col-6"><label for="" style="margin-top: 8px; color: #34395e; font-size: 14px;"><?php echo lang('Typing on display :'); ?></label></div>
                              <div class="col-6">
                          ...
                          <div class="col-12">              
                            <div class="form-group">
                              ...
                              <select class="form-control select2 ecommerce_product_info" multiple="multiple" id="ecommerce_product_ids<?php echo $k; ?>" name="ecommerce_product_ids<?php echo $k; ?>[]">
                                <option value=""><?php echo lang('Please select a store first.'); ?></option>
                              </select>
                            </div>        
                          </div> 
                        ...
                        <div class="row" id="image_div_<?php echo $k; ?>" style="display: none;">             
                          <div class="col-12">              
                            <div class="form-group">
                              ...
                              <input type="text" placeholder="<?php echo lang('Put your image URL here or click the upload button.'); ?>" class="form-control"  name="image_reply_field_<?php echo $k; ?>" id="image_reply_field_<?php echo $k; ?>">
                        ...
                        <div class="row" id="media_div_<?php echo $k; ?>" style="display: none; margin-bottom: 10px;">  
                          <div class="col-12"> 
                            ...
                            <div class="row button_border" id="media_row_<?php echo $i; ?>_<?php echo $k; ?>" style="display: none;">
                              ...
                              <div class="col-12 col-sm-4">
                                <div class="form-group">
                                  ...
                                  <select class="form-control media_type_class" id="media_type_<?php echo $i; ?>_<?php echo $k; ?>" name="media_type_<?php echo $i; ?>_<?php echo $k; ?>">
                                    ...
                                    <option value="web_url"><?php echo lang('Web Url'); ?></option>
                                    ...
                                    <option value="post_back" id="human_postback"><?php echo lang('Chat with Human'); ?></option>
                                    <option value="post_back" id="robot_postback"><?php echo lang('Chat with Robot'); ?></option>
                                  </select>
                                </div>
                              </div>
                              <div class="col-10 col-sm-3">
                                ...
                                <div class="form-group" id="media_postid_div_<?php echo $i; ?>_<?php echo $k; ?>" style="display: none;">
                                  ...
                                  <select class="form-control push_postback"  name="media_post_id_<?php echo $i; ?>_<?php echo $k; ?>" id="media_post_id_<?php echo $i; ?>_<?php echo $k; ?>"><option value=""><?php echo lang('Select');?></option></select>
                            ...
                            <div class="row clearfix">
                              <div class="col-12 text-center"><button class="btn btn-outline-primary float-right no_radius btn-xs" id="media_add_button_<?php echo $k; ?>"><i class="fa fa-plus-circle"></i> <?php echo lang('add more button');?></button></div>
                            </div>
                        ...
                        <div class="row" id="quick_reply_div_<?php echo $k; ?>" style="display: none; margin-bottom: 10px;">  
                          <div class="col-12">  
                            ...
                            <div class="row button_border" id="quick_reply_row_<?php echo $i; ?>_<?php echo $k; ?>" style="display: none;">
                              ...
                              <div class="col-10 col-sm-3">
                                 <div class="form-group" id="quick_reply_postid_div_<?php echo $i; ?>_<?php echo $k; ?>" style="display: none;">
                                    <label><?php echo lang('PostBack id'); ?></label>
                                    <select class="form-control push_postback"  name="quick_reply_post_id_<?php echo $i; ?>_<?php echo $k; ?>" id="quick_reply_post_id_<?php echo $i; ?>_<?php echo $k; ?>"><option value=""><?php echo lang('Select');?></option></select>
                                    <a href="" class="add_template float-left"><i class="fa fa-plus-circle"></i> <?php echo lang('Add');?></a>
                                    <a href="" class="ref_template float-right"><i class="fa fa-refresh"></i> <?php echo lang('Refresh');?></a>
                                  </div>
                              </div>
                            ...
                            <div class="row clearfix">
                              <div class="col-12 text-center"><button class="btn btn-outline-primary float-right no_radius btn-xs" id="quick_reply_add_button_<?php echo $k; ?>"><i class="fa fa-plus-circle"></i> <?php echo lang('add more button');?></button></div>
                            </div>
                        ...
                        <div class="row" id="text_with_buttons_div_<?php echo $k; ?>" style="display: none; margin-bottom: 10px;">  
                          <div class="col-12"> 
                            ...
                            <div class="row button_border" id="text_with_buttons_row_<?php echo $i; ?>_<?php echo $k; ?>" style="display: none;">
                              ...
                              <div class="col-10 col-sm-3">
                                <div class="form-group" id="text_with_button_postid_div_<?php echo $i; ?>_<?php echo $k; ?>" style="display: none;">
                                  <label><?php echo lang('PostBack id'); ?></label>
                                  <select class="form-control push_postback"  name="text_with_button_post_id_<?php echo $i; ?>_<?php echo $k; ?>" id="text_with_button_post_id_<?php echo $i; ?>_<?php echo $k; ?>"><option value=""><?php echo lang('Select');?></option></select>
                                  <a href="" class="add_template float-left"><i class="fa fa-plus-circle"></i>     <?php echo lang('Add');?></a>
                                  <a href="" class="ref_template float-right"><i class="fa fa-refresh"></i> <?php echo lang('Refresh');?></a>
                                </div>
                            ...
                            <div class="row clearfix">
                              <div class="col-12 text-center"><button class="btn btn-outline-primary float-right no_radius btn-xs" id="text_with_button_add_button_<?php echo $k; ?>"><i class="fa fa-plus-circle"></i> <?php echo lang('add more button');?></button></div>
                            </div>
                          ...
                          <div class="col-12"> 
                            ...
                            <div class="card card-secondary">
                              ...
                              <div class="card-body">
                                ...
                                <div class="row">
                                  <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" placeholder="<?php echo lang('Put your image URL here or click the upload button.'); ?>" class="form-control"  name="generic_template_image_<?php echo $k; ?>" id="generic_template_image_<?php echo $k; ?>" />
                                  ...
                                  <div class="col-12 col-sm-4">
                                    <div class="form-group">
                                      ...
                                      <select class="form-control generic_template_button_type_class" id="generic_template_button_type_<?php echo $i; ?>_<?php echo $k; ?>" name="generic_template_button_type_<?php echo $i; ?>_<?php echo $k; ?>">
                                        ...
                                        <option value="web_url_compact" <?php echo $hide_generic_item; ?>><?php echo lang('WebView [Compact]'); ?></option>
                                        <option value="web_url_tall" <?php echo $hide_generic_item; ?>><?php echo lang('WebView [Tall]'); ?></option>
                                        <option value="web_url_full" <?php echo $hide_generic_item; ?>><?php echo lang('WebView [Full]'); ?></option>
                                        <option value="web_url_birthday"><?php echo $this->lang->line("User's Birthday"); ?></option>
                                        ...
                                        <option value="phone_number" <?php echo $hide_generic_item; ?>><?php echo lang('Call Us'); ?></option>
                                        
                                        <option value="post_back" id="unsubscribe_postback" <?php echo $hide_generic_item; ?>><?php echo lang('unsubscribe'); ?></option>
                                        <option value="post_back" id="resubscribe_postback" <?php echo $hide_generic_item; ?>><?php echo lang('re-subscribe'); ?></option>
                                        
                                        <option value="post_back" id="human_postback" <?php echo $hide_generic_item; ?>><?php echo lang('Chat with Human'); ?></option>
                                        <option value="post_back" id="robot_postback" <?php echo $hide_generic_item; ?>><?php echo lang('Chat with Robot'); ?></option>
                                      </select>
                                    </div>
                                  </div>
                                  <div class="col-10 col-sm-3">
                                    <div class="form-group" id="generic_template_button_postid_div_<?php echo $i; ?>_<?php echo $k; ?>" style="display: none;">
                                      <label><?php echo lang('PostBack id'); ?></label>
                                      <select class="form-control push_postback"  name="generic_template_button_post_id_<?php echo $i; ?>_<?php echo $k; ?>" id="generic_template_button_post_id_<?php echo $i; ?>_<?php echo $k; ?>"><option value=""><?php echo lang('Select');?></option></select>
                                      <a href="" class="add_template float-left"><i class="fa fa-plus-circle"></i>     <?php echo lang('Add');?></a>
                                      <a href="" class="ref_template float-right"><i class="fa fa-refresh"></i> <?php echo lang('Refresh');?></a>
                                    </div>
                                ...
                                <div class="row clearfix">
                                  <div class="col-12 text-center"><button class="btn btn-outline-primary float-right no_radius btn-xs" id="generic_template_add_button_<?php echo $k; ?>"><i class="fa fa-plus-circle"></i> <?php echo lang('add more button');?></button></div>
                                </div>
                        ...
                        <div class="row" id="carousel_div_<?php echo $k; ?>" style="display: none; margin-bottom: 10px;">  
                          ...
                          <div class="col-12" id="carousel_div_<?php echo $j; ?>_<?php echo $k; ?>" style="display: none;">
                            ...
                            <div class="card card-secondary">
                              <div class="card-header">
                                <h4 class="full_width"><?php echo lang('Carousel Template').' '.$j; ?>
                                  <?php if($j != 1) : ?>
                              ...
                              <div class="card-body">
                                ...
                                <div class="row">
                                  <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                      <label><?php echo lang('Please provide your reply image'); ?> <span style='color:orange !important;'>(<?php echo lang('optional'); ?>)</span></label>
                                      <input type="text" placeholder="<?php echo lang('Put your image URL here or click the upload button.'); ?>" class="form-control"  name="carousel_image_<?php echo $j; ?>_<?php echo $k; ?>" id="carousel_image_<?php echo $j; ?>_<?php echo $k; ?>" />
                                ...
                                <div class="row button_border" id="carousel_row_<?php echo $j."_".$i; ?>_<?php echo $k; ?>" style="display: none;">
                                  ...
                                  <div class="col-10 col-sm-3">
                                    <div class="form-group" id="carousel_button_postid_div_<?php echo $j."_".$i; ?>_<?php echo $k; ?>" style="display: none;">
                                      <label><?php echo lang('PostBack id'); ?></label>
                                      <select class="form-control push_postback"  name="carousel_button_post_id_<?php echo $j."_".$i; ?>_<?php echo $k; ?>" id="carousel_button_post_id_<?php echo $j."_".$i; ?>_<?php echo $k; ?>"><option value=""><?php echo lang('Select');?></option></select>
                                      <a href="" class="add_template float-left"><i class="fa fa-plus-circle"></i>     <?php echo lang('Add');?></a>
                                      <a href="" class="ref_template float-right"><i class="fa fa-refresh"></i> <?php echo lang('Refresh');?></a>
                                    </div>
                                ...
                                <div class="row clearfix" style="padding-bottom: 10px;">
                                  <div class="col-12 text-center"><button class="btn btn-outline-primary float-right no_radius btn-xs" id="carousel_add_button_<?php echo $j; ?>_<?php echo $k; ?>"><i class="fa fa-plus-circle"></i> <?php echo lang('add more button');?></button></div>
                                </div>
        ...
        <div class="row">
          <div class="col-12 clearfix">
            <button id="multiple_template_add_button"  class="btn btn-outline-primary float-right no_radius" ><i class="fa fa-plus-circle"></i> <?php echo lang('add more reply'); ?></button>
          </div>
        </div>
              <br/><br/>
              <div class="row">
                ...
                <div class="col-6">
                  <a class="btn btn-lg btn-secondary float-right" href="<?php echo base_url("messenger_bot/ig_bot_settings/").$page_info['id']."/1?media_type=".$this->using_media_type; ?>"><i class="fas fa-times"></i> <?php echo lang('Back'); ?></a>
                </div>
              </div>
...
<?php if(session()->getFlashdata('bot_success')===1) { ?>
<div class="alert alert-success text-center" id="bot_success"><i class="fas fa-check-circle"></i> <?php echo lang('Bot reply has been saved successfully.');?></div>
<?php } ?>
<?php if(session()->getFlashdata('bot_update_success')===1) { ?>
<div class="alert alert-success text-center" id="bot_success"><i class="fas fa-check-circle"></i> <?php echo lang('Bot reply has been saved successfully.');?></div>
<?php } ?>
...
<div class="table-responsive data-card" id="bot_list_datatable">
  <table class="table table-bordered table-sm table-striped" id="mytable">
    <thead>
      <tr>
        <th class="text-center"><?php echo lang('SL');?></th>
        <th class="text-center"><?php echo lang('Bot Name');?></th>
        <th class="text-center"><?php echo lang('Keywords');?></th>
    ...
    <tbody>
      ...
      { 
        ...
        else $reply_at =  "<span class='label label-warning'><i class='fa fa-remove'></i> ".lang('No Replied Yet')."</span>";
        ...
        if($value['keyword_type']=="reply") 
        {
          ...
          $keywords_tooltip='<a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="'.lang('Keywords').'" data-content="'.str_replace(",",", ", $value["keywords"]).'"><i class="fa fa-info-circle gray"></i> </a>';
        ...
        if ($value['status'] == '1') {
            $current_status = '<i class="fas fa-dot-circle green"></i> '.lang('Live');
        } else {
            $current_status = '<i class="fas fa-dot-circle gray"></i> '.lang('Paused');
        }
        ...
        echo "<tr>";
          ...
          if($visual_flow_builder_exist == 'yes')
          {
            ...
            {
              echo "<td class='text-center'>".lang('Flow Builder')."</td>";
            }
            else
            {
              echo "<td class='text-center'>".lang('Classic Editor')."</td>";
            }
          }
          ...
          if ($value['status'] == '1') {
            ...
            $state_text = lang('Stop');
            $state_icon = '<i class="far fa-stop-circle"></i>';
          } else {

            $state_text = lang('Start');
          ...
          echo "<td class='text-center'>";
            ...
            if(addon_exist($module_id=315,$addon_unique_name="visual_flow_builder") && isset($value['visual_flow_type']) && $value['visual_flow_type'] == 'flow')
            {
              ...
              $action_content .= '<li><a class="dropdown-item has-icon" target="_BLANK" href="'.$flow_edit_url.'"><i class="fas fa-edit"></i> '.lang('Edit Bot Reply').'</a></li>';
            }
            else
            {
              $action_content .= '<li><a class="dropdown-item has-icon" href="'.$editurl.'"><i class="fas fa-edit"></i> '.lang('Edit Bot Reply').'</a></li>';
            }
             
            if($value['visual_flow_type'] == 'general') {
               $action_content .= '<div class="dropdown-divider d-none"></div>
              <li><a class="dropdown-item has-icon delete_bot red" href="" id="'.$value['id'].'"><i class="fas fa-trash-alt"></i> '.lang('Delete Bot Reply').'</a></li>';
            }
...
// $drop_menu = '<a id="add_bot_settings" href="" class="float-right btn btn-primary"><i class="fas fa-plus-circle"></i> '.lang('Add Bot Reply').'</a>';
$builder_load_url = base_url("visual_flow_builder/load_builder/{$page_info['id']}/1/{$media_type}");
$drop_menu = '<a href="'.$builder_load_url.'" class="float-right btn btn-primary" type="button" target="_BLANK"><i class="fas fa-plus-circle"></i> '.lang('Set Keywords').'</a> <span style="font-size:16px;font-weight:700;" id="add_bot_settings" title="'.lang('Use Classic Builder').'"><a class="float-right mr-2 mt-1" href="#"><i class="fa fa-plus-circle"></i> </a></span>';
?> 
...
<?php for($template_type=1;$template_type<=6;$template_type++){ ?>
  ...
  <?php } ?>
    ...
    $(document).on('click','.delete_bot',function(e){
      ...
      swal({
        title: '<?php echo lang('Delete Bot Reply'); ?>',
        ...
        if (willDelete) 
        {
          ...
          $.ajax({
            ...
            success:function(response){ 
              ...
              if(response == '1')
              {
                swal('<?php echo lang('Reply Deleted'); ?>', "<?php echo lang('Bot reply has been deleted successfully.'); ?>", 'success').then((value) => {
                  window.location.assign(link);
                });
              }
              else
              {
                swal('<?php echo lang('Error'); ?>', somethingwentwrong, 'error');
              }
            }
          });
        } 
    ...
    $(document).on('click','#submit',function(e){   
      ...
      {
        swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please select a reply type form (Reply/Post-back/No Match/Get Started)');?>", 'warning');
        return;
      }

      if(bot_name == '')
      {
        swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Give Bot Name');?>", 'warning');
        return;
      }
      ...
      var queryString = new FormData($("#messenger_bot_form")[0]);
        $.ajax({
          ...
          success:function(response){
            $(this).removeClass('btn-progress');
            swal('<?php echo lang('Reply Created'); ?>', "<?php echo lang('Bot reply has been added successfully.'); ?>", 'success').then((value) => {
              location.reload();
            });            
          },
    ...
    $(document).on('click', '.bot_status_btn', function(event) {
        ...
        swal({
            title: 'Warning',
            text: '<?php echo lang('Do you really want to change this state?'); ?>',
            icon: 'warning',
            buttons: true,
            dangerMode: true

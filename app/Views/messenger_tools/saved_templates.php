  ...
  <div class="section-header">
    ...
    <div class="section-header-button">
      <a class="btn btn-primary export_bot" href="#">
        <i class="fas fa-cloud-upload-alt"></i> <?php echo lang('Upload Template'); ?>
      </a>
  </div>
    
    <div class="section-header-breadcrumb">
      <div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot/bot_list'); ?>"><?php echo lang('Bot Manager'); ?></a></div>
        ...
        <div class="category_sidebar">
            <ul class="list-group list-group-flush">
              <li class="list-group-item pointer <?php if($category_id == '') echo 'active'; ?>">
                <a class="<?php if($category_id == '') echo 'active'; ?>" href="<?php echo base_url("messenger_bot/saved_templates/".$media_type); ?>"><i class="fas fa-book-open"></i> <?php echo lang('All Categories'); ?></a>
              </li>
            ...
            <article class="article article-style-c">
              ...
              <div class="article-details template_details">
                  ...
                  <h2>
                    ...
                    <div class="dropdown d-inline dropright float-right">
                      ...
                      <div class="dropdown-menu mini_dropdown text-center" style="width:<?php echo $action_width.'px !important'; ?>">
                        ...
                        <a data-toggle='tooltip' title='<?php echo lang('Delete Template'); ?>' href='' class='btn btn-circle btn-outline-danger delete_template' table_id="<?php echo $template['id']?>"><i class='fas fa-trash-alt'></i></a>
                      </div>
                    </div>
                  </h2>
                </div>
                ...
                <div class="text-center">
                  <button class="btn btn-primary btn-block install_template" current_template_id="<?php echo $template['id']; ?>" media_type="<?php echo $media_type; ?>"><?php echo lang('Install Template'); ?></button>
                </div>
              </div>
            </article>
          </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="padding-left: 30px;">
                <h5 class="modal-title"><i class="fa fa-file-export"></i> <?php echo lang('Upload Template');?></h5>
            ...
            <div class="modal-body" id="export_bot_modal_body">             
                ...
                <form id="export_bot_form" method="POST">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      <label> <?php echo lang('Template Category'); ?></label>
                      <small class="blue float-right pointer" id="create_category"><i class="fas fa-plus-circle"></i> <?php echo lang('Create category'); ?></small>
                  ...
                  <div class="col-12">
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group">
                          <label><?php echo lang('Template Preview Image');?>
                            <a href="#" data-placement="top"  data-toggle="popover" title="<?php echo lang('Template Preview Image'); ?>" data-content="<?php echo lang('Upload a preview image for this template and the image will be showed as preview image of the template.').'Square image like (400x400) is recommended.'; ?>"><i class='fa fa-info-circle'></i> </a>&nbsp;
                            <span style="cursor:pointer;" title="<?php echo lang('Preview'); ?>" class="badge badge-status blue load_preview_modal float-right" item_type="image" file_path=""><i class="fa fa-eye"></i></span>
                          </label>
                  ...
                  <div class="row">
                    <div class="col-6">
                      <a href="#" id="export_bot_submit" class="btn btn-primary btn-lg"><i class="fa fa-file-export"></i> <?php echo lang('Upload Template');?></a>
                    </div>                
                    <div class="col-6">
                      <a href="#" id="cancel_bot_submit" class="btn btn-secondary btn-lg float-right"><i class="fa fa-close"></i> <?php echo lang('Cancel');?></a>
                    </div>
                  </div>
...
<div class="modal fade" id="edit_export_bot_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="padding-left: 30px;">
                <h5 class="modal-title"><i class="fa fa-edit"></i> <?php echo lang('Edit Saved Template');?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
...
<div class="modal fade" id="install_template_modal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fas fa-cloud-download-alt"></i> <?php echo lang('Install Template'); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      </div>
      <div class="modal-body">
        <div class="row">
            ...
            <form action="#" id="install_template_form" method="POST">
              ...
              <div class="form-group">
                <?php if($media_type == 'ig') : ?>
                  <label for=""> <?php echo lang('Intall to account'); ?> </label>
                <?php else : ?>
                  <label for=""> <?php echo lang('Intall to Page'); ?> </label>
                <?php endif; ?>
                <select name="page_id" id="page_id" class="form-control select2" style="width:100% !important;">
                  <?php if($media_type == 'ig') : ?>
                    <label for=""> <?php echo lang('Select Account'); ?> </label>
                  <?php else : ?>
                    <label for=""> <?php echo lang('Select Page'); ?> </label>
                  <?php endif; ?>
              ...
              <div>
                <button class="btn btn-primary btn-block btn-lg install_template_action"><i class="fas fa-cloud-download"></i><?php echo lang('Install'); ?></button>
              </div>
            </form>
          </div>
        </div>
...
<script type="text/javascript">
  $(document).ready(function() { 
      ...
      $(document).on('click','#export_bot_submit',function(e){
        ...
        if(bot_category=="")
        {
          swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please select template category.');?>", 'warning');
          return;
        }

        if(filename=="")
        {
          swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Upload your template json file.');?>", 'warning');
          return;
        }
        ...
        $.ajax({
              ...
              { 
                ...
                swal({ title:'<?php echo lang('Template Upload Status'); ?>', content:span,icon:'success'}).then((value) => {location.reload();});
              }
        });
              ...
              { 
                ...
                if(response.status=='1'){                  
                  swal({ title:'<?php echo lang('Template Upload Status'); ?>', content:span,icon:'success'}).then((value) => {location.reload();});
                    ...
                    swal({ title:'<?php echo lang('Template Upload Status'); ?>', content:span,icon:'error'})
                }
              }
        });
      ...
      $(document).on('click','.delete_template_category',function(e){
          e.preventDefault();
          swal({
              title: '<?php echo lang('Do you want to delete this category?'); ?>',
              icon: 'warning',
              buttons: true,
              dangerMode: true,
          })
              ...
              if (willDelete) 
              {
                  ...
                  $.ajax({
                      ...
                      { 
                          if(response == '1')
                          {
                              swal({title: 'Success',text: '<?php echo lang('Category has been deleted successfully.'); ?>',icon: 'success'}).then((value) => {window.location.href=base_url+"messenger_bot/saved_templates/"+selected_global_media_type;});
                          } else
                          {
                    ...
                    if (willDelete) 
                    {
                      ...
                      $.ajax({
                        ...
                        success:function(response2){ 
                          ...
                          var span = document.createElement("span");
                          span.innerHTML = success_message;
                          swal({ title:'<?php echo lang('Import Status'); ?>', content:span,icon:'success'}).then((value) => {location.reload();});
                        }
                      });
                    } 
                  });
      ...
      $(document).on('click','#create_category',function(e){
        ...
        swal("<?php echo lang('Category Name'); ?>", {
          content: "input",
          button: {text: "<?php echo lang('New Category'); ?>"},
        })
        .then((value) => {
      ...
      $(document).on('click','.delete_template',function(e){
        ...
        swal({
          title: '<?php echo lang('Warning!'); ?>',
          text: '<?php echo lang('Do you really want to delete this template?'); ?>',
          icon: 'warning',
          buttons: true,
          dangerMode: true,
        })
          ...
          if (willDelete) 
          {
            ...
            $.ajax({
              ...
              success:function(response){ 
                ...
                if(response == '1')
                {
                  swal('<?php echo lang('Success'); ?>', '<?php echo lang('Template has been deleted successfully.'); ?>', 'success').then((value) => {window.location.href=report_link;});
                  
                }
                else
                {
                  iziToast.error({title: '',message: '<?php echo lang('Something went wrong.'); ?>',position: 'bottomRight'});
                }
              }
            });
          } 

    ...
    <div class="modal-content no_shadow">
      <?php if ($iframe != '1') : ?>
        <div class="modal-header">
          <h5 class="modal-title"><i class="fa fa-list"></i> <?php echo lang('Persistent Menu'); ?> [<a href="https://facebook.com/<?php echo $page_info['page_id']; ?>"><?php echo $page_info['page_name']; ?></a>]</h5>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-12 col-md-4">
                      <div class="form-group">
                        <input type="text" class="form-control" placeholder="<?php echo lang('menu title'); ?>" name="text_with_buttons_text_<?php echo $i; ?>" id="text_with_buttons_text_<?php echo $i; ?>">
                      </div>
                    </div>
                    <div class="col-4 col-md-4">
                      <div class="form-group">
                        <select class="form-control text_with_button_type_class_level1" id="text_with_button_type_<?php echo $i; ?>" name="text_with_button_type_<?php echo $i; ?>">
                          ...
                          <!-- <option value="nested"><?php echo lang('Nested'); ?></option> -->
                        </select>
                      </div>
                    </div>
                    <div class="col-8 col-md-4">
                      <div class="form-group" id="text_with_button_postid_div_<?php echo $i; ?>" style="display: none;">
                        <!-- <input type="text" class="form-control" placeholder="<?php echo lang('PostBack id'); ?>" name="text_with_button_post_id_<?php echo $i; ?>" id="text_with_button_post_id_<?php echo $i; ?>"> -->
                        <select class="form-control push_postback" name="text_with_button_post_id_<?php echo $i; ?>" id="text_with_button_post_id_<?php echo $i; ?>">
                          <option value=""><?php echo lang('Select PostBack id'); ?></option>
                        </select>
                      ...
                      <div class="form-group" id="text_with_button_web_url_div_<?php echo $i; ?>">
                        <input type="text" class="form-control" placeholder="<?php echo lang('web url'); ?>" name="text_with_button_web_url_<?php echo $i; ?>" id="text_with_button_web_url_<?php echo $i; ?>">
                      </div>
                    </div>
                  </div>
                  <?php
                    ...
                    <div class="card card-warning level2<?php if ($j > 0) echo ' hidden'; ?>" id="text_with_buttons_row_<?php echo $i; ?>_<?php echo $j; ?>">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          <div class="col-12 col-md-4">
                            <div class="form-group">
                              <input type="text" class="form-control" placeholder="<?php echo lang('menu title'); ?>" name="text_with_buttons_text_<?php echo $i; ?>_<?php echo $j; ?>" id="text_with_buttons_text_<?php echo $i; ?>_<?php echo $j; ?>">
                            </div>
                          </div>
                          <div class="col-4 col-md-4">
                            <div class="form-group">
                          ...
                          <div class="col-8 col-md-4">
                            ...
                            <div class="form-group" id="text_with_button_web_url_div_<?php echo $i; ?>_<?php echo $j; ?>">
                              <input type="text" class="form-control" placeholder="<?php echo lang('web url'); ?>" name="text_with_button_web_url_<?php echo $i; ?>_<?php echo $j; ?>" id="text_with_button_web_url_<?php echo $i; ?>_<?php echo $j; ?>">
                            </div>
                          </div>
                        </div>
                        <?php
                          ...
                          <div class="card card-secondary level3<?php if ($k > 0) echo ' hidden'; ?>" id="text_with_buttons_row_<?php echo $i; ?>_<?php echo $j; ?>_<?php echo $k; ?>">
                            ...
                            <div class="card-body">
                              ...
                              <div class="row">
                                <div class="col-12 col-md-4">
                                  <div class="form-group">
                                    <input type="text" class="form-control" placeholder="<?php echo lang('menu title'); ?>" name="text_with_buttons_text_<?php echo $i; ?>_<?php echo $j; ?>_<?php echo $k; ?>" id="text_with_buttons_text_<?php echo $i; ?>_<?php echo $j; ?>_<?php echo $k; ?>">
                                  </div>
                                </div>
                                <div class="col-4 col-md-4">
                                  <div class="form-group">
                                ...
                                <div class="col-8 col-md-4">
                                  ...
                                  <div class="form-group" id="text_with_button_web_url_div_<?php echo $i; ?>_<?php echo $j; ?>_<?php echo $k; ?>">
                                    <input type="text" class="form-control" placeholder="<?php echo lang('web url'); ?>" name="text_with_button_web_url_<?php echo $i; ?>_<?php echo $j; ?>_<?php echo $k; ?>" id="text_with_button_web_url_<?php echo $i; ?>_<?php echo $j; ?>_<?php echo $k; ?>">
                                  </div>
                                </div>
                              </div>
                        ...
                        <a href="#" style="border-radius: 0;" class="btn btn-sm btn-outline-primary float-right level3_add hidden" id="add_more_<?php echo $i ?>_<?php echo $j ?>"><i class="fa fa-plus-circle"></i> <?php echo lang('level-3 menu'); ?></a>
                        <a href="#" style="border-radius: 0;margin-right:2px;" class="btn btn-sm btn-outline-danger float-right level3_remove hidden" id="remove_menu_<?php echo $i ?>_<?php echo $j ?>"><i class="fa fa-remove"></i> <?php echo lang('remove'); ?></a>
                        <div class="clearfix"></div>
                      </div> <!-- level2 card body end -->
                    </div> <!-- level2 end -->
                  <?php
                  } ?>
                  <a href="#" style="border-radius: 0;" class="btn btn-sm btn-outline-primary float-right level2_add hidden" id="add_more_<?php echo $i ?>"><i class="fa fa-plus-circle"></i> <?php echo lang('level-2 menu'); ?></a>
                  <a href="#" style="border-radius: 0;margin-right:2px;" class="btn btn-sm btn-outline-danger float-right level2_remove hidden" id="remove_menu_<?php echo $i ?>"><i class="fa fa-remove"></i> <?php echo lang('remove'); ?></a>
                  <div class="clearfix"></div>
                </div> <!-- leve1 card body end -->
              </div> <!-- leve1 end -->
            <?php
            } ?>
            <a href="#" style="border-radius: 0;" class="btn btn-sm btn-outline-primary float-right" id="add_more"><i class="fa fa-plus-circle"></i> <?php echo lang('Add'); ?></a>
            <a href="#" style="border-radius: 0;margin-right:2px;" class="btn btn-sm btn-outline-danger float-right hidden" id="remove_menu" style="margin-right:5px"><i class="fa fa-remove"></i> <?php echo lang('remove'); ?></a>
            <div class="clearfix"></div>

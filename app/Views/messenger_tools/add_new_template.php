...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
      <a class="btn btn-primary variables" href="#"><i class="fas fa-plus-circle"></i> <?php echo lang('Variables'); ?></a>
    </div>
    <?php endif; ?>

    <div class="section-header-breadcrumb">
       <div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot'); ?>"><?php echo lang('Messenger Bot'); ?></a></div>
      <div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot/template_manager')."?media_type={$media_type}"; ?>"><?php echo lang('Post-back Manager'); ?></a></div>
        ...
        <div class="<?php if($is_iframe=="1") echo 'col-12'; else echo 'col-12 col-lg-9';?>">
          <form action="#" method="post" id="messenger_bot_form" style="padding-left: 0;">
            ...
            <div class="row"> 
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label><?php echo lang('Click the below button to see variable list'); ?></label>
                  <a class="btn btn-outline-primary variables form-control" href="#"><i class="fas fa-plus-circle"></i> <?php echo lang('Variables'); ?></a>
                </div>
              </div>
              <?php endif; ?>
              ...
              <div class="col-12 col-sm-6 order-last"> 
                <div class="form-group">
                  <label><?php echo lang('Choose a Page'); ?></label>
                  <?php 
                    $page_list[''] = lang('Please select a page');
            ...
            echo '<div class="row">
              <div class="'.$first_col.'"> 
                  <div class="form-group">
                    ...
                    <a class="blue float-right pointer" page_id_for_label="" id="create_label_postback"><i class="fas fa-plus-circle"></i> '.lang('Create Label').'</a>  
                    </label>
          ...
          <!--   This div is added by Konok to make it sortable  -->
            ...
            <div class="row">
              ...
              <?php if($iframe != '1') : ?>
              <div class="col-6">
                <a class="btn btn-lg btn-secondary float-right" href="<?php echo base_url("messenger_bot/template_manager")."?media_type={$media_type}"; ?>"><i class="fas fa-times"></i> <?php echo lang('Back'); ?></a>
              </div>
              <?php endif; ?>
            </div>
...
<?php for($template_type=1;$template_type<=6;$template_type++){ ?>
  ...
  <?php } ?>
    ...
    $(document).on('click','#submit',function(e){   
      ...
      if(output === false)
      {
        swal('<?php echo lang('Warning'); ?>', '<?php echo lang('There is disallowed characters in your main PostBack Id')?>', 'warning');
        return;
      }
            ...
            for(var n=1; n<=submited_media_counter; n++)
            {
              ...
              if(media_type_check == ''){
                ...
                if(media_post_id_check == template_postback_id){
                  swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please use different ID for main postback and button type postback.')?>", 'warning');
                  return;
                }
      ...
      $.ajax({
        ...
        success:function(response){
          ...
          if(is_iframe=='1') 
          {
            swal('<?php echo lang('Success'); ?>', "<?php echo lang('Template has been created successfully.'); ?>", 'success').then((value) => {
              $(this).attr("disabled","disabled");
            });
          }
          else

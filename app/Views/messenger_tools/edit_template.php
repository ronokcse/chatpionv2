...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
       <div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot'); ?>"><?php echo lang('Messenger Bot'); ?></a></div>
      <div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot/template_manager/'.$media_type); ?>"><?php echo lang('Post-back Manager'); ?></a></div>
            ...
            <div class="<?php if($iframe=="1") echo 'col-12'; else echo 'col-9';?>">
              <form action="#" method="post" id="messenger_bot_form" style="padding-left: 0;">
               ...
               <br/>
                <div class="row" <?php if($is_default=='default') echo "style='display: none;'"; ?> > 
                  ...
                  <?php if (isset($action_type) && $action_type == 'clone'): ?>
                    <div class="col-12 col-sm-6 hidden"> 
                      <div class="form-group">
                        <label><?php echo lang('Selected page'); ?></label>
                        <?php 
                ...
                <div class="row" <?php if($is_default=='default') echo "style='display: none;'"; ?> > 
                  ...
                  <?php if (isset($action_type) && $action_type == 'clone'): ?>
                    <div class="col-12 col-sm-6">
                      <div class="form-group" >
                        <label><?php echo lang('PostBack Type'); ?></label>
                  ...
                  <div class="col-12 col-sm-6"> 
                    <div class="form-group" id="postback_section">
                      <label><?php echo lang('Postback ID'); ?>
                        <?php if (isset($action_type) && $action_type == 'clone'): ?>
                          <a href="#" data-placement="right"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Supported Characters') ?>" data-content="It is recommended to use English characters as postback id. You can use a-z, A-Z, 0-9, -, , _"><i class='fa fa-info-circle'></i> </a>
                        <?php endif ?>
                      </label>
                ...
                <?php 
                  ...
                  <div class="'.$first_col.'"> 
                      <div class="form-group">
                        ...
                        <a class="blue float-right pointer" page_id_for_label="'.$bot_info['page_id'].'" id="create_label_postback"><i class="fas fa-plus-circle"></i> '.lang('Create Label').'</a>  
                        </label>';
                        ...
                        $str .= '<option value="">'.lang('Select Labels').'</option>';
                  ...
                  '<div class="col-12 col-sm-6"> 
                      <div class="form-group">
                        <label style="width:100%">
                        '.lang('Choose Sequence Campaigns')." ".$popover2.'
                        </label>';
                        ...
                        $str .= '<option value="">'.lang('Select').'</option>';
                ...
                <div class="row" id="keywords_div" style="display: none;"> 
                  <div class="col-12">              
                    <div class="form-group">
                      <label><?php echo lang('Please provide your keywords in comma separated'); ?></label>
                ...
                <div class="row" id="postback_div" style="display: none;"> 
                  <div class="col-12">              
                    <div class="form-group">
                      <label><?php echo lang('Please select your postback id : '); ?></label>
              ...
              for($k=1;$k<=6;$k++){ 
                ...
                <div class="card-header">
                  <h4 class="full_width">
                    <?php echo lang('Reply')." ".$k; ?>
                    <?php if($k != 1 && $k == count($full_message_array)) : ?>
                      <i class="fa fa-times-circle remove_reply float-right red" row_id="multiple_template_div_<?php echo $k; ?>" counter_variable="" title="<?php echo lang('Remove this item'); ?>"></i>
                    <?php else : ?>
                      <i class="fa fa-times-circle remove_reply float-right red" style="display: none;" row_id="multiple_template_div_<?php echo $k; ?>" counter_variable="" title="<?php echo lang('Remove this item'); ?>"></i>
                    <?php endif; ?>
                  </h4>
                </div>
                <div class="card-body">
                  ...
                  <div style="">
                    ...
                    <div class="input-group <?php if($media_type =="ig") echo 'mb-3'; else echo 'mb-1'; ?>">                            
                      <div class="input-group-prepend">
                        <div class="input-group-text" style="font-weight: bold;">
                          <?php echo lang('Select Reply Type') ?>
                        </div>
                      </div>
                    ...
                    <div class="row <?php if($media_type =="ig") echo 'hidden';; ?>" id="delay_and_typing_on_<?php echo $k; ?>">
                      <div class="col-12 col-sm-6">
                        <div class="row">
                          <div class="<?php if($iframe == '1') echo 'col-7'; else echo 'col-5' ?>"><label for="" style="margin-top: 8px; color: #34395e; font-size: 14px;"><?php echo lang('Typing on display :'); ?></label></div>
                          <div class="<?php if($iframe == '1') echo 'col-5'; else echo 'col-7' ?>">
                            <label class="custom-switch mt-2 float-left">
                              ...
                              <span class="custom-switch-indicator"></span>
                              <span class="custom-switch-description"><?php echo lang('Enable'); ?></span>
                            </label>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-sm-6">
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text"><?php echo lang('Delay in reply'); ?></span>
                          </div>
                          ...
                          <div class="input-group-append">
                            <span class="input-group-text"><?php echo lang('Sec'); ?></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row" id="text_div_<?php echo $k; ?>"> 
                      <div class="col-12">              
                        <div class="form-group">
                          <label><?php echo lang('Please provide your reply message'); ?>
                            <a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Spintax'); ?>" data-content="Spintax example : {Hello|Howdy|Hola} to you, {Mr.|Mrs.|Ms.} {{Jason|Malina|Sara}|Williams|Davis}"><i class='fa fa-info-circle'></i> </a>
                          </label>
                          ...
                          <span class='float-right hidden'>
                            <a title="<?php echo lang('You can tag user in your comment reply. Facebook will notify them about mention whenever you tag.') ?>" data-placement="top" data-toggle="tooltip"
                             class='btn btn-default btn-sm full_lead_tag_name button-outline'><i class='fa fa-tags'></i> <?php echo lang('mention user') ?></a>
                          </span>

                          <span class='float-right'>
                            <a title="<?php echo lang('You can include #LEAD_FULL_NAME# variable inside your message. The variable will be replaced by real Full Name when we will send it.') ?>" data-placement="top" data-toggle="tooltip" class='btn btn-default btn-sm full_lead_first_name button-outline'><i class='fa fa-user'></i> <?php echo lang('Full Name') ?></a>
                          </span>
                          <?php endif; ?>  
                    ...
                    <div class="row" id="One_Time_Notification_div_<?php echo $k; ?>" style="display: none;"> 
                      ...
                      <div class="col-12 col-md-6">              
                        <div class="form-group">
                          <label><?php echo lang('OTN Postback'); ?>
                          </label>
                          <?php 
                    ...
                    <div class="row" id="image_div_<?php echo $k; ?>" style="display: none;">             
                      <div class="col-12">              
                        <div class="form-group">
                          ...
                          <span class="badge badge-status blue load_preview_modal float-right" item_type="image" file_path="<?php if(isset($full_message[$k]['template_type']) && $full_message[$k]['template_type']== 'image') echo $full_message[$k]['attachment']['payload']['url'];?>"><i class="fa fa-eye"></i> <?php echo lang('preview'); ?></span>

                          <input type="text" placeholder="<?php echo lang('Put your image URL here or click the upload button.'); ?>" class="form-control"  name="image_reply_field_<?php echo $k; ?>" id="image_reply_field_<?php echo $k; ?>" value="<?php if(isset($full_message[$k]['template_type']) && $full_message[$k]['template_type']== 'image') echo $full_message[$k]['attachment']['payload']['url'];?>">
                    ...
                    <div class="row" id="audio_div_<?php echo $k; ?>" style="display: none;">  
                      <div class="col-12">             
                        <div class="form-group">
                          <label><?php echo lang('Please provide your reply audio'); ?></label>

                          <span class="badge badge-status blue load_preview_modal float-right" item_type="audio" file_path="<?php if(isset($full_message[$k]['template_type']) && $full_message[$k]['template_type']== 'audio') echo $full_message[$k]['attachment']['payload']['url'];?>"><i class="fa fa-eye"></i> <?php echo lang('preview'); ?></span>
                    ...
                    <div class="row" id="video_div_<?php echo $k; ?>" style="display: none;">  
                      <div class="col-12">             
                        <div class="form-group">
                          <label><?php echo lang('Please provide your reply video'); ?></label>

                          <span class="badge badge-status blue load_preview_modal float-right" item_type="video" file_path="<?php if(isset($full_message[$k]['template_type']) && $full_message[$k]['template_type'] == 'video') echo $full_message[$k]['attachment']['payload']['url'];?>"><i class="fa fa-eye"></i> <?php echo lang('preview'); ?></span>
                    ...
                    <div class="row" id="file_div_<?php echo $k; ?>" style="display: none;">  
                      <div class="col-12">             
                        <div class="form-group">
                          <label><?php echo lang('Please provide your reply file'); ?></label>

                          <span class="badge badge-status blue load_preview_modal float-right" item_type="file" file_path="<?php if(isset($full_message[$k]['template_type']) && $full_message[$k]['template_type'] == 'file') echo $full_message[$k]['attachment']['payload']['url'];?>"><i class="fa fa-eye"></i> <?php echo lang('preview'); ?></span>
                      ...
                      <div class="col-12">  
                       ...
                       <div class="row button_border" id="quick_reply_row_<?php echo $i; ?>_<?php echo $k; ?>" <?php if(!isset($full_message[$k]['quick_replies'][$i-1])) echo 'style="display: none;"'; else $quickreply_add_button_display++; ?> >
                          ...
                          <div class="col-10 col-sm-3">
                            <div class="form-group" id="quick_reply_postid_div_<?php echo $i; ?>_<?php echo $k; ?>" <?php if(!isset($full_message[$k]['quick_replies'][$i-1]['content_type']) || $full_message[$k]['quick_replies'][$i-1]['content_type'] != 'text') echo 'style="display: none;"'; ?>>
                              ...
                              <div>                              
                                ...
                                <a href="" class="add_template float-left" page_id_add_postback="<?php echo $bot_info['page_id']; ?>"><i class="fa fa-plus-circle"></i> <?php echo lang('Add');?></a>
                                <a href="" class="ref_template float-right" page_id_ref_postback="<?php echo $bot_info['page_id']; ?>"><i class="fa fa-refresh"></i> <?php echo lang('Refresh');?></a>
                              </div>
                        ...
                        <div class="row clearfix">
                          <div class="col-12 text-center"><button class="btn btn-outline-primary float-right no_radius btn-xs" <?php if($quickreply_add_button_display==11) echo 'style="display : none;"'; ?> id="quick_reply_add_button_<?php echo $k; ?>"><i class="fa fa-plus-circle"></i> <?php echo lang('add more button');?></button></div>
                        </div>
                      ...
                      <div class="col-12"> 
                        ...
                        <div class="form-group">
                          <label><?php echo lang('Please provide your media URL'); ?>
                            <a href="#" class="media_template_modal" title="<?php echo lang('How to get media URL?'); ?>"><i class='fa fa-info-circle'></i> </a>
                          </label>
                          ...
                          <div class="col-12 col-sm-4">
                            <div class="form-group">
                              ...
                              <select class="form-control select2 text_with_button_type_class" id="text_with_button_type_<?php echo $i; ?>_<?php echo $k; ?>" name="text_with_button_type_<?php echo $i; ?>_<?php echo $k; ?>">
                                ...
                                <option value="post_back" id="resubscribe_postback" <?php if(isset($full_message[$k]['attachment']['payload']['buttons'][$i-1]['type']) && $full_message[$k]['attachment']['payload']['buttons'][$i-1]['type'] == 'postback' && isset($full_message[$k]['attachment']['payload']['buttons'][$i-1]['payload']) && $full_message[$k]['attachment']['payload']['buttons'][$i-1]['payload'] == 'RESUBSCRIBE_QUICK_BOXER') echo 'selected'; ?> ><?php echo lang('re-subscribe'); ?></option>
                                
                                <option value="post_back" id="human_postback" <?php if(isset($full_message[$k]['attachment']['payload']['buttons'][$i-1]['type']) && $full_message[$k]['attachment']['payload']['buttons'][$i-1]['type'] == 'postback' && isset($full_message[$k]['attachment']['payload']['buttons'][$i-1]['payload']) && $full_message[$k]['attachment']['payload']['buttons'][$i-1]['payload'] == 'YES_START_CHAT_WITH_HUMAN') echo 'selected'; ?> ><?php echo lang('Chat with Human'); ?></option>
                                <option value="post_back" id="robot_postback" <?php if(isset($full_message[$k]['attachment']['payload']['buttons'][$i-1]['type']) && $full_message[$k]['attachment']['payload']['buttons'][$i-1]['type'] == 'postback' && isset($full_message[$k]['attachment']['payload']['buttons'][$i-1]['payload']) && $full_message[$k]['attachment']['payload']['buttons'][$i-1]['payload'] == 'YES_START_CHAT_WITH_BOT') echo 'selected'; ?> ><?php echo lang('Chat with Robot'); ?></option>
                              </select>
                            </div>
                          </div>
                          <div class="col-10 col-sm-3">
                    ...
                    <div class="row" id="generic_template_div_<?php echo $k; ?>" style="display: none; margin-bottom: 10px;">   
                      <div class="col-12"> 
                        ...
                        <div class="card card-secondary">
                          <div class="card-header">
                            <h4><?php echo lang('Generic Template'); ?></h4>
                          </div>
                          <div class="card-body">
                    ...
                    <div class="row" id="Ecommerce_div_<?php echo $k; ?>" style="display: none; margin-bottom: 10px;">
                      <?php 
                        $selected_store_id = '';
                        $buy_now_button_text = lang('Buy Now');
                        $current_products = [];
                        if( isset($full_message[$k]["template_type"]) && $full_message[$k]["template_type"]=='Ecommerce' )
                        {
                          ...
                          $buy_now_button_text = isset($full_message[$k]['attachment']['payload']['elements'][0]['buttons'][0]['title']) ? $full_message[$k]['attachment']['payload']['elements'][0]['buttons'][0]['title'] : lang('Buy Now');
                      ...
                      <div class="col-12">              
                        <div class="form-group">
                          <label><?php echo lang('Select your Ecommerce store'); ?>
                          </label>
                      ...
                      <div class="col-12">              
                        <div class="form-group">
                          <label><?php echo lang('Please select products for carousel/generic reply'); ?>
                          </label>
                      ...
                      <?php $carousel_template_counter = 0; for ($j=1; $j <=10 ; $j++) : ?>
                        <div class="col-12" id="carousel_div_<?php echo $j; ?>_<?php echo $k; ?>" style="<?php if(!isset($full_message[$k]['attachment']['payload']['elements'][$j-1])) echo 'display: none;'; else $carousel_template_counter++; ?>"> 
                          <div class="card card-secondary">
                            <div class="card-header">
                              <h4 class="full_width">
                                <?php echo lang('Carousel Template').' '.$j; ?>
                                ...
                                <div class="col-12 col-sm-4">
                                  <div class="form-group">
                                    ...
                                    <select class="form-control select2 carousel_button_type_class" id="carousel_button_type_<?php echo $j."_".$i; ?>_<?php echo $k; ?>" name="carousel_button_type_<?php echo $j."_".$i; ?>_<?php echo $k; ?>">
                                      ...
                                      <option value="post_back" id="resubscribe_postback" <?php if(isset($full_message[$k]['attachment']['payload']['elements'][$j-1]['buttons'][$i-1]['type']) && $full_message[$k]['attachment']['payload']['elements'][$j-1]['buttons'][$i-1]['type'] == 'postback' && isset($full_message[$k]['attachment']['payload']['elements'][$j-1]['buttons'][$i-1]['payload']) && $full_message[$k]['attachment']['payload']['elements'][$j-1]['buttons'][$i-1]['payload'] == 'RESUBSCRIBE_QUICK_BOXER') echo 'selected'; ?> ><?php echo lang('re-subscribe'); ?></option>
                                      
                                        <option value="post_back" id="human_postback" <?php if(isset($full_message[$k]['attachment']['payload']['elements'][$j-1]['buttons'][$i-1]['type']) && $full_message[$k]['attachment']['payload']['elements'][$j-1]['buttons'][$i-1]['type'] == 'postback' && isset($full_message[$k]['attachment']['payload']['elements'][$j-1]['buttons'][$i-1]['payload']) && $full_message[$k]['attachment']['payload']['elements'][$j-1]['buttons'][$i-1]['payload'] == 'YES_START_CHAT_WITH_HUMAN') echo 'selected'; ?> ><?php echo lang('Chat with Human'); ?></option>
                                      <option value="post_back" id="robot_postback" <?php if(isset($full_message[$k]['attachment']['payload']['elements'][$j-1]['buttons'][$i-1]['type']) && $full_message[$k]['attachment']['payload']['elements'][$j-1]['buttons'][$i-1]['type'] == 'postback' && isset($full_message[$k]['attachment']['payload']['elements'][$j-1]['buttons'][$i-1]['payload']) && $full_message[$k]['attachment']['payload']['elements'][$j-1]['buttons'][$i-1]['payload'] == 'YES_START_CHAT_WITH_BOT') echo 'selected'; ?> ><?php echo lang('Chat with Robot'); ?></option>
                                    </select>
                                  </div>
                                </div>
                                <div class="col-10 col-sm-3">
              ...
              <input type="hidden" name="main_reply_sort_order" id="main_reply_sort_order">
                ...
                <div class="row">
                  <div class="col-12">
                    <button id="multiple_template_add_button" class="btn btn-outline-primary float-right no_radius" <?php if($active_reply_count==6) echo 'style="display: none;"'; ?> ><i class="fa fa-plus-circle"></i> <?php echo lang('add more reply'); ?></button>
                  </div>
                </div>
                <br/><br/>
                <div class="row">
                  <div class="col-6">
                    <button id="submit" class="btn btn-lg btn-primary"><i class="fa fa-send"></i> <?php echo (!(isset($action_type) && $action_type == 'clone')) ? lang('Update') : lang('Clone');; ?></button>
                  </div>
                  <?php if($iframe != '1') : ?>
                  <div class="col-6">
                    <a class="btn btn-lg btn-secondary float-right" href="<?php echo base_url("messenger_bot/template_manager"); ?>"><i class="fas fa-step-backward"></i> <?php echo lang('Back'); ?></a>
                  </div>
                  <?php endif; ?>
                </div>
              </form>
...
$doyoureallywanttodeletethisbot = lang('do you really want to delete this bot?');
?>
   ...
   <?php } ?>
      ...
      $(document).on('click',"#quick_reply_add_button_<?php echo $template_type; ?>",function(e){
        ...
        {        
          if(quick_reply_post_id_check == ''){
            swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide Your PostBack Id')?>", 'warning');
            return;
          }
        ...
        if(output === false)
        {
          swal('<?php echo lang('Warning'); ?>', '<?php echo lang('There is disallowed characters in your PostBack Id')?>', 'warning');
          return;
        }

        if(quick_reply_button_type == '')
        {
          swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide Your Button Type')?>", 'warning');
          return;
        }
        ...
        { 
          if(quick_reply_button_text_check == ''){
            swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide Your Button Text')?>", 'warning');
            return;
          }
        }
     ...
     $(document).on('click',"#media_add_button_<?php echo $template_type; ?>",function(e){
        ...
        if(media_type_check == ''){
          ...
          if(media_web_url_check == ''){
            swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide Your Web Url')?>", 'warning');
            return;
          }
          ...
          if(media_call_us_check == ''){
            swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide Your Phone Number')?>", 'warning');
            return;
          }
        }
    ...
    $(document).on('click','#carousel_template_add_button_<?php echo $template_type; ?>',function(e){
         ...
         if(carousel_title_check == ''){
           swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide carousel title')?>", 'warning');
           return;
         }
  ...
  $(document).ready(function() {
        ...
        $.ajax({
          ...
          success:function(response){  
            if(response.first_dropdown == ''){
              swal('<?php echo lang('Warning'); ?>', '<?php echo lang('You have no child PostBack for this page.'); ?>', 'warning');
              $("#parent_postback").prop("checked", true);
              var content = '<label><?php echo lang('PostBack ID'); ?><a href="#" data-placement="right"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Supported Characters') ?>" data-content="It is recommended to use English characters as postback id. You can use a-z, A-Z, 0-9, -, , _"><i class="fa fa-info-circle"></i> </a></label>'+
    ...
    $(document).on('click','#create_label_postback',function(e){
      ...
      swal("<?php echo lang('Label Name'); ?>", {
        content: "input",
        button: {text: "<?php echo lang('New Label'); ?>"},
      })
      .then((value) => {
    ...
    $(document).on('change','.text_with_button_type_class',function(){
      ...
      if(button_type == 'post_back')
      {
        ...
        if(option_id=="human_postback")
        {
           $("#text_with_button_postid_div_"+which_number_is_clicked+"_"+which_block_is_clicked+" select").append($("<option></option>").attr("value","YES_START_CHAT_WITH_HUMAN").text("<?php echo lang('Chat with Human');?>")); 
        ...
        if(option_id=="robot_postback")
        {
           $("#text_with_button_postid_div_"+which_number_is_clicked+"_"+which_block_is_clicked+" select").append($("<option></option>").attr("value","YES_START_CHAT_WITH_BOT").text("<?php echo lang('Chat with Robot');?>")); 
            $("#text_with_button_postid_div_"+which_number_is_clicked+"_"+which_block_is_clicked+" select option").removeAttr('selected');
    ...
    $(document).on('change','.generic_template_button_type_class',function(){
      ...
      if(button_type == 'post_back')
      {
        ...
        if(option_id=="human_postback")
        {
           $("#generic_template_button_postid_div_"+which_number_is_clicked+"_"+which_block_is_clicked+" select").append($("<option></option>").attr("value","YES_START_CHAT_WITH_HUMAN").text("<?php echo lang('Chat with Human');?>")); 
        ...
        if(option_id=="robot_postback")
        {
           $("#generic_template_button_postid_div_"+which_number_is_clicked+"_"+which_block_is_clicked+" select").append($("<option></option>").attr("value","YES_START_CHAT_WITH_BOT").text("<?php echo lang('Chat with Robot');?>")); 
           $("#generic_template_button_postid_div_"+which_number_is_clicked+"_"+which_block_is_clicked+" select option").removeAttr('selected');
    ...
    $(document).on('change','.carousel_button_type_class',function(){
      ...
      if(button_type == 'post_back')
      {
        ...
        if(option_id=="unsubscribe_postback")
        {
           $("#carousel_button_postid_div_"+second+"_"+first+"_"+block_template_third+" select").append($("<option></option>").attr("value","UNSUBSCRIBE_QUICK_BOXER").text("<?php echo lang('unsubscribe');?>")); 
        ...
        if(option_id=="resubscribe_postback")
        {
           $("#carousel_button_postid_div_"+second+"_"+first+"_"+block_template_third+" select").append($("<option></option>").attr("value","RESUBSCRIBE_QUICK_BOXER").text("<?php echo lang('re-subscribe');?>")); 
           $("#carousel_button_postid_div_"+second+"_"+first+"_"+block_template_third+" select option").removeAttr('selected');
        ...
        if(option_id=="human_postback")
        {
           $("#carousel_button_postid_div_"+second+"_"+first+"_"+block_template_third+" select").append($("<option></option>").attr("value","YES_START_CHAT_WITH_HUMAN").text("<?php echo lang('Chat with Human');?>")); 
        ...
        if(option_id=="robot_postback")
        {
           $("#carousel_button_postid_div_"+second+"_"+first+"_"+block_template_third+" select").append($("<option></option>").attr("value","YES_START_CHAT_WITH_BOT").text("<?php echo lang('Chat with Robot');?>")); 
           $("#carousel_button_postid_div_"+second+"_"+first+"_"+block_template_third+" select option").removeAttr('selected');
    ...
    $(document).on('click','#submit',function(e){   
      ...
      <?php if (!(isset($action_type) && $action_type == 'clone')) : ?>
        if(jQuery.inArray(template_postback_id.toUpperCase(), eval(new_variable_name)) !== -1){
          swal('<?php echo lang('Warning'); ?>', "<?php echo lang('The PostBack ID you have given is allready exist. Please provide different PostBack Id')?>", 'warning');
          return ;
        }
      <?php else : ?>
        if($("input[name=postback_type]:checked").val()!="child")
      ...
      if(bot_name == '')
      {
        swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Give Template Name')?>", 'warning');
        return;
      }
      ...
      {
        swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please give a postback ID')?>", 'warning');
        return;
      }
      ...
      if(keyword_type == 'post-back')
      {
        ...
        {
          swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please provide postback id')?>", 'warning');
          return;
        }
      }
      ...
      if(keyword_type == 'reply')
      {
        ...
        if(keywords_list =='')
        {
          swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide Your Keywords In Comma Separated')?>", 'warning');
          return;
        }
      }
      ...
      for(var m=1; m<=multiple_template_add_button_counter; m++)
      {
          ...
          if(template_type == 'Ecommerce')
          {
            ...
            if(ecommerce_store_id == ''){
              swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Select an Ecommerce Store')?>", 'warning');
              return;
            }

            var ecommerce_product_ids = $("#ecommerce_product_ids"+m).val();
            if(ecommerce_product_ids == ''){
              swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please select atleast one product for carousel/generic reply')?>", 'warning');
              return;
            }
          }
          ...
          if(template_type == 'User Input Flow')
          {
            ...
            if(flow_campaign_id_ == ''){
              swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Select a Flow Campaign')?>", 'warning');
              return;
            }
          }
          ...
          if(template_type == "image")
          {
            ...
            if(image_reply_field == ''){
              swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide Your Reply Image')?>", 'warning');
              return;
            }
          }
          ...
          if(template_type == "One Time Notification")
          {
            ...
            if(otn_title == ''){
              swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide OTN Title')?>", 'warning');
              return;
            }
            if(otn_postback == ''){
              swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Select an OTN Postback')?>", 'warning');
              return;
            }
          }
          ...
          if(template_type == "audio")
          {
            ...
            if(audio_reply_field == ''){
              swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide Your Reply Audio')?>", 'warning');
              return;
            }
          }
          ...
          if(template_type == "video")
          {
            ...
            if(video_reply_field == ''){
              swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide Your Reply Video')?>", 'warning');
              return;          
            }
          }
          ...
          if(template_type == "file")
          {
            ...
            if(file_reply_field == ''){
              swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide Your Reply File')?>", 'warning');
              return;          
            }
          }
          ...
          if(template_type == "media")
          {
            ...
            if(media_input == ''){
              swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Provide Your Media URL')?>", 'warning');
              return;          
            }
            ...
            {
              swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please provide Facebook content URL as Media URL')?>", 'warning');
              return; 
            }
          ...
          if(template_type == "generic template")
          {
            ...
            if(generic_template_title == ''){
              swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please give the title')?>", 'warning');
              return;          
            }
    ...
    $(document).on('change','input[name=postback_type]',function(){
      ...
      {     
        ...
        if(page_auto_id == '')
        {
          swal('<?php echo lang('Warning'); ?>', '<?php echo lang('You have to select a page first.'); ?>', 'warning');
          $("#parent_postback").prop("checked", true);
          return false;
        }
        else
...
<div class="modal fade" id="error_modal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title"><i class="fa fa-info"></i> <?php echo lang('campaign error'); ?></h4>
      </div>
      <div class="modal-body">
...
<div class="modal fade" id="media_template_modal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog  modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fas fa-info-circle"></i> <?php echo lang('How to get media URL?'); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      </div>
      <div class="modal-body">
        <div>

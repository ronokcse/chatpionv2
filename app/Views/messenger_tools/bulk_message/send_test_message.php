    ...
    <div id="test_send_modal_content">
		...
		<div class="form-group">
            <label class="full_width" style="margin-bottom: 0">
           		<?php echo lang('Test Subscribers'); ?>
           		<a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo lang('Subscriber Name');?>" data-content="<?php echo lang('Choose up to 3 subscriber to test how it will look. Start typing, it is auto-complete.') ?>"><i class='fa fa-info-circle'></i> </a>              	
           		<a class="btn btn-sm btn-light float-right" id="submit_test_post" name="submit_test_post"><i class="fa fa-envelope"></i> <?php echo lang('Send Test Message') ?> </a>
            </label>
...
<script type="text/javascript">
	...
	$("document").ready(function(){	
	    ...
	    $(document).on('click','#submit_test_post',function(){ 
	    	...
	    	{
	        swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Please choose a subscriber to send test message.');?>', 'warning');
	    	 	return;
	    	}

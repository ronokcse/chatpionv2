<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      <div class="breadcrumb-item active"><a href="<?php echo base_url('messenger_bot_broadcast'); ?>"><?php echo lang('Messenger Broadcast');?></a></div>
	  ...
	  <form action="#" enctype="multipart/form-data" id="inbox_campaign_form" method="post">
	    <div class="card main_card">
	      <div class="card-header">        
	         <h4><i class="fas fa-envelope"></i> <?php echo lang('Message Content'); ?></h4>       
	      </div>
	      <div class="card-body">
          ...
          <div class="text-center waiting">
            <i class="fas fa-spinner fa-spin blue text-center"></i>
              ...
              <a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('message'); ?>" data-content="<?php echo lang('Message may contain texts, urls, emotions and any promotional content.You can personalize message by including subscriber name. Message supports spintax, example'); ?> : {Hello|Howdy|Hola} to you, {Mr.|Mrs.|Ms.} {{Jason|Malina|Sara}|Williams|Davis}"><i class='fa fa-info-circle'></i> </a>
      			...
      			<span class='float-right'> 
      				<a data-toggle="tooltip" data-placement="top" title='<?php echo lang('You can include #LEAD_USER_FIRST_NAME# variable inside your message. The variable will be replaced by real name when we will send it.') ?>' class='btn-outline btn-sm' id='lead_last_name'><i class='fas fa-user'></i> <?php echo lang('First Name') ?></a>
      			</span>
      			<div class="clearfix"></div>
      			<textarea class="form-control" name="message" id="message" placeholder="<?php echo lang('type your message here...') ?>" style="height:170px;"><?php echo $xdata[0]["campaign_message"];?></textarea>
      			
      		</div>  
	      </div>
	      <div class="card-footer">
	      	<button class="btn btn-lg btn-primary" id="submit_post" name="submit_post" type="button"><i class="fa fa-edit"></i> <?php echo lang('edit') ?>  <?php echo lang('message') ?> </button>
	      </div>
	    </div>  
    </form>       
  </div>

  ...
  <div class="section-header">
    <h1>
      ...
      <?php echo lang('Messenger Broadcasting'); ?>
     </h1>
  </div>
      ...
      <div class="col-12 col-md-4">
          ...
          <div class="wizard-step wizard-step-light">
            ...
            <div class="wizard-step-label">
              <?php echo lang('Subscriber Broadcast'); ?>
            </div>
            <p class="text-muted mt-3"><?php echo lang('Non-promo with tag, 24H structured message broadcast to messenger bot subscribers'); ?></p>       
          </div>
          </a>
        </div>
      </div>
    ...
    if(session()->get('user_type')=="Admin"  || in_array(275,$this->module_access)) { ?>
      <div class="col-12 col-md-4">
          ...
          <div class="wizard-step wizard-step-light">
            ...
            <div class="wizard-step-label">
              <?php echo lang('OTN Subscriber Broadcast'); ?>
            </div>
            <p class="text-muted mt-3"><?php echo lang('One-Time Notification request follow-up message broadcasting.'); ?></p>       
          </div>
          </a>
        </div>
      </div>
  ...
  if($this->recurring_notification_exist) { ?>
    <div class="col-12 col-md-4">
        ...
        <div class="wizard-step wizard-step-light">
          ...
          <div class="wizard-step-label">
            <?php echo lang('Recurring Notification Broadcast'); ?>
          </div>
          <p class="text-muted mt-3"><?php echo lang('Recurring Notification request follow-up message broadcasting.'); ?></p>       
        </div>
        </a>
      </div>
    </div>
  ...
  <section class="section">
      <div class="section-header">
          <h1><i class="fas fa-envelope"></i> <?php echo lang('SMS/Email Broadcasting'); ?></h1>
      </div>
          ...
          <div class="row"> 
              ...
              <div class="col-12 col-md-4">
                  ...
                  <div class="wizard-step wizard-step-light px-lg-2">
                    ...
                    <p class="text-muted mt-2"><?php echo lang('SMS/email contact, contact group/label');?></p>
                    <div class="mt-1">
                      <a href="<?php echo base_url("sms_email_manager/contact_group_list"); ?>" class="no_hover  btn btn-outline-light text-primary"><i class="fas fa-address-book"></i> <?php echo lang('Group'); ?> <i class="fas fa-chevron-right"></i></a>
                      <a href="<?php echo base_url("sms_email_manager/contact_list"); ?>" class="no_hover  btn btn-outline-light text-primary"><i class="fas fa-users"></i> <?php echo lang('Contact'); ?> <i class="fas fa-chevron-right"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12 col-md-4">
                ...
                <div class="wizard-step wizard-step-light px-lg-2">
                  ...
                  <div class="wizard-step-label">
                    <?php echo lang('Broadcast Campaign'); ?>
                  </div>
                  <p class="text-muted mt-2"><?php echo lang('Campaign list, new campaign, report');?></p>
                  <div class="mt-1">
                    <a href="<?php echo base_url('sms_email_manager/email_campaign_lists'); ?>" class="no_hover  btn btn-outline-light text-primary"><i class="fas fa-envelope"></i> <?php echo lang('Email'); ?> <i class="fas fa-chevron-right"></i></a>
                    <a href="<?php echo base_url('sms_email_manager/sms_campaign_lists'); ?>" class="no_hover  btn btn-outline-light text-primary"><i class="fas fa-sms"></i> <?php echo lang('SMS'); ?> <i class="fas fa-chevron-right"></i></a>
                  </div>
                </div>
              </div>
            </div> 
                ...
                <div class="col-12 col-md-4">
                  ...
                  <a href="<?php echo base_url('sms_email_sequence/external_sequence_lists'); ?>" class="no_hover">
                    <div class="wizard-step wizard-step-light px-lg-2">
                      ...
                      <div class="wizard-step-label">
                        <?php echo lang('Sequence Campaign'); ?>
                      </div>
                      <p class="text-muted mt-2"><?php echo lang('Sequence sms/email broadcasting for external contact.');?></p>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div class="col-12 col-md-4">
                ...
                <a href="<?php echo base_url("email_optin_form_builder"); ?>" class="no_hover">
                  <div class="wizard-step wizard-step-light px-lg-2">
                    ...
                    <div class="wizard-step-label">
                      <?php echo lang('Opt-in Form Builder'); ?>
                    </div>
                    <p class="text-muted mt-2"><?php echo lang('Custom sms/email subscribers opt-in form builder for website.');?></p>
                  </div>
                </a>
              </div>
          </div>

	...
	<form action="#" enctype="multipart/form-data" id="inbox_campaign_form" method="post">
	    ...
	    <div class="card main_card">
          ...
          <br><br>
      		...
      		<div class="row">
      			...
      			<div class="form-group schedule_block_item col-12 col-md-4">
      				...
      				<input placeholder="<?php echo lang('Choose Time');?>" value="<?php echo $xdata[0]['schedule_time']; ?>"  name="schedule_time" id="schedule_time" class="form-control datepicker_x" type="text"/>
      			</div>
	      ...
	      <div class="card-footer">
	      	<button class="btn btn-lg btn-primary" id="submit_post" name="submit_post" type="button"><i class="fas fa-edit"></i> <?php echo lang('Edit Campaign') ?> </button>
	      </div>
	    </div>  
    </form>       
  </div>
...
<script> 
	$("document").ready(function(){
        ...
        var message = $("#message").val();
	      ...
	      {
	        swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Page does not have any subscriber send message.'); ?>', 'warning');
	        return;
	      }

  	...
  	<div class="section-body">
	    ...
	    { ?>	
			...
			<div class="row">
				...
				<div class="card card-statistic-2">
					<div class="card-stats">
					  <div class="card-stats-title"><?php echo lang('7 Days Summary'); ?>
					  </div>
					  <div class="card-stats-items">
					    <div class="card-stats-item">
				...
				<div class="col-lg-4 col-12">
					<div class="card card-statistic-2">
					<div class="card-stats">
					  <div class="card-stats-title"><?php echo lang('30 Days Summary'); ?>
					  </div>
					  <div class="card-stats-items">
					    <div class="card-stats-item">
			...
			<div class="row">
		        ...
		        <div class="card card-statistic-1">
		          ...
		          <div class="card-wrap">
		            <div class="card-header">
		              <h4><?php echo lang('Total Connections'); ?></h4>
		            </div>
		            <div class="card-body">
		      ...
		      <div class="col-md-4 col-12">
		        <div class="card card-statistic-1">
		          ...
		          <div class="card-wrap">
		            <div class="card-header">
		              <h4><?php echo lang('Total Blocked'); ?></h4>
		            </div>
		            <div class="card-body">
		      ...
		      <div class="col-md-4 col-12">
		        <div class="card card-statistic-1">
		          ...
		          <div class="card-wrap">
		            <div class="card-header">
		              <h4><?php echo lang('Total Reported'); ?></h4>
		            </div>
		            <div class="card-body">
		    ...
		    <div class="row">
			  <div class="col-12 col-lg-6">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Daily Unique New Conversations');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Daily unique new conversations') ?>" data-content="<?php echo lang('Daily: The number of messaging conversations on Facebook Messenger that began with people who had never messaged with your business before.') ?>"><i class='fas fa-info-circle'></i> </a>
			        </h4>
			      </div>
			      <div class="card-body">
			  ...
			  <div class="col-12 col-lg-6" style="display: none;">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Daily Active Conversations');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Daily active conversations') ?>" data-content="<?php echo lang('The number of daily active conversations between users and the page') ?>"><i class='fas fa-info-circle'></i> </a>
			        </h4>
			      </div>
			      <div class="card-body">
		  	  ...
		  	  <div class="col-12 col-lg-6">
		          <div class="card">
		            <div class="card-header">
		              <h4>
		              	<?php echo lang('Messaging Connections');?>
		              	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Messaging connections') ?>" data-content="<?php echo lang('Daily: The number of people your business can send messages to.') ?>"><i class='fas fa-info-circle'></i> </a>
		  			 </h4>
		            </div>
		            <div class="card-body">
			...
			<div class="row">
			  <div class="col-12 col-lg-6">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Daily Unique Blocked Conversations');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Daily unique blocked conversations') ?>" data-content="<?php echo lang('Daily: The number of conversations with the Page that have been blocked') ?>"><i class='fas fa-info-circle'></i> </a>
			        </h4>
			      </div>
			      <div class="card-body">
			  ...
			  <div class="col-12 col-lg-6">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Daily Unique Reported Conversations');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Daily unique reported conversations') ?>" data-content="<?php echo lang('Daily: The number of conversations from your Page that have been reported by people for reasons such as spam, or containing inappropriate content') ?>"><i class='fas fa-info-circle'></i> </a>
			        </h4>
			      </div>
			      <div class="card-body">
			...
			<div class="row" style="display: none;">
			  <div class="col-12 col-lg-8">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Daily Unique Reported Conversations by Type');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Daily unique reported conversations by type') ?>" data-content="<?php echo lang('Daily: The number of conversations from your Page that have been reported by people for reasons such as spam, or containing inappropriate content broken down by report type') ?>"><i class='fas fa-info-circle'></i> </a>
					</h4>
			      </div>
			      <div class="card-body">
			...
			<div class="row">
			  <div class="col-12">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Daily Unique Reported vs Blocked Conversations');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Daily unique reported vs blocked conversations') ?>" data-content="<?php echo lang('Conversations from your Page that have been reported by people vs conversations with the page that have been blocked') ?>"><i class='fas fa-info-circle'></i> </a>
					</h4>
			      </div>
			      <div class="card-body">
...
<script>
	...
	var page_messages_new_conversations_unique_chart = new Chart(page_messages_new_conversations_unique_data, {
	  ...
	  data: {
	    ...
	    datasets: [{
	      label: '<?php echo lang('Unique New Conversations'); ?>',
	...
	var page_messages_active_threads_unique_chart = new Chart(page_messages_active_threads_unique, {
	  ...
	  data: {
	    ...
	    datasets: [{
	       label: '<?php echo lang('Active Conversations'); ?>',
	...
	var page_messages_blocked_conversations_unique_chart = new Chart(page_messages_blocked_conversations_unique, {
	  ...
	  data: {
	    ...
	    datasets: [{
	      label: '<?php echo lang('Blocked Conversations'); ?>',
	...
	var page_messages_reported_conversations_unique_chart = new Chart(page_messages_reported_conversations_unique, {
	  ...
	  data: {
	    ...
	    datasets: [{
	      label: '<?php echo lang('Reported Conversations'); ?>',
	...
	var page_messages_reported_conversations_by_report_type_unique = document.getElementById("page_messages_reported_conversations_by_report_type_unique").getContext('2d');
  	var page_messages_reported_conversations_by_report_type_unique_chart = new Chart(page_messages_reported_conversations_by_report_type_unique, {
	    ...
	    data: {
	      ...
	      {
	        label: "<?php echo lang('Inappropriate');?>",
	...
	var page_messages_total_messaging_connections_chart = new Chart(page_messages_total_messaging_connections, {
	  ...
	  data: {
	    ...
	    datasets: [{
	      label: '<?php echo lang('Conversations'); ?>',

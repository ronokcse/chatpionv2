...
<section class="section section_custom">
  <div class="section-header">
    <h1><i class="fas fa-edit"></i> <?php echo lang('Edit OTN PostBack Template');?></h1>
    <div class="section-header-breadcrumb">
       <div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot'); ?>"><?php echo lang('Messenger Bot'); ?></a></div>
      <div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot/otn_template_manager'); ?>"><?php echo lang('OTN Post-back Manager'); ?></a></div>
              ...
              <form action="#" method="post" id="messenger_bot_form" style="padding-left: 0;">
                ...
                <div class="row" <?php if($is_default=='default') echo "style='display: none;'"; ?> > 
                  ...
                  <div class="col-12 col-sm-6"> 
                    <div class="form-group">
                      <label>
                        <?php echo lang('Select a reply PostBack'); ?>
                      </label>
                      <div>                              
                ...
                <div class="row"> 
                  ...
                  <div class="col-12 col-sm-6"> 
                    <div class="form-group" id="postback_section">
                      <label><?php echo lang('OTN Postback ID'); ?>
                ...
                <div class="row">
                  ...
                  <?php if($iframe != '1') : ?>
                  <div class="col-6">
                    <a class="btn btn-lg btn-secondary float-right" href="<?php echo base_url("messenger_bot/otn_template_manager"); ?>"><i class="fas fa-step-backward"></i> <?php echo lang('Back'); ?></a>
                  </div>
                  <?php endif; ?>
                </div>
              </form>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(document).on('click','#submit',function(e){   
      ...
      {
        swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please select a reply postback ID')?>", 'warning');
        return;
      }

...
<section class="section section_custom">
  <div class="section-header">
    <h1><i class="fas fa-plus-circle"></i> <?php echo lang('Add an OTN PostBack Template');?></h1>
        ...
        <div class="<?php if($is_iframe=="1") echo 'col-12'; else echo 'col-12 col-lg-12';?>">
          <form action="#" method="post" id="messenger_bot_form" style="padding-left: 0;">
            ...
            <div class="row">
              ...
              <?php if($iframe != '1') : ?>
              <div class="col-6">
                <a class="btn btn-lg btn-secondary float-right" href="<?php echo base_url("messenger_bot/otn_template_manager"); ?>"><i class="fas fa-times"></i> <?php echo lang('Back'); ?></a>
              </div>
              <?php endif; ?>
            </div>

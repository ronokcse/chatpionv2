<script type="text/javascript">
            ...
            $.ajax({
              ...
              success:function(response){
                 ...
                 if(response.status=='1'){                  
                  ...
                  iziToast.error({title: '',message: '<?php echo lang('You do not have access to perform this action.'); ?>',position: 'bottomRight'});
                 }
              }
            });
          }
        ...
        $.ajax({
          ...
          success:function(response){
             ...
             if(response=='1'){
              ...
              iziToast.success({title: '',message: '<?php echo lang('Subscriber information has been saved successfully.'); ?>',position: 'bottomRight'});
             }
             else{
              iziToast.error({title: '',message: '<?php echo lang('You do not have access to perform this action.'); ?>',position: 'bottomRight'});
             }
    ...
    $(document).on('click','.delete_user_details',function(e){
      ...
      swal({
         title: '<?php echo lang('Delete Subscriber'); ?>',
         text: '<?php echo lang('Do you really want to delete this subscriber?'); ?>',
         icon: 'warning',
         buttons: true,
         dangerMode: true,
       })
         ...
         if (willDelete) 
         {
             ...
             $.ajax({
               ...
               success:function(response){
                  ...
                  if(response=='1') iziToast.success({title: '',message: '<?php echo lang('Subscriber has been deleted successfully.'); ?>',position: 'bottomRight'});    
                  else iziToast.error({title: '',message: '<?php echo lang('You do not have access to perform this action.'); ?>',position: 'bottomRight'});    

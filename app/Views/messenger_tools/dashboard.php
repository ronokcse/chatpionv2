...
<div class="well well_border_left">
	...
	<h4 class="text-center"><i class='fa fa-dashboard'></i> <?php echo lang('dashboard'); ?></h4>
		...
		<div id='dashboard-top'>
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				...
				<div class=" cmn bg-a">
					...
					<h5 class='short-info'><?php echo lang('Bot enabled') ?></h5>
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				...
				<div class="cmn bg-b">
					...
					<h5 class='short-info'><?php echo lang('Persistent menu enabled') ?></h5>
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				...
				<div class=" cmn bg-c">
					...
					<h5 class='short-info'><?php echo lang('Total subscribers') ?></h5>
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				...
				<div class="cmn bg-d">
					...
					<h5 class='short-info'><?php echo lang('Total email(QuickReply)') ?></h5>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-12 col-md-6">
			...
			<div class="box box-primary">
				...
				<h3 class="box-title"><i class="fa fa-group"></i> <?php echo lang('Total bot subscribers report for last 30 days'); ?></h3>
		...
		<div class="col-xs-12 col-sm-12 col-md-6">
			...
			<div class="box box-primary">
				...
				<h3 class="box-title"><i class="fa fa-envelope"></i> <?php echo lang('Daywise email gain (QuickReply) for last 30 days'); ?></h3>
...
<?php 
    ...
    $male_subscriber = lang('Male subscriber');

    $female_subscriber = lang('Female subscriber');

    $subscriber = lang('Subscribers');

    $quickreply_email = lang('QuickReply email gain');

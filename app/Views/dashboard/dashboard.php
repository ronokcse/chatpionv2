...
<?php 
// $user_id_url is now passed from controller
$user_id_url = $user_id_url ?? 0;
...
<section class="section">
    ...
    { ?>
      <div class="section-header">
        <h1><i class="fas fa-fire"></i> <?php echo lang('Dashboard for')." ".$user_name." [".$user_email."]"; ?> </h1>
      </div>
    <?php 
    }
   ?>
  ...
  <?php endif; ?>
          ...
          <div class="card-wrap">
            <div class="card-header">
              <h4 class="text-dark dropleft">
                <?php echo lang('Total Subscribers'); ?>
                ...
                <ul class="dropdown-menu dropdown-menu-sm">
                  <!-- <li class="dropdown-title"><?php echo lang('Select Month'); ?></li> -->
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == '01') echo 'active'; ?>" month_no="01"><?php echo lang('January');?></a></li>
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == '02') echo 'active'; ?>" month_no="02"><?php echo lang('February');?></a></li>
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == '03') echo 'active'; ?>" month_no="03"><?php echo lang('March');?></a></li>
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == '04') echo 'active'; ?>" month_no="04"><?php echo lang('April');?></a></li>
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == '05') echo 'active'; ?>" month_no="05"><?php echo lang('May');?></a></li>
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == '06') echo 'active'; ?>" month_no="06"><?php echo lang('June');?></a></li>
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == '07') echo 'active'; ?>" month_no="07"><?php echo lang('July');?></a></li>
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == '08') echo 'active'; ?>" month_no="08"><?php echo lang('August');?></a></li>
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == '09') echo 'active'; ?>" month_no="09"><?php echo lang('September');?></a></li>
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == '10') echo 'active'; ?>" month_no="10"><?php echo lang('October');?></a></li>
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == '11') echo 'active'; ?>" month_no="11"><?php echo lang('November');?></a></li>
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == '12') echo 'active'; ?>" month_no="12"><?php echo lang('December');?></a></li>
                  <li><a href="#" class="dropdown-item month_change <?php if($month_number == 'year') echo 'active'; ?>" month_no="year"><?php echo lang('This Year');?></a></li>
                </ul>
        ...
        <div class="card card-statistic-2 border">
          <div class="card-stats">
            <div class="statistic-details mt-0">
              <div class="statistic-details-item" title="<?php echo lang('Comment Reply Campaign Enabled'); ?>" data-toggle="tooltip">
                <div class="detail-value"><?php echo custom_number_format($number_of_auto_comment_reply_campaign);?></div>
                <div class="detail-name"><?php echo lang('Comment Reply Campaign Enabled'); ?></div>
              </div>
              <div class="statistic-details-item" title="<?php echo lang('FB - Comment Replied (Last 24 Hours)'); ?>" data-toggle="tooltip">
                <div class="detail-value"><?php echo custom_number_format($number_of_auto_comment_report_fb);?></div>
                <div class="detail-name"><?php echo lang('FB - Comment Replied (Last 24 Hours)'); ?></div>
              </div>
              <div class="statistic-details-item" title="<?php echo lang('IG - Comment Replied (Last 24 Hours)'); ?>" data-toggle="tooltip">
                <div class="detail-value"><?php echo custom_number_format($number_of_auto_comment_report_ig);?></div>
                <div class="detail-name"><?php echo lang('IG - Comment Replied (Last 24 Hours)'); ?></div>
              </div>
            </div>
            ...
            <div class="card-stats-items mb-1">
              <div class="card-stats-item">
                ...
                <div class="card-stats-item-label"><?php echo lang('Page'); ?></div>
              </div>
              <div class="card-stats-item">
              ...
              <div class="card-stats-item">
                ...
                <div class="card-stats-item-label"><?php echo lang('Flow'); ?></div>
              </div>
            </div>
          </div>
          ...
          <div class="card-wrap">
            ...
            <div class="card-header">
              <h4 class="text-dark"><?php echo lang('Bot Enabled'); ?></h4>
            </div>
          ...
          <div class="card-stats mb-1">
            ...
            <div class="card-stats-items ecommerce_month_change_middle_content">
              <div class="card-stats-item">
                ...
                <div class="card-stats-item-label"><?php echo lang('Orders'); ?></div>
              </div>
              <div class="card-stats-item">
                ...
                <div class="card-stats-item-label"><?php echo lang('Pending'); ?></div>
              </div>
              <div class="card-stats-item">
                ...
                <div class="card-stats-item-label"><?php echo lang('Checkout'); ?></div>
              </div>
            </div>
          </div>
          ...
          <div class="card-wrap">
            ...
            <div class="card-header">
              <h4 class="text-dark dropleft">
                ...
                <ul class="dropdown-menu dropdown-menu-sm">
                  <!-- <li class="dropdown-title"><?php echo lang('Select Month'); ?></li> -->
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == '01') echo 'active'; ?>" month_no="01"><?php echo lang('January');?></a></li>
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == '02') echo 'active'; ?>" month_no="02"><?php echo lang('February');?></a></li>
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == '03') echo 'active'; ?>" month_no="03"><?php echo lang('March');?></a></li>
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == '04') echo 'active'; ?>" month_no="04"><?php echo lang('April');?></a></li>
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == '05') echo 'active'; ?>" month_no="05"><?php echo lang('May');?></a></li>
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == '06') echo 'active'; ?>" month_no="06"><?php echo lang('June');?></a></li>
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == '07') echo 'active'; ?>" month_no="07"><?php echo lang('July');?></a></li>
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == '08') echo 'active'; ?>" month_no="08"><?php echo lang('August');?></a></li>
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == '09') echo 'active'; ?>" month_no="09"><?php echo lang('September');?></a></li>
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == '10') echo 'active'; ?>" month_no="10"><?php echo lang('October');?></a></li>
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == '11') echo 'active'; ?>" month_no="11"><?php echo lang('November');?></a></li>
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == '12') echo 'active'; ?>" month_no="12"><?php echo lang('December');?></a></li>
                  <li><a href="#" class="dropdown-item ecommerce_month_change <?php if($month_number == 'year') echo 'active'; ?>" month_no="year"><?php echo lang('This Year');?></a></li>
                </ul>

                <div class="dropdown d-inline">
                  <a class="dropdown-toggle text-muted text-small" href="#" data-toggle="dropdown">
                    <?php if(in_array($selected_curr,$currency_lists)) echo '('.$selected_curr.')'; else echo lang('Select'); ?>
                  </a>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card  mb-2">
          <div class="card-header">
            <h4><i class="fas fa-users"></i> <?php echo lang('Messenger Subscriber Gain - 12 Months') ?> </h4>
          </div>
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-12 col-md-2">
                <div class="statistic-details mt-sm-4 d-block">
                  <div class="statistic-details-item">
                    ...
                    <div class="detail-name"><?php echo lang('Subscriber Gain'); ?></div>
                  </div>
                  <div class="statistic-details-item">
                    ...
                    <div class="detail-name"><?php echo lang('Email Gain'); ?></div>
                  </div>
                  <div class="statistic-details-item">
                    ...
                    <div class="detail-name"><?php echo lang('Phone Number Gain'); ?></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-12 col-md-12">
        <div class="card mb-2">
          <div class="card-header border-bottom-0">
            <h4><i class="fas fa-user-circle"></i> <?php echo lang('Subscribers from Different Sources - 12 Months'); ?></h4>
          </div>
          <div class="card-body">
            <div class="row">             
    ...
    <!--<div class="row no-gutters mb-4">     
      <div class="col-12 col-md-4 ltr">
        <div class="card card-large-icons card-condensed gradient">
          ...
          <div class="card-body justify-content-center align-self-center font-weight-bold text-primary gradient"><?php echo lang('Facebook Subscribers'); ?> (<?php echo $fsub_chart_data??0; ?>%)</div>
        </div>  
      </div>
      <div class="col-12 col-md-4 ltr">
        <div class="card card-large-icons card-condensed border-right border-left no_radius">
          ...
          <div class="card-body justify-content-center align-self-center font-weight-bold text-primary gradient"><?php echo lang('Instagram Subscribers'); ?> (<?php echo $igsub_chart_data??0; ?>%)</div>
        </div>
      </div>
      <div class="col-12 col-md-4 ltr">
        <div class="card card-large-icons card-condensed">
          ...
          <div class="card-body justify-content-center align-self-center font-weight-bold text-primary gradient"><?php echo lang('Ecommerce Customers'); ?> (<?php echo $esub_chart_data??0; ?>%)</div>
        </div>
      </div>
    ...
    <div class="row mt-3 <?php if(empty(array_values($fb_earning_chart_values))) echo 'd-none';?>">
      <div class="col-12">
        <div class="card mb-0">
          <div class="card-header border-bottom-0">
            <h4><i class="fas fa-shopping-cart"></i> <?php echo lang('Ecommerce Earnings')." (".$selected_curr.") - ".lang('30 days'); ?></h4>
          </div>
          <div class="card-body">
              ...
              <div class="col-9 col-md-3 col-lg-3">
                <div class="nicescroll" id="cart_activities">
                  <ul class="list-unstyled list-unstyled-border">
                    <?php
                    if(empty($cart_data_graph)) echo '<div class="alert alert-light">'.lang('No activity found').'</div>';                               
                    ...
                    { 
                      ...
                      else 
                      {
                        ...
                        $hook_activity = lang('Checkout').' <span class="">('.$currency_icon.$value['payment_amount'].')</span>';
                      }
                    ...
                    <div>
                      <div class="product-item">
                        ...
                        <div class="product-details mb-2">
                          ...
                          <div class="text-muted text-small"><?php echo $product["sales_count"];?> <?php echo lang('Sales'); ?></div>
                        </div>
                      </div>
                    </div>
                  <?php endforeach; ?>
    ...
    <div class="row dashboard_fullCalendar no-gutters mt-4">
      <div class="col-12">
        <div class="card no_radius">
            <div class="card-header">
              <h4 class="w-100 pr-0">
                <i class="fa fa-calendar"></i> <?php echo lang('Activity Calendar') ?>
                <a href="<?php echo (isset($user_id) ? $user_id : 0)==(isset($user_id_url) ? $user_id_url : 0) || (isset($user_id_url) && $user_id_url==0) ? base_url('calendar') : base_url('calendar/user/'.(isset($user_id_url) ? $user_id_url : 0));?>" class="btn btn-outline-primary float-right" target="_BLANK"><i class="fas fa-calendar-alt"></i> <?php echo lang('Monthly Activity');?></a>
              </h4>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
  ...
  var subscribers_myChart = new Chart(subscribers_chart, {
    ...
    data: {
      ...
      datasets: [{
        label: <?php echo json_encode(lang('Subscribers'));?>,
  ...
  var ecommerce_myChart = new Chart(ecommerce_chart, {
    ...
    data: {
      ...
      datasets: [{
        label: <?php echo json_encode(lang('Earnings'));?>,
...
<script>
  var user_id_url = <?php echo json_encode($user_id_url);?>;
  var ctx = document.getElementById("subscribers_stats").getContext('2d');
  var v1 = <?php echo json_encode(lang('Subscriber Gain')); ?>;
  var v2 = <?php echo json_encode(lang('Email Gain')); ?>;
  var v3 = <?php echo json_encode(lang('Phone Gain')); ?>;
...
<script>
    $(document).ready(function() {   
      ...
      var stepsize = <?php echo json_encode($step_size); ?>; 
      ...
      var myChart1 = new Chart(fb_vs_ig_vs_web_earning_chart, {
        ...
        data: {
          ...
          datasets: [
          {
            label: <?php echo json_encode(lang('Facebook')); ?>,
          ...
          {
            label: <?php echo json_encode(lang('Instagram')); ?>,
          ...
          {
            label: <?php echo json_encode(lang('Web')); ?>,
...
<script>
    ...
    $(document).on('click', '.currency_item', function(event) {
      ...
      $.ajax({
        url: <?php echo json_encode(base_url('dashboard/set_currency'));?>,
        type: 'POST',
      ...
      var url = <?php echo json_encode(base_url('dashboard/get_first_div_content'));?>;
    ...
    $(document).on('click', '.ecommerce_month_change', function(e) {
      ...
      var url = <?php echo json_encode(base_url('dashboard/get_ecommerce_div_content'));?>;

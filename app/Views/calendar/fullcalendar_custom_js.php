...
<script>
   var user_id_url = <?php echo json_encode($user_id_url ?? 0);?>;
    document.addEventListener('DOMContentLoaded', function() {
       $('[data-toggle="popover"]').popover();
       var isDashboard = <?php echo json_encode(isset($uri) && $uri ? $uri->segment(1) : ""); ?>;
       ...
       var calendar = new FullCalendar.Calendar(calendarEl, {
       	   locale: 'all',
           direction : <?php echo json_encode($is_rtl ? "rtl" : "ltr");?>,
           views: {
             dayGridMonth: {
               dayMaxEventRows: 5
             },

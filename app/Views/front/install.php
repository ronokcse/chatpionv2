      ...
      <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-xl-6">
          <div class="card card-primary">
            <div class="card-header"><h4><i class="far fa-check-circle"></i> Install "<?php echo config('MyConfig')->product_short_name;?>" Package </h4></div>
            ...
            <div class="card-body" id="recovery_form">
              <form class="form-horizontal" action="<?php echo site_url().'home/installation_action';?>" method="POST">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="form-group col-12 col-lg-6">
                          <label><?php echo config('MyConfig')->product_short_name ?> Admin Panel Login Email*</label>
                       ...
                       <div class="form-group col-12 col-lg-6">
                          <label><?php echo config('MyConfig')->product_short_name ?> Admin Panel Login Password *</label>
                    ...
                    <div class="form-group text-center">
                      <button type="submit" style="margin-top:20px" class="btn btn-primary btn-lg" <?php if($install_allow == 0) echo "disabled"; ?> ><i class="fa fa-check"></i> Install <?php echo config('MyConfig')->product_short_name;?> Now</button><br/><br/> 
                    </div>  
                  </form>   
            </div>
          </div>

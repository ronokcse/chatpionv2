<section class="section">
	<div class="section-header">
		<h1><i class="fas fa-leaf"></i> <?php echo config('MyConfig')->product_name; ?> : <?php echo lang('Updates'); ?></h1>
	</div>
	...
	<div class="section-body">
		<div class="card">
          <div class="card-header">
          	<h4 style="width: 100%"><i class="fas fa-toolbox"></i>&nbsp;<?php echo config('MyConfig')->product_short_name.' '.lang('Updates');?> <code class="float-right"><?php echo lang('Your Version');?> : <b>v<?php echo $current_version; ?></b></code></h4>
          </div>
          ...
          <div class="card-body">
          	...
          	<?php
        		...
        		{ ?>       
		        	<div class="table-responsive2">
		        		<table class='table table-bordered table-striped table-md'>
			        		<tr class='head'>
			        			<th style='text-align: center;'><?php echo lang('Version');?></th>
			        			<th style='text-align: center;'><?php echo lang('Change Log');?></th>
			        		...
			        		foreach($update_versions as $update_version)
			        		{
			        			...
			        			<tr>
			        				...
			        				<td style='text-align: center;'>
			        					<button class='btn btn-outline-primary' data-toggle="modal" data-target="#<?php echo $modal; ?>"><i class='fa fa-eye'></i> <?php echo lang('See Log');?></button>
			        					<!-- Modal -->
			        					  ...
			        					  <div class="modal-dialog modal-lg" role="document">
			        					    ...
			        					    <div class="modal-content">
			        					      <div class="modal-header">			        					       
			        					        <h5 class="modal-title"><?php echo $update_version->name; ?> <?php echo $update_version->version; ?> ( <?php echo lang('Change Log');?> )</h5>
			        					      ...
			        					      <div class="modal-body">
			        					      	<?php 
			        					      		...
			        					      		{ 	?>
			        					        		<br><br><h6><?php echo lang('Files');?></h6>
			        					        		<?php 
													...
													echo "<br><br><h6>".lang('Change Log')."</h6>";
													if($update_version->change_log!='') echo "<pre>".nl2br($update_version->change_log)."</pre>";
													else echo lang('Not available');
			 										?>
			        					      </div>
			        					      <div class="modal-footer bg-whitesmoke br">
										        <button type="button" class="btn btn-secondary btn-lg" data-dismiss="modal"><i class="fas fa-remove"></i> <?php echo lang('Close'); ?></button>
										      </div>
			        					    </div>
			        					  </div>
			        					</div>
			        				...
			        				<td style='text-align: center;'>
			        					<?php
			        						if($i == 1) 
			        						{ ?>
		        								<button class='btn btn-outline-primary update' updateid="<?php echo $update_version->id; ?>" version="<?php echo $update_version->version; ?>"><i class="fas fa-leaf"></i> <?php echo lang('Update Now');?></button>
			        							<?php
			        						} 
			        						else
			        						{ ?>
			        							<button disabled='disabled' class='btn btn-outline-primary update' updateid="<?php echo $update_version->id; ?>" version="<?php echo $update_version->version; ?>"><i class="fas fa-leaf"></i> <?php echo lang('Update Now');?></button>
			        							<?php
			        						} ?>
			        				</td>
			        			</tr>
	            ...
	            { ?>
	          	 <h6> <?php echo lang('No update available, you are already using latest version.') ?></h6>
	          	 <?php        	
	            } ?>
          </div>          
        </div>
        ...
        <br><br>
        <div class="section-header">
        	<h1><i class="fas fa-plug"></i>   <?php echo config('MyConfig')->product_name; ?> : <?php echo lang('Add-on Updates'); ?></h1>
    	...
    	<?php endif; ?>
 		...
 		foreach($add_ons as $add_on)
 		{
 			...
 			<div class="card">
	          <div class="card-header">
	          	<h4 style="width: 100%"><i class="fas fa-plug"></i>&nbsp;<?php echo $add_on['add_on_name'].' '.lang('Updates');?> <code class="float-right"><?php echo lang('Your Version');?> : <b>v<?php echo $add_on['version']; ?></b></code></h4>
	          </div>
	          <div class="card-body">
        		<?php
				        		...
				        		foreach($this_update_version as $add_on_update_version)
				        		{
				        			...
				        			<tr>
				        				...
				        				<td style='text-align: center;'>
				        					...
				        					<div id="<?php echo $modal; ?>" class="modal fade"  tabindex="-1" role="dialog"  tabindex="-1" role="dialog" >
				        					  <div class="modal-dialog modal-lg">
				        					    ...
				        					    <div class="modal-content">
				        					      <div class="modal-header">				        					        
				        					        <h5 class="modal-title"><?php echo $add_on_update_version->name; ?> <?php echo $add_on_update_version->version; ?> ( <?php echo lang('Change Log');?> )</h5>
				        					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				        					          <span aria-hidden="true">&times;</span>
				        					        </button>
				        					      </div>
				        				...
				        				<td style='text-align: center;'>
				        					...
				        					if($k == 1)
				        					{?>
			        							<button id="<?php echo 'addonupdate' . $add_on['id']; ?>" class='btn btn-outline-primary' folder="<?php echo $add_on['unique_name']; ?>" updateid="<?php echo $add_on_update_version->id; ?>" version="<?php echo $add_on_update_version->version; ?>"><i class="fas fa-leaf"></i> <?php echo lang('Update Now');?></button>
				        						<?php
				        					}
				        					else
				        					{ ?>
				        						<button disabled='disabled' class='btn btn-outline-primary' updateid="<?php echo $add_on_update_version->id; ?>" version="<?php echo $add_on_update_version->version; ?>"><i class="fas fa-leaf"></i> <?php echo lang('Update Now');?></button>
				        						<?php
				        					} ?>
				        				</td>
				        			</tr>
...
<script>
	$(document).ready(function()
	{
		...
		{
			swal({
			      title: '<?php echo lang('Update System');?>',
			      text: '<?php echo lang('You are about to update system files and database.');?>',
			      icon: 'warning',
			      buttons: true,
			      dangerMode: true,
			    })
			    .then((willDelete) => {
			      if (willDelete) {
	      			...
	      			{				
	      				...
	      				var warning_msg="<?php echo lang('do not close this window or refresh page untill update done.');?>";
		...
		{
			swal({
			      title: '<?php echo lang('Update Add-on');?>',
			      text: '<?php echo lang('You are about to update add-on files and database.');?>',
			      icon: 'warning',
			      buttons: true,
			      dangerMode: true,
			    })
...
<div class="modal fade" tabindex="-1" role="dialog" id="update_success" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fas fa-leaf"></i> <?php echo lang('System Update');?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-button">
      <a class="btn btn-primary" href="<?php echo base_url('themes/upload');?>"><i class="fas fa-cloud-upload-alt"></i> <?php echo lang('Install Theme');?></a>
    </div>
  ...
  <?php if(session()->getFlashdata('theme_upload_success')!="") echo "<div class='alert alert-success text-center'><i class='fa fa-check'></i> ".session()->getFlashdata('theme_upload_success')."</div>";?>
   ...
   <div class="section-body">
          ...
          <div class="col-12 col-sm-6 col-md-4">
            ...
            <div class="card">
              <div class="card-header">
                <h4>
                  <?php 
                    if($value['folder_name'] == config('MyConfig')->current_theme) 
                      echo "<i class='fas fa-check-circle blue' title='".lang('active')."'></i> "; 
              ...
              <div class="card-footer text-center">
                <?php if($value['folder_name'] != config('MyConfig')->current_theme): ?>
      ...
      { ?>
        <div class="card">
            <div class="card-header">
              <h4><i class="fas fa-question"></i> <?php echo lang('No Theme uploaded'); ?></h4>
            </div>
            <div class="card-body">
              <div class="empty-state" data-height="400" style="height: 400px;">
                ...
                <h2><?php echo lang('System could not find any Theme.'); ?></h2>
                <p class="lead">
                  <?php echo lang('No Theme found. Your Theme will display here once uploaded.'); ?>
                  
                </p>
                <a class="btn btn-primary" href="<?php echo base_url('themes/upload');?>"><i class="fas fa-cloud-upload-alt"></i> <?php echo lang('Upload Theme');?></a>
              </div>
            </div>
          </div>
...
<script>
  ...
  $("document").ready(function(){
    ...
    $(".activate_action").click(function(e){ 
       ...
       swal({
           title: '<?php echo lang('Theme Activation'); ?>',
           text: '<?php echo lang('Do you really want to activate this Theme?'); ?>',
           icon: 'info',
           buttons: true,
           dangerMode: true,
         })
    ...
    $(".deactivate_action").click(function(e){ 
       ...
       var folder_name = $(this).attr('data-unique-name');
       swal({
           title: '<?php echo lang('Theme Deactivation'); ?>',
           text: '<?php echo lang('Do you really want to deactivate this Theme? Your theme data will still remain'); ?>',
           icon: 'warning',
           buttons: true,
           dangerMode: true,
         })
    ...
    $(".delete_action").click(function(e){ 
       ...
       swal({
           ...
           text: '<?php echo lang('Do you really want to delete this Theme? This process can not be undone.'); ?>',
           icon: 'warning',
           buttons: true,
           dangerMode: true,
         })

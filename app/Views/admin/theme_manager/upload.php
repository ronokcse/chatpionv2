...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active"><a href="<?php echo base_url('themes/lists');?>"><?php echo lang('Theme Manager'); ?></a></div>
        ...
        <div class="col-12 col-md-6">
          <div class="card">
            <div class="card-header">
              <h4><i class="fas fa-cloud-upload-alt"></i> <?php echo lang('Upload New Theme'); ?></h4>
            </div>
            <div class="card-body">
              <div class="form-group">    
                <div id="addon_url_upload"><?php echo lang('Upload');?></div>
              </div>
            </div>
            <div class="card-footer bg-whitesmoke text-justify">
              <h6><?php echo lang('After you upload theme file you will be taken to Theme Manager page, you need to active the theme there.');?> <?php echo lang('If you are having trouble uploading file using our uploader then you can simply upload theme zip file in application/views/site folder, unzip it and then activate it from Theme Manager.');?></h6>
            </div>
          </div>
        </div>
          ...
          <div class="card" id="server-status">
            ...
            <div class="card-body">
              <?php
                ...
                {
                  $make_dir = (!function_exists('mkdir')) ? lang('Not Enabled'):lang('Enabled');
                  $zip_archive = (!class_exists('ZipArchive')) ? lang('Not Enabled'):lang('Enabled');

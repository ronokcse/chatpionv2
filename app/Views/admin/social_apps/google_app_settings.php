<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
        <a class="btn btn-primary" href="<?php echo base_url('social_apps/add_google_settings') ?>"><i class="fas fa-plus-circle"></i> <?php echo lang('Add New APP'); ?></a>
    </div>
              ...
              <table class="table table-bordered" id="mytable">
                <thead>
                  <tr>
                    ...
                    <th><?php echo lang('APP Key'); ?></th>      
                    <th><?php echo lang('Client ID'); ?></th>      
                    <th><?php echo lang('Client Secret'); ?></th>
...
<script>       
  ...
  $(document).ready(function() {
    ...
    $(document).on('click','.delete_app',function(e){
      e.preventDefault();
      var ifyoudeletethisaccount = "<?php echo lang('If you delete this APP then, all the imported Google accounts and Campaigns will be deleted too corresponding to this APP.'); ?>";
      swal({
    ...
    $(document).on('click','.change_state',function(e){
      e.preventDefault();
      var ifyoudeletethisaccount = "<?php echo lang('If you change this APP status to inactive then, all the imported Google accounts and Campaigns will not work corresponding to this APP.'); ?>";
      swal({
        title: '<?php echo lang('Are you sure?'); ?>',
        text: ifyoudeletethisaccount,
        icon: 'warning',

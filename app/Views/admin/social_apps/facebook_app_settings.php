<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
        <a class="btn btn-primary" href="<?php echo base_url('social_apps/add_facebook_settings') ?>"><i class="fas fa-plus-circle"></i> <?php echo lang('Add New APP'); ?></a>
    </div>
    <div class="section-header-breadcrumb">
      <div class="breadcrumb-item"><a href="<?php echo base_url('integration'); ?>"><?php echo lang('Integration'); ?></a></div>
      <div class="breadcrumb-item"><?php echo lang('Facebook'); ?></div>
    </div>
  </div>
              ...
              <table class="table table-bordered" id="mytable">
                <thead>
                  <tr>
                    ...
                    <th><?php echo lang('APP Secret'); ?></th>
                    <th><?php echo lang('Status'); ?></th>
                    <th><?php echo lang('Token Validity'); ?></th>
...
<script>       
  ...
  $(document).ready(function() {
    ...
    $(document).on('click','.delete_app',function(e){
      e.preventDefault();
      var ifyoudeletethisaccount = "<?php echo lang('If you delete this APP then, all the imported Facebook accounts and their Pages and Campaigns will be deleted too corresponding to this APP.'); ?>";
      swal({

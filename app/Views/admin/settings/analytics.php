          ...
          <div class="card">
            <div class="card-body">              
                <div class="form-group">
                     <label class="col-xs-12" for=""><?php echo lang('Paste Facebook Pixel Code');?> (<?php echo lang('Inside Script Tag');?>)
                     </label>
                     <?php
                ...
                <div class="form-group">
                     <label class="col-xs-12" for=""><?php echo lang('Paste Google Analytics Code');?> (<?php echo lang('Inside Script Tag');?>)
                     </label>
                     <?php

			...
			<div class="row">
				...
				<div class="col-md-8">
		    		<?php 
		    			...
		    			{
		    				if(session()->get('license_type') != 'double' && in_array($value['template_type'], $double_email))  continue;
							...
							<div class="card" id="<?php echo $temp_fildset; ?>">
								...
								<div class="card-body">
		       			           	...
		       			           	<div class="form-group">
		       			             	<label for="<?php echo $value['template_type'].'-subject'; ?>" ><i class="fa fa-bars"></i> <?php echo lang('Subject');?> 
		       			             	</label>
		       			            ...
		       			            <div class="form-group">
		       			             	<label for="<?php echo $value['template_type'].'-message' ?>"><i class="fa fa-envelope"></i> <?php echo lang('Message');?> 
		       			             	</label>
		       			            ...
		       			            <a href="<?php echo base_url()."admin/delete_email_template/".$value['template_type']; ?>" class="float-right"><i class="fa fa-refresh"></i>  <?php echo lang('Restore To Default');?></a>

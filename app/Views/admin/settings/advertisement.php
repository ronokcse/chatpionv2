            ...
            <div class="card">
              <div class="card-body">
                  <div class="form-group">
                    <label for="force_https" ><i class="fas fa-eye"></i> <?php echo lang('Display/Hide Advertisement');?>?</label>                   
                      ...
                      <div class="row">   
                        <div class="col-12 col-md-6 col-lg-4">
                          <label class="custom-switch">
                            ...
                            <span class="custom-switch-description"><?php echo lang('I want to display advertisement'); ?></span>
                          </label>
                        </div>
                        <div class="col-12 col-md-6 col-lg-4">
                          <label class="custom-switch">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <span class="custom-switch-description"><?php echo lang('I do not want to display advertisement'); ?></span>
                          </label>
                        </div>
                      </div>                                  
                      </div>
                  ...
                  <div class="row">
                    <div class="col-12 col-md-4">
                      <div class="form-group">
                          <label><?php echo lang('Section - 1 (970x90 px)');?> 
                          </label>
                    ...
                    <div class="col-12 col-md-4">
                      <div class="form-group">
                          <label><?php echo lang('Section - 1 : Mobile  (320x100 px)');?> 
                          </label>
                  ...
                  <div class="row">
                    <div class="col-12 col-md-4">
                      <div class="form-group">
                          <label><?php echo lang('Section: 2 (300x250 px)');?> 
                          </label>
                    ...
                    <div class="col-12 col-md-4">
                      <div class="form-group">
                          <label><?php echo lang('Section: 3 (300x250 px)');?>
                          </label>
                    ...
                    <div class="col-12 col-md-4">
                       <div class="form-group">
                          <label><?php echo lang('Section: 4 (300x600 px)');?> 
                          </label>

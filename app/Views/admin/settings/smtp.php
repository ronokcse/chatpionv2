    ...
    <?php if($test_btn == 1) { ?>
      <div class="section-header-button">
          <a class="btn btn-primary send_test_mail" href="">
              <i class="fas fa-paper-plane"></i> <?php echo lang('Send Test Email'); ?>
          </a> 
      </div>
    <?php } ?>
          ...
          <div class="card">
            <div class="card-body">              
                <div class="form-group">
                    <label for=""><i class="fa fa-at"></i> <?php echo lang('Sender Email Address');?> </label>
                ...
                <div class="row">
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <label for=""><i class="fa fa-server"></i>  <?php echo lang('SMTP Host');?></label>
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <label for=""><i class="fas fa-plug"></i>  <?php echo lang('SMTP Port');?></label>
                ...
                <div class="row">
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <label for=""><i class="fas fa-user-circle"></i>  <?php echo lang('SMTP User');?></label>
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('SMTP Password');?></label>
                ...
                <div class="form-group">
                  <label for="smtp_type" ><i class="fa fa-shield-alt"></i> <?php echo lang('Connection Type');?>?</label>
                    <?php 
                      ...
                      <div class="row">   
                        <div class="col-4 col-md-2">
                          <label class="custom-switch">
                            ...
                            <span class="custom-switch-description"><?php echo lang('Default'); ?></span>
                          </label>
                        </div>
                        <div class="col-4 col-md-2">
                          <label class="custom-switch">
            ...
            <div class="card-footer bg-whitesmoke">
              ...
              <button class="btn btn-secondary btn-lg float-right" onclick='goBack("admin/settings")' type="button"><i class="fa fa-remove"></i>  <?php echo lang('Cancel');?></button>
            </div>
          </div>
        </form>
      </div>
      ...
      $.ajax({
        ...
        success:function(response){
          ...
          if(response == 1) {
            ...
            $("#show_message").html('<?php echo lang('Test email has been sent successfully.');?>');
    ...
    <div class="modal-content">
      ...
      <div id="modalBody" class="modal-body">        
        ...
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="form-group">
              <label for="recipient_email"><i class="fas fa-at"></i> <?php echo lang('Recipient Email'); ?></label>
          ...
          <div class="col-12">
            <div class="form-group">
              <label for="message"><i class="fas fa-envelope"></i> <?php echo lang('Message'); ?></label>
      ...
      <div class="modal-footer bg-whitesmoke">
        ...
        <button type="button" onclick="javascript:window.location.reload()" class="btn-lg btn btn-secondary" data-dismiss="modal"><i class="fas fa-times"></i> <?php echo lang('Close'); ?></button>
      </div>
    </div>
  </div>
</div>
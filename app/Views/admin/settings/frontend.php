				...
				<div class="col-md-8">
					<div class="card" id="general-settings">
						...
						<div class="card-header">
							<h4><i class="fas fa-wrench"></i> <?php echo lang('General Settings'); ?></h4>
						</div>
						<div class="card-body">
							<div class="row">
					            <div class="col-12 col-md-6">
						            <div class="form-group">
					           		  <?php	
				               			$display_landing_page = config('MyConfig')->display_landing_page;
					           		  ...
					           		  <label class="custom-switch mt-2">
					           		    ...
					           		    <span class="custom-switch-description"><?php echo lang('Display Landing Page');?></span>
				           		...
				           		<div class="col-12 col-md-6">
						            <div class="form-group">
						             	<label for=""><i class="fas fa-palette"></i> <?php echo lang('Theme Color');?> ( <?php echo lang('default theme only');?>) </label>            			
				               			<?php 
				               			$select_front_theme="purple";
										if(config('MyConfig')->theme_front!="") $select_front_theme=config('MyConfig')->theme_front;
					...
					<div class="card" id="social-settings">
						...
						<div class="card-header">
							<h4><i class="fas fa-share-square"></i> <?php echo lang('Social Settings'); ?></h4>
						</div>
						<div class="card-body">
       	        			<div class="row">
       	        				<div class="col-12 col-md-6"> 			
       					            <div class="form-group">
       					             	<label for=""><i class="fab fa-facebook"></i> <?php echo lang('Facebook');?></label>
       					             	<input name="facebook_link" value="<?php echo config('MyConfig')->facebook;?>" class="form-control" type="text">		          
       			             			<span class="red"><?php echo form_error('facebook_link'); ?></span>           			
       					            </div>
       					        </div>
       					        <div class="col-12 col-md-6">
       					            <div class="form-group">
       					             	<label for=""><i class="fab fa-twitter"></i> <?php echo lang('Twitter');?></label>
       					             	<input name="twitter_link" value="<?php echo config('MyConfig')->twitter;?>" class="form-control" type="text">		          
       						...
       						<div class="row">
       	        				<div class="col-12 col-md-6">
       					            <div class="form-group">
       					             	<label for=""><i class="fab fa-linkedin"></i> <?php echo lang('Linkedin');?></label>
       					             	<input name="linkedin_link" value="<?php echo config('MyConfig')->linkedin;?>" class="form-control" type="text">		          
       			             			<span class="red"><?php echo form_error('linkedin_link'); ?></span>           			
       					            </div>
       					        </div>
       							<div class="col-12 col-md-6">
       					            <div class="form-group">
       					             	<label for=""><i class="fab fa-youtube"></i> <?php echo lang('Youtube');?></label>
       					             	<input name="youtube_link" value="<?php echo config('MyConfig')->youtube;?>" class="form-control" type="text">		          
					...
					<div class="card" id="review-settings">
						...
						<div class="card-header">
							<h4><i class="fas fa-smile"></i> <?php echo lang('Review Settings'); ?></h4>
						</div>
						<div class="card-body">

							<div class="form-group">
			           		  <?php	
		               			$display_review_block = config('MyConfig')->display_review_block;
			           		  ...
			           		  <label class="custom-switch mt-2">
			           		    ...
			           		    <span class="custom-switch-indicator"></span>
			           		    <span class="custom-switch-description"><?php echo lang('Display Review Block');?></span>
			           		    <span class="red"><?php echo form_error('display_review_block'); ?></span>
			           		  </label>
			           		</div>		

							<!-- review block display section -->
							<?php $customer_review = config('MyConfig')->customer_review; ?>

							<div class="allReview">
								<!-- demo video section started -->
					            <div class="form-group">
					             	<label for=""><i class="fa fa-play-circle"></i> <?php echo lang('Customer Review Video');?></label>
					             	<input name="customer_review_video" value="<?php echo config('MyConfig')->customer_review_video;?>" class="form-control" type="text">
								...
								?>
									  <div class="accordion">
									    <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#panel-body-<?php echo $i; ?>" aria-expanded="false">
									      <h4><i class="fa fa-thumbs-up"></i> <?php echo lang('Review #').' '.$i.' '; ?></h4>
									    </div>
									    <div class="accordion-body collapse" id="panel-body-<?php echo $i; ?>" data-parent="#accordion" style="padding: 25px;">
									      	<div class="row">
												<div class="col-xs-12 col-md-6">
										           	<div class="form-group">
										             	<label ><i class="fa fa-user"></i> <?php echo lang('Name');?></label>
									           	...
									           	<div class="col-xs-12 col-md-6">
										           	<div class="form-group">
										             	<label ><i class="fa fa-briefcase"></i> <?php echo lang('Designation');?></label>
											...
											<div class="row">
									           	<div class="col-xs-12 col-md-12">
										           	<div class="form-group">
										             	<label ><i class="fa fa-picture-o"></i> <?php echo lang('Avatar');?></label>
								          	...
								          	<div class="row">
									           	<div class="col-xs-12 col-md-12">
										           	<div class="form-group">
										             	<label ><i class="fa fa-comment"></i> <?php echo lang('Review');?><small style="font-size: 12px;">&nbsp;</small></label>
					...
					<div class="card" id="video-settings">
						...
						<div class="card-header">
							<h4><i class="fas fa-video"></i> <?php echo lang('Video Settings'); ?></h4>
						</div>
						<div class="card-body">
							<div class="form-group">
			           		  <?php	
		               			$display_video_block = config('MyConfig')->display_video_block;
			           		  ...
			           		  <label class="custom-switch mt-2">
			           		    ...
			           		    <span class="custom-switch-indicator"></span>
			           		    <span class="custom-switch-description"><?php echo lang('Display Tutorial Block');?></span>
		           			...
		           			<div class="extensions">
					            ...
					            <div class="form-group">
					             	<label for=""><i class="fa fa-play-circle"></i> <?php echo lang('Promo Video');?></label>
					             	<input name="promo_video" value="<?php echo config('MyConfig')->promo_video;?>" class="form-control" type="text">
			             			<span class="red"><?php echo form_error('promo_video'); ?></span>           			
					            </div>
				            	<!-- end of the promo video section -->

				            	<?php $custom_video = config('MyConfig')->custom_video; ?>
					            ...
					            ?>
									<div class="accordion">
									  <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#video-settings-body-<?php echo $i; ?>" aria-expanded="false">
									    <h4><i class="fa fa-youtube"></i> <?php echo lang('Tutorial # ').' '.$i.' '; ?></h4>
									  </div>
									  <div class="accordion-body collapse" id="video-settings-body-<?php echo $i; ?>" data-parent="#accordion-1" style="padding: 25px;">
						    			<div class="row">
						    				<div class="col-xs-12 col-md-6">
						    		           	<div class="form-group">
						    		             	<label ><i class="fa fa-image"></i> <?php echo lang('Thumbnail');?></label>
						    	           	...
						    	           	<div class="col-xs-12 col-md-6">
						    		           	<div class="form-group">
						    		             	<label ><i class="fa fa-hashtag"></i> <?php echo lang('Title');?></label>
						    			...
						    			<div class="row">
						    	           	<div class="col-xs-12 col-md-12">
						    		           	<div class="form-group">
						    		             	<label ><i class="fa fa-link"></i> <?php echo lang('URL');?></label>
							...
							<div class="card">
								...
								<div class="card-body">
									<ul class="nav nav-pills flex-column settings_menu">
										<li class="nav-item"><a href="#general-settings" class="nav-link"><i class="fas fa-wrench"></i> <?php echo lang('General Settings'); ?></a></li>
										<li class="nav-item"><a href="#social-settings" class="nav-link"><i class="fas fa-share-square"></i> <?php echo lang('Social Settings'); ?></a></li>
										<li class="nav-item"><a href="#review-settings" class="nav-link"><i class="fas fa-smile"></i> <?php echo lang('Review Settings'); ?></a></li>
										<li class="nav-item"><a href="#video-settings" class="nav-link"><i class="fas fa-video"></i> <?php echo lang('Video Settings'); ?></a></li>								
									</ul>

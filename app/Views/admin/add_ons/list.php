...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-button">
      <a class="btn btn-primary" href="<?php echo base_url('addons/upload');?>"><i class="fas fa-cloud-upload-alt"></i> <?php echo lang('Install Add-on');?></a>
    </div>
  ...
  <?php if(session()->getFlashdata('addon_uplod_success')!="") echo "<div class='alert alert-success text-center'><i class='fa fa-check'></i> ".session()->getFlashdata('addon_uplod_success')."</div>";?>
            ...
            <div class="card profile-widget">
                <div class="profile-widget-header">
                  ...
                  <div class="profile-widget-items">
                    ...
                    <div class="profile-widget-item">
                      <div class="profile-widget-item-value">
                        <?php 
                        if($value['installed']=="0") echo "<span class='badge badge-light'><i class='fas fa-ban'></i> ".lang('Inactive')."</span>";
                        else echo "<span class='badge badge-light'><i class='fas fa-check-circle'></i> ".lang('Active')."</span>"; 
                        ?> 
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-footer text-center" style="padding-top: 10px;">
                  ...
                  <?php if($value['installed'] == '0'): ?>
                    <a title="<?php echo lang('activate'); ?>" class="btn btn-outline-primary activate_action" data-i='<?php echo $i; ?>' href="" data-href="<?php echo $module_controller.'/activate';?>"><i class="fa fa-check"></i> <?php echo lang('activate');?></a>
                  <?php endif; ?>

                  <?php if($value['installed'] == '1'): ?>
                    <a title="<?php echo lang('deactivate'); ?>" class="<?php if($this->is_demo=='1') echo 'disabled'; ?> btn btn-outline-dark deactivate_action" href="" data-i='<?php echo $i; ?>' data-href="<?php echo $module_controller.'/deactivate';?>"><i class="fa fa-ban"></i> <?php echo lang('deactivate');?></a>
                  <?php endif; ?>
                  <a title="<?php echo lang('delete'); ?>" class="<?php if($this->is_demo=='1') echo 'disabled'; ?> btn btn-outline-danger delete_action" href="" data-i='<?php echo $i; ?>' data-href="<?php echo $module_controller.'/delete';?>"><i class="fa fa-trash"></i> <?php echo lang('delete');?></a>
                </div>
              </div>
      ...
      { ?>
        <div class="card">
            <div class="card-header">
              <h4><i class="fas fa-question"></i> <?php echo lang('No add-on uploaded'); ?></h4>
            </div>
            <div class="card-body">
              <div class="empty-state" data-height="400" style="height: 400px;">
                ...
                <h2><?php echo lang('System could not find any add-on.'); ?></h2>
                <p class="lead">
                  <?php echo lang('No add-on found. Your add-on will display here once uploaded.'); ?>
                  
                </p>
                <a class="btn btn-primary" href="<?php echo base_url('addons/upload');?>"><i class="fas fa-cloud-upload-alt"></i> <?php echo lang('Upload Add-on');?></a>
              </div>
            </div>
          </div>
...
<script>
  ...
  $("document").ready(function(){
    ...
    $("#activate_submit").click(function(){    
       if(is_demo=='1') 
       {
         alertify.alert('<?php echo lang('Alert');?>','Permission denied',function(){ });
         return false;
       }        
    ...
    $(".deactivate_action").click(function(e){ 
       ...
       swal({
            title: '<?php echo lang('Deactive Add-on?'); ?>',
            text: '<?php echo lang('Do you really want to deactive this add-on? Your add-on data will still remain.'); ?>',
            icon: 'error',
            buttons: true,
            dangerMode: true,
          })
    ...
    $(".delete_action").click(function(e){ 
       ...
       var action =  base_url+$(this).attr('data-href');
        ...
        swal({
            title: '<?php echo lang('Delete Add-on?'); ?>',
            text: '<?php echo lang('Do you really want to delete this add-on? This process can not be undone.'); ?>',
            icon: 'error',
            buttons: true,
            dangerMode: true,
          })
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-check"></i> <?php echo lang('activate');?>  <span class="put_add_on_title"></span></h5>
            ...
            <div class="modal-body">             
              ...
              <div class="form-group">
                <label>
                  <?php echo lang('add-on purchase code');?>
                </label>
            ...
            <div class="modal-footer bg-whitesmoke">
              <button type="button" id="activate_submit" class="btn btn-primary btn-lg"><i class="fa fa-check-circle"></i> <?php echo lang('Activate'); ?></button>

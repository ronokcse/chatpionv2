...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active"><a href="<?php echo base_url('addons/lists');?>"><?php echo lang('Add-on Manager'); ?></a></div>
        ...
        <div class="col-12 col-md-6">
          <div class="card">
            <div class="card-header">
              <h4><i class="fas fa-cloud-upload-alt"></i> <?php echo lang('Upload New Add-on'); ?></h4>
            </div>
            <div class="card-body">

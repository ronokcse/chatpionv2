  ...
  <div class="section-body">
      ...
      <div class="col-12">			
          ...
          <div class="card-header">
            <h4><i class="fas fa-circle"></i> <?php echo lang('Membership Expiration Alert & Delete Junk Data');?> <code><?php echo lang('Once/Day'); ?></code></h4>
          </div>
          <div class="card-body">
        ...
        <div class="card">
          <div class="card-header">
            <h4><i class="fas fa-circle"></i> 
              <?php echo lang('Sequecne Message Broadcasting');?>
              <code><?php echo lang('Once/5 Minutes'); ?></code>
              <p class="mb-0">
      ...
      <?php endif;?>
        ...
        <div class="card">
          <div class="card-header">
            <h4><i class="fas fa-circle"></i> 
              <?php echo lang('Broadcasting');?>
              <code><?php echo lang('Once/Minute'); ?></code></h4>
          </div>
          <div class="card-body">
        ...
        <div class="card">
          <div class="card-header">
            <h4>
              ...
              <?php endif; ?>
              <code><?php echo lang('Once/5 Minutes'); ?></code></h4>
          </div>
          <div class="card-body">
        ...
        <div class="card">
          <div class="card-header">
            <h4><i class="fas fa-circle"></i> <?php echo lang('Social Posting');?> <code><?php echo lang('Once/5 Minutes'); ?></code></h4>
          </div>
          <div class="card-body">

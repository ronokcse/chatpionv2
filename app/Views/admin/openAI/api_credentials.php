<section class="section section_custom">
  ...
  <?php 
    ...
    if(isset($xvalue['instruction_to_ai']) && !empty($xvalue['instruction_to_ai'])){
      ...
      $xvalue['instruction_to_ai'] = lang('The following is a conversation with an AI assistant. The assistant is helpful, creative, clever, and very friendly.');
    }
    $text_completions =[
        'text-davinci-003',
        'text-davinci-002',
          ...
          <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12 col-md-12">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('Open AI secret key');?></label>
                ...
                <div class="row">
                  <div class="col-12 col-md-12">
                    <div class="form-group">
                      <label for=""><i class="fas fa-quote-right"></i>  <?php echo lang('Instruction To AI ');?></label>
                ...
                <div class="row">
                    <div class="col-12 col-md-12">
                      <div class="form-group">
                        <label for="models"><i class="fas fa-paper-plane"></i>  <?php echo lang('Models');?></label>
                        <select class="select2 w-100" name="models">
                          <option value=""><?php echo lang('Select Models'); ?></option>
               ...
               <div class="row">
                  <div class="col-12 col-md-12">
                    <div class="form-group">
                      <label for=""><i class="fas fa-solid fa-route"></i>  <?php echo lang('Maximum Token');?></label>

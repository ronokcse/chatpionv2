<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active"><a href="<?php echo base_url('payment/package_manager'); ?>"><?php echo lang('Package Manager'); ?></a></div>
      ...
      <form class="form-horizontal" action="<?php echo site_url().'payment/edit_package_action';?>" method="POST">
        ...
        <div class="card">
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  <label for="name"> <?php echo lang('Package Name')?> *</label>
              ...
              <div class="col-6">
                <div class="form-group">
                  <label for="price"><?php echo lang('Price')?> - <?php echo isset($payment_config[0]['currency']) ? $payment_config[0]['currency'] : 'USD'; ?> *</label>              
                    <?php 
                    if($value[0]['is_default']=="1") 
                    { ?>
                      <select name="price" id="price_default" class="form-control select2">
                          <option  value="Trial" <?php if( $value[0]["price"]=="Trial") echo 'selected="yes"'; ?>><?php echo lang('Trial');?></option>
                          <option  value="0" <?php if( $value[0]["price"]=="0") echo 'selected="yes"'; ?>><?php echo lang('Free');?></option>
                       </select>
                     <?php
                    }
                    else
             ...
             <div class="form-group" id="hidden">
               <label for="price"><?php echo lang('Validity');?> *</label>              
                <div class="row">
                  <div class="col-6">
             ...
             <div class="row">
               <div class="col-12 col-md-6">
                 <div class="form-group">
                   <label for="visible" ><i class="fas fa-hand-holding-usd"></i>  <?php echo lang('Available to Purchase');?></label>
               ...
               <div class="col-12 col-md-6">
                 <div class="form-group" id="highlight_container">
                   <label for="highlight" ><i class="far fa-lightbulb"></i> <?php echo lang('Highlighted Package');?></label>
             ...
             <div class="form-group">
               <label for=""><?php echo lang('Modules')?> *</label>   
                   ...
                   <?php                  
                    ...
                    echo "<tr>"; 
                        ...
                        echo "<th class='text-center info' colspan='2'>"; 
                          echo lang('Usage Limit');         
                        echo "</th>";
                        echo "<th class='text-center info' colspan='2'>"; 
                          echo lang('Bulk Limit');         
                        echo "</th>";
                     echo "</tr>"; 
                    ...
                    {  
                     ...
                     echo "<tr>"; 
                        ...
                        if(is_array($current_modules) && in_array($module['id'], $current_modules)) $check_module='checked';  ?>
                          ...
                          if(in_array($module['id'], $mandatory_modules)) $style = "style='border-color:var(--blue);cursor:pointer;' title='".lang('This is a mandatory module and can not be unchecked.')."' data-toggle='tooltip'";
          ...
          <div class="card-footer bg-whitesmoke">
            ...
            <button  type="button" class="btn btn-secondary btn-lg float-right" onclick='goBack("payment/package_manager",0)'><i class="fa fa-remove"></i> <?php echo lang('Cancel');?></button>
          </div>
        </div>
      </form>  
    </div>

            ...
            <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12 col-md-4">
                    <div class="form-group">
                        <label for=""><i class="fas fa-at"></i> <?php echo lang('Paypal Email');?> </label>
                  ...
                  <div class="col-12 col-md-4">
                    <div class="form-group">
                      <label for="paypal_payment_type" ><i class="fas fa-hand-holding-usd"></i>  <?php echo lang('Paypal Recurring Payment');?></label>
                  ...
                  <div class="col-12 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-vial"></i> <?php echo lang('Paypal Sandbox Mode');?></label>
                      <br>
                      <?php 
                ...
                <div class="row">
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('Stripe Secret Key');?></label>
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <label for=""><i class="fab fa-keycdn"></i> <?php echo lang('Stripe Publishable Key');?></label>
                 ...
                 <div class="row">
                  <div class="col-12 col-md-8">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('Mollie API Key');?></label>
                ...
                <div class="row">
                  <div class="col-6 col-md-6">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('Razorpay Key ID');?></label>
                  ...
                  <div class="col-6 col-md-6">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i> <?php echo lang('Razorpay Key Secret');?></label>
                ...
                <div class="row">
                  <div class="col-6 col-md-6">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('Paystack Secret Key');?></label>
                  ...
                  <div class="col-6 col-md-6">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i> <?php echo lang('Paystack Public Key');?></label>
                 ...
                 <div class="row">
                  <div class="col-6 col-md-3">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('Mercadopago Public Key');?></label>
                  ...
                  <div class="col-6 col-md-3">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i> <?php echo lang('Mercadopago Access Token');?></label>
                  ...
                  <div class="col-6 col-md-3">
                    <div class="form-group">
                      <label for=""><i class="fas fa-globe"></i>  <?php echo lang('Mercadopago Country');?></label>                    
                  ...
                  <div class="col-12 col-md-3">
                    <div class="form-group">
                      <label for=""><i class="fas fa-vial"></i> <?php echo lang('Mercadopago Sandbox Mode');?></label>
                      <br>
                      <?php 
                ...
                <!-- SSLCMMERZ -->
                 ...
                 <div class="row">
                  <div class="col-6 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('SSLCommerz Store ID');?></label>
                  ...
                  <div class="col-6 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i> <?php echo lang('SSLCommerz Store Password');?></label>
                  ...
                  <div class="col-12 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-vial"></i> <?php echo lang('SSLCommerz Sandbox Mode');?></label>
                      <br>
                      <?php 
                ...
                <div class="row">
                  <div class="col-6 col-md-4">
                    <div class="form-group mb-0">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('SenangPay Merchant Id');?></label>
                  ...
                  <div class="col-6 col-md-4">
                    <div class="form-group mb-0">
                      <label for=""><i class="fas fa-key"></i> <?php echo lang('SenangPay Secret Key');?></label>
                  ...
                  <div class="col-12 col-md-4">
                    <div class="form-group mb-0">
                      <label for=""><i class="fas fa-vial"></i> <?php echo lang('SenangPay Sandbox Mode');?></label>
                      <br>
                      <?php 
                ...
                <div class="row">
                  <div class="col-6 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('Instamojo Private Api Key');?></label>
                  ...
                  <div class="col-6 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i> <?php echo lang('Instamojo Private Auth Token');?></label>
                  ...
                  <div class="col-12 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-vial"></i> <?php echo lang('Instamojo Sandbox Mode');?></label>
                      <br>
                      <?php 
                ...
                <div class="row">
                  <div class="col-6 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('Toyyibpay Secret Key');?></label>
                  ...
                  <div class="col-6 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i> <?php echo lang('Toyyibpay Category code');?></label>
                  ...
                  <div class="col-12 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-vial"></i> <?php echo lang('Toyyibpay Sandbox Mode');?></label>
                      <br>
                      <?php 
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('Xendit Secret Api Key');?></label>
                ...
                <div class="row">
                  ...
                  <div class="col-6 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-vial"></i> <?php echo lang('Myfatoorah Sandbox Mode');?></label>
                      <br>
                      <?php 
                 ...
                 <div class="row">
                  <div class="col-6 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i>  <?php echo lang('Paymaya Public Key');?></label>
                  ...
                  <div class="col-6 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-key"></i> <?php echo lang('Paymaya Secret Key');?></label>
                  ...
                  <div class="col-12 col-md-4">
                    <div class="form-group">
                      <label for=""><i class="fas fa-vial"></i> <?php echo lang('Paymaya Sandbox Mode');?></label>
                      <br>
                      <?php 
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <label for=""><i class="fas fa-file-invoice-dollar"></i> <?php echo lang('Enable manual payment');?></label>
                      <br>
                      <?php 
                ...
                <div class="row">
                  <div id="manual-payins" class="col-12">
                    <div class="form-group">
                      <label><i class="fa fa-info"></i> <?php echo lang('Manual payment instructions'); ?></label>

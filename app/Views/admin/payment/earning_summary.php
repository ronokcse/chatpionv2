  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-12">
      <div class="card card-statistic-2">
        <div class="card-stats">
          <div class="card-stats-title"><i class="fas fa-eye"></i> <?php echo lang('Summary'); ?>
          </div>
          <div class="card-stats-items">
            <div class="card-stats-item">
              <div class="card-stats-item-count"><?php echo $curency_icon.$payment_today; ?></div>
              <div class="card-stats-item-label"><?php echo lang('Today'); ?></div>
            </div>
            <div class="card-stats-item">
            ...
            <div class="card-stats-item">
              ...
              <div class="card-stats-item-label"><?php echo lang('Year'); ?></div>
            </div>
          </div>
        </div>
        ...
        <div class="card-wrap">
          <div class="card-header">
            <h4><?php echo lang('Life Time')." ".lang('Earning'); ?></h4>
          </div>
          <div class="card-body">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
      <div class="card card-statistic-2">
        ...
        <div class="card-wrap">
          <div class="card-header">
            <h4><?php echo date("M - Y")." ".lang('Earning'); ?></h4>
          </div>
          <div class="card-body">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
      <div class="card card-statistic-2">
        ...
        <div class="card-wrap">
          <div class="card-header">
            <h4><?php echo date("Y")." ".lang('Earning'); ?></h4>
          </div>
          <div class="card-body">
  ...
  <div class="row">
    <div class="col-lg-6">
      <div class="card" style="min-height: 420px">
        <div class="card-header">
          <h4><i class="fas fa-balance-scale"></i> <?php echo lang('Earning Comparison')." : ".$year." ".lang('Vs')." ".$lastyear; ?></h4>
        </div>
        <div class="card-body">
    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">
          <h4><i class="fas fa-flag-checkered"></i> <?php echo lang('Top Countries')." : ".$year." ".lang('Vs')." ".$lastyear; ?></h4>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-sm-6">

<section class="section">
  ...
  <div class="row">
      ...
      <div class="card card-statistic-1">
        ...
        <div class="card-wrap">
          <div class="card-header">
            <h4><?php echo lang('Package Name')?></h4>
          </div>
          <div class="card-body">
    ...
    <div class="col-md-4 col-sm-4 col-12">
      <div class="card card-statistic-1">
        ...
        <div class="card-wrap">
          <div class="card-header">
            <h4><?php echo lang('Price')?> - <?php echo isset($payment_config[0]['currency']) ? $payment_config[0]['currency'] : 'USD'; ?></h4>
          </div>
          <div class="card-body">
            <?php 
            if($value[0]['is_default']=="1") 
            { 
               if( $value[0]["price"]=="Trial") echo lang('Trial');
               if( $value[0]["price"]=="0") echo lang('Free');            
            }
  ...
  <div class="row">
    <div class="col-12">      
      <div class="card">
        <div class="card-header"><h4 class="card-title"><i class="fas fa-info-circle"></i> <?php echo lang('Module Access'); ?></h4></div>
        <div class="card-body">         
        ...
        <div class="card-footer bg-whitesmoke">
          <button  type="button" class="btn btn-secondary btn-lg" onclick='goBack("payment/package_manager",0)'><i class="far fa-arrow-alt-circle-left"></i> <?php echo lang('Go back');?></button>
        </div>
      </div> 
    </div>
  </div>

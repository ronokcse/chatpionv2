<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
      <a href="<?php echo base_url('payment/transaction_log_manual'); ?>" class="btn btn-primary"><i class="fas fa-hand-holding-usd"></i> <?php echo lang('Manual Transaction Log'); ?></a> 
    </div>
  ...
  <?php 
    view('admin/theme/message'); 
    if(session()->getFlashdata('xendit_currency_error') != '')
    echo "<div class='alert alert-danger text-center'><i class='fas fa-check-circle'></i> ".session()->getFlashdata('xendit_currency_error')."</div>";
  ?>
              ...
              <table class="table table-bordered" id="mytable">
                <thead>
                  <tr>
                    ...
                    <th><?php echo lang('Cycle Start'); ?></th>
                    <th><?php echo lang('cycle End'); ?></th>
                    <th><?php echo lang('Paid at'); ?></th>
                    <th><?php echo lang('Amount')." ".$curency_icon; ?></th>
                  </tr>
                </thead>
                <tbody>
                </tbody>
                <tfoot>
                  <tr>
                    <th><?php echo lang('Total'); ?></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th>
                  </tr>
                </tfoot>
              </table>
            </div>             

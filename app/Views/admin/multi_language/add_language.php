<section class="section">
	<div class="section-header">
		...
		<div class="section-header-breadcrumb">
			...
			<div class="breadcrumb-item active"><a href="<?php echo base_url('multi_language/index'); ?>"><?php echo lang('Language Editor'); ?></a></div>
		...
		<div class="card">
          <div class="card-footer bg-whitesmoke language_name_field">
              ...
              <div class="form-group">
	              <div class="input-group mb-3">
	                <input type="text" class="form-control" id="language_name" name="language_name" placeholder="<?php echo lang('language name'); ?>" aria-label="">
	                <div class="input-group-append">
	                  <button class="btn btn-primary" type="submit" id="save_language_name"><i class="fas fa-plus-circle"></i> <?php echo lang('Add Language'); ?></button>
	                </div>
	              </div>
            </div>
          </div>
          <div class="card-body">
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                <a id="main_tab" class="nav-link active" data-toggle="tab" href="#fbinboxer_languages_tab" role="tab" aria-selected="false"><?php echo lang('System Languages'); ?></a>
              </li>              
              <li class="nav-item hidden">
                <a id="addon_tab" class="nav-link" data-toggle="tab" href="#addons_languages_tab" role="tab" aria-selected="true"> <?php echo lang('Add-ons Languages'); ?></a>
              </li>
              <li class="nav-item">
                <a id="plugin_tab" class="nav-link" data-toggle="tab" href="#plugins_languages_tab" role="tab" aria-selected="false"><?php echo lang('3rd Party Languages'); ?></a>
              </li>
            </ul>
                ...
                <section id="plugin_section">
		      		<div class="row">
		      			<div class="language_file" file_type ="plugin_0" id="plugins">
		      				<div class="card">
		      					<div class="card-header langFile">
				                    <i class="fa fa-plug"></i> &nbsp;<?php echo lang('Plugin Languages');?>
...
<?php $giveAname = lang('Please put a language name & then save.'); ?>
	...
	$(document).ready(function(){
		...
		$(document).on('click', '#save_language_name', function(event) {
			...
			if(languageName == '') {
				...
				swal('<?php echo lang('Warning')?>', giveAname, 'warning');
				return false;
			}
			...
			$.ajax({
				...
				success:function(response)
				{
					if(response == "1") 
					{
						swal('<?php echo lang('Success')?>', '<?php echo lang('Your data has been successfully saved.') ?>', 'success');

					} else if(response == '3') 
					{
						swal('<?php echo lang('Error') ?>', '<?php echo lang('Only characters and underscores are allowed.') ?>', 'error');
					}
					else 
					{
						swal('<?php echo lang('Error') ?>', '<?php echo lang('Sorry, this language already exists, you can not add this again.') ?>', 'error');
					}
	...
	<div class="modal-dialog modal-lg" role="document" style="min-width: 90%">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title"><i class="fa fa-plus-circle"></i> <?php echo lang('Add Language Translation');?></h5>
			...
			<div class="modal-footer bg-whitesmoke br">
				<button type="button" form_id="language_creating_form" class="btn btn-primary btn-lg save_language_button"><i class="fas fa-save"></i> <?php echo lang('Save'); ?></button>

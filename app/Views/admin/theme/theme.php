...
<html lang="en">
    ...
    $function_name = isset($uri) && $uri ? $uri->segment(2) : '';
    ...
    if(
    	...
    	// $main_content_class = (isset($uri) && $uri && $uri->segment(1)=='dashboard') ? 'bg-white' : '';
    	$main_content_class = '';
    ?>
	...
	<audio id="agentAssignNotificationAudio" class="d-none"><source src="<?php echo base_url('assets/images/media/agentAssigned-notification.mp3');?>" type="audio/mp3"></audio>
	  <div id="app">
	    <div class="main-wrapper">
			...
			include(APPPATH.'Views/admin/theme/header.php');

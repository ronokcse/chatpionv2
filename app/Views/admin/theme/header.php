...
foreach ($account_switch as $key => $value) {
  if(stripos($current_url, '/'.$value) !==false || (isset($uri) && $uri && $uri->segment(1)=='ultrapost' && $uri->segment(2)=='' )) {
    $found_in_account_switch = true;
    break;
  }
}
$no_account_switch_classs = $found_in_account_switch ? 'd-none' : 'd-none d-lg-block ml-2';
$selected_global_media_type = isset($using_media_type) ? $using_media_type : 'fb';
?>
...
<nav class="navbar navbar-expand-lg main-navbar">
  <form class="form-inline mr-auto">
     ...
     <?php 
        ...
        $fb_img = 'https://graph.facebook.com/me/picture?access_token='.$fb_rx_account_switching_info[session()->get('facebook_rx_fb_user_info')]['access_token'].'&width=150&height=150';
     ?>
  ...
  <ul class="navbar-nav navbar-right">    
    <?php include(APPPATH.'Views/admin/theme/notification.php'); ?>
    <?php include(APPPATH.'Views/admin/theme/usermenu.php'); ?>      
  </ul>

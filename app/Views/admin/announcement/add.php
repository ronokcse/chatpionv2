<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active"><a href="<?php echo base_url('announcement/full_list'); ?>"><?php echo lang('Announcement'); ?></a></div>
        ...
        <form class="form-horizontal" action="<?php echo site_url().'announcement/add_action';?>" method="POST">
          ...
          <div class="card">
              ...
              <div class="form-group">
                <div class="form-group">
                  ...
                  <label class="custom-switch mt-2">
                    ...
                    <span class="custom-switch-description"><?php echo lang('Publish');?></span>
            ...
            <div class="card-footer bg-whitesmoke">
              <button name="submit" type="submit" id="save_announcement" class="btn btn-primary btn-lg"><i class="fas fa-save"></i> <?php echo lang('Save');?></button>
              <button  type="button" class="btn btn-secondary btn-lg float-right" onclick='goBack("announcement/full_list",0)'><i class="fa fa-remove"></i> <?php echo lang('Cancel');?></button>
            </div>
          </div>
        </form>
      </div>

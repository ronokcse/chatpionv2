<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active"><a href="<?php echo base_url('payment/package_settings'); ?>"><?php echo lang('Package Manager'); ?></a></div>
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-sm-4 col-12">
      <div class="card card-statistic-1">
        ...
        <div class="card-wrap">
          <div class="card-header">
            <h4><?php echo lang('Price')?> - <?php echo $payment_config[0]['currency']; ?></h4>
          </div>
          <div class="card-body">
            <?php 
    ...
    <div class="col-12">      
      <div class="card">
        ...
        <div class="card-footer bg-whitesmoke">
          <button  type="button" class="btn btn-secondary btn-lg" onclick='goBack("payment/package_settings",0)'><i class="far fa-arrow-alt-circle-left"></i> <?php echo lang('Go back');?></button>
        </div>
      </div> 
    </div>
  </div>

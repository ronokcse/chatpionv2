      ...
      <form class="form-horizontal" action="<?php echo site_url().'admin/add_user_action';?>" method="POST">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label for="user_type" > <?php echo lang('User Type');?></label>
                      ...
                      <div class="row">   
                        <div class="col-6 col-md-4">
                          <label class="custom-switch">
                            ...
                            <span class="custom-switch-description"><?php echo lang('Member'); ?></span>
                          </label>
                        </div>                        
                        <div class="col-6 col-md-4">
                          <label class="custom-switch">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <span class="custom-switch-description"><?php echo lang('Admin'); ?></span>
                          </label>
                        </div>
                      </div>                                  
                    </div>
            ...
            <div class="row" id="hidden">
              <div class="col-6">
                <div class="form-group">
                  <label for="package_id"> <?php echo lang('Package')?> *</label>
              ...
              <div class="col-6">
                ...
                ?>
                <div class="form-group">
                  <label for="expired_date"> <?php echo lang('Expiry Date')?> *</label>
          ...
          <div class="card-footer bg-whitesmoke">
            ...
            <button  type="button" class="btn btn-secondary btn-lg float-right" onclick='goBack("admin/user_manager",0)'><i class="fa fa-remove"></i> <?php echo lang('Cancel');?></button>
          </div>
        </div>
      </form>  
    </div>

<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active"><a href="<?php echo base_url('admin/user_manager'); ?>"><?php echo lang('User Manager'); ?></a></div>
...
<?php
$drop_menu = '<div class="btn-group dropleft float-right"><button type="button" class="btn btn-primary btn-lg dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">  '.lang('Options').'  </button>  <div class="dropdown-menu dropleft"> <a class="dropdown-item are_you_sure_datatable" data-refresh="0" href="'.base_url('admin/delete_user_log').'"><i class="fas fa-trash"></i> '.lang('Delete old data').'</a></div> </div>';
?> 
...
<div class="modal fade" tabindex="-1" role="dialog" id="modal_send_sms_email" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer bg-whitesmoke br">
           <button id="send_sms_email" class="btn btn-primary btn-lg" > <i class="fas fa-paper-plane"></i>  <?php echo lang('Send'); ?></button>
            <button type="button" class="btn btn-secondary btn-lg" data-dismiss="modal"><i class="fas fa-remove"></i> <?php echo lang('Close'); ?></button>
      </div>
    </div>
  </div>

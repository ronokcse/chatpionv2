	      ...
	      <div class="breadcrumb-item">
	      	<form method="POST" action="<?php echo base_url('page_analytics/analytics/'.$page_auto_id); ?>">					
		      	<div class="input-group">
		      	  ...
		      	  <button class="btn btn-outline-primary" style="margin-left:1px" type="submit"><i class="fa fa-search"></i> <?php echo lang('Search');?></button>
		      	</div>
		    </form>
	      </div>
	    </div>
  	...
  	<div class="section-body">	
		...
		{ ?>	
			  ...
			  <div class="col-12 col-lg-6">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Page and Post Stories (People talking about this)');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Page and Post Stories') ?>" data-content="<?php echo lang('The summary of Page and Post Stories that people talking about this.') ?>"><i class='fas fa-info-circle'></i> </a>
			        </h4>
			      </div>
			      <div class="card-body">
			   ...
			   <div class="col-12 col-lg-6">
			     <div class="card">
			       <div class="card-header">
			         <h4>
			         	<?php echo lang('Page Impressions: Latest Top 10 Countries Unique');?>
			         	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Page Impressions') ?>" data-content="<?php echo lang('The number of people who have seen any content associated with your Page by country.') ?>"><i class='fas fa-info-circle'></i> </a>
			         </h4>
			       </div>
			       <div class="card-body">
			...
			<div class="row">
			  ...
			  <div class="col-12 col-lg-6">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Page CTA Clicks: Device Statistics');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Page CTA Clicks Device Statistics') ?>" data-content="<?php echo lang('Number of people who logged in to Facebook and clicked the Page CTA button, broken down by www, mobile, api and other.') ?>"><i class='fas fa-info-circle'></i> </a>
			        </h4>
			      </div>
			      <div class="card-body">
			...
			<div class="row">
			  <div class="col-12 col-lg-6">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Page Fans');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Page User Demographics') ?>" data-content="<?php echo lang('The total number of people who have liked your Page, And Daily fan adds in your page and fan Removes in your page.') ?>"><i class='fas fa-info-circle'></i> </a>
			        </h4>
			      </div>
			      <div class="card-body">
			  ...
			  <div class="col-12 col-lg-6">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Daily Fan Adds and removes in your page');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Page User Demographics') ?>" data-content="<?php echo lang('The total number of people who have liked your Page, fan Removes from your page.') ?>"><i class='fas fa-info-circle'></i> </a>
			        </h4>
			      </div>
			      <div class="card-body">
			...
			<div class="row">
				<div class="col-12 col-lg-6">
				  <div class="card">
				    <div class="card-header">
				      <h4>
				      	<?php echo lang('Page Fans: Top 10 Countries');?>
				      	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Page User Demographics') ?>" data-content="<?php echo lang('Top 10 Countries Like Your page') ?>"><i class='fas fa-info-circle'></i> </a>
				      </h4>
				    </div>
				    <div class="card-body">
			  ...
			  <div class="col-12 col-lg-6">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Page Views: Latest Viewed Each Page Profile Tab');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Page View') ?>" data-content="<?php echo lang('The number of people who have viewed each Page profile tab.') ?>"><i class='fas fa-info-circle'></i> </a>
			        </h4>
			      </div>
			      <div class="card-body">
			...
			<div class="row">
			  <div class="col-12 col-lg-6">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Page Views: Latest Device Statistics');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Page Views:Latest Device Statistics') ?>" data-content="<?php echo lang('The number of people logged in to Facebook who have viewed your Page profile, broken down by the type of device.') ?>"><i class='fas fa-info-circle'></i> </a>
			        </h4>
			      </div>
			      <div class="card-body">
			  ...
			  <div class="col-12 col-lg-6">
			    <div class="card">
			      <div class="card-header">
			        <h4>
			        	<?php echo lang('Page Views: Latest Page Views By Referers Domains');?>
			        	<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo lang('Page Views By Referers') ?>" data-content="<?php echo lang('Logged-in page visit counts (unique users) by referral source.') ?>"><i class='fas fa-info-circle'></i> </a>
			        </h4>
			      </div>
			      <div class="card-body">
  		...
  		{ 
  			...
  			<div class="card">
                <div class="card-header">
                  <h4>'.lang('Something Went Wrong').'</h4>
                </div>
                <div class="card-body">
                  <div class="empty-state" data-height="400" style="height: 400px;">
                    ...
                    <h2>'.lang('Something Went Wrong').'</h2>
                    <p class="lead">
                     '.$error_message.'
                    </p>
                  </div>
...
<script>
	...
	var page_messages_new_conversations_unique_chart = new Chart(page_content_activity_unique_data, {
	  ...
	  data: {
	    ...
	    datasets: [{
	      label: '<?php echo lang('Page Content Activity'); ?>',
	    ...
	    {
	      label: '<?php echo lang('Page Content Activity Type Unique Fan'); ?>',
	      ...
	      label: '<?php echo lang('Page Content Activity Type Unique Other'); ?>',
	      ...
	      label: '<?php echo lang('Page Content Activity Type Unique Page Post'); ?>',
    ...
    var page_impressions_chart_data = new Chart(page_impressions, {
      ...
      data: {
        ...
        datasets: [{
          label: '<?php echo lang('Page Impressions'); ?>',
        ...
        {
          label: '<?php echo lang('Page Impressions Unique'); ?>',
          ...
          label: '<?php echo lang('Page Impressions Viral'); ?>',
        ...
        {
          label: '<?php echo lang('Page Impressions Viral Unique'); ?>',
        ...
        {
          label: '<?php echo lang('Page Impressions Non Viral'); ?>',
        ...
        {
          label: '<?php echo lang('Page Impressions Non Viral Unique'); ?>',
	...
	var page_ImpressionPaid_vs_unpaidChart = new Chart(ctx_impressesion_p_un, {
	  ...
	  data: {
	    ...
	    datasets: [{
	      label: '<?php echo lang('Page Impressions Unpaid'); ?>',
	    ...
	    {
	      label: '<?php echo lang('Page Impressions Unpaid Unique') ?>',
	    ...
	    {
	      label: '<?php echo lang('Page Impressions Paid') ?>',
	     ...
	     {
	       label: '<?php echo lang('Page Impressions Paid Unique') ?>',
	...
	var page_enagagement_data = {
				...
				datasets: [{
					...
					hidden: false,
					label: '<?php echo lang('Page Engaged Users'); ?>'
				}, 
				{
					backgroundColor: '#4bc0c0',
					borderColor: 'transparent',
					data: <?php echo json_encode($page_post_engagements_data_values); ?>,
					label: '<?php echo lang('Page Post Engagement'); ?>',
					fill: '-1'
				},
				{
					...
					label: '<?php echo lang('Page Consumptions') ?>',
					fill: 1
				},
				{
					...
					label: '<?php echo lang('Page Consumptions Unique'); ?>',
					fill: '-1'
				},
				{
					...
					label: '<?php echo lang('Page Places Checkin Total'); ?>',
					fill: '-1'
				},
 				{
					...
					label: '<?php echo lang('Page Negative Feedback'); ?>',
					fill: '+2'
				},
				{
					...
					label: '<?php echo lang('Page Positive Feedback'); ?>',
					fill: 1
				},
				{
					...
					label: '<?php echo lang('Page Fans Online Per Day'); ?>',
					fill: 1
				}
    ...
    var page_reactions_config = {
			   	...
			   	data: {
			   		...
			   		datasets: [{
			   			label: '<?php echo lang('Daily Page Post Total Like'); ?>',
 					...
 					{
			   			label: '<?php echo lang('Daily Page Post Total Love Reaction'); ?>',
	   				...
	   				{
	   		   			label: '<?php echo lang('Daily Page Post Total Wow Reaction'); ?>',
	   				...
	   				{
	   		   			label: '<?php echo lang('Daily Page Post Total Haha Reaction'); ?>',
	   		   		...
	   		   		{
			   			label: '<?php echo lang('Daily Page Post Total Sad Reaction'); ?>',
	   				...
	   				{
	   		   			label: '<?php echo lang('Daily Page Post Total Angry Reaction'); ?>',
	...
	var myChart = new Chart(page_cta_clicks_ctx1, {
	  	  ...
	  	  data: {
	  	    ...
	  	    datasets: [{
	  	      label: '<?php echo lang('Page CTA Total'); ?>',
	  	    ...
	  	    {
	  	      label: '<?php echo lang('Page CTA Click User Logged-in'); ?>',
	  	    ...
	  	    {
	  	      label: '<?php echo lang('Clicked Page Call Now Button Unique'); ?>',
	  	    ...
	  	    {
	  	      label: '<?php echo lang('Clicked Page Get Direection Button Unique'); ?>',
    ...
    // Page Fans
 	...
 	var page_user_demographics_add_remove_chart = new Chart(page_user_demographics_add_remove_ctx, {
 	  ...
 	  data: {
 	    ...
 	    datasets: [
 	    {
 	      label: '<?php echo lang('Daily Page Fan Adds'); ?>',
 	      ...
 	      label: '<?php echo lang('Daily Page Fan Removes'); ?>',
	...
	var page_video_views_paid_vs_un_chart = new Chart(page_video_views_paid_vs_un_ctx, {
	  ...
	  data: {
	    ...
	    datasets: [
	    {
	      label: '<?php echo lang('Page Video Views Unpaid') ?>',
	    ...
	    {
	      label: '<?php echo lang('Page Video Views Paid'); ?>',
	...
	var page_video_views_mychart = new Chart(page_video_views_ctx, {
	  ...
	  data: {
	    ...
	    datasets: [{
	      label: '<?php echo lang('Page Videos View '); ?>',
	    ...
	    {
	      label: '<?php echo lang('Page Videos View By Auto Played'); ?>',
	      ...
	      label: '<?php echo lang('Page Videos View By Click'); ?>',
	      ...
	      label: '<?php echo lang('Page Videos View Unique'); ?>',
	    ...
	    {
	      label: '<?php echo lang('Total Vidoes View Time in milliseconds'); ?>',
   ...
   var page_post_impression_viral_non_my_chart = new Chart(page_post_impression_viral_non_ctx, {
     ...
     data: {
       ...
       datasets: [{
         label: '<?php echo lang('Page Post Impressions Nonviral '); ?>',
       ...
       {
         label: '<?php echo lang('Page Post Impressions Viral'); ?>',
   ...
   var page_post_impression_paid_unpaid_my_chart = new Chart(page_post_impression_paid_unpaid_ctx, {
     ...
     data: {
       ...
       datasets: [{
         label: '<?php echo lang('Page Post Impressions Paid '); ?>',
       ...
       {
         label: '<?php echo lang('Page Post Impressions Unpaid'); ?>',

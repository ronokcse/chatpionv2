  ...
  <div class="row">
    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3">
      ...
      <div class="card card-primary" >
        <div class="card-header"><h4><i class="fas fa-key"></i> <?php echo lang('Reset Password'); ?></h4></div>

        <div class="card-body" id="recovery_form">
          <p class="text-muted"<?php echo lang('You are one step away to get back access to your account') ?></p>
          <form method="POST">
            <div class="form-group">
              <label for="email"><?php echo lang('Password Reset Code'); ?></label>
              <input id="code" type="text" class="form-control" name="code" tabindex="1" required autofocus>
              <div class="invalid-feedback"><?php echo lang('Please enter your email'); ?></div>
            </div>

            <div class="row">
              <div class="form-group col-6">
                <label for="password" class="d-block"><?php echo lang('New Password'); ?> *</label>
              ...
              <div class="form-group col-6">
                <label for="password2" class="d-block"><?php echo lang('Confirm New Password');?> *</label>
            ...
            <div class="form-group">
              <button type="submit" id="submit" class="btn btn-primary btn-lg btn-block" tabindex="4">
                <i class="fas fa-key"></i> <?php echo lang('Reset Password'); ?>
              </button>
            </div>
          </form>
        </div>

  ...
  <div class="row">
    <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3">
      ...
      <div class="card card-primary">
        <div class="card-header"><h4><i class="far fa-user-circle"></i> <?php echo lang('Sign Up'); ?></h4></div>

        <div class="card-body">
          <?php 
            if(session()->get('reg_success') == 1) {
              echo "<div class='alert alert-success text-center'>".lang('An activation code has been sent to your email. please check your inbox to activate your account.')."</div>";
              session()->remove('reg_success');
            }                  
            if(session()->get('reg_success') == 'limit_exceed') {
              echo "<div class='alert alert-danger text-center'>".lang('Signup has been disabled. Please contact system admin.')."</div>";
              session()->remove('reg_success');
            }
            ...
            else if(session()->get('sign_up_captcha_error')!='')  
            { 
              echo "<div class='alert alert-danger text-center'>".session()->get('sign_up_captcha_error')."</div>"; 
              session()->remove('sign_up_captcha_error'); 
            } 
          ?>
          ...
          <form method="POST" action="<?php echo site_url('home/sign_up_action');?>">
            ...
            <div class="row">
              <div class="form-group col-6">
                <label for="frist_name"><?php echo lang('Name'); ?> *</label>
            ...
            <div class="row">
              <div class="form-group col-6">
                <label for="password" class="d-block"><?php echo lang('Password'); ?> *</label>
                <input id="password" type="password" class="form-control" required name="password" value="<?php echo set_value('password');?>">
              </div>
              <div class="form-group col-6">
                <label for="password2" class="d-block"><?php echo lang('Confirm Password');?> *</label>
            ...
            <div class="input-group mb-3">
              ...
              <input type="number" class="form-control" required name="captcha" placeholder="<?php echo lang('Put your answer here'); ?>" >
            </div>      

            <div class="form-group">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" name="agree" required class="custom-control-input" id="agree">
                <label class="custom-control-label" for="agree"><a target="_BLANK" href="<?php echo site_url();?>home/terms_use"><?php echo lang('I agree with the terms and conditions');?></a></label>
              </div>
            </div>

            <div class="form-group">
              <button type="submit" class="btn btn-primary btn-lg btn-block">
                <i class="fa fa-user-circle"></i> <?php echo lang('sign up'); ?>
              </button>
            </div>
          </form>
        </div>

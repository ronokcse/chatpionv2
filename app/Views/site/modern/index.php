...
<head>
	...
	<!--====== Title ======-->
	<title><?php echo config('MyConfig')->product_name; if(config('MyConfig')->slogan!='') echo " | ".config('MyConfig')->slogan?></title>

	<meta name="description" content="<?php echo config('MyConfig')->slogan; ?>">
...
<body>
						...
						<nav class="navbar navbar-expand-lg">
							...
							<div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
								<ul id="nav" class="navbar-nav ml-auto">
									<li class="nav-item">
										<a class="page-scroll active" href="#home"><?php echo lang('Home'); ?></a>
									</li>
									<li class="nav-item">
										<a class="page-scroll" href="#feature"><?php echo lang('Features');?></a>
									</li>									
									<li class="nav-item">
										<a class="page-scroll" href="#pricing"><?php echo lang('Pricing'); ?></a>
									</li>
									<li <?php if(config('MyConfig')->display_video_block == '0') echo "class='d-none'"; else echo "class='nav-item'";?>>
	                                    <a class="page-scroll" href="#tutorial"><?php echo lang('Tutorial');?></a>
	                                </li>
	                                <?php if (session()->get('license_type') == 'double')  {?>
	                                <li class="nav-item">
	                                    <a href="<?php echo base_url('blog');?>"><?php echo lang('Blog'); ?></a>
	                                </li>
	                                <?php } ?>
									<li class="nav-item">
									...
									<li class="nav-item">
									    <a class="" href="<?php echo site_url('home/login'); ?>"><?php echo lang('Login'); ?></a>
									</li>
								</ul>
							</div> <!-- navbar collapse -->
						</nav> <!-- navbar -->
			...
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-6">
					<div class="hero-content">
						<h2 class="wow fadeInUp" data-wow-delay=".2s"><?php echo config('MyConfig')->product_name; ?></h2>
						<h3 class="wow fadeInUp" data-wow-delay=".2s"> <?php echo lang('Developed using Facebook official API'); ?></h3><br>
						<p class="wow fadeInUp" data-wow-delay=".4s"><?php echo lang("Revolutionary, world's very first, and complete marketing software for Facebook & Other Social Medias developed using official APIs."); ?></p>
						<div class="hero-btns">
							<a href="<?php echo site_url('home/sign_up'); ?>" class="main-btn btn-hover wow fadeInUp <?php if(config('MyConfig')->enable_signup_form =='0') echo "d-none"; ?>" data-wow-delay=".45s"><?php echo lang('Sign up now'); ?></a>
							<?php 
							    $promo_video = config('MyConfig')->promo_video;
							    $video_source = videoType($promo_video);
							 ?>
							<a href="#" class="ms-2 watch-btn glightbox wow fadeInUp <?php if(config('MyConfig')->display_video_block == '0' || config('MyConfig')->promo_video == '') echo 'd-none';?>" data-wow-delay=".5s"> <i class="lni lni-play"></i> <span><?php echo lang('Quick Video'); ?></span></a>
						</div>
					</div>
				</div>
				<div class="col-xl-6 col-lg-6">
	...
	<section id="feature" class="feature-area pt-120">
		<div class="container">
			<div class="section-title">
				<h3 class="mb-60 wow fadeInUp" data-wow-delay=".2s"><?php echo lang('Awesome Features'); ?></h3>
			</div>
			<div class="row">
				<div class="col-xl-3 col-lg-3 col-md-6">
					<div class="single-feature item-1 wow fadeInUp" data-wow-delay=".2s">
						...
						<div class="feature-content">
							<h4><?php echo lang('Messenger Chatbot'); ?></h4>
							<p><?php echo lang('Setup Messenger bot for replying 24/7 with Visual Flow Builder.'); ?></p>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6">
					<div class="single-feature item-2 wow fadeInUp" data-wow-delay=".4s">
						...
						<div class="feature-content">
							<h4><?php echo lang('Live Chat'); ?></h4>
							<p><?php echo lang('Live Chat with Facebook/Instagram subscribers'); ?></p>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6">
					<div class="single-feature item-3 wow fadeInUp" data-wow-delay=".6s">
						...
						<div class="feature-content">
							<h4><?php echo lang('Comment Reply'); ?></h4>
							<p><?php echo lang('Template, hide/delete offensive comment, keyword based reply, generic reply to facebook pages posts comment.'); ?></p>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6">
					<div class="single-feature item-4 wow fadeInUp" data-wow-delay=".8s">
						...
						<div class="feature-content">
							<h4><?php echo lang('Social Poster'); ?></h4>
							<p><?php echo lang('Instant/Schedule posting on Social Medias.'); ?></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xl-6 offset-xl-1 col-lg-6">
					<div class="how-work-content-wrapper">
						<div class="section-title">
							<h3 class="mb-45 wow fadeInUp" data-wow-delay=".2s"><?php echo lang('How does this App Work?'); ?></h3>
							<p class="mb-35 wow fadeInUp" data-wow-delay=".3s"><?php echo lang('Few steps to connect your Facebook & Instagram account and make this app work.');?></p>
						</div>
								...
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".2s">
									<div class="accordion-btn">
										<button class="btn-block text-left collapsed" type="button" data-toggle="collapse"
											...
											<span><?php echo lang('Connect Social account'); ?></span>
										</button>
									</div>

									<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
										<div class="accordion-content">
											<?php echo lang("Connect Facebook account is just few clicks easy. Clicking 'Login with Facebook' button will prompt you to allow access to import your facebook & instagram account and enable bot for page and you are ready to go."); ?>
										</div>
									</div>
								</div>
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".3s">
									<div class="accordion-btn">
										<button class="btn-block text-left collapsed" type="button" data-toggle="collapse"
											...
											<span><?php echo lang('Create Comment'); ?></span>
										</button>
									</div>

									<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
										<div class="accordion-content">
											<?php echo lang('You can comment your own post one time or multiple times. You can save your comments as template and use it whenever you want. Perodic posting feature will allow you to comment randomly or serially taking content from template in a frequent manner and start-end time interval.'); ?>
										</div>
									</div>
								</div>
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".4s">
									<div class="accordion-btn">
										<button class="btn-block text-left collapsed" type="button" data-toggle="collapse"
											...
											<span><?php echo lang('Create Comment Reply'); ?></span>
										</button>
									</div>
									...
									<div id="collapseThree" class="collapse" aria-labelledby="headingThree"
										...
										<div class="accordion-content">
											<?php echo lang('Reply automatically your facebook post based on comment content. You can also hide/delete any offensive comments. You can save your replies as template and use it whenever you want.'); ?>
										</div>
									</div>
								</div>
								...
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".5s">
									<div class="accordion-btn">
										<button class="btn-block text-left collapsed" type="button" data-toggle="collapse"
											...
											<span><?php echo lang('Create Messenger Bot'); ?></span>
										</button>
									</div>

									<div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
										<div class="accordion-content">
											<?php echo lang('You can set messenger bot with Visual flow builder beside classic builder, So your messenger will work 24/7 automatically.'); ?>
										</div>
									</div>
								</div>
								...
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".6s">
									<div class="accordion-btn">
										<button class="btn-block text-left collapsed" type="button" data-toggle="collapse"
											...
											<span><?php echo lang('Create Posting Campaign'); ?></span>
										</button>
									</div>

									<div id="collapseFive" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
										<div class="accordion-content">
											<?php echo lang('Just create text/image/video/link content you want to post. Now post it or schedule it to post later. You can also set scheduled periodic post to post same content periodically.'); ?>
										</div>
									</div>
								</div>
						...
						<div class="download-btn wow fadeInUp" data-wow-delay=".5s">
							<a href="<?php echo site_url('home/sign_up'); ?>" class="main-btn btn-hover <?php if(config('MyConfig')->enable_signup_form =='0') echo "d-none"; ?>" data-wow-delay=".45s"><?php echo lang('See Features in Action'); ?></a>
						</div>
					</div>
				</div>
			</div>
	...
	<!--====== VIDEO PART START ======-->
	<section id="tutorial" class="video-area pt-130 <?php if(config('MyConfig')->display_video_block == '0' || config('MyConfig')->promo_video == '') echo 'd-none';?>">
		<div class="container">
			<div class="video-header bg_cover">
				<div class="section-title text-center">
					<h3 class="mb-60 wow fadeInUp" data-wow-delay=".2s"><?php echo lang('Watch a Quick Video'); ?></h3>
				</div>
			</div>
			<div class="video-frame wow fadeInUp" data-wow-delay=".4s">
			    ...
			    <div class="row">
			    	<?php 
			        $custom_videos = config('MyConfig')->custom_video; 
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-6 col-lg-8 col-md-10 mx-auto">
						<div class="section-title text-center">
							<h3 class="mb-30 wow fadeInUp" data-wow-delay=".2s"><?php echo lang('Apps Screenshot'); ?></h3>
							<p class="mb-60 wow fadeInUp" data-wow-delay=".4s"><?php echo lang('Here are some screenshots of how it looks. See the amazing shots and enjoy.'); ?></p>
						</div>
					</div>
				</div>
	...
	<section dir="ltr" class="testimonial-area pt-150 <?php if(config('MyConfig')->display_review_block == '0') echo 'd-none';?>">
		<div class="container">
			<div class="row">
				<div class="col-xl-6 col-lg-8 col-md-10">
					<div class="section-title">
						<h3 class="mb-30 wow fadeInUp" data-wow-delay=".2s"><?php echo lang("What's Our Customers Saying");?></h3>						
				</div> <!-- End col -->
			</div> <!-- End row -->
				...
				<div class="col-xl-12 col-lg-12 col-sm-11 col-md-9 mx-auto">
					<div class="testimonial-slider-wrapper">
						<div class="testimonial-slider">
							<?php 
			                	$customerReview = config('MyConfig')->customer_review;
				                $ct=0;
												...
												<small>
													<?php 
													    if(strlen($singleReview[3]) > 200 )
													    {
													        ...
													        echo $str.". . ."."<a class='exe' type='button' data-toggle='modal' data-target=#myModal".$ct.">".lang('Read More')."</a>";
	...
	<section id="pricing" class="pricing-area pt-120">
		<div class="container">
			<div class="row">
				<div class="col-xl-6 col-lg-8 col-md-10 mx-auto">
					<div class="section-title text-center">
						<h3 class="mb-30 wow fadeInUp" data-wow-delay=".2s"><?php echo lang('Get in Reasonable Price');?></h3>
						<p class="mb-50 wow fadeInUp"><?php echo lang('Complete marketing software for Facebook/Instagram in very reasonable price');?></p>
					</div>
				</div>
			</div>
			<div class="row">
								...
								<div class="col-xl-4 col-lg-4 col-md-6">
									<div class="single-price text-center <?php if($pack["highlight"]=='1') echo 'active'; ?> wow fadeInUp" data-wow-delay=".4s">
										...
										<h4 class="package-price mb-20">
											...
											<sub><?php echo $pack["validity"]?> <?php echo lang('days'); ?></sub>
										</h4>
										<ul class="package-details">
										    <?php 
										        $module_ids=$pack["module_ids"];
										        $monthly_limit=json_decode($pack["monthly_limit"],true);
										        $module_names_array=isset($basic) && $basic ? $basic->execute_query('SELECT module_name,id FROM modules WHERE FIND_IN_SET(id,"'.$module_ids.'") > 0  ORDER BY module_name ASC') : [];
										        ...
										        <li>
										            ...
										            <?php 
										                ...
										                if($limit=="0") $limit2="<b>".lang('unlimited')."</b>";
										                else $limit2=$limit;
										                if($row["id"]!="1" && $limit!="0") 										                    
										                $limit2="<b>".$limit2."/".lang('month')."</b>";
										                echo lang($row["module_name"]);
										...
										<a href="<?php echo site_url('home/sign_up'); ?>" class="btn-hover price-btn main-btn <?php if(config('MyConfig')->enable_signup_form == '0') echo "d-none"; ?>"><?php echo lang('Subscribe');?></a>
									</div>
								</div>
							<?php endforeach; ?>
				...
				<div class="row">
					<div class="col-xl-6 col-lg-6 offset-1 col-11">
						<div class="download-content">
							<div class="section-title">
								<h3 class="mb-30 text-white wow fadeInUp" data-wow-delay=".2s"><?php echo lang('Get the greatest app!');?></h3>
								<p class="mb-40 text-white wow fadeInUp" data-wow-delay=".35s"><?php echo lang('We provide you trial package, so that you can see awesomeness in action and explore it more.');?></p>
							</div>
							    

							<div class="download-btns">
							    <?php if(isset($default_package[0])) : ?>
							    	<a href="<?php echo site_url('home/sign_up'); ?>" class="btn-hover download-btn mr-4 wow fadeInUp <?php if(config('MyConfig')->enable_signup_form == '0') echo "d-none"; ?>" data-wow-delay=".45s">
							    		<span class="icon gradient-2"><i class="lni lni-customer"></i></span>
							    		<span class="text"><?php echo $default_package[0]["validity"] ?> <?php echo lang('Days')."<b>".lang('Free Trial')."</b>"; ?></span>
							    	</a>
								<?php endif; ?>
								<?php if(!empty($pricing_table_data)) : ?>
								<a href="#pricing" class="btn-hover download-btn wow fadeInUp page-scroll" data-wow-delay=".55s">
									...
									<span class="text"><?php echo lang('Pricing');?> <b><?php echo lang('Choose Plan');?></b></span>
								</a>
								<?php endif; ?>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-xl-6 col-lg-6">
					<div class="faq-wrapper">
						<h4 class="mb-40 wow fadeInUp text-center" data-wow-delay=".2s"><?php echo lang('Frequently Asked Questions'); ?></h4>
								...
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".3s">
									<div class="accordion-btn">
										<button class="btn-block text-left collapsed" type="button" data-toggle="collapse"
											...
											<span><?php echo lang('Do I need to create Facebook App?'); ?></span>
										</button>
									</div>

									<div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordionExample2">
										<div class="accordion-content">
											<?php echo lang("No, you don't need to create any Facebook app. We are covering all the complex stuff and giving you the easiest experience possible. Just import your account and start using the awesome features."); ?>
										</div>
									</div>
								</div>
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".4s">
									<div class="accordion-btn">
										<button class="btn-block text-left collapsed" type="button" data-toggle="collapse"
											...
											<span><?php echo lang('Is there any risk involved with my Instagram?'); ?></span>
										</button>
									</div>

									<div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionExample2">
										<div class="accordion-content">
											<?php echo lang("Not at all. We are using Instgram official API. Everything is official here. Don't need to worry."); ?>
										</div>
									</div>
								</div>
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".5s">
									<div class="accordion-btn">
										<button class="btn-block text-left collapsed" type="button" data-toggle="collapse"
											...
											<span><?php echo lang('Can I edit images before posting?'); ?></span>
										</button>
									</div>

									<div id="collapse6" class="collapse" aria-labelledby="heading6" data-parent="#accordionExample2">
										<div class="accordion-content">
											<?php echo lang('Yes, you can. We have full-featured image editor integrated with the system. You can crop, add text, add shape, add filters etc. before you post images.'); ?>
										</div>
									</div>
								</div>
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".6s">
									<div class="accordion-btn">
										<button class="btn-block text-left collapsed" type="button" data-toggle="collapse"
											...
											<span><?php echo lang('What if I face issues?'); ?></span>
										</button>
									</div>

									<div id="collapse7" class="collapse" aria-labelledby="heading7" data-parent="#accordionExample2">
										<div class="accordion-content">
											<?php echo lang('We are always alert to mitigate any global issue arise. If you still face any issue using the system you can open support tickets and our support team will guide and help you out.'); ?>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-xl-6 col-lg-6">
					<div class="contact-form-wrapper">
						<h4 class="mb-40 wow fadeInUp text-center" data-wow-delay=".3s"><?php echo lang('Do you have any question?'); ?></h4>
                        <?php 
							if(session()->get('mail_sent') == 1) {
							echo "<div class='alert alert-success text-center'>".lang('We have received your email. We will contact you through email as soon as possible.')."</div>";
						...
						<form action="<?php echo site_url("home/email_contact"); ?>" method="post" class="contact-form wow fadeInUp" data-wow-delay=".4s">
							<input type="email" class="mb-0" required id="email" <?php echo set_value("email"); ?> placeholder="<?php echo lang('email');?>" name="email">
							<span class="text-danger"><?php echo form_error("email"); ?></span>
							<div class="row">
								<div class="col-8">
									<input type="text" class="mb-0" required id="subject" <?php echo set_value("subject"); ?> placeholder="<?php echo lang('message subject');?>" name="subject">		
								...
								<div class="col-4">
									...
									<span class="text-danger">
										...
										{ 
											...
											session()->remove('contact_captcha_error'); 
										} 
										?>
									</span>								
								</div>
							</div>
							<textarea class="mb-0" rows="3" required id="message" <?php echo set_value("message"); ?> placeholder="<?php echo lang('message');?>" name="message"></textarea>
							<span class="text-danger"><?php echo form_error("message") ?></span>
							<button class="btn-hover btn-block main-btn" type="submit"><?php echo lang('Send Message');?></button>
						</form>
					</div>
				</div>
			</div>
	...
	<?php 
	    $facebook = config('MyConfig')->facebook;
	    $twitter  = config('MyConfig')->twitter;
	    $linkedin = config('MyConfig')->linkedin;
	    $youtube  = config('MyConfig')->youtube;
	...
	<footer id="footer" class="footer-area bg_cover">
		<div class="container pb-4">
			<div class="row">
				<div class="col-12 col-md-4">
					<div class="footer-widget wow fadeInUp text-center" data-wow-delay=".2s">
						...
						<p class="wow fadeInUp" data-wow-delay=".4s"><?php echo lang("Revolutionary, world's very first, and complete marketing software for Instagram developed using official APIs."); ?></p>
						
					</div>
				</div>
				<div class="col-12 col-md-4">
					<div class="footer-widget wow fadeInUp text-center" data-wow-delay=".6s">
						<h4><?php echo lang('Quick Links'); ?></h4>
						<ul>
							<li><a href="#pricing" class="page-scroll"><?php echo lang('Pricing'); ?></a></li>
							<li><a href="<?php echo base_url('home/privacy_policy'); ?>" target="_blank"><?php echo lang('Privacy Policy'); ?></a></li>
							<li><a href="<?php echo base_url('home/terms_use'); ?>" target="_blank"><?php echo lang('Terms of Service'); ?></a></li>
							<li><a href="<?php echo base_url('home/gdpr'); ?>" target="_blank"><?php echo lang('GDPR Compliant'); ?></a></li>	
						</ul>
					</div>
				</div>
				<div class="col-12 col-md-4">
					<div class="footer-widget wow fadeInUp text-center" data-wow-delay=".2s">
						<?php if(!empty(config('MyConfig')->institute_address1)) echo "<h3 class='mb-4'>".config('MyConfig')->institute_address1.'</h3>';?>
						<?php if(!empty(config('MyConfig')->institute_address2)) echo "<i class='lni lni-map-marker'></i> ".config('MyConfig')->institute_address2.'<br>';?>
						<?php if(!empty(config('MyConfig')->institute_email)) echo "<i class='lni lni-envelope'></i> ".config('MyConfig')->institute_email;?>
						<?php if(!empty(config('MyConfig')->institute_mobile)) echo "<br><i class='lni lni-phone'></i> ".config('MyConfig')->institute_mobile.'<br>';?>
			...
			<div class="footer-cradit">
				<p class="text-center mb-0"><?php echo lang('Copyright'); ?> &copy; <a target="_blank" href="<?php echo site_url(); ?>"><?php echo config('MyConfig')->institute_address1; ?></a></p>
			</div>
		</div>
	</footer>
	<?php if(session()->get('allow_cookie')!='yes') : ?>
	    ...
	    <div class="text-center cookiealert">
	        <div class="cookiealert-container py-3">
	            <a class="cookie_content_css" href="<?php echo base_url('home/privacy_policy#cookie_policy');?>">
	                <?php echo lang('This site requires cookies in order for us to provide proper service to you.');?>
	            </a>
	            <a type="button" href="#" class="btn btn-warning btn-sm acceptcookies black_color" aria-label="Close">
	                <?php echo lang('Got it !'); ?>
	            </a>
    ...
    <div class="modal fade" id="myModal<?php echo $ct; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
        	<div class="modal-header">
		        <h5 class="modal-title" id="exampleModalLabel"><?php echo lang('Full Review'); ?></h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-dark" data-dismiss="modal"><?php echo lang('Close'); ?></button>
            </div>
        </div>

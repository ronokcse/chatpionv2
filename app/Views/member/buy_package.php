...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      <div class="breadcrumb-item"><?php echo lang('Payment'); ?></div>
          ...
          <div class="pricing <?php if($pack['highlight']=='1') echo 'pricing-highlight';?>">
            ...
            <div class="pricing-padding">
              <div class="pricing-price">
                ...
                <div><?php echo $pack["validity"]?> <?php echo lang('days'); ?></div>
              </div>
              <div class="pricing-details nicescroll" style="height: 180px;">
                ...
                {                              
                    ...
                    if($limit=="0") $limit2=lang('unlimited');
                    else $limit2=$limit;
                    $limit2=" : ".$limit2;
                    echo '
            ...
            <div class="pricing-cta">
              <a href="" class="choose_package" data-id="<?php echo $pack['id'];?>"><?php echo lang('Select Package'); ?> <i class="fas fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
      <?php 
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fas fa-cart-plus"></i> <?php echo lang('Payment Options');?></h5>
...
<script>
  $(document).ready(function() {
    ...
    $(document).on('click', ".choose_package", function(e) {
       ...
       if(has_reccuring)  
       {
        swal("<?php echo lang('Subscription Message'); ?>", "<?php echo lang('You have already a subscription enabled in paypal. If you want to use different paypal or different package, make sure to cancel your previous subscription from your paypal.');?>")
        .then((value) => { 

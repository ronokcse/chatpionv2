...
<section class="section">
	...
	<div class="section-body">
           ...
           <div class="card card-statistic-1">
             ...
             <div class="card-wrap">
               ...
               <div class="card-body">
                  ...
                  <?php echo $validity;?> <?php echo lang('Days')?> 
               </div>
             </div>
           </div>
         </div>
         <div class="col-md-4 col-sm-4 col-12">
           <div class="card card-statistic-1">
             ...
             <div class="card-wrap">
               ...
               <div class="card-body">                 
                 <?php echo date("d M Y",strtotime(session()->get('expiry_date'))); ?>      
               </div>
             </div>
           </div>
         </div>
	  ...
	  <div class="card">
          <div class="card-header">
            <h4><i class="fas fa-th-list"></i> <?php echo lang('Usage Details'); ?></h4>
          </div>
          <div class="card-body">
            ...
            <div class="table-responsive">
            	<table class="table table-bordered table-condensed">
            		<tr>
            			...
            			<th class="text-center"><?php echo lang('Limit');?></th>
            			<th class="text-center"><?php echo lang('Used');?></th>
            		</tr>
            		<?php 
            		...
            		foreach($info as $row)
            		{
            			...
            			else
            			{
            				...
            				if($bulk_limit_print==0) $bulk_limit_print=lang('Unlimited');

            				echo "<td class='text-center'>";
            				if($monthly_limit[$row["module_id"]]=="0") $monthly_limit[$row["module_id"]]=lang('Unlimited');

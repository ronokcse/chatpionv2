...
<section class="section">
	<div class="section-header">
		<h1><i class="far fa-user"></i> <?php echo lang('Profile'); ?></h1>
		<div class="section-header-breadcrumb">
		  <div class="breadcrumb-item active"><a href="<?php echo base_url('dashboard'); ?>"><?php echo lang('Dashboard'); ?></a></div>
		  <div class="breadcrumb-item"><?php echo lang('Profile'); ?></div>
		</div>
	</div>
	...
	<div class="section-body">
	  <h2 class="section-title"><?php echo lang('Hi'); ?>, <?php echo $name; ?> !</h2>
	  <p class="section-lead">
	    <?php echo lang('Change information about yourself on this page.'); ?>
	  </p>
	      ...
	      <div class="card profile-widget">
	        <div class="profile-widget-header">
	          ...
	          <div class="profile-widget-items">
	            ...
	            <?php if(session()->get('user_type') != 'Admin') : ?>
		            <div class="profile-widget-item">
		              <div class="profile-widget-item-label"><?php echo lang('Package') ?></div>
	        ...
	        <div class="profile-widget-description">
	          <div class="profile-widget-name"><?php echo $name; ?> <div class="text-muted d-inline font-weight-normal"><div class="slash"></div> <?php echo $user_type; ?></div></div>
	          	<?php if(session()->get('user_type') != 'Admin') echo "<b>".lang('Package')." : </b>".$package_name." (".$expired_date.")"; ?>
	          	<br><?php echo "<b>".lang('Address')." : </b>".$address; ?></b>
	        </div>
	        <div class="card-footer text-center">
	          ...
	          <?php if(session()->get('user_type') == 'Member')
			  { ?>
	      		  <a class="delete_full_access btn btn-outline-danger red pointer btn-sm" title="<?php echo lang('Delete Account'); ?>"><i class="fas fa-trash"></i> <?php echo lang('Delete Account'); ?></a>
      		  	  <?php 
      		  } ?>
	        </div>
	      </div>
	      ...
	      <div class="card" style="margin-top: 35px;">
	        <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url().'myprofile/edit_profile_action';?>" method="POST">
	          ...
	          <div class="card-header">
	            <h4><i class="far fa-edit"></i> <?php echo lang('Edit Profile'); ?> </h4>
	          </div>
	          <div class="card-body">
	              <div class="row">
	                <div class="form-group col-md-6 col-12">
	                  	<label class="control-label" for=""><i class="fas fa-monument"></i> <?php echo lang('Name');?> *</label>
                      	<div>
	                ...
	                <div class="form-group col-md-6 col-12">
	                  	<label class="control-label" for=""><i class="far fa-envelope-open"></i> <?php echo lang('Email');?> *</label>
                   		<div>
	              ...
	              <div class="row">
	                <div class="form-group col-12">
	                  	<label class="control-label" for=""><i class="fas fa-map-marked-alt"></i> <?php echo lang('Address');?></label>
                   		<div>
	              ...
	              <div class="row">
	                <div class="form-group col-12 col-md-6">
	                	<label for=""><i class="fas fa-image"></i> <?php echo lang('image');?> (png)</label>
						<div class="custom-file">
                            <input name="logo" class="custom-file-input" type="file">
                            <label class="custom-file-label">Choose File</label>
                            <small>
                            	<?php echo lang('Max Dimension');?> : 300 x 300, <?php echo lang('Max Size');?> : 200KB</small>	          
                            <span class="red"> <?php echo session()->get('logo_error'); session()->remove('logo_error'); ?></span>
                        </div>
	                </div>
	                <div class="form-group col-md-6 col-12">
	                  	<label class="control-label" for=""><i class="fas fa-user-clock"></i> <?php echo lang('Time Zone');?></label>
                   		<div>
                   			<select name="time_zone" id="time_zone" class="form-control select2">
                   				<?php 
                   					$time_zone_list[''] = lang('Please select Time Zone');
    ...
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-warning"></i> <?php echo lang('Delete Account?');?></h5>
            ...
            <div class="modal-body">
            	<div id="message_div">
                	...
                	<h6><?php echo lang('Deleting your account will delete all your data from our system and this account can not be restored again. Do you really want to delete your account?'); ?></h6>
             	</div>
             </div>

            <div class="modal-footer" style="display: block">
            	<button csrf_token="<?php echo session()->get('csrf_token_session');?>" class="btn btn-danger delete_confirm btn-lg float-left"><i class="fas fa-trash"></i> <?php echo lang('Delete My Account'); ?></button>
            	<button class="btn btn-light cancel_button btn-lg float-right"><i class="fa fa-remove"></i> <?php echo lang('Cancel'); ?></button>
            </div>

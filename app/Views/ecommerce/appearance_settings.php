              ...
              <div class="row">
                <div class="col-12 col-md-6">
                    <div class="form-group mb-0">                      
                      <label><?php echo lang('Choose Theme color'); ?></label>
                    </div>
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group mb-3">
                    <label>
                      <?php echo lang('Product grouping'); ?>
                    </label>
                    <div class="selectgroup d-block">
                      <label class="selectgroup-item">
                        ...
                        <span class="selectgroup-button"> <?php echo lang('Category-wise') ?></span>
                      </label>
                      <label class="selectgroup-item">
                        ...
                        <span class="selectgroup-button"> <?php echo lang('None') ?></span>
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="form-group mb-3">
                    ...
                    <div class="selectgroup d-block">
                      <label class="selectgroup-item">
                        ...
                        <span class="selectgroup-button"> <?php echo lang('Grid view') ?></span>
                      </label>
                      <label class="selectgroup-item">
                        ...
                        <span class="selectgroup-button"> <?php echo lang('List view') ?></span>
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group mb-3">
                    <label><?php echo lang('Product sorting'); ?></label>
                    <div class="input-group">
                      <div class="input-group-prepend">
                      <span class="input-group-text"><?php echo lang('Order by'); ?></span>
                      </div>
                      <?php
                      ...
                      (
                        ...
                        'new'=>lang('New Product'),
                        'price'=>lang('Price'),
                        'sale'=>lang('Total Sales'),
                        'random'=>lang('Random')
                      );
                      $arr2 = array
                      (
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group">
                    <label><?php echo lang('Font'); ?></label>
                    <?php
                ...
                <div class="col-12 <?php if($xdata2['store_type'] == 'physical') echo 'col-md-6'; ?>">
                  <div class="form-group">
                    <label>
                      <?php echo lang('Buy now button title'); ?>
                    </label>
                ...
                <?php if($xdata2['store_type'] == 'physical') : ?>
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <label>
                        <?php echo lang('Store pickup title'); ?>
                      </label>
                      <div class="input-group mb-2">
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group">
                    <label for=""><?php echo lang('Hide Add to Cart Button');?></label>
                    <br>
                    <?php 
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group">
                    <label for=""><?php echo lang('Hide Buy Now Button');?></label>
                    <br>
                    <?php 
                ...
                ?>
                 <div class="col-12 col-md-6">
                    <div class="form-group">
                      <label for=""><?php echo lang('Whatsapp Send Order Button');?></label>
                      <br>
                      <?php 
                 ...
                 <div class="col-12 col-md-6 whatsapp_phone_number_div" <?php if($whatsapp_send_order_button == '1') echo 'style="display:block"'; else echo 'style="display:none"' ?>>
                    <div class="form-group">
                      <label for=""><?php echo lang('Whatsapp Phone Number');?> <span class="red">*</span></label>
                      <br>
                      <?php 
                      $whatsapp_phone_number =isset($xvalue['whatsapp_phone_number'])?$xvalue['whatsapp_phone_number']:"";
                      ?>
                      <input type="text" name="whatsapp_phone_number" id="whatsapp_phone_number" value="<?php echo $whatsapp_phone_number; ?>" class="form-control" placeholder="<?php echo lang('Type phone number with country code'); ?>">
                 ...
                 <div class="col-12 whatsapp_message_div" <?php if($whatsapp_send_order_button == '1') echo 'style="display:block"'; else echo 'style="display:none"' ?>>
                    <div class="form-group">
                      <label><?php echo lang('Whatsapp Send Order text'); ?></label>

...
<html lang="en">
	<head>
		...
		<title><?php echo isset($page_title) ? $page_title : config('MyConfig')->product_name;?></title>
  		  ...
  		  <div class="container">		  
	  		  ...
	  		  <div class='m-0 mt-3 w-100 search_form'>
	  		    <div class="input-group">
	  		      ...
	  		      ?>
	  		      <input type="text" onkeyup="search_product(this,'product-container')" autofocus="" class="form-control" name="search" id="search" value= "<?php echo session()->get('search_search');?>" 
    ...
    if(isset($social_analytics_codes)) 
    {
        ...
        if($function=='order' && session()->get('logged_in')=='1') echo '';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#login_submit', function(e) {
            ...
            if(email=="" || password==""){
                swal("<?php echo lang('Error'); ?>", "<?php echo lang('Email and password are required.'); ?>", 'error'); 
                return;
            }
        ...
        $(document).on('click', '#register_submit', function(e) {
            ...
            if(register_first_name=="" || register_last_name=="" || register_email=="" || register_password=="" || register_password_confirm==""){
                swal("<?php echo lang('Error'); ?>", "<?php echo lang('Please fill the required fields.'); ?>", 'error'); 
                return;
            }
        ...
        $(document).on('click', '#save_profile', function(e) {
            ...
            if(first_name=="" || last_name=="" || street==""){
                swal("<?php echo lang('Error'); ?>", "<?php echo lang('Please input the required fields.'); ?>", 'error'); 
                return;
            }
        	$("#save_profile").addClass('btn-progress');
        ...
        $(document).on('click', '#delete_address', function(e) {
            ...
            swal({title: '<?php echo lang('Delete Address'); ?>',
             text: '<?php echo lang('Do you really want to delete this address?'); ?>',
             icon: 'warning',
             buttons: true,
             dangerMode: true,
           })
           .then((willDelete) => {
             if (willDelete) 
             {
                 ...
                 $.ajax({
                   ...
                   success:function(response){
                     iziToast.success({title: "",message: '<?php echo lang('Address has been deleted successfully.');?>',position: 'bottomRight',timeout: 3000});
                     $("#deliveryAddressModal").modal('hide');
                     setTimeout(function(){ 
                         $("#showAddress").trigger('click');
                         $("#sidebarCollapse").click();
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="profileModalLabel"><i class="fas fa-user-circle"></i> <?php echo lang('Profile'); ?></h5>
      ...
      <div class="modal-footer p-0">
        ...
        <button type="button" id="save_profile" class="btn btn-primary btn-lg btn-block no_radius p-3 m-0"><i class="fas fa-save"></i> <?php echo lang('Save Profile'); ?></button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="deliveryAddressModal" tabindex="-1" role="dialog" aria-labelledby="deliveryAddressModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deliveryAddressModalLabel"><i class="fas fa-truck"></i> <?php echo lang('Delivery Address'); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><i class="fas fa-chevron-circle-left"></i></span>
        </button>
      </div>
      ...
      <div class="modal-footer p-0">
        <!-- <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-times"></i> <?php echo lang('Close'); ?></button> -->
        <button type="button" id="new_address" class="btn btn-primary btn-lg btn-block no_radius p-3 m-0"><i class="fas fa-plus-circle"></i> <?php echo lang('Add Address'); ?></button>
        <button type="button" id="save_address" data-close="0" class="btn btn-primary btn-lg btn-block no_radius p-3 m-0 d-none"><i class="fas fa-save"></i> <?php echo lang('Save Address');?> </button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="TermsModal" tabindex="-1" role="dialog" aria-labelledby="TermsModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="TermsModalLabel"><i class="lnr lnr-license"></i> <?php echo lang('Terms of Use'); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><i class="fas fa-chevron-circle-left"></i></span>
        </button>
      </div>
...
<div class="modal fade" id="RefundModal" tabindex="-1" role="dialog" aria-labelledby="RefundModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="RefundModalLabel"><i class="lnr lnr-book"></i> <?php echo lang('Refund Policy'); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><i class="fas fa-chevron-circle-left"></i></span>
        </button>
      </div>
...
<div class="modal fade" id="LoginModal" tabindex="-1" role="dialog" aria-labelledby="LoginModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="LoginModalLabel"><i class="fas fa-sign-in-alt"></i> <?php echo lang('Login'); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><i class="fas fa-chevron-circle-left"></i></span>
        </button>
      </div>
      <div class="modal-body text-justify" id="LoginModalBody">
            <form method="POST" action="#" class="needs-validation" novalidate="" _lpchecked="1">
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="login_email" name=""  placeholder="<?php echo lang('Email'); ?>" required autofocus autocomplete="off">
              ...
              <div class="form-group">
                ...
                <input  type="password" id="login_password" class="form-control" name="" placeholder="<?php echo lang('Password'); ?>" required autocomplete="off">
                <div class="invalid-feedback"></div>
            ...
            <div class="<?php echo $is_guest_login=='1' ? '' : 'text-center'; ?> mt-4 mb-3">
              <div class="text-job text-muted"><a href="" class="pointer <?php echo $is_guest_login=='1' ? 'float-left' : ''; ?>" id="register_form"><i class="fas fa-user-circle"></i> <?php echo lang('Register Now');?></a></div>
              <div class="text-job text-muted"><a href="" class="pointer <?php echo $is_guest_login=='1' ? 'float-right' : 'd-none'; ?>" id="guest_register_form"><i class="fas fa-user-secret"></i> <?php echo lang('Checkout as Guest');?></a></div>
            </div>  
      </div>
    </div>
  </div>
...
<div class="modal fade" id="RegisterModal" tabindex="-1" role="dialog" aria-labelledby="RegisterModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="RegisterModalLabel"><i class="fas fa-sign-in-alt"></i> <?php echo lang('Register'); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><i class="fas fa-chevron-circle-left"></i></span>
        </button>
      </div>
      <div class="modal-body text-justify" id="RegisterModalBody">
            <form method="POST" action="#" class="needs-validation" novalidate="" _lpchecked="1">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="<?php echo lang('First Name'); ?>" id="register_first_name" name="" required autofocus autocomplete="off">
                    <input type="text" class="form-control" placeholder="<?php echo lang('Last Name'); ?>" id="register_last_name" name="" required autofocus autocomplete="off">
                </div>
                <div class="invalid-feedback"></div>
              </div>
              ...
              <div class="form-group">
                <label for="email"><?php echo lang('Email');?>*</label>
                <input type="email" class="form-control" placeholder="<?php echo lang('Email'); ?>" id="register_email" name="" required autofocus autocomplete="off">
                <div class="invalid-feedback"></div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                    <input  type="password" id="register_password" placeholder="<?php echo lang('Password'); ?>" class="form-control" name="" required autocomplete="off">
                    <input  type="password" id="register_password_confirm" placeholder="<?php echo lang('Confirm Password'); ?>" class="form-control" name="" required autocomplete="off">
                </div>
                <div class="invalid-feedback"></div>

<section class="section section_custom pt-1">
  <div class="section-header d-none">
    ...
    <div class="section-header-button">
        <a class="btn btn-primary" href="#" id="add_new_row"><i class="fas fa-plus-circle"></i> <?php echo lang('Add Pickup Point'); ?></a>
    </div>
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><?php echo lang('Pickup Point'); ?></div>
    </div>
  </div>
...
<script>       
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '#save_row', function(event) {
        ...
        if(point_name == "")
        {
            swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Name name is required'); ?>', 'warning');
            return;
        }

        if(point_details == "")
        {
            swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Details value is required'); ?>', 'warning');
            return;
        }        
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center blue">
                    <i class="fas fa-plus-circle"></i> <?php echo lang('New Point')." : ".session()->get('ecommerce_selected_store_title'); ?>
                </h5>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label><?php echo lang('Point Name'); ?> *</label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label><?php echo lang('Point Details'); ?> *</label>
    ...
    <div class="modal-dialog modal-mega">
        <div class="modal-content">
            <div class="modal-header bbw">
                <h5 class="modal-title text-center blue">
                    <i class="fas fa-edit"></i> <?php echo lang('Edit Point')." : ".session()->get('ecommerce_selected_store_title'); ?>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div class="modal-body">

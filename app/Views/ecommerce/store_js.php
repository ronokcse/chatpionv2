...
{        
    ...
    if($("#store_name").val()=="")
    {
      swal("<?php echo lang('Error'); ?>", "<?php echo lang('Please put your store name.'); ?>", 'error');
      return false;
    }

    if($("#store_email").val()=="")
    {
      swal("<?php echo lang('Error'); ?>", "<?php echo lang('Please put your store email.'); ?>", 'error');
      return false;
    }

    if($("#store_country").val()=="")
    {
      swal("<?php echo lang('Error'); ?>", "<?php echo lang('Please put your store country.'); ?>", 'error');
      return false;
    }

    if($("#store_state").val()=="")
    {
      swal("<?php echo lang('Error'); ?>", "<?php echo lang('Please put your store state.'); ?>", 'error');
      return false;
    }

    if($("#store_city").val()=="")
    {
      swal("<?php echo lang('Error'); ?>", "<?php echo lang('Please put your store city.'); ?>", 'error');
      return false;
    }
    ...
    {
      swal("<?php echo lang('Error'); ?>", "<?php echo lang('Please put your store address.'); ?>", 'error');
      return false;
    }
    ...
    if($("#store_zip").val()=="")
    {
      swal("<?php echo lang('Error'); ?>", "<?php echo lang('Please put your store postal code.'); ?>", 'error');
      return false;
    }

...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-button">
      <a title="<?php echo lang('Create Store');?>" data-toggle="tooltip" class="btn btn-primary iframed" href="<?php echo base_url("ecommerce/add_store");?>">
        <i class="fas fa-plus-circle"></i> <?php echo lang('Create Store'); ?>
      </a> 
    </div>    
  </div>
  ...
  <div class="section-body">
            ...
            <div class="breadcrumb-item">
              <form method="POST" action="<?php echo base_url('ecommerce/store_list') ?>">          
                <div class="input-group">
                  ...
                  <input type="text" class="form-control datepicker_x" value="<?php echo session()->get('ecommerce_from_date'); ?>" id="from_date" name="from_date" style="width:115px"> 
                  <div class="input-group-prepend">
                    <div class="input-group-text">
                      -
                    </div>
                  </div>
                  <input type="text" class="form-control datepicker_x" value="<?php echo session()->get('ecommerce_to_date'); ?>" id="to_date" name="to_date" style="width:115px">                 
                  <select name='currency' id='currency' class='form-control select2' style="width: 85px;">
                  <?php
                  foreach ($currecny_list_all as $key => $value)
                  {
                    if(session()->get('ecommerce_currency')==$key) $selected_curr = "selected='selected'";
                    else $selected_curr = '';
                    echo '<option value="'.$key.'" '.$selected_curr.' >'.$key.'</option>';
                  }
                  ?>
                  </select>
                  <button class="btn btn-outline-primary" style="margin-left:1px" id="search_submit" type="submit"><i class="fa fa-search"></i> <?php echo lang('Search');?></button>
                </div>
              </form>
            </div>
          </div>
      ...
      <div class="card-body">
        ...
        <div class="empty-state hide_in_iframe">
          <img class="img-fluid" style="height: 200px" src="<?php echo base_url('assets/img/drawkit/drawkit-nature-man-colour.svg'); ?>" alt="image">
           <h2 class="mt-0"><?php echo lang('We could not find any ecommerce store.');?></h2>
          <p class="lead"><?php echo lang('You have to create a store first.'); ?></p>
          <a href="<?php echo base_url('ecommerce/add_store'); ?>" title="<?php echo lang('Create Store');?>" data-toggle="tooltip" class="btn btn-primary iframed" class="btn btn-outline-primary mt-4"><i class="fas fa-arrow-circle-right"></i> <?php echo lang('Create Store');?></a>
        </div>
      </div>
    </div>
    ...
    { 
      ...
      $from_date = strtotime(session()->get('ecommerce_from_date')); 
      $to_date = strtotime(session()->get('ecommerce_to_date')); 
      do 
      {
      ...
      <div class="row multi_layout">
          ...
          <div class="card main_card">
            <div class="card-header">
              <!-- <div class="col-6 padding-0"> -->
                <h4><i class="fas fa-store-alt"></i> <?php echo lang('Stores'); ?></h4>
              <!-- </div> -->
              <!-- <div class="col-6 padding-0">             -->
            ...
            <div class="card-body padding-0">
              <ul class="list-group" id="page_list_ul" style="margin-top: 20px;">
                ...
                { 
                  if($value['id']==session()->get('ecommerce_selected_store')) $current_store_data = $value;
                  
                  ?> 
                  <li class="list-group-item <?php if($value['id']==session()->get('ecommerce_selected_store')) echo 'active'; ?> page_list_item" page_table_id="<?php echo $value['id']; ?>">
        ...
        if(session()->get('ecommerce_currency')=='')
        $store_currency = isset($currency_icons[$config_currency]) ? $currency_icons[$config_currency] : "$";
        else $store_currency = isset($currency_icons[session()->get('ecommerce_currency')]) ? $currency_icons[session()->get('ecommerce_currency')] : "$";
        ...
        (
          ...
          (
            ...
            'title'=>lang('Business Hour Settings'),
          ...
          (
            ...
            'title'=>lang('Signed-up Customers'),
            'icon'=>'fas fa-users',
            'attr'=>''
          ),
          29 => array
          ...
          (
            'class'=>'iframed',
            'href'=>base_url('ecommerce/copy_url/'.session()->get('ecommerce_selected_store')),
            'title'=>lang('Copy URL'),
            'icon'=>'fas fa-copy',
            'attr'=>''
          ),
          ...
          (
            ...
            'title'=>lang('Order Status Notification'),
            'icon'=>'fas fa-bell',
            'attr'=>'campaign_id='.$current_store_data['id']
          ),
          42 => array
          (
            ...
            'title'=>lang('Confirmation & Reminder'),
        ...
        <div class="col-12 col-md-9 col-lg-8 colrig" id="right_column">
          ...
          <div class="card main_card">
            <div class="card-header">
              <div class="col-8 p-0">
                <h4 id="right_column_title"><i class="fas fa-tachometer-alt"></i> <a title="<?php echo lang('Visit Store'); ?>" data-toggle="tooltip" target="_BLANK" href="<?php echo base_url('ecommerce/store/'.$current_store_data['store_unique_id']); ?>"><?php echo str_replace(array('https://','http://'), '', $current_store_data['store_name']); ?></a> (
                    <?php if($current_store_data['page_id'] != 0) : 
                      echo '<a title="'.lang('Visit Page').'" data-toggle="tooltip" target="_BLANK" href="https://facebook.com/'.$current_store_data['fb_page_id'].'">'.$current_store_data['page_name'].'</a>';
                     else :
                        echo lang('No Page');
                      ?>
                    <?php endif; ?>
                  ) 
                  <span id='iframe_title'> : <?php echo lang('Dashboard'); ?></span></h4>
              </div>
              <div class="col-4 p-0 d-lg-none">
                <div class="card-header-action dropleft float-right">
                  <a href="#" data-toggle="dropdown" class="btn btn-lg btn-outline-primary dropdown-toggle"><?php echo lang('Actions'); ?></a>
                      ...
                      <div class="row">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                          <div class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                              <div class="card-header">
                                <h4><?php echo lang('Total Order'); ?></h4>
                              </div>
                              <div class="card-body">
                       ...
                       <!--  <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                          <div class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                              <div class="card-header">
                                <h4><?php echo lang('Reminded Cart'); ?></h4>
                              </div>
                              <div class="card-body">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                          <div class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                              <div class="card-header">
                                <h4><?php echo lang('Recovered Cart'); ?></h4>
                              </div>
                              <div class="card-body">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                          <div class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                              <div class="card-header">
                                <h4><?php echo lang('Checkout Order'); ?></h4>
                              </div>
                              <div class="card-body">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                          <div class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                              <div class="card-header">
                                <h4><?php echo lang('Total Earnings'); ?></h4>
                              </div>
                              <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-8">
                          <div class="card no_shadow">
                            <div class="card-header">
                              <h4><i class="fas fa-coins"></i> <?php echo lang('Earnings'); ?></h4>
                            </div>
                            <div class="card-body">
                          ...
                          <div class="card no_shadow">
                            <div class="card-header">
                              <h4><i class="fas fa-star"></i> <?php echo lang('Top Products'); ?></h4>
                            </div>
                            <div class="card-body">
                                      ...
                                      <div>
                                        <div class="product-item">
                                          ...
                                          <div class="product-details">
                                            ...
                                            <div class="text-muted text-small"><?php echo $value["sales_count"];?> <?php echo lang('Sales'); ?></div>
                                            <!-- <div class="product-cta">
                                              <a target="_BLANK" href="<?php echo base_url('ecommerce/product/'.$pro_id);?>" class="btn btn-outline-primary"><?php echo lang('Details'); ?></a>
                                            </div> -->
                                          </div>
                                        </div>
                                      </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-4">
                          ...
                          <div class="card no_shadow">
                            <div class="card-header">
                                <h4><i class="fas fa-tasks"></i> <?php echo lang('Cart Activities'); ?></h4>                             
                            </div>
                            <div class="card-body nicescroll" id="cart_activities" style="padding-right: 10px">
                              ...
                              <ul class="list-unstyled list-unstyled-border">
                                <?php
                                if(empty($cart_data)) echo '<div class="alert alert-light">'.lang('No activity found').'</div>';                               
                                foreach ($cart_data as $key => $value) 
                                { 
                                  ...
                                  else 
                                  {
                                    ...
                                    $hook_activity = lang('Successful checkout').' <span class="">('.$currency_icon.$value['payment_amount'].')</span>';
                                  }
        ...
        <div class="col-lg-2 collef d-none d-lg-block" style="border:.5px solid #dee2e6;">
          <div class="card main_card" >
            <div class="card-header">
                <h4><i class="fas fa-paper-plane"></i> <?php echo lang('Actions'); ?></h4>
            </div>
            <div class="card-body padding-0">
...
$(document).ready(function($) {  
    ...
    $(document).on('click', '.delete_campaign', function(event) {
        ...
        swal({
              title: '<?php echo lang('Delete Store'); ?>',
              text: '<?php echo lang('Do you really want to delete this store? Deleting store will also delete all related data like cart,purchase,settings etc.'); ?>',
              icon: 'warning',
              buttons: true,
              dangerMode: true,
            })
              ...
              if (willDelete) 
              {
                  ...
                  $.ajax({
                    ...
                    success:function(response){ 
                      ...
                      {
                        iziToast.success({title: '<?php echo lang('Deleted Successfully'); ?>', message: response.message,position: 'bottomRight'});
                        $("#search_submit").click();
                      }
                      else
  ...
  <div class="modal-dialog modal-mega" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fas fa-bell"></i> <?php echo lang('Reminder Report'); ?></h5>
            ...
            <table class="table table-bordered" id="mytable2">
              <thead>
                <tr>
                  ...
                  <th><?php echo lang('Reminder Hour'); ?></th>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-times"></i> <?php echo lang('Close'); ?></button>
      </div>
    </div>
  </div>
</div>
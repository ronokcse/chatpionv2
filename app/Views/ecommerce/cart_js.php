<script>
  ...
  $("document").ready(function()  {
    // $(".selecttwo").select2();
    $(".selecttwo_multiple").select2({minimumResultsForSearch: -1,placeholder: "<?php echo lang('Choose Options');?>",});
    $(document).on('click','.add_to_cart',function(e){
     ...
     if(exit)
     {
      swal("<?php echo lang('Error'); ?>", "<?php echo lang('Please choose the required options.'); ?> (*)", 'error');
      return false;
     }
     ...
     {
       swal("<?php echo lang('Error'); ?>", '<?php echo lang('Item can not be removed. It is not in cart anymore.');?>', 'error');
       return false;
     }
     var new_count = 0;

			...
			<div class="card-body p-0">
				<?php foreach ($product_list as $value): ?>
					<?php 
						...
						if($payment_status=='pending') $payment_status_badge = "<span class='text-danger'>".lang('Pending')."</span>";
						else if($payment_status=='approved') $payment_status_badge = "<span class='text-primary'>".lang('Approved')."</span>";
						else if($payment_status=='rejected') $payment_status_badge = "<span class='text-danger'>".lang('Rejected')."</span>";
						else if($payment_status=='shipped') $payment_status_badge = "<span class='text-info'>".lang('Shipped')."</span>";
						else if($payment_status=='delivered') $payment_status_badge = "<span class='text-info'>".lang('Delivered')."</span>";
						else if($payment_status=='completed') $payment_status_badge = "<span class='text-success'>".lang('Completed')."</span>";
								...
								<div class="mb-2">
									...
									<div class="float-right dropdown ml-3">
										...
										<div class="dropdown-menu">
											<div class="dropdown-title"><?php echo lang('Options'); ?></div>
											<a href="<?php echo base_url("ecommerce/download_item/".$value['id']."?subscriber_id=".$value['subscriber_id']); ?>" class="dropdown-item has-icon"><i class="fas fa-cloud-download-alt"></i> <?php echo lang('Download'); ?></a>
										</div>
									</div>
...
<!--         <div class="row">
          <div class="col-6 col-md-4">
            ...
            '<div class="input-group mb-3" id="searchbox">
              ...
              <input type="text" class="form-control rounded-left" id="search_value" autofocus name="search_value" placeholder="'.lang('Search...').'">
          ...
          <div class="col-6 col-md-8 text-right">
        	...
        	<?php
	          echo $drop_menu ='<a href="javascript:;" id="search_date_range" class="btn btn-outline-primary btn-lg  icon-left btn-icon"><i class="fas fa-calendar"></i> '.lang('Choose Date').'</a><input type="hidden" id="search_date_range_val">';
	        ?>

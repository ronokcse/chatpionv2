<section class="section section_custom pt-1">
  <div class="section-header d-none">
    ...
    <div class="section-header-button">
      <a href="<?php echo base_url('ecommerce/add_coupon'); ?>" class="btn btn-primary"><i class="fas fa-plus-circle"></i> <?php echo lang('Add Coupon'); ?></a>
    </div>
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><?php echo lang('Coupon'); ?></div>
    </div>
  </div>
          ...
          <div class="card-body data-card p-0 pt-1 pr-3">
            <div class="row">              
              ...
              <div class="d-none d-sm-block col-sm-3 col-md-3">
                <?php
                echo $drop_menu ='<a href="javascript:;" id="search_date_range" class="btn btn-lg btn-outline-primary float-right icon-left btn-icon d-inline"><i class="fas fa-calendar"></i> '.lang('Choose Date').'</a><input type="hidden" id="search_date_range_val">';
                ?>                                         
              </div>
              <div class="col-5 col-sm-12">  
                 <a href="<?php echo base_url('ecommerce/add_coupon'); ?>" class="btn btn-lg float-right btn-primary"><i class="fas fa-plus-circle"></i> <?php echo lang('Add'); ?></a>
                <?php
                ?>                                         
              </div>
            </div>
                ...
                <table class="table table-bordered" id="mytable">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo lang('Expiry Date')?></th>                    
                      <th><?php echo lang('Status')?></th>                    
                      <th><?php echo lang('Actions')?></th>                    
                      <th><?php echo lang('Store')?></th>                    
                      <th><?php echo lang('Free Shipping')?></th>                    

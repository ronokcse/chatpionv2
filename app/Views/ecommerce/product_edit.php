<section class="section section_custom pt-1">
  <div class="section-header d-none">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('ecommerce/product_list'); ?>"><?php echo lang('Product');?></a></div>
      <div class="breadcrumb-item"><?php echo lang('Edit Product'); ?></div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-12">
      ...
      $save_button = ($operation=='clone') ? '<i class="fas fa-clone"></i> '.lang('Clone') : '<i class="fas fa-save"></i> '.lang('Save');
        ...
        <div class="card no_shadow">
          <div class="card-body p-0">
            <div class="row">
              <div class="col-12 col-md-4">
                <div class="form-group">
                  ...
                  <label for="product_name"> <?php echo lang('Product name')?> *</label>
              ...
              <div class="col-6 col-md-4">
                <div class="form-group">
                  ...
                  <label for="original_price"> <?php echo lang('Original price')?> *</label>
              ...
              <div class="col-6 col-md-4">
                <div class="form-group">
                  ...
                  <label for="sell_price"> <?php echo lang('Sell price')?>
                    <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo lang('Sell Price'); ?>" data-content="<?php echo lang('Put offer price if it is on sale'); ?>"><i class='fa fa-info-circle'></i> </a>
                  </label>
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><?php echo $config_currency_icon; ?></span>
            ...
            <?php if(isset($is_ecommerce_related_product_addon_exist) && $is_ecommerce_related_product_addon_exist) : ?>
              <div class="row">
                <div class="col-12 col-md-4">
                  ...
                  ?>
                  <div class="form-group">
                    <label> <?php echo lang('Related Products')?></label>
                ...
                <div class="col-12 col-md-4">
                  ...
                  ?>
                  <div class="form-group">
                    <label> <?php echo lang('Upsell Product')?></label>
                ...
                <div class="col-12 col-md-4">
                  ...
                  ?>
                  <div class="form-group">
                    <label for="name"> <?php echo lang('Downsell Product')?></label>
            ...
            <div class="row">
              <div class="col-12 col-md-4 d-none">
                <div class="form-group">
                  ...
                  <label for="name"> <?php echo lang('Store')?> *</label>
              ...
              <div class="col-12">
                <div class="form-group">
                    ...
                    ?>
                  <label><?php echo lang('Attributes'); ?></label>
              ...
              <div class="col-12 col-md-8">
                <div class="form-group">
                  ...
                  <label for="product_video_id"> <?php echo lang('Product Video')?>
                  <a href="#" data-placement="bottom" data-toggle="popover" data-trigger="focus" title="<?php echo lang('Product Video'); ?>" data-content="<?php echo lang('Provide YouTube Video id'); ?>"><i class='fa fa-info-circle'></i> </a>
                  </label>
                  <input name="product_video_id" value="<?php echo $default_vd;?>"  class="form-control" type="text" placeholder="<?php echo lang('Provide YouTube Video id'); ?>">
            ...
            <div class="row mt-1">
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <label for="product_description"> <?php echo lang('Product description')?></label>
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <label for="purchase_note"> <?php echo lang('Purchase note')?></label>
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="full_width"><?php echo lang('Thumbnail'); ?> 
                   <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo lang('Thumbnail'); ?>" data-content="<?php echo lang('Maximum: 1MB, Format: JPG/PNG, Preference: Square image, Recommended dimension : 500x500'); ?>"><i class='fa fa-info-circle'></i> </a>
                    
                    <?php if($default_tb!='' && $operation=='edit') { ?>
                      <span id="tmb_preview" class="float-right pointer text-primary" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-eye"></i> <?php echo lang('Preview'); ?></span>
                    <?php } ?>
                  </label>
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label><?php echo lang('Featured  Images'); ?> 
                   <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo lang('Featured  Images'); ?>" data-content="<?php echo lang('Upto 3 images, Maximum: 1MB each, Format: JPG/PNG, Preference: Square image, Recommended dimension : 500x500. Uploading new images will overwrite previous images.'); ?>"><i class='fa fa-info-circle'></i> </a>
                  </label>
              ...
              <?php if(isset($store_type) && $store_type == 'digital') : ?>
                <div class="col-12">
                  <div class="form-group">
                    <label><?php echo lang('Upload Product'); ?> 
                     <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo lang('Product File'); ?>" data-content="<?php echo lang('Upload your product file here.'); ?>"><i class='fa fa-info-circle'></i> </a>
                    </label>
              ...
              <div class="row">             
                <div class="col-6 col-md-4">
                  <div class="form-group">
                    ...
                    ?>
                    <label for="status" > <?php echo lang('Item in stock');?> *</label><br>
                    <input name="stock_item" value="<?php echo $default_stock_item;?>"  class="form-control" type="number" min="0">
                  </div>
                </div>
                <div class="col-6 col-md-4">
                  <div class="form-group">
                    <label for="stock_display"> <?php echo lang('Display stock');?> *</label><br>
                ...
                <div class="col-6 col-md-4">
                  <div class="form-group">
                    <label for="stock_prevent_purchase"> <?php echo lang('Prevent purchase if out of stock');?> *</label><br>
                    <label class="custom-switch mt-2">
            ...
            <div class="row <?php if($system_is_preparation_time=='0') echo 'd-none';?>">              
              <div class="col-12">
                <div class="form-group">
                  <label><?php echo lang('Preparation time');?></label>
                  <div class="input-group">
                    <div class="input-group-prepend">
                    ...
                    ?>
                    <input type="text" placeholder="<?php echo lang('example : 10 or 10-15');?>" name="preparation_time" class="form-control" value="<?php echo $preparation_time; ?>">
            ...
            <div class="row">             
              <div class="col-6 col-md-4">
               ...
               <div class="col-6 col-md-4">
                <div class="form-group">
                  <label for="taxable"> <?php echo lang('Taxable');?> *</label><br>
                  <label class="custom-switch mt-2">
          ...
          <div class="card-footer p-0" style="margin-bottom: 200px">
            ...
            <button  type="button" class="btn btn-secondary btn-lg float-right" onclick='goBack("ecommerce/product_list",0)'><i class="fa fa-remove"></i> <?php echo lang('Cancel');?></button>
          </div>
        </div>
      </form>  
    </div>

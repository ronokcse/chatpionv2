        ...
        <div class="col-12">
          <div class="card main_card no_shadow">
              <div class="card-header p-0 mb-3" style="border:none;min-height: 0;">
                <h6 class="full_width">
                  <a id="variables" class="float-left text-warning pointer"><i class="fas fa-circle"></i> <?php echo  lang('Variables'); ?></a>
                  <a onclick="reset_values()" class="float-right text-danger pointer"><i class="fas fa-undo-alt"></i> <?php echo  lang('Reset'); ?></a>
                </h6>
              </div>    
              <div class="card-body p-0">
                <ul class="nav nav-tabs" id="sequence_tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" id="messenger_link" data-toggle="tab" href="#messenger_tab" role="tab" aria-controls="profile" aria-selected="false"> <?php echo  lang('Messenger'); ?></a>
                  </li>

                  <li class="nav-item">
                    <a class="nav-link" id="sms_link" data-toggle="tab" href="#sms_tab" role="tab" aria-controls="profile" aria-selected="false"><?php echo  lang('SMS'); ?></a>
                  </li>

                  <li class="nav-item">
                    <a class="nav-link" id="email_link" data-toggle="tab" href="#email_tab" role="tab" aria-controls="profile" aria-selected="false"><?php echo  lang('Email'); ?></a>
                  </li>
                   ...
                   <div class="row">
                                   ...
                                   { ?>
                                     <div class="reminder_badge_warpper tab-pane fade" id="msg_reminder<?php echo $i;?>" role="tabpanel" aria-labelledby="msg_reminder_link>">
                                       ...
                                       <div class="reminder_block">
                                        <span class="block1">
                                          <textarea autofocus data-toggle="tooltip" title="<?php echo lang('Intro message will be displayed here, click to edit text.'); ?>"  name="msg_reminder_text[]" id="msg_reminder_text<?php echo $i;?>"><?php echo isset($messenger_content['reminder'][$i]['reminder_text']) ? $messenger_content['reminder'][$i]['reminder_text'] : $reminder_default['messenger']['reminder']['reminder_text'];?></textarea>
                                        </span>                               
                                        <span class="block2 ">
                                          <img data-toggle="tooltip" title="<?php echo lang('Item preview will be displayed here as carousel.'); ?>" src="<?php echo base_url('assets/img/products/product-6.jpg') ?>">
                                        </span>
                                        <span class="block3">
                                 ...
                                 <?php 
                                   ...
                                   <div class="reminder_badge_warpper tab-pane fade active show" id="msg_checkout" role="tabpanel" aria-labelledby="msg_checkout_link>">
                                    <span class="reminder_badge" data-toggle="tooltip" title="<?php echo lang('Messenger Checkout'); ?>"><i class="fas fa-shopping-bag"></i></span>              
                                     <div class="reminder_block">
                                      <span class="block1">
                                        <textarea autofocus data-toggle="tooltip" title="<?php echo lang('Intro message will be displayed here, click to edit text.'); ?>"  name="msg_checkout_text" id="msg_checkout_text"><?php echo isset($messenger_content['checkout']['checkout_text']) ? $messenger_content['checkout']['checkout_text'] : $reminder_default['messenger']['checkout']['checkout_text'];?></textarea>
                                      </span> 
                                      <span class="block5">
                           ...
                           <div class="col-12 col-sm-12 col-md-6 col-lg-5">
                               <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                 ...
                                 { ?>                                 
                                   <li class="nav-item">
                                      <a href="#msg_reminder<?php echo $i;?>"  id="msg_reminder_link<?php echo $i;?>" class="nav-link" data-toggle="pill" role="tab" aria-controls="msg_reminder<?php echo $i;?>" aria-selected="true"><i class="fas fa-bell"></i> <?php echo lang('Messenger Reminder');?> #<?php echo $i;?></a> 
                                 ...
                                 ?>
                                 <li class="nav-item">                                  
                                  <a href="#msg_checkout"  id="msg_checkout_link" class="nav-link nav_cart active" data-toggle="pill" role="tab" aria-controls="msg_checkout" aria-selected="true"><i class="fas fa-shopping-bag"></i> <?php echo lang('Checkout Messenger');?></a> 
                                 </li>
                               </ul>
                           </div>
                         </div>
                    ...
                    <div class="row">
                               ...
                               for($i=1; $i <=$how_many_reminder; $i++)
                                   { ?>
                                     <div class="reminder_badge_warpper tab-pane fade" id="sms_reminder<?php echo $i;?>" role="tabpanel" aria-labelledby="sms_reminder_link>">
                                       ...
                                       <div class="reminder_block">
                                        <span class="block4">
                                          <textarea data-toggle="tooltip" title="<?php echo lang('SMS content goes here.');?>" name="sms_reminder_text_checkout[]" id="sms_reminder_text_checkout<?php echo $i;?>"><?php echo isset($sms_content['reminder'][$i]['reminder_text']) ? $sms_content['reminder'][$i]['reminder_text'] : $reminder_default['sms']['reminder']['reminder_text'];?></textarea>
                                        </span>
                                       </div>
                                   </div>
                                 <?php 
                                   ...
                                   <div class="reminder_badge_warpper tab-pane fade active show" id="sms_checkout" role="tabpanel" aria-labelledby="sms_checkout_link>">  
                                    <span class="reminder_badge" data-toggle="tooltip" title="<?php echo lang('SMS Checkout'); ?>"><i class="fas fa-shopping-bag"></i></span>                    
                                     <div class="reminder_block">
                                      <span class="block4">
                                        <textarea data-toggle="tooltip" title="<?php echo lang('SMS content goes here.'); ?>" name="sms_reminder_text_checkout_next" id="sms_reminder_text_checkout_next"><?php echo isset($sms_content['checkout']['checkout_text']) ? $sms_content['checkout']['checkout_text'] : $reminder_default['sms']['checkout']['checkout_text'];?></textarea>
                                      </span>
                                     </div>
                                 </div>
                           ...
                           <div class="col-12 col-sm-12 col-md-5">
                               <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                 ...
                                 { ?>                                 
                                   <li class="nav-item">
                                      <a href="#sms_reminder<?php echo $i;?>"  id="sms_reminder_link<?php echo $i;?>" class="nav-link" data-toggle="pill" role="tab" aria-controls="sms_reminder<?php echo $i;?>" aria-selected="true"><i class="fas fa-bell"></i> <?php echo lang('SMS Reminder');?> #<?php echo $i;?></a> 
                                 ...
                                 ?>
                                 <li class="nav-item">                                  
                                  <a href="#sms_checkout"  id="sms_checkout_link" class="nav-link nav_cart active" data-toggle="pill" role="tab" aria-controls="msg_checkout" aria-selected="true"><i class="fas fa-shopping-bag"></i> <?php echo lang('Checkout SMS');?></a> 
                                 </li>
                               </ul>
                           </div>
                          </div>
                        ...
                        <div class="tab-content" id="EmailReminderTabContent">
                             ...
                             for($i=1; $i <=$how_many_reminder; $i++)
                               { ?>
                                   <div class="reminder_badge_warpper tab-pane fade" style="border:none;padding: 0" id="email_reminder<?php echo $i;?>" role="tabpanel" aria-labelledby="email_reminder_link>">
                                       ...
                                       <textarea class="visual_editor" data-toggle="tooltip" title="<?php echo lang('Email content goes here.');?>" name="email_reminder_text_checkout[]" id="email_reminder_text_checkout<?php echo $i;?>"><?php echo isset($email_content['reminder'][$i]['reminder_text']) ? $email_content['reminder'][$i]['reminder_text'] : $reminder_default['email']['reminder']['reminder_text'];?></textarea>                                      
                                   </div>
                                 <?php 
                               } 
                               ?>
                              ...
                              <div class="reminder_badge_warpper tab-pane fade active show" style="border:none;padding: 0" id="email_checkout" role="tabpanel" aria-labelledby="email_checkout_link>">  
                                <span class="reminder_badge" data-toggle="tooltip" title="<?php echo lang('Email Checkout'); ?>"><i class="fas fa-shopping-bag"></i></span>                    
                                  <textarea class="visual_editor"  data-toggle="tooltip" title="<?php echo lang('Email content goes here.'); ?>" name="email_reminder_text_checkout_next" id="email_reminder_text_checkout_next"><?php echo isset($email_content['checkout']['checkout_text']) ? $email_content['checkout']['checkout_text'] : $reminder_default['email']['checkout']['checkout_text'];?></textarea>
                                </div>
                          ...
                          <div class="col-12 col-sm-12 col-md-5">
                            <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                               ...
                               { ?>                                 
                                  <li class="nav-item">
                                <a href="#email_reminder<?php echo $i;?>"  id="email_reminder_link<?php echo $i;?>" class="nav-link" data-toggle="pill" role="tab" aria-controls="email_reminder<?php echo $i;?>" aria-selected="true"><i class="fas fa-bell"></i> <?php echo lang('Email Reminder');?> #<?php echo $i;?></a> 
                               ...
                               ?>
                              <li class="nav-item">                                 
                                <a href="#email_checkout"  id="email_checkout_link" class="nav-link nav_cart active" data-toggle="pill" role="tab" aria-controls="msg_checkout" aria-selected="true"><i class="fas fa-shopping-bag"></i> <?php echo lang('Checkout Email');?></a> 
                              </li>
                            </ul>
                          </div>
                      </div>
        ...
        <div class="col-12">
          <div class="card no_shadow">
            <div class="card-footer p-0">  
              <button class="btn btn-lg btn-primary" id="get_button2" name="get_button2" type="button"><i class="fas fa-save"></i> <?php echo lang('Save');?></button>
              <button class="btn btn-lg btn-light float-right" onclick="ecommerceGoBack()" type="button"><i class="fas fa-times"></i> <?php echo lang('Cancel');?></button>
              </div>
          </div>
        </div>
      </div>
...
<script>
  ...
  var success_title = '<?php echo lang('Settings Updated'); ?>';
  ...
  {
    var mes='';
    mes="<?php echo lang('Do you really want restore default settings?');?>";
    swal({
      title: "<?php echo lang('Restore Default Settings');?>",
      text: mes,
      icon: "warning",
      buttons: true,
      dangerMode: true,

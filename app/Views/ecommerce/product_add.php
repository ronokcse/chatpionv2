<section class="section section_custom pt-1">
  <div class="section-header d-none">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><?php echo lang('Add Product'); ?></div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-12">
      ...
      <form class="form-horizontal" action="<?php echo site_url().'ecommerce/add_product_action';?>" method="POST">
        <input type="hidden" id="store_id" name="store_id" value="<?php echo session()->get('ecommerce_selected_store'); ?>">
          ...
          <div class="card-body p-0">
            ...
            <?php if(isset($is_ecommerce_related_product_addon_exist) && $is_ecommerce_related_product_addon_exist) : ?>
              <div class="row">
                <div class="col-12 col-md-4">
                  <div class="form-group">
                    <label for="name"> <?php echo lang('Related Products')?></label>
                ...
                <div class="col-12 col-md-4">
                  <div class="form-group">
                    <label for="name"> <?php echo lang('Upsell Product')?></label>
            ...
            <div class="row">
              <div class="col-12 col-md-4 d-none">
                <div class="form-group">
                  ...
                  <?php echo form_dropdown('', $store_list,session()->get('ecommerce_selected_store'),'disabled class="form-control select2"'); ?>
              ...
              <div class="col-12 col-md-8">
                <div class="form-group">
                  ...
                  <input name="product_video_id" value="<?php echo set_value('product_video_id');?>"  class="form-control" type="text" placeholder="<?php echo lang('Provide YouTube Video id'); ?>">
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label><?php echo lang('Featured  Images'); ?> 
                   <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo lang('Featured  Images'); ?>" data-content="<?php echo lang('Upto 3 images, Maximum: 1MB each, Format: JPG/PNG, Preference: Square image, Recommended dimension : 500x500'); ?>"><i class='fa fa-info-circle'></i> </a>
                  </label>
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    ?>
                    <input type="text" placeholder="<?php echo lang('example : 10 or 10-15');?>" name="preparation_time" class="form-control" value="<?php echo $system_preparation_time; ?>">

<section class="section section_custom">
  <div class="section-header d-none">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('ecommerce'); ?>"><?php echo lang('E-commerce'); ?></a></div>
      <div class="breadcrumb-item"><?php echo lang('Payment Accounts'); ?></div>
    </div>
  </div>

  <?php 
    if(session()->getFlashdata('success_message')==1)
    echo "<div class='alert alert-success text-center'><i class='fas fa-check-circle'></i> ".lang('Your data has been successfully stored into the database.')."</div><br>";
  ?>
      ...
      <div class="col-12">
          ...
          <div class="card no_shadow">
            <div class="card-body p-0">
                ...
                <div class="card">
                  <div class="card-header p-3" style="border:1px solid #e4e6fc;border-bottom: none;">
                    <h4><?php echo lang('Payment Integration'); ?></h4><hr>
                  </div>
                  <div class="card-footer p-3" style="border:1px solid #e4e6fc">
                    ...
                    <div class="row">
                      <div class="col-12 col-md-8">
                        <div class="form-group">
                            <label for=""><?php echo lang('Paypal Email');?> </label>
                      ...
                      <div class="col-12 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Paypal Sandbox Mode');?></label>
                          <br>
                          <?php 
                    ...
                    <div class="row">
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""> <?php echo lang('Stripe Secret Key');?></label>
                      ...
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Stripe Publishable Key');?></label>
                      ...
                      <div class="col-12 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Stripe billing address');?></label>
                          <br>
                          <?php 
                    ...
                    <div class="row">
                      <div class="col-6 col-md-4">
                        <div class="form-group mb-0">
                          <label for=""><?php echo lang('SenangPay Merchant Id');?></label>
                      ...
                      <div class="col-6 col-md-4">
                        <div class="form-group mb-0">
                          <label for=""><?php echo lang('SenangPay Secret Key');?></label>
                      ...
                      <div class="col-12 col-md-4">
                        <div class="form-group mb-0">
                          <label for=""><?php echo lang('SenangPay Sandbox Mode');?></label>
                          <br>
                          <?php 
                       ...
                       <div class="col-12">
                          <div class="form-group">
                            <?php $red_url = base_url('ecommerce/senangpay_action'); ?>
                              <small class="text-dark mt-2 d-block"><b><?php echo lang('Senangpay return url :'); ?></b> <?php echo "<span class='badge badge-danger p-1 pl-2 pr-2'>".$red_url."</span>";?> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo lang('Senangpay return url'); ?>" data-content="<?php echo lang('please put this redirect url in your senangpay profile`s return url field.'); ?>"><i class='fa fa-info-circle'></i> <?php echo lang('Details'); ?></a></small>
                          </div>
                       </div>
                    ...
                    <div class="row">
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Instamojo Private Api Key');?></label>
                      ...
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Instamojo Private Auth Token');?></label>
                      ...
                      <div class="col-12 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Instamojo Sandbox Mode');?></label>
                          <br>
                          <?php 
                    ...
                    <div class="row">
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""> <?php echo lang('Sslcommerz Store ID');?></label>
                      ...
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Sslcommerz Store Password');?></label>
                      ...
                      <div class="col-12 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Sslcommerz Sandbox Mode');?></label>
                          <br>
                          <?php 
                    ...
                    <div class="row">
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""> <?php echo lang('Mercado Pago Public Key');?></label>
                      ...
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Mercado Pago Acceess Token');?></label>
                      ...
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Mercadopago Country');?></label>                    
                    ...
                    <div class="row">
                      <div class="col-12 col-md-6">
                        <div class="form-group">
                          <label for=""> <?php echo lang('Mollie API Key');?></label>
                      ...
                      <div class="col-12 col-md-6">
                        <div class="form-group">
                          <label for=""><?php echo lang('Xendit Secret Api Key');?></label>
                    ...
                    <div class="row">
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Toyyibpay Secret Key');?></label>
                      ...
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Toyyibpay Category code');?></label>
                      ...
                      <div class="col-12 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Toyyibpay Sandbox Mode');?></label>
                          <br>
                          <?php 
                    ...
                    <div class="row">
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Paymaya Public Key');?></label>
                      ...
                      <div class="col-6 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Paymaya Secret Key');?></label>
                      ...
                      <div class="col-12 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Paymaya Sandbox Mode');?></label>
                          <br>
                          <?php 
                      ...
                      <div class="col-12 col-md-8">
                        <div class="form-group">
                          <label for=""><i class="fas fa-key"></i>  <?php echo lang('Myfatoorah Api Key');?>
                          <a href="#" data-placement="top" data-toggle="popover" title="" data-content="Myfatoorah only Supports KWD, SAR, BHD, AED, QAR, OMR, JOD, EGP  Currency" data-original-title="<?php echo lang('Myfatoorah Supported Currency');  ?>" ><i class="fa fa-info-circle"></i> </a>
                        </label>
                      ...
                      <div class="col-12 col-md-4">
                        <div class="form-group">
                          <label for=""><?php echo lang('Myfatoorah Sandbox Mode');?></label>
                          <br>
                          <?php 
                    ...
                    <div class="row">
                      <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""> <?php echo lang('Razorpay Key ID');?></label>
                      ...
                      <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""><?php echo lang('Razorpay Key Secret');?></label>
                    ...
                    <div class="row">
                      <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""> <?php echo lang('Paystack Secret Key');?></label>
                      ...
                      <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""><?php echo lang('Paystack Public Key');?></label>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="form-group mb-0">
                          <label type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" class="pointer text-primary" style="font-size: 14px"><b><i class="fa fa-newspaper"></i> <?php echo lang('Write Manual payment instructions'); ?></b></label>
                ...
                <div class="card" id="payment_options">
                    <div class="card-header p-3"  style="border:1px solid #e4e6fc;border-bottom: none;">
                      <h4><?php echo lang('Payment Options'); ?></h4><hr>
                    </div>
                    <div class="card-footer p-3" style="border:1px solid #e4e6fc;">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>
                              <?php echo lang('Razorpay checkout'); ?> *
                            </label>
                            <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                              <label>
                                <?php echo lang('Paystack checkout'); ?> *
                              </label>
                              <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                              <label>
                                <?php echo lang('Mercado Pago checkout'); ?> *
                              </label>
                              <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                              <label>
                                <?php echo lang('Sslcommerz checkout'); ?> *
                              </label>
                              <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                              <label>
                                <?php echo lang('Senangpay checkout'); ?> *
                              </label>
                              <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                              <label>
                                <?php echo lang('Instamojo checkout'); ?> *
                              </label>
                              <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                       ...
                       <div class="col-12 col-md-3">
                        <div class="form-group">
                          <label>
                            <?php echo lang('Myfatoorah checkout'); ?> *
                          </label>
                          <div class="selectgroup w-100">
                            <label class="selectgroup-item">
                       ...
                       <div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>
                              <?php echo lang('Toyyibpay checkout'); ?> *
                            </label>
                            <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                        ...
                        <div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>
                              <?php echo lang('Paymaya checkout'); ?> *
                            </label>
                            <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                       ...
                       <?php if($xdata2['store_type'] == 'physical') : ?>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                              <label>
                                <?php echo lang('Cash on delivery'); ?> *
                              </label>
                              <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                ...
                <div class="card">
                    <div class="card-header p-3"  style="border:1px solid #e4e6fc;border-bottom: none;">
                      <h4><?php echo lang('Currency & Formatting'); ?></h4><hr>
                    </div>
                    <div class="card-footer p-3" style="border:1px solid #e4e6fc;">
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group">
                            <label for=""><i class="fas fa-coins"></i>  <?php echo lang('Currency');?></label>
                        ...
                        <div class="col-12 col-md-4">   
                          <div class="form-group">                       
                            <label for="">
                              <?php echo lang('Right Alignment');?>
                              <a href="#" data-placement="top" data-toggle="tooltip" title="<?php echo lang('Right alignment could be helpful for several currencies. Example display : 25৳');?>"><i class="fa fa-info-circle"></i> </a>
                          </label>
                            <br>
                            <?php 
                        ...
                        <div class="col-12 col-md-4">
                          <div class="form-group">
                           <label for="">
                            <?php echo lang('Two Decimal');?>
                            <a href="#" data-placement="top" data-toggle="tooltip" title="<?php echo lang('If enabled prices will be displayed with two decimal points. Example display : $25.99');?>"><i class="fa fa-info-circle"></i> </a>
                           </label>
                           <?php 
                        ...
                        <div class="col-12 col-md-4">
                          <div class="form-group">
                            <label for="">
                              <?php echo lang('Display Comma');?>
                              <a href="#" data-placement="top" data-toggle="tooltip" title="<?php echo lang('If enabled prices will be displayed comma separated. Example display : $25,000');?>"><i class="fa fa-info-circle"></i> </a>
                ...
                <div class="card">
                    <div class="card-header p-3"  style="border:1px solid #e4e6fc;border-bottom: none;">
                      <h4><?php echo lang('Tax & Delivery Charge'); ?></h4><hr>
                    </div>
                    <div class="card-footer p-3" style="border:1px solid #e4e6fc;">
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-header p-3"  style="border:1px solid #e4e6fc;border-bottom: none;">
                      <h4><?php echo lang('Delivery Preference'); ?></h4><hr>
                    </div>
                    <div class="card-footer p-3" style="border:1px solid #e4e6fc;">
                      <div class="row">
                        <div class="col-6 col-md-4">
                          <div class="form-group">
                            <label for=""><?php echo lang('Store Pickup');?></label>
                            <br>
                            <?php 
                        ...
                        <div class="col-6 col-md-4">
                          <div class="form-group">
                            <label for=""><?php echo lang('Home Delivery');?></label>
                            <br>
                            <?php 
                      ...
                      <div class="row">                        
                        <div class="col-12 col-md-4">
                          <div class="form-group mb-2">
                            <label for=""><?php echo lang('Preparation time');?></label>
                            <br>
                            <?php 
                        ...
                        <div class="col-12 col-md-8">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <span class="input-group-text"><?php echo lang('Time'); ?></span>
                              </div>
                              <?php
                              ...
                              ?>
                              <input type="text" placeholder="<?php echo lang('example : 10 or 10-15');?>" <?php echo $disabled; ?> name="preparation_time" class="form-control" value="<?php echo isset($xvalue['preparation_time'])?$xvalue['preparation_time']:"30" ?>">
                        ...
                        <div class="col-6 col-md-4">
                          <div class="form-group mb-2">
                            <label for=""><?php echo lang('Scheduled order');?></label>
                            <br>
                            <?php 
                        ...
                        <div class="col-6 col-md-8">
                          <div class="form-group">
                            ...
                            <?php
                              ...
                              $arr = array
                              (
                                'today'=>lang('Only Today'),
                                'tomorrow'=>lang('Today & Tomorrow'),
                                'week'=>lang('One Week'),
                                'any'=>lang('Any')
                              );
                              ?>
                ...
                <div class="card">
                    <div class="card-header p-3"  style="border:1px solid #e4e6fc;border-bottom: none;">
                      <h4><?php echo lang('Login Preference'); ?></h4><hr>
                    </div>
                    <div class="card-footer p-3" style="border:1px solid #e4e6fc;">
                      <div class="row">
                        <div class="col-12 col-md-4">
                          <div class="form-group mb-2">
                            <label for=""><?php echo lang('Guest Purchase');?></label>
                            <br>
                            <?php 
                ...
                <div class="card <?php if($xdata2['page_id'] == 0) echo 'd-none'; ?>">
                    <div class="card-header p-3"  style="border:1px solid #e4e6fc;border-bottom: none;">
                      <h4><?php echo lang('Assign Labels'); ?></h4><hr>
                    </div>
                    <div class="card-footer p-3" style="border:1px solid #e4e6fc;">
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group mb-2">
                            <label for=""><?php echo lang('Choose Labels (Labels will be assigned to the subscribers after successfull checkout.)');?></label>
                ...
                <div class="card">
                    <div class="card-header p-3"  style="border:1px solid #e4e6fc;border-bottom: none;">
                      <h4><?php echo lang('Address Preference'); ?></h4><hr>
                    </div>
                    <div class="card-footer p-3" style="border:1px solid #e4e6fc;">
                      <div class="row">                        
                        <div class="col-6 col-md-4">
                          <div class="form-group">
                            <label for=""><?php echo lang('Checkout Country');?></label>
                            <br>
                            <?php 
                        ...
                        <div class="col-6 col-md-4">
                          <div class="form-group">
                            <label for=""><?php echo lang('Checkout State');?></label>
                            <br>
                            <?php 
                        ...
                        <div class="col-6 col-md-4">
                          <div class="form-group">
                            <label for=""><?php echo lang('Checkout City');?></label>
                            <br>
                            <?php 
                        ...
                        <div class="col-6 col-md-4">
                          <div class="form-group">
                            <label for=""><?php echo lang('Checkout Zip');?></label>
                            <br>
                            <?php 
                        ...
                        <div class="col-6 col-md-4">
                          <div class="form-group">
                            <label for=""><?php echo lang('Checkout Email');?></label>
                            <br>
                            <?php 
                        ...
                        <div class="col-6 col-md-4">
                          <div class="form-group">
                            <label for=""><?php echo lang('Checkout Phone');?></label>
                            <br>
                            <?php 
                        ...
                        <div class="col-6 col-md-4">
                          <div class="form-group">
                            <label for=""><?php echo lang('Delivery Note');?></label>
                            <br>
                            <?php 
            ...
            <div class="card-footer p-0">
              ...
              <?php 
              if(session()->getFlashdata('error_message')==1)
              echo "<div class='alert alert-danger text-center'><i class='fas fa-times-circle'></i> ".lang('You must select at least one checkout payment option.')."</div><br>";
              ?>
              <?php 
              if(session()->getFlashdata('error_message2')==1)
              echo "<div class='alert alert-danger text-center'><i class='fas fa-times-circle'></i> ".lang('You cannot disable both store pickup and home delivery.')."</div><br>";
              ?>

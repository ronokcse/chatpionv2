<section class="section section_custom pt-1">
  <div class="section-header d-none">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><?php echo lang('Orders'); ?></div>
    </div>
  </div>
          ...
          <div class="card-body data-card p-0 pr-3">
            <div class="row">
              <div class="col-12 col-md-8">
                ...
                '<div class="input-group mb-3" id="searchbox">
                  <div class="input-group-prepend d-none">
                    '.form_dropdown('search_store_id',$store_list,session()->get('ecommerce_selected_store'),'class="form-control select2" id="search_store_id"').'
                  </div>
                  <div class="input-group-prepend">
                    '.form_dropdown('search_status',$status_list,'','class="form-control select2" id="search_status"').'
                  </div>
                  <input type="text" class="form-control" id="search_value" autofocus name="search_value" placeholder="'.lang('Search...').'" style="max-width:300px;">
              ...
              <div class="col-12 col-md-4 d-none d-sm-block">
              	<?php
  			          echo $drop_menu ='<a href="javascript:;" id="search_date_range" class="btn btn-outline-primary btn-lg float-right icon-left btn-icon"><i class="fas fa-calendar"></i> '.lang('Choose Date').'</a><input type="hidden" id="search_date_range_val">';
  			        ?>                                         
              </div>
              <div class="col-12 text-left">
                <?php
                  echo '<a href="'.base_url("ecommerce/download_csv").'" target="_BLANK" class="btn btn-outline-primary btn-lg float-right"><i class="fas fa-file-csv"></i> '.lang('Download').'</a>';
                ?>                                         
              </div>
            </div>
                ...
                <table class="table table-bordered" id="mytable">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo lang('Manual Payment')?></th>                                      
          ...
          $.ajax({
              ...
              { 
                  ...
                  if(response.status == '1')
                  {
                    ...
                    swal({ title:'<?php echo lang('Order Status Updated'); ?>', content:span,icon:'success'});
                  }
                  else
                  {
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fas fa-file-invoice-dollar"></i> <?php echo lang('Manual Payment Information');?></h5>
...
<div class="modal fade" id="change_payment_status_modal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-mega" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><?php echo lang('Update Order Status');?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <label><?php echo lang('Additional Note'); ?> (<?php echo lang('Optional'); ?>)</label>
      ...
      <div class="modal-footer bg-whitesmoke br"> 
        <button type="button" class="btn btn-primary btn-lg" id="change_payment_status_submit"><i class="fas fa-paper-plane"></i> <?php echo lang('Submit'); ?></button>

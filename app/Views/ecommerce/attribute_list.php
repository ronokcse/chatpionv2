<section class="section section_custom pt-1">
  <div class="section-header d-none">
    ...
    <div class="section-header-button">
        <a class="btn btn-primary" href="#" id="add_new_row"><i class="fas fa-plus-circle"></i> <?php echo lang('Add Attribute'); ?></a>
    </div>
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><?php echo lang('Attributes'); ?></div>
    </div>
  </div>
...
<?php $drop_menu = '<a class="btn btn-primary float-right btn-lg" href="#" id="add_new_row"><i class="fas fa-plus-circle"></i> '.lang('Add').'</a>';?>
<script>       
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '#save_row', function(event) {
        ...
        if(store_id == "")
        {
            swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Store is required'); ?>', 'warning');
            return;
        }

        if(attribute_name == "")
        {
            swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Attribute name is required'); ?>', 'warning');
            return;
        }

        if(attribute_values == "")
        {
            swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Attribute value is required'); ?>', 'warning');
            return;
        }        
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center blue">
                    <i class="fas fa-plus-circle"></i> <?php echo lang('New Attribute')." : ".session()->get('ecommerce_selected_store_title'); ?>
                </h5>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                      ...
                                      <?php echo form_dropdown('', $store_list,session()->get('ecommerce_selected_store'),'style="width:100%" disabled class="form-control select2"'); ?>
                                    </div>
                                </div>

                                <div class="col-12">
                                    <div class="form-group">
                                        <label><?php echo lang('Attribute Name'); ?> *</label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label><?php echo lang('Attribute Values'); ?> * (<?php echo lang('comma separated'); ?>)</label>
                                  ...
                                  <div class="form-group">
                                    <label class="custom-switch mt-2">
                                      ...
                                      <span class="custom-switch-description">
                                        <?php echo lang('Multi-select');?>
                                        <a href="#" class="d-inline" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo lang('Multi-select') ?>" data-content='<?php echo lang('If enabled, buyer can select multiple values for this attribute.') ?>'><i class='fas fa-info-circle'></i> </a>
                                      </span>
                                    </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-4">
                                  <div class="form-group">
                                    <label class="custom-switch mt-2">
                                      ...
                                      <span class="custom-switch-indicator"></span>
                                      <span class="custom-switch-description">
                                        <?php echo lang('Optional');?></span>
                                        <a href="#" class="d-inline" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo lang('Optional') ?>" data-content='<?php echo lang('If enabled, buyer can skip selecting this attribute.') ?>'><i class='fas fa-info-circle'></i> </a>
                                    </label>
                                    </div>
                                </div>
            ...
            <div class="modal-footer bg-whitesmoke">
                <div class="col-12 padding-0">
                    <button class="btn btn-primary btn-lg" id="save_row" name="save_row" type="button"><i class="fas fa-save"></i> <?php echo lang('Save') ?> </button>
                    <a class="btn btn-light btn-lg float-right" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i> <?php echo lang('Cancel') ?> </a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-mega">
        <div class="modal-content">
            <div class="modal-header bbw">
                <h5 class="modal-title text-center blue">
                    <i class="fas fa-edit"></i> <?php echo lang('Edit Attribute')." : ".session()->get('ecommerce_selected_store_title'); ?>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer bg-whitesmoke">
                <div class="col-12 padding-0">
                    <button class="btn btn-primary btn-lg" id="update_row" name="update_row" type="button"><i class="fas fa-save"></i> <?php echo lang('Save'); ?></button>
                    <a class="btn btn-light btn-lg float-right" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i> <?php echo lang('Cancel'); ?></a>
                </div>
            </div>
        </div>

<section class="section section_custom pt-1">
  ...
  <div class="section-header d-none">
    ...
    <div class="section-header-button">
      <a href="<?php echo base_url('ecommerce/add_product'); ?>" class="btn btn-primary"><i class="fas fa-plus-circle"></i> <?php echo lang('Add Product'); ?></a>
    </div>
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><?php echo lang('Product'); ?></div>
    </div>
  </div>
          ...
          <div class="card-body data-card p-0 pt-1 pr-3">
            <div class="row">
              ...
              <div class="col-5 col-md-3">             
                <a href="<?php echo base_url('ecommerce/add_product'); ?>" class="btn btn-lg btn-primary float-right"><i class="fas fa-plus-circle"></i> <?php echo lang('Add'); ?></a>                                 
              </div>

              <div class="col-12 d-none">
                <?php
                echo $drop_menu ='<a href="javascript:;" id="search_date_range" class="btn btn-lg btn-outline-primary float-right icon-left btn-icon"><i class="fas fa-calendar"></i> '.lang('Choose Date').'</a><input type="hidden" id="search_date_range_val">';
                ?>                                      
              </div>
            </div>
...
<script>
	...
	$("document").ready(function(){	   
	    ...
	    $(document).on('change', '#search_date_range_val', function(e) {
      	...
      	var Doyouwanttodeletethisrecordfromdatabase = "<?php echo lang('Do you want to detete this products? Deleting product does not affect existing orders.'); ?>";

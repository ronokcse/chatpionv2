...
'<li class="list-group-item d-flex justify-content-between align-items-center no_border text-muted pl-3 pr-3 pt-1 pb-1">
  '.lang('Discount').'<span class="font-weight-bold text-dark">-'.$currency_left.mec_number_format($coupon_amount,$decimal_point,$thousand_comma).$currency_right.'</span>
</li>';
...
$tax_info =
'<li class="list-group-item d-flex justify-content-between align-items-center no_border text-muted pl-3 pr-3 pt-1 pb-1">
  '.lang('Tax').'<span class="font-weight-bold text-dark">+'.$currency_left.mec_number_format($total_tax,$decimal_point,$thousand_comma).$currency_right.'</span>
</li>';
...
$shipping_info =
'<li class="list-group-item d-flex justify-content-between align-items-center no_border text-muted pl-3 pr-3 pt-1 pb-1">
  '.lang('Delivery Charge').'<span class="font-weight-bold text-dark">+'.$currency_left.mec_number_format($shipping_cost,$decimal_point,$thousand_comma).$currency_right.'</span>
</li>';
...
'<li class="list-group-item d-flex justify-content-between align-items-center no_radius no_border pl-3 pr-3 pt-1 pb-1">
  '.lang('Total').'<span class="font-weight-bold text-primary">'.$currency_left.$checkout_amount.$currency_right.'</span>
</li>';

$apply_coupon = '
<a class="collpase_link float-left text-dark" data-toggle="collapse" href="#collapsecoupon" role="button" aria-expanded="false" aria-controls="collapsecoupon"><i class="fas fa-gift ml-0"></i> '.lang('Apply Coupon').'</a>
<a class="float-right text-dark" id="showProfile" href="#"><i class="fas fa-map-marker-alt"></i> '.lang('Billing Address').'</a> 
<div class="input-group collapse pt-2" id="collapsecoupon">
  <input type="text" class="form-control" id="coupon_code" name="coupon_code" style="height:50px;" placeholder="'.lang('Coupon Code').'" value="'.$coupon_code.'">
  <div class="input-group-append">
    <button class="btn btn-primary" style="height:50px;" type="button" id="apply_coupon"><i class="fas fa-check-circle"></i> '.lang('Apply').'</button>
  </div>
</div>';
...
<div class="invoice p-0 pt-2 no_shadow bg-light">
  ...
  <div class="invoice-print"> 
    <di class="section"><div class="section-title mt-0 mb-2"><?php echo lang('Cart'); ?><span class="float-right"><?php echo date("jS M,Y"); ?></span></div></di>
    <?php echo $table_data;?>
    <div class="row">      
      ...
      <ul class="list-group w-100 bordered <?php if($webhook_data_final['store_type'] == "digital") echo "mb-3"; ?>">
        <li class="list-group-item d-flex justify-content-between align-items-center no_border text-muted pl-3 pr-3 pt-1 pb-1">
          <?php echo lang('Subtotal');?><span class="font-weight-bold text-dark"><?php echo $currency_left.$subtotal.$currency_right;?></span>
        </li>
    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        <a href="#" id="proceed_checkout" class="btn btn-lg btn-primary btn-block btn-lg pt-3 pb-3"><i class="fas fa-credit-card"></i> <?php echo lang('Proceed Checkout'); ?></a> 
      </div>
    </div>

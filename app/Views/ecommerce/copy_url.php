...
{
   $store_code[] = array("title"=>lang('Store Page')." - ".lang('Category')." : ".$value,"url"=>base_url("ecommerce/store/".$current_store_data['store_unique_id']."?category=".$key));
}
$product_list_assoc = array();                         
foreach ($product_list as $key => $value) 
{
  $product_copy[] = array("title"=>lang('Product Page')." : ".$value["product_name"],"url"=>base_url("ecommerce/product/".$value['id']));  
}
?>
  ...
  <div class="section-body">
    <div class="modal-body">
      <ul class="nav nav-tabs" id="myTab2" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" id="profile-tab2" data-toggle="tab" href="#profile2" role="tab" aria-controls="profile" aria-selected="false"><?php echo lang('Order URL'); ?></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" id="legal-tab2" data-toggle="tab" href="#legal2" role="tab" aria-controls="legal" aria-selected="false"><?php echo lang('Legal URL'); ?></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="embed-tab2" data-toggle="tab" href="#embed2" role="tab" aria-controls="embed" aria-selected="false"><?php echo lang('Widget'); ?></a>
        </li>
      </ul>
           ...
           <div class="card">
            <div class="card-header">
              <h4><i class="fas fa-circle"></i>
                ...
                <a href="<?php echo $legal_url1;?>" target="_BLANK"><?php echo lang('Terms of service');?></a>
              </h4>
            </div>
            <div class="card-body">
          ...
          <div class="card">
            <div class="card-header">
              <h4><i class="fas fa-circle"></i>
                ...
                <a href="<?php echo $legal_url2;?>" target="_BLANK"><?php echo lang('Refund policy');?></a>
              </h4>
            </div>
            <div class="card-body">
           ...
           <div class="card">
            <div class="card-header">
              <h4><i class="fas fa-circle"></i>
                ...
                <a href="<?php echo $embed_url;?>" target="_BLANK"><?php echo lang('Embed Code');?></a>
              </h4>
            </div>
            <div class="card-body">

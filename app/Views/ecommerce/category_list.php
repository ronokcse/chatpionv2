<section class="section section_custom pt-1">
  <div class="section-header d-none">
    ...
    <div class="section-header-button">
        <a class="btn btn-primary" href="#" id="add_new_row"><i class="fas fa-plus-circle"></i> <?php echo lang('Add Category'); ?></a>
    </div>
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><?php echo lang('Category'); ?></div>
    </div>
  </div>
...
<?php $drop_menu = '<a class="btn btn-primary float-right btn-lg ml-1" href="#" id="add_new_row"><i class="fas fa-plus-circle"></i> '.lang('Add').'</a> <a class="btn btn-outline-primary float-right btn-lg" href=""  data-toggle="modal" data-target="#sort_modal"><i class="fas fa-sort"></i> '.lang('Sort').'</a> ';?>
<script>       
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '#save_row', function(event) {
        ...
        if(category_name == "")
        {
            swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Category name is required'); ?>', 'warning');
            return;
        }      
        ...
        <div class="modal-content">
            <div class="modal-header bbw">
                <h5 class="modal-title text-center blue">
                    <i class="fas fa-plus-circle"></i> <?php echo lang('New Category')." : ".session()->get('ecommerce_selected_store_title'); ?>
                </h5>
                                ...
                                <div class="col-12">
                                  <div class="form-group">
                                    <label><?php echo lang('Thumbnail'); ?> 
                                     <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo lang('Thumbnail'); ?>" data-content="<?php echo lang('Maximum: 500KB, Format: JPG/PNG, Preference: Square image, Recommended dimension : 100x100'); ?>"><i class='fa fa-info-circle'></i> </a>
                                    </label>
            ...
            <div class="modal-footer bg-whitesmoke">
                <div class="col-12 padding-0">
                    ...
                    <a class="btn btn-light float-right btn-lg" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i> <?php echo lang('Cancel') ?> </a>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="update_row_form_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bbw">
                <h5 class="modal-title text-center blue">
                    <i class="fas fa-edit"></i> <?php echo lang('Edit Category')." : ".session()->get('ecommerce_selected_store_title'); ?>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="sort_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bbw">
                <h5 class="modal-title text-center blue">
                    <i class="fas fa-sort"></i> <?php echo lang('Sort Category'); ?>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer bg-whitesmoke">
                <div class="col-12 padding-0">
                    <button class="btn btn-primary btn-lg" id="sort_cat" name="sort_cat" type="button"><i class="fas fa-save"></i> <?php echo lang('Save'); ?></button>
                    <a class="btn btn-light float-right btn-lg" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i> <?php echo lang('Cancel'); ?></a>
                </div>
            </div>
        </div>
    ...
    $(document).on('click','#sort_cat',function(e){
        ...
        $.ajax({
          ...
          success: function(response)
          {
             ...
             else swal("<?php echo lang('Success'); ?>", response.message, 'success').then((value) => {location.reload();});
          }
        });
    });

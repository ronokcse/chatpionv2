							...
							<div class="tab-content tab-bordered">
							  ...
							  <div class="tab-pane fade show active" id="messenger_tab" role="tabpanel" aria-labelledby="messenger_link">
							   ...
							   <div class="row">				                
				                 <div class="col-12 col-sm-12 col-md-6 col-lg-7">
				                 	<?php echo lang('Messenger Notification'); ?>
					                         ...
					                         <div class="reminder_badge_warpper tab-pane fade  <?php if($i==1) echo 'active show';?>" id="msg_reminder<?php echo $i;?>" role="tabpanel" aria-labelledby="msg_reminder_link>">
						                         ...
						                         <div class="reminder_block">
						                         	<span class="block4">
						                         		...
						                         		<p>
						                         		<input data-toggle="tooltip" title="<?php echo lang('Buyer can see his/her order list clicking this button. Click to edit button name.'); ?>" value="<?php echo isset($notification_message['messenger'][$value]['btn']) ? $notification_message['messenger'][$value]['btn'] : 'MY ORDERS'; ?>" class="btn btn-block bg-white" name="msg_btn[]" id="msg_btn_<?php echo $value;?>"/>
						                         		</p>
						                         	</span>
						                         </div>
						                     </div>
							  ...
							  <div class="tab-pane fade" id="sms_tab" role="tabpanel" aria-labelledby="sms_link">
				                 ...
				                 <div class="col-12 col-sm-12 col-md-7">
				                 	<?php echo lang('SMS Notification'); ?>
				                    ...
				                    <div class="form-group">
				                    	<div class="label"><?php echo lang('SMS Sender'); ?> <i class="fas fa-info-circle" data-toggle="tooltip" title="<?php echo lang('SMS settings will not be stored and no sms will be sent if sender is not selected. If selected but not provided other details then system will send default notification.');?>"></i></div>
							      ...
							      <div class="col-12 col-sm-12 col-md-7">
				                      ...
				                      <div class="row">
				                      	<div class="col-12 col-md-6">
				                      		  <div class="form-group">
				                      			<div class="label"><?php echo lang('Email Sender'); ?> <i class="fas fa-info-circle" data-toggle="tooltip" title="<?php echo lang('Email settings will not be stored and no email will be sent if sender is not selected. If selected but not provided other details then system will send default notification.');?>"></i></div>
				...
				<div class="col-12">
					<div class="card no_shadow">
						<div class="card-footer p-0">  
							<button class="btn btn-lg btn-primary" id="get_button" name="get_button" type="button"><i class="fas fa-save"></i> <?php echo lang('Save');?></button>

<section class="section section_custom pt-1">
  <div class="section-header d-none">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('ecommerce/coupon_list'); ?>"><?php echo lang('Coupon'); ?></a></div>
      <div class="breadcrumb-item"><?php echo lang('Add Coupon'); ?></div>
    </div>
  </div>
        ...
        <div class="card no_shadow">
          <div class="card-body p-0">
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label for="name"> <?php echo lang('Products')?> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo lang('Products'); ?>" data-content="<?php echo lang('Choose products you want to apply this coupon, selecting no product means it will apply for all.'); ?>"><i class='fa fa-info-circle'></i> </a></label>
                  <div id="product_con">
            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  <label for="coupon_type" > <?php echo lang('Coupon Type');?> *</label>
             ...
             <div class="row">
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label for="coupon_code"> <?php echo lang('Coupon Code')?> *</label>
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label for="coupon_amount"><?php echo lang('Coupon Amount')?> *</label>              
            ...
            <div class="row" id="hidden">              
              <div class="col-12 col-md-6">
                ...
                ?>
                <div class="form-group">
                  <label for="expiry_date"> <?php echo lang('Expiry Date')?> *</label>
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label for="max_usage_limit"><?php echo lang('Max Usage Limit')?> </label>              
            ...
            <div class="row">             
              <div class="col-6">
               ...
               <div class="col-6">
                <div class="form-group">
                  <label for="free_shipping_enabled" > <?php echo lang('Free Shipping?');?></label><br>
                  <label class="custom-switch mt-2">
                    <input type="checkbox" name="free_shipping_enabled" value="1" class="custom-switch-input" <?php echo $checked3; ?>>
                    <span class="custom-switch-indicator"></span>
                    <span class="custom-switch-description"><?php echo lang('Enabled');?></span>
          ...
          <div class="card-footer p-0">
            ...
            <button  type="button" class="btn btn-secondary btn-lg float-right" onclick='goBack("ecommerce/coupon_list",0)'><i class="fa fa-remove"></i> <?php echo lang('Cancel');?></button>
          </div>
        </div>
      </form>  
    </div>

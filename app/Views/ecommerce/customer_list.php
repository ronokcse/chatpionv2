          ...
          <div class="card-body data-card p-0">
            <div class="row">
              ...
              <div class="col-12 col-md-2">
                  <a class="btn btn-outline-primary btn-lg float-right mr-1" href="<?php echo base_url('ecommerce/download_result'); ?>"><i class="fas fa-cloud-download-alt"></i> <?php echo lang('Download'); ?></a>                          
              </div>
            </div>
                ...
                <table class="table table-bordered" id="mytable">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo lang('Subscribed at'); ?></th>
                    </tr>
                  </thead>
                </table>
            </div>
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-key"></i> <?php echo lang('Change Password');?></h5>
            ...
            <div class="modal-body">  
              <form class="form-horizontal" action="" method="POST">
                ...
                <div class="form-group">
                  <label for="password"><?php echo lang('Email'); ?> *  </label>   

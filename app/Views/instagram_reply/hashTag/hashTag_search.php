...
<section class="section section_custom">
	<div class="section-header">
		...
		<div class="section-header-breadcrumb">
			<div class="breadcrumb-item"><a href="<?php echo base_url("instagram_reply") ?>"><?php echo lang('Instagram Reply');?></a></div>
						...
						<div class="form-group">
							<div class="form-group">
								<div class="input-group">
									...
									<input type="text" class="form-control" id="hash_tag" name="hash_tag" placeholder="<?php echo lang('Provide hash tag'); ?>">
									<div class="input-group-append">
										<button class="btn btn-primary" id="search_hashtag"><i class="fas fa-search"></i> <?php echo lang('Search'); ?></button>
									</div>
								</div>
							</div>
						</div>

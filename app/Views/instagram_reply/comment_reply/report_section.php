<section class="section">
 <div class="section-header">
   ...
   <div class="section-header-breadcrumb">
     ...
     <div class="breadcrumb-item"><?php echo lang('Instagram Reply');?></div>
      ...
      <div class="wizard-steps mb-4 mt-1">
        <a href="<?php echo base_url("instagram_reply/instagram_autoreply_report/full?media_type=".$this->using_media_type); ?>" class="no_hover">
          <div class="wizard-step wizard-step-light">
            ...
            <div class="wizard-step-label">
              <?php echo lang('Full Account Reply Reports'); ?>
            </div>
            <p class="text-muted mt-3"><?php echo lang('Report of Posts comment reply of Instagram Full Account.'); ?></p>       
          </div>
        </a>
      </div>
 		</div>

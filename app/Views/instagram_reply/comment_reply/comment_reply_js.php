<script>
	...
	$(document).ready(function($) {
		...
		$(document).on('click', '.enable_auto_commnet', function () {
		    ...
		    var Pleaseprovidepostid = "<?php echo lang('Please provide Post ID'); ?>";
		...
		$(document).on('click', '#save_button', function () {
		    ...
		    else if(use_template == 'yes') 
		    {
		    	...
		    	{
		    		var Youdidntselectanytemplate = "<?php echo lang('you have not select any template.'); ?>";
		...
		$(document).on('click','.pause_campaign_info',function(e){
			...
			swal({
			    ...
			    text: '<?php echo lang('Do you really want to'); ?> '+to_do+' <?php echo lang('this campaign?'); ?>',
			    icon: 'warning',
			    buttons: true,
			    dangerMode: true,
			})
		...
		$(document).on('click','.delete_full_campaign',function(e){
		    ...
		    swal({
		        title: '<?php echo lang('Are you sure?'); ?>',
		        text: '<?php echo lang('Do you want to delete Full Account Campaign for the account?'); ?>',
		        icon: 'warning',
		        buttons: true,
		        dangerMode: true,
		    })
		        ...
		        if (willDelete) 
		        {
		            ...
		            $.ajax({
		                ...
		                success:function(response){ 
		                    ...
		                    if (response == "1") {
		                    	swal('<?php echo lang('Success'); ?>', '<?php echo lang('Full Account Campaign has been successfully deleted.'); ?>', 'success').then((value) => {
		                    		  $(".page_list_item.active").click();
		                    	});
		                    }
		                    else {
		                        swal('<?php echo lang('Error'); ?>', '<?php echo lang('Something went wrong, please try once again. '); ?>', 'error');
		                    }
		                }
		            });
		        } 
			    ...
			    if (willDelete) 
			    {
			        ...
			        $.ajax({
			            ...
			            success:function(response){ 
			                ...
			                if (response == "1") {
			                	swal('<?php echo lang('Success'); ?>', '<?php echo lang('Camapaign Status hase been updated successfully.'); ?>', 'success').then((value) => {
			                		  $(".page_list_item.active").click();
			                	});
			                }
			                else {
		...
		$(document).on('click','.delete_mentions_campaign',function(e){
		    ...
		    swal({
		        title: '<?php echo lang('Are you sure?'); ?>',
		        text: '<?php echo lang('Do you want to delete mentions Account Campaign for the account?'); ?>',
		        icon: 'warning',
		        buttons: true,
		        dangerMode: true,
		    })
		        ...
		        if (willDelete) 
		        {
		            ...
		            $.ajax({
		                ...
		                success:function(response){ 
		                    ...
		                    if (response == "1") {
		                    	swal('<?php echo lang('Success'); ?>', '<?php echo lang('mentions Account Campaign has been successfully deleted.'); ?>', 'success').then((value) => {
		                    		  $(".page_list_item.active").click();
		                    	});
		                    }
		                    else {
		...
		$(document).on('click', '.media_insights', function(event) {
			...
			if(typeof(post_id) === 'undefined' || post_id == "") {
				swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Please Provide Post ID'); ?>', 'warning');
				return false;
			}
		...
		$(document).on('click','.delete_full_mention_report',function(e){
		    ...
		    swal({
		        title: '<?php echo lang('Are you sure?'); ?>',
		        text: '<?php echo lang('Do you really want to delete this Campaign? If you delete this all of your post report will be deleted.'); ?>',
		        icon: 'warning',
		        buttons: true,
		        dangerMode: true,
		    })
		        ...
		        if (willDelete) 
		        {
		            ...
		            $.ajax({
		                ...
		                success:function(response){ 
		                    ...
		                    if (response == "1") {
		                    	swal('<?php echo lang('Success'); ?>', '<?php echo lang('Campaign Reports has been successfully deleted.'); ?>', 'success');
		                    	report_table.draw();
		                    }
		                    else {
		                        swal('<?php echo lang('Error'); ?>', '<?php echo lang('Something went wrong, please try once again. '); ?>', 'error');
		...
		$(document).on('click','.enable_disable_comments',function(e){
			...
			swal({
			    title: '<?php echo lang('Are you sure?'); ?>',
			    text: '<?php echo lang('Do you really want to'); ?> '+to_do+' <?php echo lang('comments for this post on Instagram?'); ?>',
			    icon: 'warning',
			    buttons: true,
			    dangerMode: true,
			})
			        ...
			        $.ajax({
			            ...
			            success:function(response){ 
			                ...
			                if (response == "1") {
			                	...
			                	if(to_do == 'enable')
			                		swal('<?php echo lang('Success'); ?>', '<?php echo lang('Comments for this post has been enabled successfully.'); ?>', 'success').then((value) => {
			                		  $(".page_list_item.active").click(); });
			                	else
			                		swal('<?php echo lang('Success'); ?>', '<?php echo lang('Comments for this post has been disabled successfully.'); ?>', 'success').then((value) => {
			                		  $(".page_list_item.active").click(); });

...
<?php 
    ...
    else $title = ucfirst($reply_type).' '.lang('Reply Report');
?>
...
<section class="section section_custom">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo base_url('instagram_reply/reports'); ?>"><?php echo lang('Instagram Report Section'); ?></a></div>
                            ...
                            <div class="co-12 col-md-6">
                                <div class="input-group float-left" id="searchbox">
                                    <select name="insta_accounts" id="insta_accounts" class="form-control select2">
                                        <option value=""><?php echo lang('Instagram Accounts'); ?></option>
                                    ...
                                    <input type="text" name="post_id" id="post_id" class="form-control" placeholder="<?php echo lang('Search...'); ?>">
                                    <div class="input-group-append">
                                        <button class="btn btn-primary" id="report_search" title="<?php echo lang('Search'); ?>" type="button"><i class="fas fa-search"></i> <span class="d-none d-sm-inline"><?php echo lang('Search'); ?></span></button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                    ...
                                    <table class="table table-bordered" id="mytable_instagram_report">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo lang('Last Replied at'); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>

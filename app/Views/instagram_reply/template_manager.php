              ...
              <table class="table table-bordered" id="mytable">
                <thead>
                  <tr>
                    ...
                    <th class="min_width_150px"><?php echo lang('Actions'); ?></th>
                  </tr>
                </thead>
                <tbody>
                </tbody>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title padding_10_20_10_20px" ><?php echo lang('Please give the following information for auto reply') ?></h5>
                ...
                <div class="modal-body" id="auto_reply_message_modal_body">
                    <div class="row padding_10_20_10_20px">
                        ...
                        <div class="col-12 col-md-8">
                          <?php 
                            $page_list['']=lang('Select an Account');
                            ...
                            <div class="form-group clearfix e4e6fc_border_dashed">
                                ...
                                <div>                      
                                    <select class="form-group private_reply_postback select2" id="private_message_offensive_words" name="private_message_offensive_words">
                                        <option value=""><?php echo lang('Please select an account first to see the message templates.'); ?></option>
                                    </select>
        ...
        <div class="row">
          <div class="col-6">
            <button class="btn btn-lg btn-primary float-left" id="save_button"><i class='fas fa-save'></i> <?php echo lang('Submit') ?></button>
          </div>

          <div class="col-6">
            <button class="btn btn-lg btn-secondary float-right" id="modal_close"><i class='fas fa-times'></i> <?php echo lang('cancel') ?></button>
          </div>
        </div>
            </div>
        </div>
...
<div class="modal fade" id="edit_auto_reply_message_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center"><?php echo lang('Please give the following information for auto Reply') ?></h5>
                    ...
                    <div class="row padding_10_20_10_20px <?php if (!$commnet_hide_delete_addon) echo 'd_none'; ?>">
                        ...
                        <div class="col-12 col-md-6" id="edit_delete_offensive_comment_keyword_div">
                            <div class="form-group e4e6fc_border_dashed">
                                ...
                                <textarea class="form-control message height_170px" name="edit_delete_offensive_comment_keyword" id="edit_delete_offensive_comment_keyword" placeholder="<?php echo lang('Type keywords here in comma separated (keyword1,keyword2)...Keep it blank for no actions') ?>"></textarea>
                            </div>
                        </div>
                        <!-- private reply section -->
                        <div class="col-12 col-md-6 <?php if(!$instagram_reply_bot_addon) echo "d_none"; ?>">
                                    ...
                                    <div class="<?php if(!$instagram_reply_bot_addon) echo "d_none"; ?>">                      
                                        <label>
                                          ...
                                          <select class="form-group private_reply_postback select2" id="edit_filter_message_<?php echo $i; ?>" name="edit_filter_message_<?php echo $i; ?>">
                                            <option><?php echo lang('Please select an account first to see the message templates.'); ?></option>
                                          </select>

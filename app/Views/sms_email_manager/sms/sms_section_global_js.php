    ...
    $(document).ready(function($) {
        ...
        $(document).on('click', '#save_api', function(event) {
...

        	{
        		...
        		swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Gateway is Required'); ?>', 'warning');
            ...
            if(gateway_name == "routesms.com" && !isURL(routesms_host_name)){
                ...
                swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Route host URL is not valid.'); ?>', 'warning');
            ...
            if(namesForAuthId.indexOf(gateway_name) != -1 && (username_auth_id == "" || phone_number == "")){
                ...
                swal('<?php echo lang('Warning'); ?>', '<?php echo lang('You didn`t Provided all required information of the Gateway'); ?>', 'warning');
            ...
            if(gateway_name == "clickatell" && username_auth_id == ""){
                ...
                swal('<?php echo lang('Warning'); ?>', '<?php echo lang('API Username is Required'); ?>', 'warning');
            ...
            if(gateway_name == "routesms.com" && routesms_host_name == ""){
                ...
                swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Routesms Host name is required.'); ?>', 'warning');
        	...
        	$.ajax({
...

        		{
...

        			{
                        ...
                        swal({ title:'<?php echo lang('Success'); ?>', content:span,icon:'success'}).then((value) => {window.location.href=report_link;});
        ...
        var Doyouwanttodeletethisrecordfromdatabase2 = "<?php echo lang('If you delete this API, then all SMS Campaigns which were created with this API will be deleted. So do you really want to detete this API?'); ?>";
                    ...
                    $.ajax({
                        ...
                        success:function(response){ 
...

                            {
                                ...
                                iziToast.success({title: '',message: '<?php echo lang('API has been Deleted Successfully.'); ?>',position: 'bottomRight'});
        ...
        $(document).on('click', '#send_test_sms', function(event) {
            ...
            if(table_id == "" || table_id == 0) {
                ...
                span.innerHTML = '<?php echo lang('Something went wrong, please try once again.'); ?>';
        ...
        $("#import_submit").click(function(){      
            ...
            if(fileval=="")
                ...
                swal('<?php echo lang('Warning'); ?>', '<?php echo lang('No file selected, Please upload a file.');?>', 'warning');
                ...
                $.ajax({
...

                    {
                        ...
                        {               
                            ...
                            iziToast.success({title: '',message: '<?php echo lang('import from csv was successful')?>',position: 'bottomRight'});
        ...
        $(document).on('click','#create_campaign',function(){
...

            {
                ...
                swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please select a SMS API'); ?>", 'warning');
...

            {
                ...
                swal('<?php echo lang('Warning'); ?>', "<?php echo lang('Please Select Page name or Contact Group.'); ?>", 'warning');
    ...
    // =================================================== SMS Report Section ===============================================
        ...
        $(document).on('click', '#analyze_button', function(event) {
            ...
            if (custom_url != '') {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.message == 'error') {
                            ...
                            swal('<?php echo lang('Error'); ?>', '<?php echo lang('Please provide a valid url'); ?>', 'error');
                ...
                swal('<?php echo lang('Warning'); ?>', '<?php echo lang('Please put the input first.'); ?>', 'warning');
        ...
        $(document).on('click', '#update_custom_api', function(event) {
            ...
            if (custom_api_name == '' || custom_api_url == '' || updated_url == '') {
                ...
                swal('<?php echo lang('Error'); ?>', '<?php echo lang('Either api name or api url is empty.'); ?>', 'error');
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.status == 'success') {
                            ...
                            swal({ title: '<?php echo lang('Success'); ?>', text: response.message, icon: 'success', buttons: true, dangerMode: true, })
                            ...
                            swal('<?php echo lang('Success'); ?>', response.message, 'error');

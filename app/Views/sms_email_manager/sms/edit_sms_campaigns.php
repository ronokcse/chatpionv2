...
<section class="section">
    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo base_url("sms_email_manager/sms_campaign_lists"); ?>"><?php echo lang('SMS Campaigns'); ?></a></div>
                ...
                <form action="#" id="updated_sms_campaign_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <h4><?php echo lang('Campaign Details'); ?></h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php echo lang('SMS API'); ?></label>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php echo lang('Message'); ?> 
                                            ...
                                            <a href="#" data-placement="top"  data-toggle="popover" title="<?php echo lang('include lead user first name'); ?>" data-content="<?php echo lang('You can include Contacts #FIRST_NAME#, #LAST_NAME# as variable inside your message. The variable will be replaced by corresponding real values when we will send it.'); ?>"><i class='fa fa-info-circle'></i> </a> 

                                        </label>

                                        <span class='float-right'>

                                            <a data-toggle="tooltip" data-placement="top" title='<?php echo lang('You can include #LAST_NAME# variable inside your message. The variable will be replaced by real name when we will send it.') ?>' class='btn-outline btn-sm' id='contact_last_name'><i class='fas fa-user'></i> <?php echo lang('Last Name') ?></a>

                                        </span>

                                        <span class='float-right'>

                                            <a data-toggle="tooltip" data-placement="top" title='<?php echo lang('You can include #FIRST_NAME# variable inside your message. The variable will be replaced by real name when we will send it.') ?>' class='btn-outline btn-sm' id='contact_first_name'><i class='fas fa-user'></i> <?php echo lang('First Name') ?></a>

                                        </span>

                                        <textarea id="message" name="message" class="form-control" placeholder="<?php echo lang('type your message here...') ?>" style="height:140px !important;"><?php echo $campaign_data[0]['campaign_message']; ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="card card-primary">
                                                ...
                                                <div class="card-header">
                                                    ...
                                                    <h4><?php echo lang('Messenger Subscribers'); ?></h4>
                                                ...
                                                <div class="card-body left_body" style="min-height:388px;">
                                                        ...
                                                        <ul class="list-group">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12 col-md-6">
                                                                    ...
                                                                    <li class="list-group-item d-flex justify-content-between align-items-center pointer" title='<?php echo lang('Total Page Subscribers With Phone Number'); ?>'>
                                                                ...
                                                                <div class="col-12 col-md-6">
                                                                    ...
                                                                    <li class="list-group-item d-flex justify-content-between align-items-center pointer" title='<?php echo lang('Targetted Reach'); ?>'>

                                                                      <?php echo lang('Targetted Reach'); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label><?php echo lang('Select Page'); ?> </label>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="card card-primary">
                                                ...
                                                <div class="card-header">
                                                    ...
                                                    <h4><?php echo lang('SMS Subscriber (External)'); ?></h4>
                                                ...
                                                <div class="card-body right_body">
                                                        ...
                                                        <ul class="list-group">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12 col-md-6">
                                                                    ...
                                                                    <li class="list-group-item d-flex justify-content-between align-items-center pointer" title='<?php echo lang('Total Contact Group Numbers'); ?>'>

                                                                      <?php echo lang('Contact Numbers'); ?> 
                                                                ...
                                                                <div class="col-12 col-md-6">
                                                                    ...
                                                                    <li class="list-group-item d-flex justify-content-between align-items-center pointer" title='<?php echo lang('Total Manual Numbers'); ?>'>

                                                                      <?php echo lang('Manual Numbers'); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label><?php echo lang('Select Contacts'); ?> </label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label><?php echo lang('Numbers To Send');?> 

                                                            <a href="#" data-placement="top"  data-toggle="popover" title="<?php echo lang('include lead user first name'); ?>" data-content="<?php echo lang('Beside contact groups If you also want to send messages to manual numbers, you can simply put your numbers in below field with comma separated. System will send message to both your contact numbers and also to your manual numbers.'); ?>"><i class='fa fa-info-circle'></i> </a>

                                                        </label>

                                                        <span class="float-right">

                                                            <a href="#" data-placement="top"  data-toggle="popover" title="<?php echo lang('include lead user first name'); ?>" data-content="<?php echo lang('If you want to upload numbers from your CSV file, you can upload your CSV file. You will see your uploaded files number at the below box.'); ?>"><i class='fa fa-info-circle'></i> </a>

                                                            <a style="border-radius:5px;" id="import_from_csv" data-toggle="modal" href='#csv_import_modal' class="btn btn-outline-primary btn-sm"><i class="fa fa-upload"></i> <?php echo lang('Upload CSV');?></a>

                                                        </span>

                                                        <textarea style='height:120px !important' placeholder="<?php echo lang('You can type comma seperated numbers with country code here. You can also import numbers from a CSV file and numbers will be mereged here.') ;?>" id="to_numbers" name="to_numbers" class="form-control"><?php echo $campaign_data[0]['manual_phone'] ?></textarea>
                                        ...
                                        <?php if ( $this->basic->is_exist("add_ons",array("project_id"=>72)) && (session()->get('user_type') == 'Admin' || in_array(353, $this->module_access))){ ?>           
                                            <div class="col-12 col-md-6">
                                                <div class="card card-primary">
                                                    <div class="card-header">
                                                        <h4><?php echo lang('SMS Subscriber (Google Contacts)'); ?></h4>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <ul class="list-group">
                                                                <div class="row">
                                                                    <div class="col-12 col-md-6">
                                                                        <li class="list-group-item d-flex justify-content-between align-items-center pointer" title='<?php echo lang('Total Contact Group Numbers'); ?>'>
                                                                        <?php echo lang('Google Contact Numbers'); ?> 
                                                        ...
                                                        <div class="form-group">
                                                            <label><?php echo lang('Select Google Contacts account'); ?> </label>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php echo lang('Delay (second)'); ?>

                                            <a href="#" data-placement="top"  data-toggle="popover" title="<?php echo lang('Add Campaign Delay'); ?>" data-content="<?php echo lang('If you want any delay during sending sms to phone numbers, then provide a delay, keep it blank if you do not need any delay.'); ?>"><i class='fa fa-info-circle'></i> </a>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php echo lang('Country Code'); ?>

                                            <a href="#" data-placement="top"  data-toggle="popover" title="<?php echo lang('Add or remove country code'); ?>" data-content="<?php echo lang('If you want to add your country code to your contact numbers, then simply put you contry code here, then select add option from dropdown. Country Code will be added into your every contact number. You can also remove country code by selecting remove option from dropdown menu.'); ?>"><i class='fa fa-info-circle'></i> </a>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <select class="custom-select select2" name="country_code_action" id="country_code_action" style="width:100%;">
                                                    ...
                                                    <option value=""><?php echo lang('Actions'); ?></option>

                                                    <option value="1" id="item-1"><?php echo lang('Add'); ?></option>

                                                    <option value="0" id="item-2"><?php echo lang('Remove'); ?></option>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input placeholder="<?php echo lang('Choose time');?>" name="schedule_time" id="schedule_time" class="form-control datepicker_x" value="<?php echo $campaign_data[0]['schedule_time'] ?>" type="text"/>
                        ...
                        <div class="card-footer bg-whitesmoke">
                            ...
                            <button class="btn btn-lg btn-primary" id="update_sms_campaign_btn" name="update_sms_campaign_btn" type="button"><i class="fas fa-edit"></i> <?php echo lang('Update Campaign') ?> </button>



                            <a class="btn btn-lg btn-light float-right" onclick='goBack("sms_email_manager/sms_campaign_lists",0)'><i class="fas fa-times"></i> <?php echo lang('Cancel') ?> </a>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title blue"><i class="fa fa-file-text"></i> <?php echo lang('Import numbers from CSV'); ?></h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-close"></i> <?php echo lang('Cancel');?></button>

                <button type="button" id="import_submit" class="btn btn-primary"><i class="fa fa-upload"></i> <?php echo lang('Import');?></button>

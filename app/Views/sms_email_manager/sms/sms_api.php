    ...
    <div class="section-header">
        ...
        <div class="section-header-button">
            ...
            <!-- <a class="btn btn-primary add_gateway" href="#">
                ...
                <i class="fas fa-plus-circle"></i> <?php echo lang('New API'); ?>
            ...
            <a class="btn btn-primary add_custom_gateway" href="#">
                ...
                <i class="fas fa-plus-circle"></i> <?php echo lang('New Custom SMS API'); ?>
            ...
            <a class="btn btn-primary add_custom_gateway_post_method" href="#">
                ...
                <i class="fas fa-plus-circle"></i> <?php echo lang('New Custom SMS API[Post Method]'); ?>
            ...
            <div class="dropdown-menu" style="width:250px;">
             ...
             <a class="dropdown-item has-icon add_gateway" href="#">
                ...
                <i class="fas fa-plus-circle"></i> <?php echo lang('Add Default Gateway'); ?>
            ...
            <a class="dropdown-item has-icon add_custom_gateway" href="#">
                ...
                <i class="fas fa-plus-circle"></i> <?php echo lang('Add Custom SMS API [GET]'); ?>
            ...
            <a class="dropdown-item has-icon add_custom_gateway_post_method" href="#">
                ...
                <i class="fas fa-plus-circle"></i> <?php echo lang('Add Custom SMS API [POST]'); ?>
                                ...
                                <table class="table table-bordered" id="mytable">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo lang('Sender/ Sender ID/ Mask/ From'); ?></th>
    ...
    <div class="modal-dialog" style="min-width:50%;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><i class="fas fa-info-circle"></i> <?php echo lang('API Informations'); ?></h5>
                                    ...
                                    <div class="activity">
                                        ...
                                        <div class="activity-detail">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <h5 class="text-job text-primary" id="auth_id_title"><?php echo lang('Auth ID/ Auth Key/API Key/ MSISDN/ Account SID/ Account ID/ Username/ Admin'); ?></h5>
                                    ...
                                    <div class="activity">
                                        ...
                                        <div class="activity-detail">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <h5 class="text-job text-primary" id="api_secret_title"><?php echo lang('Auth Token/ API Secret/ Password'); ?></h5>
                                    ...
                                    <div class="activity">
                                        ...
                                        <div class="activity-detail">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <h5 class="text-job text-primary" id="routesmsHostname"><?php echo lang('Routesms Hostname'); ?></h5>
                                    ...
                                    <div class="activity">
                                        ...
                                        <div class="activity-detail">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <h5 class="text-job text-primary" id="api_id_title"><?php echo lang('API ID'); ?></h5>
                                    ...
                                    <div class="activity">
                                        ...
                                        <div class="activity-detail">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <h5 class="text-job text-primary" id="remaining_credits_title"><?php echo lang('Remaining Credits'); ?> 
    ...
    <div class="modal-dialog modal-mega">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bbw">
                ...
                <h5 class="modal-title text-center blue">
                    ...
                    <i class="fas fa-plus-circle"></i> <?php echo lang('New SMS API'); ?>&nbsp;

                    <a href="#" class="btn btn-primary btn-sm" title="<?php echo lang('Click to See the Instruction guide on SMS API'); ?>" id="instruction_guide"><i class="fas fa-info-circle" style="font-size: 12px !important;"></i> <?php echo lang('Instructions'); ?></a>
                        ...
                        <form action="#" enctype="multipart/form-data" id="sms_api_form" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><?php echo lang('Gateway Name'); ?></label>

                                        <?php  

                                        $gateway_lists[''] = lang('Select Gateway');
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label id="authID"><?php echo lang('Auth ID/ Auth Key/ API Key/ MSISDN/ Account SID/ Account ID/ Username/ Admin'); ?></label>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label id="authToken"><?php echo lang('Auth Token/ API Secret/ Password'); ?></label>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <label id="apiId"><?php echo lang('API ID'); ?></label>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <label id="sender"><?php echo lang('Sender/ Sender ID/ Mask/ From'); ?></label>
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <label id="shortcode"><?php echo lang('Short Code'); ?></label>
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <label style="margin-bottom:20px;"><?php echo lang('Status'); ?></label><br>
        ...
        <div class="modal-footer bg-whitesmoke">
            ...
            <div class="col-12 padding-0">
                ...
                <button class="btn btn-lg btn-primary" id="save_api" name="save_api" type="button"><i class="fas fa-save"></i> <?php echo lang('Save') ?> </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bbw">
                ...
                <h5 class="modal-title text-center">
                    ...
                    <i class="fas fa-edit"></i> <?php echo lang('Update SMS API'); ?>
            ...
            <div class="modal-footer bg-whitesmoke">
                ...
                <div class="col-12 padding-0">
                    ...
                    <button class="btn btn-lg btn-primary" id="update_api" name="update_api" type="button"><i class="fas fa-edit"></i> <?php echo lang('Update');?></button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title text-center">
                    ...
                    <i class="fas fa-plus-circle"></i> <?php echo lang('Instructions to configure SMS API'); ?>
...
<!-- deprecated -->
            ...
            <div class="modal-footer bg-whitesmoke">
                ...
                <div class="col-12">
                    ...
                    <button class="btn btn-light float-right" type="button" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i> <?php echo lang('Close'); ?></button>
    ...
    <div class="modal-dialog" style="min-width:45%;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center text-primary" style="padding:12px;border:.5px solid #dee2e6;background: #fff;"><?php echo lang('Custom API only supports HTTP GET request.'); ?></div>
                ...
                <div class="form-group">
                    ...
                    <label for="custom_api_name"><?php echo lang('API Name'); ?></label>
                ...
                <div class="form-group">
                    ...
                    <label for="custom_api_url"><?php echo lang('HTTP URL'); ?><small><?php echo lang('&nbsp;&nbsp;(url of HTTP GET  request for sending SMS. Please put url that is functional for sending message.)'); ?></small></label>
                ...
                <button class="btn btn-outline-primary float-right" id="analyze_button"><i class="fas fa-sync"></i> <?php echo lang('Analyze and test call'); ?></button>
                ...
                <div id="analyzed_section">
                    ...
                    <!-- <label><?php echo lang('Base URL : '); ?> http://something.com</label> 
                    ...
                    <label><?php echo lang('Generated URL : '); ?> http://something.com</label> -->
            ...
            <div class="modal-footer bg-whitesmoke">
                ...
                <div class="col-12">
                    ...
                    <button class="btn btn-lg btn-primary" id="update_custom_api" type="button" disabled="true"><i class="fas fa-edit"></i> <?php echo lang('Save');?></button>
...
<div class="modal fade" id="custom_sms_api_modal_post_method">
    ...
    <div class="modal-dialog" style="min-width:45%;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center text-primary" style="padding:12px;border:.5px solid #dee2e6;background: #fff;"><?php echo lang('Custom API only supports HTTP POST request.'); ?></div>
                ...
                <div class="form-group">
                    ...
                    <label for="custom_api_name_post_method"><?php echo lang('API Name'); ?></label>
                ...
                <div class="form-group">
                    ...
                    <label for="custom_api_base_url_post_method"><?php echo lang('Base url'); ?></label>
                ...
                <div class="card">
                    ...
                    <div class="card-header justify-content-between">
                        ...
                        <button class="btn btn-primary" id="add_new_parameter"><i class="fa fa-plus"></i> <?php echo lang('Add New Parameter'); ?></button>
        ...
        <button class="btn btn-outline-primary" id="text_response"><i class="fas fa-sync"></i> <?php echo lang('Test response'); ?></button>
    ...
    <div class="modal-footer bg-whitesmoke">
        ...
        <div class="col-12">
            ...
            <button class="btn btn-lg btn-primary" id="update_custom_api_post_method" type="button"><i class="fas fa-edit"></i> <?php echo lang('Save');?></button>
    ...
    <div class="modal-dialog" style="min-width:50%;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bbw">
                ...
                <h5 class="modal-title blue"><i class="fas fa-paper-plane"></i> <?php echo lang('Send Test SMS'); ?></h5>
                    ...
                    <div class="col-12"> 
                        ...
                        <div class="card card-primary box-shadow-none" id="response">
                            ...
                            <div class="card-header">
                                ...
                                <h4><i class="fas fa-bullhorn"></i> <?php echo lang('Response'); ?></h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><i class="fas fa-mobile-alt"></i> <?php echo lang('Phone Number'); ?></label>

                                        <input type="text" class="form-control" name="recipient_number" id="recipient_number">

                                        <div class="invalid-feedback"><?php echo lang('Phone Number is required'); ?></div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label><i class="fas fa-envelope"></i> <?php echo lang('Message'); ?></label>

                                        <textarea id="test_message" name="test_message" class="form-control" placeholder="<?php echo lang('type your message here...') ?>" style="height:140px !important;"></textarea>

                                        <div class="invalid-feedback"><?php echo lang('Message is required'); ?></div>
            ...
            <div class="modal-footer bg-whitesmoke">
                ...
                <div class="col-12 padding-0">
                    ...
                    <button class="btn btn-lg btn-primary" id="send_test_sms" name="send_test_sms" type="button"><i class="fas fa-paper-plane"></i> <?php echo lang('Send') ?> </button>

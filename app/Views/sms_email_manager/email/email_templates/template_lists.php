    ...
    <div class="section-header">
        ...
        <div class="section-header-button">
            ...
            <?php if ('sms' == $template_type): ?>
                ...
                >
                    <i class="fa fa-file-text"></i> <?php echo lang('New template'); ?>
                </a>
                ...
                <div class="dropdown d-inline">
                    ...
                    <div class="dropdown-menu">
                        <a 
                            ...
                            template_type="<?php echo $template_type; ?>"
                        >
                            <i class="fa fa-file-text"></i> <?php echo lang('Rich Text Editor'); ?>
                        </a>
                        <a 
                            class="dropdown-item has-icon" 
                            href="<?php echo base_url('sms_email_manager/drag_drop_email_template'); ?>" target="_BLANK"
                        >   
                            <i class="fa fa-bars"></i> <?php echo lang('Drag & Drop'); ?>
                        </a>
                    </div>
                </div>
            <?php endif; ?>
                                    ...
                                    <table class="table table-bordered" id="mytable_sms_email_templates">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo lang('Editor Type'); ?></th>
                                                <?php endif; ?>

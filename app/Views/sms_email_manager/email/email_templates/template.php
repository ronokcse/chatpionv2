...
<html lang="en">
  <head>    
    ...
    <script>
        ...
        window.ddetb_vars = {
            ...
            ok: '<?php echo lang('OK'); ?>',
            sorry: '<?php echo lang('Sorry!'); ?>',
            error: '<?php echo lang('Error!'); ?>',
            action: '<?php echo lang('Action!'); ?>',
            cancel: '<?php echo lang('Cancel'); ?>',
            modal_title: '<?php echo lang('Mail preview'); ?>',
            empty_field: '<?php echo lang('Please fill in all fields'); ?>',
            confirmation_title: '<?php echo lang('Are you sure?'); ?>', 
            subject_placeholder: '<?php echo lang('Email subject'); ?>', 
            template_placeholder: '<?php echo lang('Template name'); ?>', 
            confirmation_text: '<?php echo lang('Make sure you are done with your design!'); ?>',
  ...
  <body>
    ...
    <div class="container-fullscreen">
        ...
        <div class="container text-center">
            <div id="choose-template" class="text-center d-none">
                <button class="choose" type="button" data-id="no-sidebar"><img src="<?php echo base_url('plugins/email-template-builder/img/no-sidebar.jpg'); ?>" class="img-fluid" alt=""><p><?php echo lang('No Sidebar (wide)'); ?></p></button>
                <button class="choose" type="button" data-id="left-sidebar"><img src="<?php echo base_url('plugins/email-template-builder/img/left-sidebar.jpg'); ?>" class="img-fluid" alt=""><p><?php echo lang('Left Sidebar'); ?></p></button>
                <button class="choose" type="button" data-id="right-sidebar"><img src="<?php echo base_url('plugins/email-template-builder/img/right-sidebar.jpg'); ?>" class="img-fluid" alt=""><p><?php echo lang('Right Sidebar'); ?></p></button>
                <button class="choose" type="button" data-id="both-sidebar"><img src="<?php echo base_url('plugins/email-template-builder/img/both-sidebar.jpg'); ?>" class="img-fluid" alt=""><p><?php echo lang('Both Sidebars'); ?></p></button>
            </div>
        </div>
    ...
    <button class="btn btn-info btn-left-bottom-1 d-none" type="button" id="setting" title="<?php echo lang('Layout Options'); ?>" data-toggle="tooltip" data-placement="top" data-trigger="hover"><i class="fa fa-cog fa-spin"></i></button>

    <button class="btn btn-warning btn-left-bottom-2 d-none" type="button" id="save-and-quit" title="<?php echo lang('Save & Quit'); ?>" data-toggle="tooltip" data-placement="top" data-trigger="hover"><i class="fa fa-sign-out"></i></button>

    <button class="btn btn-primary btn-left-bottom-3 d-none" type="button" id="save-only" title="<?php echo lang('Save Template'); ?>" data-toggle="tooltip" data-placement="top" data-trigger="hover"><i class="fa fa-hdd-o"></i></button>

    <button class="btn btn-success btn-left-bottom-4 d-none" type="button" id="preview" title="<?php echo lang('Preview'); ?>" data-toggle="tooltip" data-placement="top" data-trigger="hover"><i class="fa fa-search-plus"></i></button>
    ...
    <div class="tools tools-left" id="settings">
        <div class="tools-header">
            ...
            <h4><span class="fa fa-cog fa-spin"></span> <?php echo lang('Settings'); ?></h4>
        </div>

        <div class="tools-footer d-none">
            <div class="button-group text-center">
                <button class="btn btn-danger btn-sm" type="button" id="delete"><i class="fa fa-trash"></i> <?php echo lang('Delete'); ?></button>
                <button class="btn btn-warning btn-sm" type="button" id="test"><i class="fa fa-paper-plane"></i> <?php echo lang('Send Test'); ?></button>
                <button class="btn btn-success btn-sm" data-dismiss="tools" type="button" id="send-message"><i class="fa fa-check-circle-o"></i> <?php echo lang('Done'); ?></button>
            </div>
        </div>

        <div class="tools-body">

            <h6 class="text-left option-title mt-3"><?php echo lang('Layout'); ?></h6>
            
            <div class="form-group">
                <label for="body-layout-bkg-color-form" class="col-form-label"><?php echo lang('Background Color'); ?>:</label>
                <div>
            ...
            <div class="form-group">
                <label for="body-layout-bkg-color-form" class="col-form-label"><?php echo lang('Body Color'); ?>:</label>
                <div>
            ...
            <h6 class="text-left option-title mt-4"><?php echo lang('Header Section'); ?></h6>

            <div class="form-group">
                <label for="head-bkg-color-form" class="col-form-label"><?php echo lang('Background Color'); ?>:</label>
                <div>
            ...
            <div class="form-group">
                <label for="head-height" class="col-form-label"><?php echo lang('Height'); ?>:</label>
                <div class="bs-slider-container">
                    ...
                    <p class="text-left small"><?php echo lang('Height'); ?>: <span id="head-height-val"><?php echo lang('auto'); ?></span></p>
                </div>
            </div>
            ...
            <div id="dd-body-exists">
                ...
                <h6 class="text-left option-title mt-4"><?php echo lang('Content Section'); ?></h6>

                <div class="form-group">
                    <label for="content-bkg-color-form" class="col-form-label"><?php echo lang('Background Color'); ?>:</label>
                    <div>
                ...
                <div class="form-group">
                    <label for="content-height" class="col-form-label"><?php echo lang('Height'); ?>:</label>
                    <div class="bs-slider-container">
                        ...
                        <p class="text-left small"><?php echo lang('Height'); ?>: <span id="content-height-val"><?php echo lang('auto'); ?></span></p>
                    </div>
                </div>
            ...
            <div id="dd-sidebar-left-exists">
                <h6 class="text-left option-title mt-4"><?php echo lang('Left Sidebar Section'); ?></h6>

                <div class="form-group">
                    <label for="left-bkg-color-form" class="col-form-label"><?php echo lang('Background Color'); ?>:</label>
                    <div>
                ...
                <div class="form-group">
                    <label for="left-height" class="col-form-label"><?php echo lang('Height'); ?>:</label>
                    <div class="bs-slider-container">
                        ...
                        <p class="text-left small"><?php echo lang('Height'); ?>: <span id="left-height-val"><?php echo lang('auto'); ?></span></p>
                    </div>
                </div>
            ...
            <div id="dd-sidebar-right-exists">
                <h6 class="text-left option-title mt-4"><?php echo lang('Right Sidebar Section'); ?></h6>

                <div class="form-group">
                    <label for="right-bkg-color-form" class="col-form-label"><?php echo lang('Background Color'); ?>:</label>
                    <div>
                ...
                <div class="form-group">
                    <label for="right-height" class="col-form-label"><?php echo lang('Height'); ?>:</label>
                    <div class="bs-slider-container">
                        ...
                        <p class="text-left small"><?php echo lang('Height'); ?>: <span id="right-height-val"><?php echo lang('auto'); ?></span></p>
                    </div>
                </div>

            </div>

            <h6 class="text-left option-title mt-4"><?php echo lang('Footer Section'); ?></h6>

            <div class="form-group">
                <label for="footer-bkg-color-form" class="col-form-label"><?php echo lang('Background Color'); ?>:</label>
                <div>
            ...
            <div class="form-group">
                <label for="footer-height" class="col-form-label"><?php echo lang('Height'); ?>:</label>
                <div class="bs-slider-container">
                    ...
                    <p class="text-left small"><?php echo lang('Height'); ?>: <span id="footer-height-val"><?php echo lang('auto'); ?></span></p>
                </div>
            </div>

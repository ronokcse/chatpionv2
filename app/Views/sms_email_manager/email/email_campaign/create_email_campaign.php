                            ...
                            <div class="row" id="campaign_details">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="campaign_name" name="campaign_name" placeholder="<?php echo lang('Campaign Name'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="<?php echo lang('Email Subject'); ?>" id="email_subject" name="email_subject" type="text" class="form-control"/>
                                ...
                                <div class="col-12">
                                    ...
                                    <ul class="nav nav-pills" id="email-template-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="rich-text-editor-tab" data-toggle="tab" href="#rich-text-editor" role="tab" aria-controls="rich-text-editor" aria-selected="true"><?php echo lang('Rich Text Editor'); ?></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="drag-and-drop-tab" data-toggle="tab" href="#drag-and-drop" role="tab" aria-controls="drag-and-drop" aria-selected="false"><?php echo lang('Drag and Drop'); ?></a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="rich-text-editor-content">
                                        <div class="tab-pane fade show active" id="rich-text-editor" role="tabpanel" aria-labelledby="rich-text-editor-tab">
                                            <div class="form-group">
                                                ...
                                                <textarea id="message" name="message" class="form-control" placeholder="<?php echo lang('type your message here...') ?>"></textarea>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="drag-and-drop" role="tabpanel" aria-labelledby="drag-and-drop-tab">
                                            <div class="form-group">
                                                ...
                                                <a id="refresh-email-template" class="btn btn-link text-primary"><i class="fa fa-refresh"></i> <?php echo lang('Refresh template'); ?></a>
                                                <a class="btn btn-link float-right" href="<?php echo base_url('sms_email_manager/drag_drop_email_template'); ?>" target="_blank"><?php echo lang('Create new template'); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

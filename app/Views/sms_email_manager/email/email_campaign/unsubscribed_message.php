...
<body>
		...
		<div class="inner-container">
			...
			<div class="bottom">
				...
				<p class="subtitle"><p/>
					...
					<div class="buttons">
						<button class="btn btn-primary" id="subscribed" button-type="sub"><i class="fa fa-bell"></i> <?php echo lang('Subscribe');?></button>
						<button class="btn btn-danger" id="unsubscribe" button-type="unsub"><i class="fa fa-bell-slash"></i> <?php echo lang('Unsubscribe');?></button>
					</div>
				</div>
		</div>
	...
	<script>
		$(document).ready(function($) {
			...
			if(status == '0') {
				$(".bottom .title").html('<?php echo lang('Do you want to unsubscribe?'); ?>');
				$(".bottom .subtitle").html('<?php echo lang('If you unsubscribe, you will stop receiving our emails.'); ?>');
				$("#unsubscribe").css("display","block");
				$("#subscribed").css("display","none");
			}

			if(status == '1') {
				$(".bottom .title").html('<?php echo lang('Do you want to Subscribe?'); ?>');
				$(".bottom .subtitle").html('<?php echo lang('If you subscribe, you will start receiving our emails.'); ?>');
					...
					$.ajax({
						...
						success:function(response) {
							...
							if(response == "1")
							{
								...
								iziToast.success({title: '',message: '<?php echo lang('you have successfully unsubscribed from our mailing services.')?>',position: 'bottomRight'});
								$("#subscribed").show();
								$("#unsubscribe").hide();
								$(".bottom .title").html('<?php echo lang('Do you want to Subscribe?'); ?>');
								$(".bottom .subtitle").html('<?php echo lang('If you subscribe, you will start receiving our emails.'); ?>');
				...
				if(contactid != '' || email != '')
				{
					$.ajax({
						...
						success:function(response)
						{
							...
							if(response == "1")
							{
								iziToast.success({title: '',message: '<?php echo lang('you have successfully subscribed into our mailing services.')?>',position: 'bottomRight'});
								$("#subscribed").hide();
								$("#unsubscribe").show();
								$(".bottom .title").html('<?php echo lang('Do you want to unsubscribe?'); ?>');
								$(".bottom .subtitle").html('<?php echo lang('If you unsubscribe, you will stop receiving our emails.'); ?>');

	...
	<div class="section-header">
		...
		<div class="section-header-button">
			<a class="btn btn-primary new_mailgun" href="#">
				<i class="fas fa-plus-circle"></i> <?php echo lang('New Mailgun API'); ?>
			</a> 
		</div>
							...
							<table class="table table-bordered" id="mytable2">
								<thead>
									<tr>
										...
										<th><?php echo lang('Domain Name'); ?></th>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bbw">
				<h5 class="modal-title blue"><i class="fas fa-plus-circle"></i> <?php echo lang('New Mailgun API'); ?></h5>
					...
					<div class="col-12">
						<form action="#" method="POST" id="add_new_mailgun">
							<div class="row">
								...
								<div class="col-12">
									<div class="form-group">
										<label><?php echo lang('Domain Name'); ?></label>
			...
			<div class="modal-footer bg-whitesmoke">
				<button type="button" class="btn btn-primary btn-lg" id="save_mailgun"><i class="fas fa-save"></i> <?php echo lang('Save'); ?></button>
...
<div class="modal fade" id="update_mailgun_api_form_modal" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bbw">
				<h5 class="modal-title blue"><i class="fas fa-edit"></i> <?php echo lang('Update Mailgun API'); ?></h5>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="modal-body">
			...
			<div class="modal-footer bg-whitesmoke">
			    <button type="button" class="btn btn-primary btn-lg" id="update_mailgun"><i class="fas fa-edit"></i> <?php echo lang('Update'); ?></button>
			    <a type="button" class="btn btn-light btn-lg float-right" data-dismiss="modal"><i class="fas fa-times"></i> <?php echo lang('Close'); ?></a>
			</div>
		</div>
	</div>

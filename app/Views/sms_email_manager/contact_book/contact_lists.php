	...
	<div class="section-header">
		...
		<div class="section-header-button">
			<a class="btn btn-primary add_new_contact" href="#">
				<i class="fas fa-plus-circle"></i> <?php echo lang('New Contact'); ?>
			</a> 
		</div>
		<div class="section-header-breadcrumb">
			<div class="breadcrumb-item">
			    <a href="<?php echo base_url("subscriber_manager"); ?>"><?php echo lang('Subscriber Manager'); ?></a>
			</div>
								...
								<div class="input-group float-left" id="searchbox">
									...
									<div class="input-group-prepend">
										<select class="select2 form-control" id="group_id" name="group_id">
											<option value=""><?php echo lang('Contact Group'); ?></option>
											<?php foreach ($contact_group_lists as $key => $value): ?>
												<option value="<?php echo $key; ?>"><?php echo $value;?></option>
											<?php endforeach ?>
										</select>
									</div>
									<input type="text" class="form-control" id="contact_list_searching" name="contact_list_searching" placeholder="<?php echo lang('Search...'); ?>" aria-label="" aria-describedby="basic-addon2">
									<div class="input-group-append">
										<button class="btn btn-primary" id="contact_list_search_submit" title="<?php echo lang('Search'); ?>" type="button"><i class="fas fa-search"></i> <span class="d-none d-sm-inline"><?php echo lang('Search'); ?></span></button>
									</div>
								</div>
							</div>
							...
							<div class="col-12 col-md-6">
								<div class="btn-group dropleft float-right">
								    ...
								    <div class="dropdown-menu dropleft">
								        ...
								        <a class="dropdown-item has-icon pointer" id="delete_all_contacts" href=""><i class="fas fa-trash-alt"></i> <?php echo lang('Delete'); ?></a>
								    </div>
								</div>
							</div>
						</div>
							...
							<table class="table table-bordered" id="mytable1">
								<thead>
									<tr>
										...
										<th><?php echo lang('Contact Group'); ?></th>
        ...
        <div class="modal-content">
            <div class="modal-header bbw">
                <h5 class="modal-title text-center blue">
                    <i class="fas fa-user-plus"></i> <?php echo lang('New Contact'); ?>
                </h5>
                    ...
                    <div class="col-12">                    
                        <form action="#" enctype="multipart/form-data" id="contact_add_form" method="post">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label><?php echo lang('Contact Group'); ?>
                                        	<a href="#" data-toggle='tooltip' title="<?php echo lang('You Can select multiple contact group.'); ?>"><i class="fas fa-info-circle"></i></a>
                                        </label>
                                ...
                                <div class="col-12 col-md-6">
                                	<div class="form-group">
                                		<label><?php echo lang('Status') ?></label><br>
			...
			<div class="modal-footer bg-whitesmoke">
                <div class="col-12 padding-0">
                    <button class="btn btn-primary" id="save_contact" name="save_contact" type="button"><i class="fas fa-save"></i> <?php echo lang('Save') ?> </button>
                    <a class="btn btn-light float-right" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i> <?php echo lang('Cancel') ?> </a>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="update_contact_form_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" style="min-width:60%;">
        <div class="modal-content">
            <div class="modal-header bbw">
                <h5 class="modal-title text-center blue">
                    <i class="fas fa-user-edit"></i> <?php echo lang('Update Contact'); ?>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer bg-whitesmoke">
                <div class="col-12 padding-0">
                    <button class="btn btn-primary" id="update_contact" name="update_contact" type="button"><i class="fas fa-edit"></i> <?php echo lang('Update'); ?></button>
                    <a class="btn btn-light float-right" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i> <?php echo lang('Cancel'); ?></a>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="import_contacts_modal" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-lg" style="min-width:70%;">
		<div class="modal-content">
				<div class="modal-header bbw">
					<h5 class="modal-title"><i class="fas fa-cloud-upload-alt"></i> <?php echo lang('Import Contact (CSV)'); ?></h5>&nbsp;&nbsp;&nbsp;
					<a class="btn btn-primary btn-sm" target="_BLANK" href="<?php echo base_url("assets/sample/contact_import_sample.csv"); ?>"><i class="fas fa-download"></i> <?php echo lang('Sample CSV'); ?></a>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				</div>
				<div class="modal-body">
					<div class="row">
							...
							<form action="#" method="POST" id="import_contact_csv" enctype="multipart/form-data">
								<div class="row">
									<div class="col-12 col-md-12">
										<div class="form-group">
											<label><?php echo lang('Contact Group'); ?></label>
				             		...
				             		<div class="col-12 col-md-12">
				             			<div class="form-group">
				             				<label class="form-label"> <?php echo lang('CSV File') ?>
				             					<a href="#" data-placement="top" data-toggle="popover" title="<?php echo lang('Message'); ?>" data-content="<?php echo lang('Upload your CSV file. You can see the original format of importing CSV file by downloading our Sample CSV file. Email/Phone number which are already added before will be ignored during importing if CSV file have them.'); ?>"><i class='fa fa-info-circle'></i> </a>
				             				</label>
						...
						<div class="col-12 col-md-6"><br>
							<div class="alert alert-light alert-has-icon">
								...
								<div class="alert-body">
									<div class="alert-title"><?php echo lang('Message'); ?></div>
									<?php echo lang('If you used Microsoft Excel or any other spreadsheet program to fill up your contact CSV then please make sure the values were saved properly by opening the file with notepad or any other text editor. See the below image please.'); ?>
				...
				<div class="modal-footer bg-whitesmoke" id="import_contact_modal_footer">
						<button type="button" class="btn btn-lg btn-primary" id="upload_imported_csv"><i class="fas fa-cloud-upload-alt"></i> <?php echo lang('Import'); ?></button>
						<button type="button" class="btn btn-light btn-lg float-right" data-dismiss="modal"><i class="fas fa-times"></i> <?php echo lang('Close'); ?></button>
				</div>
			</div>
		</div>
	</div>
...
<div class="modal fade" id="assign_sqeuence_campaign_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" style='min-width:40%;'>
        <div class="modal-content">
            ...
            <div class="modal-body">   
              <div class="text-center" style="padding:20px;margin-bottom:20px;border:.5px solid #dee2e6; color:var(--blue);background: #fff;"><?php echo lang('Bulk sequence assign is available for Email & SMS cmapaign.'); ?></div>
...
<div class="modal fade" id="contact_details_modal">
	<div class="modal-dialog" style="min-width:80%;">
		<div class="modal-content">
			<div class="modal-header bbw">
			  <h5 class="modal-title text-primary"><i class="fas fa-info-circle"></i> <?php echo lang('Contact Details');?></h5>
			  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			    <span aria-hidden="true">×</span>
			  </button>
			</div>

      ...
      <div class="card">
        <form id="webview-form">
          <div class="card-header">
            <h4><?php echo lang('What is your Phone Number?'); ?></h4>
          </div>
          ...
          <div class="card-body">
            ...
            <div class="form-group"><label><?php echo lang('Phone Number'); ?></label><input name="phone" type="text" class="form-control" placeholder=""  />
            </div>
...
//PSID variable comes from bare-them.php file. 
    ...
    $("form").on('submit',function(event){
      ...
      {
        swal('<?php echo lang('Error'); ?>', '<?php echo lang('Please Enter your Phone.'); ?>', 'error');
        return false;
      }

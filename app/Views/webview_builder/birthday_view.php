      ...
      <div class="card">
        <form id="webview-form">
          <div class="card-header">
            <h4><?php echo lang('What is your Birthday?'); ?></h4>
          </div>
          ...
          <div class="card-body">
            ...
            <div class="form-group"><label><?php echo lang('Birth Date'); ?></label><input placeholder="YYYY-MM-DD" name="birthdate" type="text" class="datepicker_x form-control" placeholder=""  />
            </div>
...
//PSID variable comes from bare-them.php file. 
    ...
    $("form").on('submit',function(event){
      ...
      {
        swal('<?php echo lang('Error'); ?>', '<?php echo lang('Please select your birth date.'); ?>', 'error');
        return false;
      }

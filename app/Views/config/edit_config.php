...
<section class="content-header">
   ...
   <?php if(session()->get('user_type')=="Admin") { ?> <div class="alert alert-info text-center">To know more read <a target="_BLANK" href="<?php echo site_url();?>documentation/#!/administration_settings_gt_connectivity_settings"> documentation</a></div> <?php } ?>
     	<div class="box box-info custom_box">

		    	<div class="box-header">
		         <h3 class="box-title"><i class="fa fa-connectdevelop"></i> <?php echo lang('connectivity settings');?></h3>
		        </div><!-- /.box-header -->
		       		<!-- form start -->
		           	...
		           	<div class="box-footer">
		            	<div class="form-group">
		             		<div class="col-sm-12 text-center">
		               			<input name="submit" type="submit" class="btn btn-warning btn-lg" value="<?php echo lang('Save');?>"/>  
		              			<input type="button" class="btn btn-default btn-lg" value="<?php echo lang('Cancel');?>" onclick='goBack("config",1)'/>  
		             		</div>
		           		</div>
		         	</div><!-- /.box-footer -->         
		        </div><!-- /.box-info -->       

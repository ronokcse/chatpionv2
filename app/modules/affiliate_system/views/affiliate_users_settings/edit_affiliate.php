...
<section class="section section_custom">
  ...
  <div class="row">
    <div class="col-12">
      ...
      <form class="form-horizontal" action="<?php echo site_url().'affiliate_system/edit_affiliate_action';?>" method="POST">
        ...
        <div class="card">
          <div class="card-body">             
            <div class="row">
            	...
            	<div class="col-6">
            		<div class="form-group">
            		  ...
            		  <input name="username" value="<?php echo $xdata['username'];?>"  class="form-control" type="text">
            	...
            	<div class="col-12 col-md-6">
              	...
              	<div class="col-12 col-md-6">
                      ...
                      <a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="<?php echo $this->lang->line("Commission Settings"); ?>" data-content="<?php echo $this->lang->line("If you want to set special commission for this affiliate on signup/payment then enable it to start the procedure. If you set special commission, this affiliate will get commissions based on this settings instead of Generic payment setttings for affiliate."); ?>"><i class='fa fa-info-circle'></i> </a>   
	              		...
	              		<label class="custom-switch mt-2">
	              			<input type="checkbox" name="is_overwritten" id="is_overwritten" value="1" class="custom-switch-input" <?php if($xdata['is_overwritten'] == '1') echo "checked"; ?>>
	              			<span class="custom-switch-indicator"></span>
            ...
            <div class="row" id="commission_section" <?php if($xdata['is_overwritten'] == '1') echo 'style="display:block"'; else echo 'style="display: none;"'; ?>>
            	<div class="col-12">
            		<div class="card">
            					...
            					<div class="col-6">
       									<div class="form-group mt-2">
       										<div class="custom-control custom-checkbox">
       										    <input type="checkbox" value="1" id="by_signup" name="signup_commission" class="custom-control-input" <?php if($xdata['is_signup_commission'] == '1' || $general_signup_commission == '1') echo "checked"; ?>>
                        ...
                        <div class="form-group" id="signup_sec_div" <?php if($xdata['is_signup_commission'] == '1' || $general_signup_commission == '1') echo 'style="display:block"'; else echo 'style="display: none;"'; ?>>
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="signup_amount" id="signup_amount" value="<?php if($xdata['signup_amount'] != '') echo $xdata['signup_amount']; else echo $general_sign_up_amount;?>">
                          </div>
                        </div>
            					</div>
            					...
            					<div class="col-6">
            						<div class="form-group mt-2">
            							<div class="custom-control custom-checkbox">
            								<input type="checkbox" value="1" id="by_payment" name="is_payment" class="custom-control-input" <?php if($xdata['is_payment'] == '1' || $general_payment_commission == '1') echo "checked"; ?>>
                        ...
                        <div id="payment_sec_div" <?php if($xdata['is_payment'] == '1' || $general_payment_commission == '1') echo 'style="display:block"'; else echo 'style="display: none;"'; ?>>
                          <div class="row">
                            <div class="col-4">
                              <div class="form-group">
                                ...
                                <label class="custom-switch mt-2">
                                  <input type="radio" name="payment_type" id="payment_type" value="fixed" class="custom-switch-input" <?php if($is_fixed) echo "checked"; ?>>
                                  <span class="custom-switch-indicator"></span>
                            ...
                            <div class="col-4">
                              <div class="form-group">
                                ...
                                <br>
                                <label class="custom-switch mt-2">
                                  <input type="radio" name="payment_type" id="payment_type" value="percentage" class="custom-switch-input" <?php if($is_percentage) echo "checked"; ?>>
                                  <span class="custom-switch-indicator"></span>
                                  <span class="custom-switch-description"><?php echo $this->lang->line('Enable');?></span>
                                  <span class="red"><?php echo form_error('payment_type'); ?></span>
                                </label>
                            ...
                            <div class="col-4">
                              <div class="form-group">
                                ...
                                <br>
                                <label class="custom-switch mt-2">
                                  <input type="checkbox" name="is_recurring" id="is_recurring" value="1" class="custom-switch-input" <?php if($xdata["is_recurring"]=='1' || $general_is_recurring == '1') echo "checked"; ?>>
                                  <span class="custom-switch-indicator"></span>
                                  <span class="custom-switch-description"><?php echo $this->lang->line('Enable');?></span>
                          ...
                          >
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="fixed_amount" id="fixed_amount" value="<?php if($xdata['fixed_amount'] !='') echo $xdata['fixed_amount']; else echo $general_payment_fixed_amount; ?>">
                              <span class="red"><?php echo form_error('fixed_amount'); ?></span>
                            </div>
                          </div>

                          <div class="form-group" id="percentage_div" <?php if($is_percentage) echo 'style="display:block"'; else echo 'style="display: none;"'; ?>>
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="percent_amount" id="percent_amount" value="<?php if($xdata['percentage_amount'] != '') echo $xdata['percentage_amount']; else echo $general_payment_percentage;?>">

...
class Vidcasterlive extends Home
{
    ...
    public function live_stream_ffmpeg_command() // media caster go live now
    {
        ...
        $url=$ffmpeg.' -re -i '.$file_name.' -codec:a aac  -ar 44100 -b:a 128k -pix_fmt yuv420p -profile:v baseline -s '.$video_width.'x'.$video_height.' -bufsize 6000k -vb 2048k -minrate 3000k -maxrate 4500k -filter:v yadif -strict -2 -vcodec libx264 -preset ultrafast -r 30 -g 60 -f flv "'.$stream_url.'" -loglevel error 2>&1';

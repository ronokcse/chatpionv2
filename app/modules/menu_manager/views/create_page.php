                ...
                <form action="#" id="create_custom_page" method="POST" enctype="multipart/form-data">
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" id="page_description" name="page_description" placeholder="<?php echo lang("Type your page description here..."); ?>"><?php echo set_value("page_description") ?></textarea>
                        ...
                        <div class="card-footer bg-whitesmoke">
                            <button class="btn btn-lg btn-primary" id="create_page" type="button"><i class="fas fa-paper-plane"></i> <?php echo lang("Create Page") ?> </button>
        ...
        $.ajax({
            ...
            success:function(response) {
                ...
                if(response.status =="1") {
                    var span = document.createElement("span");
                    span.innerHTML = '<?php echo lang("Page has been created successfully.") ?>';

	...
	<div class="blog-content-wrap">
		...
		<div class="blog-meta-wrap">
			<p class="blog-meta">
				...
				<span><i class="fa fa-comments" aria-hidden="true"></i> <?php echo $post["total_comments"]; ?> <?php echo lang("Comments");?></span>
			</p>
		</div>
		<p class="blog-excerpt"><?php echo mb_substr(strip_tags($post["body"]), 0,200); ?>...</p>
		<!-- <p><a href="<?php echo $post_details; ?>" class="readmore-btn"><?php echo lang("Read More");?> <i class="fa fa-arrow-right" aria-hidden="true"></i></a></p> -->
	</div>
</article>

	...
	<div class="row">
		<div class="col-sm-8">
			<div class="post-details">
                ...
                <div class="blog-meta-wrap">
					<p class="blog-meta">
						...
						<span><i class="fa fa-comments" aria-hidden="true"></i> <?php echo $post[0]["total_comments"]; ?> <?php echo lang("Comments"); ?></span>
            ...
            <div class="comments-wrapper">
                <h2><?php echo $post[0]["total_comments"]; ?> <?php echo lang("Comments"); ?></h2>
                <div class="comments_area" id="display_comments" data-post-id="<?php echo $post[0]["id"]; ?>">
                	
                </div><!--/.comments_area-->
                <div class="comment-form">
                    <h1><?php echo lang("Leave a Comment");?></h1>
                                ...
                                <div class="col-sm-12">
                                    <div class="panel panel-default">
                                      <div class="panel-heading">
                                        ...
                                        <?php echo lang("Your Comment");?>
                                      </div>
                                      <textarea class="form-control" rows="7" name="comment" placeholder=' <?php echo lang("Your Comment");?>'></textarea>
                                    </div>
                                    <strong id="comment-response" class=""></strong>
                                    <button type="submit" class="comment-submit-btn"><i class="fas fa-comment-medical"></i> <?php echo lang("Post Comment");?></button>
                                </div><!--/.col-sm-12-->
                            </div><!--/.row-->
                        </form>
                    <?php else: ?>
                        
                        <a href="<?php echo base_url('home/login') ?>" class="btn btn-default btn-lg"><i class="fa fa-sign-in"></i> <?php echo lang("Login to Comment");?></a>
                    <?php endif; ?>
                </div><!--/.comment-form-->
  	...
  	<form name="comment-action" action="<?php echo base_url('blog/comment_action'); ?>" method="post">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="myModalLabel"><?php echo lang("Leave a Reply");?></h4>
	      </div>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-primary"><?php echo lang("Post Reply");?></button>
	      </div>
	    </div><!--/.modal-content-->
    </form>
  </div>
  ...
  <div class="modal-dialog" role="document">
  	<form name="comment-action" action="<?php echo base_url('blog/comment_action?type=edit'); ?>" method="post">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title" id="myModalLabel"><?php echo lang("Edit");?></h4>
	      </div>
	      <div class="modal-body">

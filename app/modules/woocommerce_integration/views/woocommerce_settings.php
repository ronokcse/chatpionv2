...
<section class="section">
	<div class="section-header">
		   ...
		   <div class="section-header-breadcrumb">
		     ...
		     <div class="breadcrumb-item"><a href="<?php echo base_url('woocommerce_integration'); ?>"><?php echo lang("WooCommerce Integration"); ?></a></div>
	...
	<div class="section-body">
	  <div class="row">
	    <div class="col-12">
	        ...
	        <div class="card">
	          <div class="card-header"><h4 class="card-title"><i class="fas fa-plus-circle"></i> <?php echo lang("WooCommerce API Settings"); ?></h4></div>
	          <div class="card-body"> 

	              <div class="row">
		                <div class="col-12">
		                  <div class="form-group">
		                    <label for=""><?php echo lang("Consumer Key");?> *</label>
		                ...
		                <div class="col-12">
		                  <div class="form-group">
		                    <label for=""><?php echo lang("Consumer Secret");?> *</label>
		                ...
		                <div class="col-12">
		                  <div class="form-group">
		                    <label for=""><?php echo lang("Website Home URL");?> *</label>
	          ...
	          <div class="card-footer bg-whitesmoke">
	            <button class="btn btn-primary btn-lg" id="save-btn" type="submit"><i class="fas fa-save"></i> <?php echo lang("Save & Sync Data");?></button>
	            <button class="btn btn-secondary btn-lg float-right" onclick='goBack("woocommerce_integration")' type="button"><i class="fa fa-remove"></i>  <?php echo lang("Cancel");?></button>
	          </div>
	        </div>
	      </form>
	    </div>

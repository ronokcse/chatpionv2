<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><?php echo lang("Open Ticket"); ?></div>
    </div>
  </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group" id="image_rich_content_block">
                    <label><?php echo lang('Ticket Desctiption'); ?> *</label>
              ...
              <div class="card-footer bg-whitesmoke">
                  ...
                  <button type="submit" class="btn btn-primary btn-lg open"><i class="fa fa-send"></i> <?php echo lang('Open Ticket'); ?> </button> 

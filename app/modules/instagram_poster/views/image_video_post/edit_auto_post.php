				...
				<div class="card main_card bg-body">
		          	<div class="card-body px-0 px-md-2 pt-0 pb-2">
			          	<ul class="nav nav-tabs w-100" role="tablist">							
							<li class="nav-item">
								<a id="text_post" class="nav-link post_type" data-toggle="tab" href="#textPost" role="tab" aria-selected="false"><i class="fas fa-file-alt"></i> <?php echo lang('Text') ?></a>
							</li>              
							<li class="nav-item">
			          	...
			          	<div class="tab-content bg-white" id="post_tab_content">
								...
								<div class="card-footer padding-0">
									...
									<button class="btn btn-primary btn-lg" submit_type="text_submit" id="submit_post" name="submit_post" type="button"><i class="fas fa-paper-plane"></i> <?php echo lang("Submit");?></button>
								</div>
						</div>
			        </div>
	          	</div>          

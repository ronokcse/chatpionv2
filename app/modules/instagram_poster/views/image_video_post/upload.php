<div id="image_block" class="mb-4">
	...
	<div class="form-group mb-1">
    <div id="image_url_upload"><?php echo lang('Upload');?></div>
	</div>

	<div class="card mr-1 mb-0 no_shadow d_none" id="image_edit_block">
    <div class="card-footer px-2 py-2 bg-primary no_radius">
      <a href="#" data-src="" class="btn btn-light btn-sm float-left edit_media image no_radius"><i class="fas fa-images"></i> <?php echo lang("Editor");?></a>
      <a href="#" data-src="" class="btn btn-danger btn-sm float-right delete_media image no_radius"><i class="fas fa-trash-alt"></i> <?php echo lang("Delete");?></a>
    </div>
  </div>
	...
	<div class="col-12">
       ...
       <div class="col-12 p-0 no-gutters">
       	<div class="alert alert-warning py-2">
       		<?php echo lang("Multi Image Post Limit: 10 Images. 
       			In Facebook it will be posted as multi images post, Instagram as carousel. Instagram Carousel post also supports images+videos. For Facebook multi image post, videos will be ignored. For Facebook carousel post") .', '. '<a href="'.base_url("ultrapost/carousel_slider_post").'">' .lang('go here').'</a>';
					?>
	...
	<div class="row">
        ...
        <div class="input-group">
          ...
          <input class="form-control" name="video_url" id="video_url" type="text" value="<?php if(set_value('video_url')) echo set_value('video_url');else {if(isset($all_data[0]['video_url'])) echo $all_data[0]['video_url'];}?>">
			...
			<div class="form-group mb-1">
            <div id="video_url_upload"><?php echo lang('Upload');?></div>
      </div>          			

      <div class="card mr-1 mb-0 no_shadow d_none" id="video_edit_block">
        <div class="card-footer px-2 py-2 bg-primary no_radius">
        	 <a href="#" data-src="" class="btn btn-light btn-sm float-left edit_media video disabled no_radius"><i class="fas fa-images"></i> <?php echo lang("Editor");?></a>
          <a href="#" data-src="" class="btn btn-danger btn-sm float-right delete_media video no_radius"><i class="fas fa-trash-alt"></i> <?php echo lang("Delete");?></a>
        </div>
      </div>
	      ...
	      <div class="col-12">
	      	<div class="form-group">
	      	  	<label class="custom-switch mt-2">
	      			...
	      			<span class="custom-switch-description"><?php echo lang('Reels Post for Instagram');?></span>
	      	  	</label>
	      	</div>
	      </div>
      </div>

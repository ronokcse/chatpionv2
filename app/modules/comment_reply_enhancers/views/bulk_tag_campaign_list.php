    ...
    <div class="modal-dialog modal-mega">
        <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><i class="fas fa-tag"></i> <?php echo lang("Tag List");?></h5>
            ...
            <div class="modal-body data-card">
                <div class="row">
                  ...
                  <div class="col-12 col-md-6">
                    <input type="text" id="searching1" name="searching1" class="form-control" placeholder="<?php echo lang("Search..."); ?>" style='width:300px;'>                                          
                  </div>
                  ...
                  <div class="col-12">
                    <div class="section">
                      <div class="section-title">
                        <h6><?php echo lang('Tag Content'); ?></h6>
                      </div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><i class="fa fa-list"></i> <?php echo lang("Tag List"); ?></h4>
			</div>

  ...
  <div class="section-header">
    ...
    <div class="section-header-button">
        <?php if(check_module_action_access($module_id=352,$actions=[1],$response_type='')): ?>
            <a href="" id="create-http-api" class="btn btn-primary"><i class="fas fa-plus-circle"></i> <?php echo lang('Create')?></a>
        <?php endif?>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title full_width">
                        <span class="card-label"><?php echo lang('Connected HTTP APIs')?></span>
                        <p class="text-muted small mb-0"><?php echo lang("Connect and manage your WhatsApp HTTP APIs")?></p>
                    </h4>
                    <a href="<?php echo base_url("http_api/list_api_report_all").$url_channel_param;?>" id="" class="btn btn-outline-primary float-right"><i class="fas fa-eye"></i> <?php echo lang('HTTP API REPORT')?></a>
                </div>
                            ...
                            <div class="input-group mb-3" id="searchbox">
                                <div class="input-group-prepend">
                                    <select class="form-control select2" id="search_status">
                                        <option value=""><?php echo lang("Any Status")?></option>
                                ...
                                <div class="input-group-prepend">
                                    <select class="form-control select2" id="search_is_mapped">
                                        <option value=""><?php echo lang("Any Verification")?></option>
                                        <option value="1"><?php echo lang("Verified")?></option>
                                        <option value="0"><?php echo lang("Non-verified")?></option>
                                    </select>
                                </div>
                                <div class="input-group-prepend">
                                    <input type="text" class="form-control no-radius" autofocus id="search_value" name="search_value" placeholder="<?php echo lang('Search...')?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class='table table-hover table-bordered table-sm w-100' id="mytable" >
                            ...
                            <tr class="table-light">
                                ...
                                <th><?php echo lang("Endpoint URL") ?></th>
                                <th><?php echo lang("Channel") ?></th>
                                <th><?php echo lang("Status") ?></th>
                                <th><?php echo lang("Verified") ?></th>
                                <th><?php echo lang("Actions") ?></th>
                                <th><?php echo lang("Created at") ?></th>
                                <th><?php echo lang("Last Called at") ?></th>
                            </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
            ...
            <form id="verify_http_api_form" action="#" method="post">
                ...
                <div class="card box-shadow" id="">
                    <div class="card-header pb-0">
                        <h4 class="card-title">
                            <span class="card-label"><?php echo lang('API Connection Details')?></span>
                            <p class="text-muted small mb-0"><?php echo lang("Build & verify a HTTP API connection")?></p>
                        </h4>
                    </div>
                    <div class="card-body px-4 pt-2 http_api_create_container">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            <label for=""><?php echo lang('API Name')?></label>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            <label for=""><?php echo lang('Method')?> *</label>
                                            <div class="input-group">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            <label for=""><?php echo lang('Test Subscriber ID')?> * <span data-toggle="tooltip" title="<?php echo lang('This subscriber`s data will be used to verify the connection.')?>"><i class="fas fa-info-circle text-primary"></i></span></label>
                                            <div class="input-group">
                                    ...
                                    <div class="col-12 col-md-5 d-none">
                                        <div class="form-group">
                                            <label for=""><?php echo lang('Social Channel')?> *</label>
                                            <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for=""><?php echo lang('End-point URL')?> *</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" autofocus="" id="api_endpoint_url" name="api_endpoint_url">
                                                <span class="input-group-text pointer" data-toggle="modal" data-target="#variable-list-modal"><i data-toggle="tooltip" title="<?php echo lang('Use variable in endpoint URL')?>" class="fas fa-list pointer"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <div class="card card-primary mb-4">
                                    <div class="card-header pb-2 d-flex justify-content-between">
                                        <h6 class="pt-2"> <?php echo lang("Header Data"); ?></h6>
                                        <div>
                                            <a href="#" class="btn btn-sm btn-outline-dark pl-1 pr-2 py-0 d-none" id="remove_header"><i class="fas fa-times-circle"></i> <?php echo lang("Remove"); ?></a>
                                            <a href="#" class="btn btn-sm btn-outline-primary pl-1 pr-2 py-0 ml-2" id="add_header"><i class="fa fa-plus-circle"></i> <?php echo lang("Add"); ?></a>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row mt-2 d-none" id="api_header_row_<?php echo $i; ?>">
                                                <div class="col-8 col-md-4">
                                                    <div class="form-group mb-0 api_header_row_key_container" id="api_header_row_key_container_<?php echo $i; ?>">
                                                        <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Header")?> : <?php echo lang("Key")?> </b> <b class="text-warning">*</b></label>
                                                        <input type="text" class="form-control api_header_row_key" placeholder="<?php echo lang("Key"); ?>" name="api_header_row_key[]" id="api_header_row_key_<?php echo $i; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-4 col-md-3">
                                                    <div class="form-group mb-0 api_header_row_type_container" data-i="<?php echo $i?>" id="api_header_row_type_container_<?php echo $i;?>">
                                                        <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Header")?> : <?php echo lang("Type")?> </b> <b class="text-warning">*</b></label>
                                                        <select class="form-control select select2 d-block api_header_row_type" style="width: 100%" id="api_header_row_type_<?php echo $i; ?>" name="api_header_row_type[]">
                                                            <option value="static"><?php echo lang("Static Value"); ?></option>
                                                            <option value="dynamic"><?php echo lang("Dynamic Value"); ?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-5 api_header_row_value_container" id="api_header_row_value_container_<?php echo $i;?>">
                                                    <div class="form-group mb-0 api_header_row_static_value_container" id="api_header_row_static_value_container_<?php echo $i; ?>">
                                                        <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Header")?> : <?php echo lang("Value")?> </b> <b class="text-warning">*</b></label>
                                                        <input type="text" class="form-control" placeholder="<?php echo lang("Value"); ?>" name="api_header_row_static_value[]" id="api_header_row_static_value_<?php echo $i; ?>">
                                                    </div>
                                                    <div class="form-group mb-0 api_header_row_dynamic_value_container d-none" data-i="<?php echo $i?>"  id="api_header_row_dynamic_value_container_<?php echo $i;?>">
                                                        <div class="input-group" data-i="<?php echo $i?>">
                                                            <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Header")?> : <?php echo lang("Value")?> </b> <b class="text-warning">*</b></label>
                                                            <span class="refresh_custom_field refresh_custom_field_header pointer text-primary ml-2" data-i="<?php echo $i?>">(<?php echo lang("Refresh");?>)</span>
                                                            <select class="form-control select select2 api_row_dynamic_value" name="api_header_row_dynamic_value[]" id="api_header_row_dynamic_value_<?php echo $i?>">
                                                                <option value=""><?php echo lang("Select Field"); ?></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-12">
                                <div class="card card-primary mb-4">
                                    <div class="card-header pb-2 d-flex justify-content-between">
                                        <h6 class="pt-2"> <?php echo lang("Body Data"); ?></h6>
                                        <div>
                                            <a href="#" class="btn btn-sm btn-outline-dark pl-1 pr-2 py-0 d-none" id="remove_body"><i class="fas fa-times-circle"></i> <?php echo lang("Remove"); ?></a>
                                            <a href="#" class="btn btn-sm btn-outline-primary pl-1 pr-2 py-0 ml-2" id="add_body"><i class="fa fa-plus-circle"></i> <?php echo lang("Add"); ?></a>
                                        </div>
                                    </div>
                                    <div class="card-body pb-4">
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="form-check form-switch float-left">
                                                        ...
                                                        <label class="form-check-label mr-3 pointer" for="api_body_data_type_default"><?php echo strtolower(lang("Default"))?></label>
                                                    </div>
                                                    ...
                                                    <div class="form-check form-switch float-left">
                                                        ...
                                                        <label class="form-check-label mr-3 pointer" for="api_body_data_type_form_data"><?php echo strtolower(lang("Form-data"))?></label>
                                                    </div>
                                                    ...
                                                    <div class="form-check form-switch float-left">
                                                        ...
                                                        <label class="form-check-label mr-3 pointer" for="api_body_data_type_x_www_form_urlencoded"><?php echo strtolower(lang("X-www-form-urlencoded"))?></label>
                                                    </div>

                                                    <div class="form-check form-switch float-left">
                                                        <input type="radio" class="form-check-input api_body_data_type" id="api_body_data_type_json" name="api_body_data_type" value="json">
                                                        <label class="form-check-label mr-3 pointer" for="api_body_data_type_json"><?php echo strtolower(lang("JSON"))?></label>
                                                    </div>
                                                    ...
                                                    <div class="form-check form-switch float-left">
                                                        ...
                                                        <label class="form-check-label mr-3 pointer" for="api_body_data_type_binary"><?php echo strtolower(lang("Binary"))?></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row mt-2 d-none" id="api_body_row_<?php echo $i; ?>">
                                                <div class="col-8 col-md-4">
                                                    <div class="form-group mb-0 api_body_row_key_container" id="api_body_row_key_container_<?php echo $i; ?>">
                                                        <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Body")?> : <?php echo lang("Key")?> </b> <b class="text-warning">*</b></label>
                                                        <input type="text" class="form-control api_body_row_key" placeholder="<?php echo lang("Key"); ?>" name="api_body_row_key[]" id="api_body_row_key_<?php echo $i; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-4 col-md-3">
                                                    <div class="form-group mb-0 api_body_row_type_container" data-i="<?php echo $i?>" id="api_body_row_type_container_<?php echo $i;?>">
                                                        <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Body")?> : <?php echo lang("Type")?> </b> <b class="text-warning">*</b></label>
                                                ...
                                                <div class="col-12 col-md-5 api_body_row_value_container" id="api_body_row_value_container_<?php echo $i;?>">
                                                    <div class="form-group mb-0 api_body_row_static_value_container" id="api_body_row_static_value_container_<?php echo $i; ?>">
                                                        <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Body")?> : <?php echo lang("Value")?> </b> <b class="text-warning">*</b></label>
                                                        <input type="text" class="form-control" placeholder="<?php echo lang("Value"); ?>" name="api_body_row_static_value[]" id="api_body_row_static_value_<?php echo $i; ?>">
                                                    </div>
                                                    <div class="form-group mb-0 api_body_row_dynamic_value_container d-none" data-i="<?php echo $i?>"  id="api_body_row_dynamic_value_container_<?php echo $i;?>">
                                                        <div class="input-group" data-i="<?php echo $i?>">
                                                            <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Body")?> : <?php echo lang("Value")?> </b> <b class="text-warning">*</b></label>
                                                            <span class="refresh_custom_field refresh_custom_field_body pointer text-primary ml-2" data-i="<?php echo $i?>">(<?php echo lang("Refresh");?>)</span>
                                                    ...
                                                    <div class="form-group mb-0 api_body_row_file_value_container d-none" id="api_body_row_file_value_container_<?php echo $i; ?>">
                                                        <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Body")?> : <?php echo lang("Value")?> </b> <b class="text-warning">*</b></label>
                                                        <input type="text" class="form-control" placeholder="<?php echo lang("File URL"); ?>" name="api_body_row_file_value[]" id="api_body_row_file_value_<?php echo $i; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php
                                        ...
                                        <div class="row mt-2 d-none" id="api_body_row_json_value_container">
                                            <div class="col-12 col-md-8 col-lg-9">
                                                <div class="form-group mb-0" id="">
                                                    <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Body")?> : <?php echo lang("JSON")?> </b> <b class="text-warning">*</b></label>
                                            ...
                                            <div class="col-12 col-md-4 col-lg-3">
                                                <div class="form-group mb-0">
                                                    <label class="pb-1 control-label mb-0 w-100">
                                                        <i class="fas fa-hashtag text-primary"></i> <b class="text-dark"><?php echo lang("Body")?> : <?php echo lang("Variables")?> </b>
                                                        <i class="fas fa-info-circle text-primary pointer" data-toggle="tooltip" title="<?php echo lang("Copy and paste the variable name to include it in your JSON content.")?>"></i>
                                                        <div class="input-group mt-1">
                                                            <input type="text" class="form-control no_radius" onkeyup="search_in_ul(this,'variable-list')" style="height:27px;" placeholder="<?php echo lang("Search");?>..." name="" id="">
                                                            <span onclick="ajax_generate_dynamic_value_list()" class="input-group-text refresh_custom_field_list bg-primary text-white border-primary pointer no_radius" style="height:27px;" data-toggle="tooltip" title="<?php echo lang("Refresh list")?>"><i class="fas fa-sync pt-1" style="font-size: 10px"></i></span>
                                                        </div>
                                                    </label>
                            ...
                            <div class="col-12">
                                <div class="card card-primary mb-4">
                                    <div class="card-header pb-2 d-flex justify-content-between">
                                        <h6 class="pt-2"> <?php echo lang("Option Data"); ?></h6>
                                        <div>
                                            <a href="#" class="btn btn-sm btn-outline-dark pl-1 pr-2 py-0 d-none" id="remove_option"><i class="fas fa-times-circle"></i> <?php echo lang("Remove"); ?></a>
                                            <a href="#" class="btn btn-sm btn-outline-primary pl-1 pr-2 py-0 ml-2" id="add_option"><i class="fa fa-plus-circle"></i> <?php echo lang("Add"); ?></a>
                                        </div>
                                    </div>
                                    <div class="card-body pb-4">
                                        <?php
                                            ...
                                            <div class="row mt-2 d-none" id="api_option_row_<?php echo $i; ?>">
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group mb-0 api_option_row_key_container" data-i="<?php echo $i?>" id="api_option_row_key_container_<?php echo $i; ?>">
                                                        <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Option")?> : <?php echo lang("key")?> </b> <b class="text-warning">*</b></label>
                                                        <select name="api_option_row_key[]" class="form-control select2 api_option_row_key" id="api_option_row_key_<?php echo $i?>" style="width:100% !important;">
                                                            <option value=""><?php echo lang("Select Option")?></option>
                                                ...
                                                <div class="col-12 col-md-6 api_option_row_value_container" id="api_option_row_value_container_<?php echo $i;?>">
                                                    <div class="form-group mb-0 api_option_row_static_value_container" id="api_option_row_static_value_container_<?php echo $i; ?>">
                                                        <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Option")?> : <?php echo lang("Value")?> </b> <b class="text-warning">*</b></label>
                                                        <input type="text" class="form-control" placeholder="<?php echo lang("Value"); ?>" name="api_option_row_static_value[]" id="api_option_row_static_value_<?php echo $i; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php
                            ...
                            <div class="col-12">
                                <div class="card card-primary mb-4">
                                    <div class="card-header pb-2 d-flex justify-content-between">
                                        <h6 class="pt-2"> <?php echo lang("Cookie Data"); ?></h6>
                                        <div>
                                            <a href="#" class="btn btn-sm btn-outline-dark pl-1 pr-2 py-0 d-none" id="remove_cookie"><i class="fas fa-times-circle"></i> <?php echo lang("Remove"); ?></a>
                                            <a href="#" class="btn btn-sm btn-outline-primary pl-1 pr-2 py-0 ml-2" id="add_cookie"><i class="fa fa-plus-circle"></i> <?php echo lang("Add"); ?></a>
                                        </div>
                                    </div>
                                    <div class="card-body pb-4">
                                        <?php
                                            ...
                                            <div class="row mt-2 d-none" id="api_cookie_row_<?php echo $i; ?>">
                                                <div class="col-8 col-md-4">
                                                    <div class="form-group mb-0 api_cookie_row_key_container" id="api_cookie_row_key_container_<?php echo $i; ?>">
                                                        <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Cookie")?> : <?php echo lang("key")?> </b> <b class="text-warning">*</b></label>
                                                        <input type="text" class="form-control api_cookie_row_key" placeholder="<?php echo lang("Key"); ?>" name="api_cookie_row_key[]" id="api_cookie_row_key_<?php echo $i; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-4 col-md-3">
                                                    <div class="form-group mb-0 api_cookie_row_type_container" data-i="<?php echo $i?>" id="api_cookie_row_type_container_<?php echo $i;?>">
                                                        <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Cookie")?> : <?php echo lang("Type")?> </b> <b class="text-warning">*</b></label>
                                                ...
                                                <div class="col-12 col-md-5 api_cookie_row_value_container" id="api_cookie_row_value_container_<?php echo $i;?>">
                                                    <div class="form-group mb-0 api_cookie_row_static_value_container" id="api_cookie_row_static_value_container_<?php echo $i; ?>">
                                                        <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Cookie")?> : <?php echo lang("Value")?> </b> <b class="text-warning">*</b></label>
                                                        <input type="text" class="form-control" placeholder="<?php echo lang("Value"); ?>" name="api_cookie_row_static_value[]" id="api_cookie_row_static_value_<?php echo $i; ?>">
                                                    </div>
                                                    <div class="form-group mb-0 api_cookie_row_dynamic_value_container d-none" data-i="<?php echo $i?>"  id="api_cookie_row_dynamic_value_container_<?php echo $i;?>">
                                                        <div class="input-group" data-i="<?php echo $i?>">
                                                            <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Cookie")?> : <?php echo lang("Value")?> </b> <b class="text-warning">*</b></label>
                                                            <span class="refresh_custom_field refresh_custom_field_cookie pointer text-primary ml-2" data-i="<?php echo $i?>">(<?php echo lang("Refresh");?>)</span>
                            ...
                            <div class="col-12">
                                <div class="alert alert-warning p-4 border-warning border-dashed"  role="alert">
                                    <h5 class="alert-heading text-dark">
                                        ...
                                        <?php echo lang('HTTP API')?> : <small><?php echo lang('How it works?')?></small>
                                    </h5>
                                    <p class=""><?php  echo lang('Connect to an external HTTP API by providing the necessary API connection details. After entering the details, verify the connection to retrieve API response data. Use this data to update subscriber information. Note that any changes to the API connection details will not be saved until the connection is verified.') ?> <b><?php echo lang("Finally, you need to save the API to activate it.")?></b></p>
                                </div>
                            </div>
                    ...
                    <div class="card-footer px-4 py-3 bg-light http_api_create_container" style="">
                        <div class="mb-0">
                            <button type="submit" id="http_api_verify" class="btn btn-primary btn-lg"><i class="fas fa-save"></i> <?php echo lang('Verify Connection')?></button>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="card box-shadow d-none" id="http_api_data_container">
                            <div class="card-header pb-0">
                                <h4 class="card-title d-flex align-iteml-start flex-column">
                                    <span class="card-label"><?php echo lang('HTTP API Response Mapping')?></span>
                                    <p class="text-muted small mb-0"><?php echo lang("Update subscriber data based on data received from HTTP API call")?></p>
                                </h4>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card card-primary mb-0 border-0 no_shadow">
                                            <div class="card-header m-0 p-0 d-flex justify-content-between px-0 py-0 border-0">
                                                <h6 class="pt-2"></h6>
                                                <div>
                                                    <a href="#" class="btn btn-sm btn-outline-dark pl-1 pr-2 py-0 d-none" id="remove_map"><i class="fas fa-times-circle"></i> <?php echo lang("Remove"); ?></a>
                                                    <a href="#" class="btn btn-sm btn-outline-primary pl-1 pr-2 py-0 ml-2" id="add_map"><i class="fa fa-plus-circle"></i> <?php echo lang("Add"); ?></a>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row mt-2 d-none api_map_row" id="api_map_row_<?php echo $i; ?>">
                                                        ...
                                                        <div class="col-6 col-md-4 pr-1">
                                                            <div class="form-group mb-0 api_map_row_key_container" data-i="<?php echo $i?>"  id="api_map_row_key_container_<?php echo $i;?>">
                                                                <div class="input-group" data-i="<?php echo $i?>">
                                                                    <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Map")?> : <?php echo lang("Field")?> </b> <b class="text-warning">*</b></label>
                                                                    <span class="refresh_custom_field refresh_custom_field_map pointer text-primary ml-2" data-i="<?php echo $i?>">(<?php echo lang("Refresh");?>)</span>
                                                        ...
                                                        <div class="col-6 col-md-4 pl-1 pr-md-1">
                                                            <div class="form-group mb-0 api_map_row_value_container" data-i="<?php echo $i?>" id="api_map_row_value_container_<?php echo $i;?>">
                                                                <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Map")?> : <?php echo lang("Value")?> </b> <b class="text-warning">*</b></label>
                                                                <select class="form-control select select2 d-block api_map_row_value" style="width: 100%" id="api_map_row_value_<?php echo $i; ?>" name="api_map_row_value[]">
                                                                    <option value=""><?php echo lang("Select Map Data"); ?></option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12 col-md-4 pl-md-1">
                                                            <div class="form-group mb-0 api_map_row_formatter_container" data-i="<?php echo $i?>"  id="api_map_row_formatter_container_<?php echo $i;?>">
                                                                <label class="pb-1 control-label mb-0"><b class="text-dark"><?php echo lang("Map")?> : <?php echo lang("Formatters")?></b></label>
                                                                <select multiple class="form-control select select2 api_map_row_formatter_value" name="api_map_row_formatter_value_<?php echo $i?>[]" id="api_map_row_formatter_value_<?php echo $i?>">
                                                                    <option value=""><?php echo lang("Select Formatter"); ?> </option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="card-footer px-4 py-3 bg-light">
                                <button type="submit" id="save-http-api" class="btn btn-warning btn-lg"><i class="fas fa-save"></i> <?php  echo lang('Save API') ?></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-5">
                        <div class="card box-shadow d-none" id="api_data_display_container">
                            <div class="card-header">
                                <h4 class="card-title d-flex align-iteml-start flex-column">
                                    <span class="card-label"><?php echo lang('Data Formatters')?></span>
                                    <p class="text-muted small mb-0"><?php echo lang("Format or manipulate API data")?></p>
                                </h4>
                            </div>
                            <div class="card-body data-card" id="put_formatter_data">
                                <div class="row">
                                    <div class="col-7 col-lg-5">
                                        <div class="input-group mb-0" id="searchbox">
                                            <div class="input-group-prepend" style="width:100% !important;">
                                                <input type="text" class="form-control no-radius" autofocus id="search_value_formatter" name="search_value_formatter" placeholder="<?php echo lang("Search...")?>">
                                    ...
                                    <div class="col-5 col-lg-7">
                                        <?php if(check_module_action_access($module_id=352,$actions=[1],$response_type='')): ?>
                                            <a href="" id="create-formatter" class="btn btn-bg btn-outline-primary float-right"><i class="fas fa-plus-circle"></i> <?php echo lang('New')?></a>
                                        <?php endif ?>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <table class='table table-hover table-bordered table-sm w-100' id="mytable1" >
                                        ...
                                        <tr class="table-light">
                                            ...
                                            <th><?php echo lang("Formatter Definition") ?></th>
                                            <th><?php echo lang("Actions") ?></th>
                                        </tr>
                                        </thead>
                                        <tbody></tbody>
                            ...
                            <div class="card-header border-top mb-0 pb-0">
                                <h4 class="card-title d-flex align-iteml-start flex-column">
                                    <span class="card-label"><?php echo lang('Raw Data')?></span>
                                    <p class="text-muted small mb-0"><?php echo lang("The original API reponse data received in raw format")?></p>
                                </h4>
                                ...
                                <div class="alert alert-danger alert-dismissible fade show p-4 border-danger border-dashed d-none" role="alert" id="data_error_container">
                                    <h5 class="alert-heading text-dark">
                                        ...
                                        <?php echo lang("Error")?> : <small><?php echo lang("Error calling API")?></small>
                                    </h5>
                                    <p id="data_error"></p>
                                </div>
            ...
            <form class="template-modal-form" action="#" method="post">
                <div class="modal-header">
                    <h5 class="modal-title full_width" id="">
                        <i class="fas fa-circle"></i> <?php  echo lang('Data Formatter') ?>
                    </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 col-md-6 mb-3">
                            <label for="" class="pb-1"><?php  echo lang('Name') ?> *</label>
                            <input type="text" class="form-control" id="formatter_name" name="formatter_name" placeholder="<?php echo lang('Name it to identify it later')?>">
                        </div>
                        <div class="col-12 col-md-6 mb-3">
                            <label for="" class="pb-1"><?php  echo lang('Action') ?> *</label>
                    ...
                    <div class="col-12 p-0">
                        <div class="alert alert-info alert-dismissible fade show p-4 border-info border-dashed"  role="alert">
                            <h5 class="alert-heading text-dark">
                                ...
                                <?php echo lang('How to use `Whitespace` ?')?>
                            </h5>
                            <p class="">
                                <?php echo lang('You can use whitespace as parameter value. Just type [space] as parameter value.') ;?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer d-flex align-iteml-center justify-content-start">
                    <button type="submit" id="save_formatter" class="btn btn-primary fw-bold"><i class="fas fa-save"></i> <?php  echo lang('Save Formatter') ?></button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="variable-list-modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title full_width" id="">
                    <i class="fas fa-circle"></i> <?php  echo lang('Variables') ?>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">               
                	<span aria-hidden="true">×</span>          
                </button> 
...
<?php include(APPPATH . 'modules/http_api/views/http-api/build_js.php'); ?>

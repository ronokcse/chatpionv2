<?php include(APPPATH . "modules/sms_email_sequence/views/sms_email_manager/sequence/sms_email_sequence_css.php"); ?>
<?php include(APPPATH . "modules/sms_email_sequence/views/sms_email_manager/sequence/sms_email_sequence_module_js.php"); ?>

<style>
    /*.dropdown-toggle::after{content:none !important;}*/
    #template_text{max-width: 40% !important;}
</style>
<input type="hidden" name="sms_email_sequence_csrf_token" id="sms_email_sequence_csrf_token" value="<?php echo session()->get('csrf_token_session'); ?>">
<section class="section section_custom">
    <div class="section-header">
        <h1><i class="fas fa-th-list"></i> <?php echo $page_title; ?></h1>
        <div class="section-header-button">

            <button class="btn btn-primary create_new_template" template_type="<?php echo $template_type; ?>"><?php echo lang('New template'); ?></button>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="input-group float-left" id="searchbox">
                                    <input type="text" class="form-control" id="template_text" name="template_text" autofocus placeholder="<?php echo lang('Search...'); ?>" aria-label="" aria-describedby="basic-addon2">
                                </div>
                            </div>
                        </div>
                        <div class="row">
    ...
    <div class="modal-dialog" style="min-width:70%;">
        <div class="modal-content">
            <div class="modal-header bbw">
                <h5 class="modal-title text-primary"><i class="fas fa-plus-circle"></i> <?php echo lang("Create Template") ?></h5>
            ...
            <div class="modal-footer bg-whitesmoke">
                <button class="btn btn-lg btn-primary" button-type="" id="save_template" name="save_template" type="button"><i class="fas fa-save"></i> <?php echo lang("Save") ?> </button>
...
<div class="modal fade" id="update_template_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" style="min-width:70%;">
        <div class="modal-content">
            <div class="modal-header bbw">
                <h5 class="modal-title text-primary"><i class="fas fa-plus-circle"></i> <?php echo lang("Update Template") ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            ...
            <div class="modal-footer bg-whitesmoke">
                <button class="btn btn-lg btn-primary" button-type="" id="update_template" name="update_template" type="button"><i class="fas fa-edit"></i> <?php echo lang("Update") ?> </button>
                <a class="btn btn-lg btn-light float-right" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i> <?php echo lang("Cancel") ?> </a>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary"><i class="fa fa-eye"></i> <?php echo lang("Email Template") ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>

<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      <div class="breadcrumb-item"><?php echo lang("Team Member"); ?></div>
      <div class="breadcrumb-item active"><a href="<?php echo base_url('team_member/member_list'); ?>"><?php echo lang("Team Member List"); ?></a></div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row" id="">
              <div class="col-12">
                <div class="form-group">
                  <label for="role_id"> <?php echo lang("Role")?> *</label>
                  <?php 
          ...
          <div class="card-footer bg-whitesmoke">
            ...
            <button  type="button" class="btn btn-secondary btn-lg float-right" onclick='goBack("team_member/member_list",0)'><i class="fa fa-remove"></i> <?php echo lang("Cancel");?></button>
          </div>
        </div>
      </form>  
    </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    // Team members don't have user_type field, so this logic is not needed
    // Keeping the script block for any future functionality
  });
</script>
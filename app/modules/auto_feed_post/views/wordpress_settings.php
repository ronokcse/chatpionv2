...
<section class="section section_custom">
    <div class="section-header">
        ...
        <div class="section-header-button">
            <a class="btn btn-primary" id="add_feed" data-toggle="modal" href='#add_feed_modal'><i class="fas fa-plus-circle"></i> <?php echo lang('Add new wordpress blog');?></a>
        </div>
    ...
    $("document").ready(function(){
      ...
      $(document).on('click','.force_process',function(e){ 
        ...
        swal({
          ...
          text: '<?php echo lang("Do you really want to force process this campaign? This can be helpful if your Wordpress blog posting tools have stopped for some unknown reasons and not responding."); ?>',
          icon: 'warning',
          buttons: true,
          dangerMode: true,
        })
      ...
      $(document).on('click','#add_feed_submit',function(){ 
        ...
        {
          swal('<?php echo lang("Error"); ?>', "<?php echo lang('Wordpress blog URL can not be empty');?>" , 'error');
          return;
        }
...
<div class="modal fade" id="add_feed_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fab fa-wordpress"></i> <?php echo lang("Wordpress post auto-posting") ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <form action="#" id="add_feed_form">
                <div class="modal-body">
                    ...
                    <div class="space"></div>
                    <label class="margin-bottom-label" style="color: rgb(0, 0, 0);">
                    <?php echo lang("Wordpress blog URL") ?> *
                    </label>

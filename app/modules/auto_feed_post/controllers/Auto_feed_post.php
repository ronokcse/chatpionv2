...
Modules:
{
   "269":{
      ...
      "limit_enabled":"1",
      "extra_text":"month",
      "module_name":"Social Posting - Auto Feed : WordPress Feed Post"
   },
   "276":{
      "bulk_limit_enabled":"1",
      "limit_enabled":"1",
      "extra_text":"month",
      "module_name":"Social Posting - Auto Feed : YouTube Feed Post"
   }
}
Project ID: 39
...
class Auto_feed_post extends Home
{
    ...
    public function campaign_settings()
    {
        ...
        if($this->is_ultrapost_exist) $fb_page_info=$this->basic->get_data("facebook_rx_fb_page_info",$where,array("facebook_rx_fb_page_info.*","facebook_rx_fb_user_info.name as account_name"),array('facebook_rx_fb_user_info'=>"facebook_rx_fb_page_info.facebook_rx_fb_user_info_id=facebook_rx_fb_user_info.id,left"));

...
<section class="section ">
	<div class="section-header">
		...
		<div class="section-header-breadcrumb">
			...
			<div class="breadcrumb-item"><?php echo lang("Edit Plugin"); ?></div>
		</div>
	</div>
				                 	...
				                 	<div class="tab-content" id="MsgReminderTabContent">
				                       	 ...
				                       	 { ?>
					                         <div class="reminder_badge_warpper tab-pane fade <?php if($i==1) echo 'active show';?>" id="msg_reminder<?php echo $i;?>" role="tabpanel" aria-labelledby="msg_reminder_link>">
						                         ...
						                         <div class="reminder_block">
						                         	<span class="block1">
						                         		<textarea autofocus data-toggle="tooltip" title="<?php echo lang('Intro message will be displayed here, click to edit text. Clean text if you do not want this.'); ?>"  name="msg_reminder_text[]" id="msg_reminder_text<?php echo $i;?>"><?php echo isset($messenger_content['reminder'][$i]['reminder_text']) ? $messenger_content['reminder'][$i]['reminder_text'] : "";?></textarea>
						                         	</span>			                         	
						                         	<span class="block2 ">
					                     ...
					                     <?php 
				                       	 ...
				                       	 <div class="reminder_badge_warpper tab-pane fade" id="msg_checkout" role="tabpanel" aria-labelledby="msg_checkout_link>">
					                         ...
					                         <div class="reminder_block">
					                         	<span class="block1">
					                         		<textarea autofocus data-toggle="tooltip" title="<?php echo lang('Intro message will be displayed here, click to edit text. Clean text if you do not want this.'); ?>"  name="msg_checkout_text" id="msg_checkout_text"><?php echo isset($messenger_content['checkout']['checkout_text']) ? $messenger_content['checkout']['checkout_text'] : "";?></textarea>
					                         	</span>	
					                         	<span class="block5">
					                         	...
					                         	<span class="block4">
					                         		...
					                         		<p>
					                         		<input data-toggle="tooltip" title="<?php echo lang('Website link will be embedded here, click to edit button name. Clean text if you do not want this.'); ?>" value="<?php echo isset($messenger_content['checkout']['checkout_btn_next']) ? $messenger_content['checkout']['checkout_btn_next'] : 'Visit Shop';?>" class="btn btn-block bg-white" name="msg_checkout_btn_website" id="msg_checkout_btn_website"/>
					                         		</p>
					                         	</span>
					                         </div>
					                     </div>
					                 	 ...
					                 	 for($i=1; $i <=$how_many_reminder; $i++)
				                       	 { ?>
					                         <div class="reminder_badge_warpper tab-pane fade <?php if($i==1) echo 'active show';?>" id="sms_reminder<?php echo $i;?>" role="tabpanel" aria-labelledby="sms_reminder_link>">
						                         ...
						                         <div class="reminder_block">
						                         	<span class="block4">
						                         		<textarea data-toggle="tooltip" title="<?php echo lang('SMS content goes here.');?>" name="sms_reminder_text_checkout[]" id="sms_reminder_text_checkout<?php echo $i;?>"><?php echo isset($sms_content['reminder'][$i]['reminder_text']) ? $sms_content['reminder'][$i]['reminder_text'] : "Hi, have you forgot something special? Stock limited, complete your order before it is out of stock : {{cart_url}}";?></textarea>
						                         	</span>
						                         </div>
						                     </div>
					                     <?php 
				                       	 ...
				                       	 <div class="reminder_badge_warpper tab-pane fade" id="sms_checkout" role="tabpanel" aria-labelledby="sms_checkout_link>">	
					                         ...
					                         <div class="reminder_block">
					                         	<span class="block4">
					                         		<textarea data-toggle="tooltip" title="<?php echo lang('SMS content goes here.'); ?>" name="sms_reminder_text_checkout_next" id="sms_reminder_text_checkout_next"><?php echo isset($sms_content['checkout']['checkout_text']) ? $sms_content['checkout']['checkout_text'] : "";?></textarea>
					                         	</span>
					                         </div>
					                     </div>
							           	 ...
							           	 for($i=1; $i <=$how_many_reminder; $i++)
							             	 { ?>
							                   <div class="reminder_badge_warpper tab-pane fade <?php if($i==1) echo 'active show';?> " style="border:none;padding: 0" id="email_reminder<?php echo $i;?>" role="tabpanel" aria-labelledby="email_reminder_link>">
							                       ...
							                       <textarea class="visualeditor" data-toggle="tooltip" title="<?php echo lang('Email content goes here.');?>" name="email_reminder_text_checkout[]" id="email_reminder_text_checkout<?php echo $i;?>"><?php echo isset($email_content['reminder'][$i]['reminder_text']) ? $email_content['reminder'][$i]['reminder_text'] : 'Hi {{last_name}},<br>Have you forgot something special? Stock limited, complete your order before it is out of stock : <a href="{{checkout_url}}" target="_blank">Checkout here</a></a><br>Happy shopping :)';?></textarea>							                       	
							                   </div>
							               	 <?php 
							             	 } 
							             	 ?>
							             	...
							             	<div class="reminder_badge_warpper tab-pane fade" style="border:none;padding: 0" id="email_checkout" role="tabpanel" aria-labelledby="email_checkout_link>">	
							                	...
							                	<textarea class="visualeditor"  data-toggle="tooltip" title="<?php echo lang('Email content goes here.'); ?>" name="email_reminder_text_checkout_next" id="email_reminder_text_checkout_next"><?php echo isset($email_content['checkout']['checkout_text']) ? $email_content['checkout']['checkout_text'] : '';?></textarea>
							                </div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-footer">  
							<button class="btn btn-lg btn-primary" id="get_button" name="get_button" type="button"><i class="fas fa-code"></i> <?php echo lang("Edit Plugin");?></button>
		...
		{        
			...
			$.ajax({
				...
				{  
					...
					{	
						swal('<?php echo lang("Plugin Updated"); ?>', response.message, 'success').then((value) => { window.location.assign('<?php echo base_url("woocommerce_abandoned_cart/recovery_plugin_list") ?>');});

...
<section class="section">
  <div class="section-header m-0">
    ...
    <div class="section-header-button">
      <a class="btn btn-primary" href="<?php echo base_url("woocommerce_abandoned_cart/recovery_plugin_add");?>">
        <i class="fas fa-plus-circle"></i> <?php echo lang("Create Plugin"); ?>
      </a> 
    </div>    
  </div>
  ...
  <div class="section-body">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-12 col-md-6">
            ...
            / <?php echo lang("WooCommerce Abandoned Cart"); ?>
          </div>
          <div class="col-12 col-md-6">
            <div class="breadcrumb-item">
              <form method="POST" action="<?php echo base_url('woocommerce_abandoned_cart/recovery_plugin_list') ?>">          
                <div class="input-group">
                  ...
                  <input type="text" class="form-control datepicker_x" value="<?php echo session()->get("woocommerce_from_date"); ?>" id="from_date" name="from_date" style="width:115px"> 
                  <input type="text" class="form-control datepicker_x" value="<?php echo session()->get("woocommerce_to_date"); ?>" id="to_date" name="to_date" style="width:115px">
      ...
      <div class="card-body">
        <div class="empty-state">
          <img class="img-fluid" style="height: 200px" src="<?php echo base_url('assets/img/drawkit/drawkit-nature-man-colour.svg'); ?>" alt="image">
           <h2 class="mt-0"><?php echo lang("We could not find any woocommerce plugin.");?></h2>
          <p class="lead"><?php echo lang("You have create a plugin for your woocommerce store first."); ?></p>
          <a href="<?php echo base_url('woocommerce_abandoned_cart/recovery_plugin_add'); ?>" class="btn btn-outline-primary mt-4"><i class="fas fa-arrow-circle-right"></i> <?php echo lang("Create Plugin");?></a>
        </div>
      </div>
    </div>
    ...
    { 
      ...
      $from_date = strtotime(session()->get("woocommerce_from_date")); 
      $to_date = strtotime(session()->get("woocommerce_to_date")); 
      do 
      {
            ...
            <div class="card-body padding-0">
              <ul class="list-group" id="page_list_ul">
                <?php $i=0; foreach($domain_info as $value) { ?> 
                  <li class="list-group-item <?php if($value['id']==session()->get("woocommerce_selected_plugin")) echo 'active'; ?> page_list_item" page_table_id="<?php echo $value['id']; ?>">
              ...
              <div class="col-4 p-0">
                <div class="card-header-action dropdown float-right">
                  ...
                  <ul class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                    <li class="dropdown-title"><?php echo lang("Actions"); ?></li>
                    <li><?php echo '<a class="dropdown-item reminder_report" href="" data-toggle="tooltip" title="'.lang('Report').'" campaign_id='.$plugin_info['id'].'><i class="fas fa-eye text-info"></i> &nbsp; '.lang("Reminder Report").'</a>';?></li>
                    <li><?php echo '<a class="dropdown-item" href="'.base_url()."woocommerce_abandoned_cart/recovery_plugin_edit/".$plugin_info['id'].'" data-toggle="tooltip" title="'.lang('Edit').'" campaign_id='.$plugin_info['id'].'><i class="fas fa-edit text-warning"></i> &nbsp; '.lang("Edit").'</a>';?></li>
                    <li><?php echo '<a class="dropdown-item download" data-toggle="tooltip" href="#" title="'.lang('Download').'" data-toggle="tooltip" campaign_id='.$plugin_info['id'].'><i class="fas fa-cloud-download-alt text-primary"></i> &nbsp; '.lang("Download").'</a>'; ?></li>
                    <li><?php echo '<a class="dropdown-item delete_campaign" data-toggle="tooltip" href="#" title="'.lang('Delete').'" data-toggle="tooltip" campaign_id='.$plugin_info['id'].'><i class="fas fa-trash-alt text-danger"></i> &nbsp; '.lang("Delete").'</a>'; ?></li>
                  </ul>
                </div> 
              </div>
            </div>
                    ...
                    <div id="right_column_bottom_content">
                      ...
                      <div class="row">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                          <div class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                              <div class="card-header">
                                <h4><?php echo lang("Total Cart"); ?></h4>
                              </div>
                              <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 col-md-8">
                          ...
                          <div class="card no_shadow">
                            <div class="card-header">
                              <h4><i class="fas fa-globe-asia"></i> <?php echo lang("Top Buyers"); ?></h4>
                            </div>
                            <div class="card-body">
                              <div class="row">
                                <?php
                                if(empty($top_buyers)) echo '<div class="col-12"><div class="alert alert-light">'.lang("No country data found").'</div></div>';
                                $country_limit = 0;
                        ...
                        <div class="col-12 col-md-4">
                          ...
                          <div class="card no_shadow">
                            <div class="card-header">
                              <h4><i class="fas fa-tasks"></i> <?php echo lang("Activities"); ?></h4>
                            </div>
                            <div class="card-body makeScroll">
                              
                              <div class="tickets-list">
                                <?php
                                if(empty($webhook_info)) echo '<div class="alert alert-light">'.lang("No activity found").'</div>';
                                foreach ($webhook_info as $key => $value) 
                                { 
                                  ...
                                  else 
                                  {
                                    ...
                                    $hook_activity = lang("Successful checkout").' <span class="text-success">('.$currency_icon.$value['checkout_amount'].')</span>';
                                  }
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fas fa-code"></i> <?php echo lang('Checkbox plugin embed code'); ?></h5>
        ...
        <div class="row">
          <div class="col-12">
            <div class="form-group">
              <label > <?php echo lang("Copy the code below and paste inside the html element of your webpage where you want to display this plugin")?> </label>
      ...
      <div class="modal-footer">
        <!-- <button id="copy_js_code" type="button" class="btn btn-primary"><i class="fas fa-cut"></i> <?php echo lang('Copy'); ?> -->
...
$(document).ready(function($) {  
    ...
    $(document).on('click', '.delete_campaign', function(event) {
        ...
        swal({
              title: '<?php echo lang("Delete Plugin"); ?>',
              text: '<?php echo lang("Do you really want to delete this plugin?"); ?>',
              icon: 'warning',
              buttons: true,
              dangerMode: true,
            })

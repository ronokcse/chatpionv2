...
class Messenger_bot extends Home
{
    ...
    public function user_input_flow_assaign_check($sender_id, $page_id, $subscriber_info, $answer = "", $fb_message_id = "", $message_type = "")
    {
        ...
        if (isset($input_flow_campaign_info[0]) && $input_flow_campaign_info[0]['input_flow_campaign_id'] > 0) {
            ...
            $this->process_user_input($flow_campaign_id, $question_id, $sender_id, $subscriber_info, $page_id, $answer, $fb_message_id, $message_type);
            exit;
        }
    }
    ...
    public function webhook_callback_main()
    {
        ...
        // file_put_contents("ronok.txt",$response_raw, FILE_APPEND | LOCK_EX);exit;
        // $response_raw = '{"object":"page","entry":[{"time":1757237589753,"id":"100544641854039","messaging":[{"sender":{"id":"3457251890987443"},"recipient":{"id":"100544641854039"},"timestamp":1757237589287,"message":{"mid":"m_SLw0dWx34BgIVpflzmAMVs3jel4-WcsNNy_jZ0883R9owdp6_I-3T_nruECgtP-0LUeWMYRbUxgqG4adO1fcgQ","text":"hello"}}]}]}';
        ...
        $insert_livechat_data = [
            ...
            'user_id' => $subscriber_info[0]['user_id'] ?? null,
        ...
        //message for all
        if (
            isset($response['entry'][0]['messaging'][0]['message']['text'])
            ...
            foreach ($messenger_bot_info as $key => $value) {
                ...
                foreach ($cam_keywords_array as $cam_keywords) {
                    ...
                    if ($matches !== FALSE) {
                        ...
                        $this->thirdparty_webhook_trigger($page_id, $sender_id, "trigger_keyword_{$cam_keywords}");
            ...
            if ($social_media_type == 'fb')
                $where['where'] = array(
                    ...
                    'messenger_bot.keyword_type' => 'no match',
                    'facebook_rx_fb_page_info.bot_enabled' => '1',
                    'facebook_rx_fb_page_info.no_match_found_reply' => 'enabled',
                ...
                $where['where'] = array(
                    ...
                    'messenger_bot.keyword_type' => 'no match',
                    'facebook_rx_fb_page_info.bot_enabled' => '1',
                    'facebook_rx_fb_page_info.ig_no_match_found_reply' => 'enabled',
                    'media_type' => $social_media_type
                );
    ...
    public function get_page_details()
    {
        ...
        if (session()->get('user_type') == 'Admin' || in_array(197, $this->module_access)) :
            ...
            else $persistent_field = "persistent_enabled";
    ...
    private function get_postback_info($matches, $page_table_id, $keyword_bot_id, $level)
    {
        ...
        foreach ($matches as $postback_match) {
            ...
            $this->postback_info[$keyword_bot_id]['postback_info'][$postback_match] = array(
                "id" => $id,
                "child_postback" => $matches[1],
                'postback_id' => $postback_match,
                "level" => $level,
...
' . json_encode($json_value) . '
    ...
    public function edit_bot_settings_from_error_log($settings_id = 161)
    {
        ...
        if ($settings_id == "") {
            echo "BOT Settings ID Not Found";
            exit;
        }

...
// Note: skip this during CLI (e.g. `php spark routes`) because CI's route introspection
// may try to reflect dynamic `::$1` method routes and crash for some modules.
if (PHP_SAPI !== 'cli') {
            ...
            if (is_dir($module_path)) {
                ...
                if (file_exists($controller_file)) {
                    ...
                    if (strpos($file_content, 'namespace App\\Modules') !== false || 
                        ...
                        // Base route: /module -> Controller::index
                        $routes->add($module_lower, $full_namespace . '::index');
